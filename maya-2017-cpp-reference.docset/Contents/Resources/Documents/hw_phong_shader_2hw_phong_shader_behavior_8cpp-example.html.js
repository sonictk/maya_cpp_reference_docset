...
<div class=\"line\">{</div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html\">MStatus</a> result = <a name=\"a8\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80a1ef6c2d725fb4bec3e7e840d28adbc00\">MS::kFailure</a>;</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span>(!srcPlug.<a name=\"a9\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a1c18142e8f09680711f472aa2ddf8ac6\">isNull</a>() &amp;&amp; !destPlug.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a1c18142e8f09680711f472aa2ddf8ac6\">isNull</a>())</div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">        <a name=\"_a10\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html\">MString</a> cmd = <span class=\"stringliteral\">&quot;connectAttr &quot;</span>;</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span> (force) cmd += <span class=\"stringliteral\">&quot;-f &quot;</span>;</div>\n\
<div class=\"line\">        cmd += srcPlug.<a name=\"a11\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a049384adbea0396ea2f03d1ad4d69df1\">name</a>() + <span class=\"stringliteral\">&quot; &quot;</span> + destPlug.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a049384adbea0396ea2f03d1ad4d69df1\">name</a>();</div>\n\
<div class=\"line\">        result = <a name=\"a12\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_global.html#a09e405631e7cf680f8ac9d934ad73434\">MGlobal::executeCommand</a>(cmd);</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"><span class=\"preprocessor\">#if VERBOSE</span></div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\"><span class=\"preprocessor\">#if VERBOSE</span></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> (result != <a name=\"a13\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80af0536797208144380691e2b376ffc1d1\">MS::kSuccess</a>)</div>\n\
...
<div class=\"line\">    <span class=\"comment\">//  </span></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> ((src.typeName() == <span class=\"stringliteral\">&quot;hwPhongShader&quot;</span>) &amp;&amp;</div>\n\
<div class=\"line\">        destinationPlug.<a name=\"a14\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#ad1aa507eb8e63e89e8d46a0abc18aa8c\">node</a>().<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html#af0af77f14f96d1134fb8e8e60dc7e420\">hasFn</a>(<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn.html#a1d1cfd8ffb84e947f82999c682b666a7a2af9af308555c50cf68e2c14595b680b\">MFn::kLambert</a>))</div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">        result = connectAttr(src.findPlug(<span class=\"stringliteral\">&quot;outColor&quot;</span>), destinationPlug, force);</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"><span class=\"preprocessor\">#if VERBOSE</span></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> (result != <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80af0536797208144380691e2b376ffc1d1\">MS::kSuccess</a>)</div>\n\
<div class=\"line\">        cerr &lt;&lt; <span class=\"stringliteral\">&quot;connectNodeToAttr &quot;</span>&lt;&lt;src.name().asChar() </div>\n\
<div class=\"line\">             &lt;&lt; <span class=\"stringliteral\">&quot; &quot;</span> &lt;&lt; destinationPlug.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a049384adbea0396ea2f03d1ad4d69df1\">name</a>().<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html#aa9ab612f356c53479afc4c648c9ef94d\">asChar</a>()  </div>\n\
<div class=\"line\">             &lt;&lt; <span class=\"stringliteral\">&quot; failed\\n&quot;</span>;</div>\n\
<div class=\"line\"><span class=\"preprocessor\">#endif</span></div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">return</span> result;</div>\n\
...
<div class=\"line\">{</div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html\">MStatus</a> result = <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80a1ef6c2d725fb4bec3e7e840d28adbc00\">MS::kFailure</a>;</div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html\">MObject</a> sourceNode = sourcePlug.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#ad1aa507eb8e63e89e8d46a0abc18aa8c\">node</a>();</div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_dependency_node.html\">MFnDependencyNode</a> src(sourceNode);</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> ((src.typeName() == <span class=\"stringliteral\">&quot;hwPhongShader&quot;</span>) &amp;&amp;</div>\n\
<div class=\"line\">        destinationNode.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html#af0af77f14f96d1134fb8e8e60dc7e420\">hasFn</a>(<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn.html#a1d1cfd8ffb84e947f82999c682b666a7a2af9af308555c50cf68e2c14595b680b\">MFn::kLambert</a>))</div>\n\
...
<div class=\"line\"><span class=\"preprocessor\">#if VERBOSE</span></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> (result != <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80af0536797208144380691e2b376ffc1d1\">MS::kSuccess</a>)</div>\n\
<div class=\"line\">        cerr &lt;&lt; <span class=\"stringliteral\">&quot;connectNodeAttrToNode &quot;</span>&lt;&lt;sourcePlug.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a049384adbea0396ea2f03d1ad4d69df1\">name</a>().<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html#aa9ab612f356c53479afc4c648c9ef94d\">asChar</a>() </div>\n\
<div class=\"line\">             &lt;&lt; <span class=\"stringliteral\">&quot; &quot;</span> &lt;&lt; <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_dependency_node.html\">MFnDependencyNode</a>(destinationNode).<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_dependency_node.html#a049384adbea0396ea2f03d1ad4d69df1\">name</a>().<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html#aa9ab612f356c53479afc4c648c9ef94d\">asChar</a>()  </div>\n\
<div class=\"line\">             &lt;&lt; <span class=\"stringliteral\">&quot; failed\\n&quot;</span>;</div>\n\
<div class=\"line\"><span class=\"preprocessor\">#endif</span></div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">{</div>\n\
<div class=\"line\"><span class=\"preprocessor\">#if VERBOSE</span></div>\n\
<div class=\"line\">    cerr &lt;&lt; <span class=\"stringliteral\">&quot;In connectAttrToAttr &quot;</span>&lt;&lt;sourcePlug.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a049384adbea0396ea2f03d1ad4d69df1\">name</a>().<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html#aa9ab612f356c53479afc4c648c9ef94d\">asChar</a>() </div>\n\
<div class=\"line\">         &lt;&lt; <span class=\"stringliteral\">&quot; &quot;</span> &lt;&lt; destinationPlug.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a049384adbea0396ea2f03d1ad4d69df1\">name</a>().<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html#aa9ab612f356c53479afc4c648c9ef94d\">asChar</a>()</div>\n\
