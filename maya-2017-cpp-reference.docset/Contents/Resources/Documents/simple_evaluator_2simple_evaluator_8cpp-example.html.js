...
<div class=\"line\"></div>\n\
<div class=\"line\"><span class=\"keywordtype\">int</span> _profilerCategory = <a name=\"a0\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_profiler.html#aa43b57b5469ba5db72843a2d2b9e5c11\">MProfiler::addCategory</a>(<span class=\"stringliteral\">&quot;Simple Evaluator&quot;</span>);</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"><span class=\"comment\">//</span></div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> (stat == <a name=\"a15\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80af0536797208144380691e2b376ffc1d1\">MS::kSuccess</a>)</div>\n\
<div class=\"line\">    {</div>\n\
...
<div class=\"line\">        {</div>\n\
<div class=\"line\">            <a name=\"_a16\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_dependency_node.html\">MFnDependencyNode</a> controllerTagNode(dgIter.thisNode(), &amp;stat);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">            </div>\n\
<div class=\"line\">            <a name=\"_a17\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html\">MPlug</a> currControllerTagPlug = controllerTagNode.findPlug(<span class=\"stringliteral\">&quot;controllerObject&quot;</span>, &amp;stat);</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">            <span class=\"keywordflow\">if</span> (stat != <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80af0536797208144380691e2b376ffc1d1\">MS::kSuccess</a>) <span class=\"keywordflow\">continue</span>;</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">            <span class=\"keywordflow\">if</span> (currControllerTagPlug.<a name=\"a18\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a3727c18c58fc5ba8be5fb2582b5d06f1\">connectedTo</a>(source, <span class=\"keyword\">true</span> <span class=\"comment\">/* asDst */</span>, <span class=\"keyword\">false</span> <span class=\"comment\">/* asSrc */</span>, &amp;stat))</div>\n\
<div class=\"line\">            {</div>\n\
<div class=\"line\">                <span class=\"keywordflow\">if</span> (stat != <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80af0536797208144380691e2b376ffc1d1\">MS::kSuccess</a>) <span class=\"keywordflow\">continue</span>;</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">                <span class=\"comment\">// there should only be one source with the controller tag node as destination</span></div>\n\
<div class=\"line\">                <a name=\"_a19\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html\">MObject</a> controllerNode = source[0].node(&amp;stat);</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">                <span class=\"keywordflow\">if</span> (stat != <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80af0536797208144380691e2b376ffc1d1\">MS::kSuccess</a>) <span class=\"keywordflow\">continue</span>;</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">                {</div>\n\
<div class=\"line\">                    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html\">MPlug</a> currPlug = currControllerNode.findPlug(values[j], &amp;stat);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">                    {</div>\n\
<div class=\"line\">                        std::cerr &lt;&lt; <span class=\"stringliteral\">&quot;NO PLUG: &quot;</span> &lt;&lt; currControllerNode.<a name=\"a20\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a049384adbea0396ea2f03d1ad4d69df1\">name</a>().<a name=\"a21\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html#aa9ab612f356c53479afc4c648c9ef94d\">asChar</a>() &lt;&lt; <span class=\"stringliteral\">&quot;.&quot;</span> &lt;&lt; values[j] &lt;&lt; std::endl;</div>\n\
<div class=\"line\">                    }</div>\n\
<div class=\"line\">                }</div>\n\
<div class=\"line\">            }</div>\n\
<div class=\"line\">        }</div>\n\
...
<div class=\"line\">        <span class=\"keywordflow\">if</span> (stat == <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80af0536797208144380691e2b376ffc1d1\">MS::kSuccess</a>)</div>\n\
<div class=\"line\">        {</div>\n\
<div class=\"line\">            boost::hash_combine(fCurrentHashValue, value);</div>\n\
<div class=\"line\">        }</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">else</span></div>\n\
<div class=\"line\">        {</div>\n\
...
<div class=\"line\">{</div>\n\
<div class=\"line\">    <a name=\"_a23\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_profiling_scope.html\">MProfilingScope</a> profilingScopeForEval(_profilerCategory, MProfiler::kColorD_L1, <span class=\"stringliteral\">&quot;buildPoseHash&quot;</span>, <span class=\"stringliteral\">&quot;building pose hash&quot;</span>);</div>\n\
...
<div class=\"line\">        cluster-&gt;<a name=\"a24\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_custom_evaluator_cluster_node.html#ad188df5aadbf5bdbc691f3d82e2e371d\">evaluate</a>();</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\">}</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">}</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"><span class=\"keyword\">const</span> <span class=\"keywordtype\">char</span>* simpleEvaluator::evaluatorName()</div>\n\
<div class=\"line\">{</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">return</span> <span class=\"stringliteral\">&quot;SimpleEvaluator&quot;</span>;</div>\n\
<div class=\"line\">}</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    {</div>\n\
<div class=\"line\">        status.<a name=\"a26\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a1f01a4748fea4d8bcced082df83f804d\">perror</a>(<span class=\"stringliteral\">&quot;registerEvaluator&quot;</span>);</div>\n\
