...
<div class=\"line\">    </div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html\">MObject</a> node = plug.<a name=\"a47\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#ad1aa507eb8e63e89e8d46a0abc18aa8c\">node</a>();</div>\n\
...
<div class=\"line\">        <a name=\"a52\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_open_c_l_info.html#a93e129c1488b06f3347eaaad703ffe34\">MOpenCLInfo::getMayaDefaultOpenCLCommandQueue</a>(),</div>\n\
<div class=\"line\">        fKernel.get(),</div>\n\
...
<div class=\"line\">{</div>\n\
<div class=\"line\">    <a name=\"a56\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_renderer.html#a4678a72ac6959ed21d422d27928d0343\">MHWRender::MRenderer::theRenderer</a>()-&gt;<a name=\"a57\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_renderer.html#a539094d46be4675c5690419f1c09b38e\">releaseGPUMemory</a>(fNumElements*<span class=\"keyword\">sizeof</span>(<span class=\"keywordtype\">float</span>));</div>\n\
<div class=\"line\">    fCLWeights.reset();</div>\n\
<div class=\"line\">    fOffsetMatrix.reset();</div>\n\
<div class=\"line\">    <a name=\"a58\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_open_c_l_info.html#a08df219d94dcf2dc03724eff7d5c6483\">MOpenCLInfo::releaseOpenCLKernel</a>(fKernel);</div>\n\
...
<div class=\"line\">    <span class=\"keywordflow\">if</span> ((fCLWeights.get() &amp;&amp; !evaluationNode.<a name=\"a59\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_evaluation_node.html#aad069e4fae5beaab80d421a1e18505aa\">dirtyPlugExists</a>(<a name=\"a60\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_px_deformer_node.html#a35a26e066faae03152b67f2067b1d53f\">MPxDeformerNode::weightList</a>, &amp;status)) || !status)</div>\n\
<div class=\"line\">    {</div>\n\
...
<div class=\"line\">    status = weightList.<a name=\"a63\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_array_data_handle.html#a8d77f0fea87bb6854b60cd199bf26240\">jumpToElement</a>(plug.<a name=\"a64\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a7ee0cc502aa499c01ff2e41c76ac53c7\">logicalIndex</a>());</div>\n\
...
<div class=\"line\">    {</div>\n\
<div class=\"line\">        <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_data_handle.html\">MDataHandle</a> weightsStructure = weightList.<a name=\"a65\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_array_data_handle.html#a81d24dca6d647d8d0a8fe0ef2c63b170\">inputValue</a>(&amp;status);</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span> (!status) <span class=\"keywordflow\">return</span>;</div>\n\
<div class=\"line\">        <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_array_data_handle.html\">MArrayDataHandle</a> weights = weightsStructure.<a name=\"a66\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_data_handle.html#a58951af761a410e17982060cae4fdf49\">child</a>(<a name=\"a67\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_px_deformer_node.html#ae4200be6c5a30e8d817e6a3b51d20402\">MPxDeformerNode::weights</a>);</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span> (!status) <span class=\"keywordflow\">return</span>;</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">        <span class=\"comment\">// number of non-zero weights</span></div>\n\
<div class=\"line\">        <span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span> numWeights = weights.<a name=\"a68\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_array_data_handle.html#a5f3dd1d27853eccbbe78b6d4383ccb79\">elementCount</a>(&amp;status);</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span> (!status) <span class=\"keywordflow\">return</span>;</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">        <span class=\"keywordflow\">for</span>(<span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span> i=0; i&lt;numWeights; i++, weights.<a name=\"a69\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_array_data_handle.html#a73616f002814b8abe6d921db72d7a496\">next</a>())</div>\n\
<div class=\"line\">        {</div>\n\
<div class=\"line\">            <span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span> weightsElementIndex = weights.<a name=\"a70\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_array_data_handle.html#a2ca3c3d60cf2f3ac005b651379f26143\">elementIndex</a>(&amp;status);</div>\n\
...
<div class=\"line\">    omat = omat.<a name=\"a73\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_matrix.html#a6fadbac6023eb9d361176a87b73063dc\">transpose</a>();</div>\n\
...
<div class=\"line\">                                  offset::initialize, <a name=\"a75\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_px_node.html#a1d1cfd8ffb84e947f82999c682b666a7a397b2fe312ffa55c207f8f9b12f616d3\">MPxNode::kDeformerNode</a> );</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    <a name=\"a76\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_g_p_u_deformer_registry.html#adea377dddd00bec03a6cdf70360f567f\">MGPUDeformerRegistry::registerGPUDeformerCreator</a>(</div>\n\
<div class=\"line\">        nodeClassName,</div>\n\
<div class=\"line\">        registrantId,</div>\n\
<div class=\"line\">        offsetGPUDeformer::getGPUDeformerInfo());</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <a name=\"a77\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_g_p_u_deformer_registry.html#a2e96bdde07077e4af65457c6edb9c11a\">MGPUDeformerRegistry::addConditionalAttribute</a>(</div>\n\
<div class=\"line\">            nodeClassName,</div>\n\
<div class=\"line\">            registrantId,</div>\n\
...
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html\">MString</a> nodeClassName(<span class=\"stringliteral\">&quot;offset&quot;</span>);</div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html\">MString</a> registrantId(<span class=\"stringliteral\">&quot;mayaPluginExample&quot;</span>);</div>\n\
<div class=\"line\">    <a name=\"a78\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_g_p_u_deformer_registry.html#aa290ea8dc9cb67e1056f132b8e441d5f\">MGPUDeformerRegistry::deregisterGPUDeformerCreator</a>(</div>\n\
<div class=\"line\">        nodeClassName,</div>\n\
<div class=\"line\">        registrantId);</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">return</span> result;</div>\n\
