...
<div class=\"line\"></div>\n\
<div class=\"line\">        <span class=\"keywordflow\">else</span> <span class=\"keywordflow\">if</span>( !_stricmp( mDesc.Semantic, dx11ShaderSemantic::kColor))                                paramSemantic = <a name=\"a54\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_uniform_parameter.html#ae2d1a7ca98deaf6f6acd790af2e234efab83a5901dec4867950652df9bde9c87a\">MUniformParameter::kSemanticColor</a>;</div>\n\
...
<div class=\"line\">        <span class=\"keywordflow\">else</span> <span class=\"keywordflow\">if</span>( !_stricmp( mDesc.Semantic, dx11ShaderSemantic::kBump))                                 paramSemantic = <a name=\"a56\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_uniform_parameter.html#ae2d1a7ca98deaf6f6acd790af2e234efae867e160beb59794a5b46005abdfec40\">MUniformParameter::kSemanticBump</a>;</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">else</span> <span class=\"keywordflow\">if</span>( !_stricmp( mDesc.Semantic, dx11ShaderSemantic::kEnvironment))                          paramSemantic = <a name=\"a57\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_uniform_parameter.html#ae2d1a7ca98deaf6f6acd790af2e234efa37192c0f651ef717c41cbc9678d1f5d4\">MUniformParameter::kSemanticEnvironment</a>;</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> (!semanticNames.<a name=\"a71\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string_array.html#a580388f31f60c46fac867ca48a48da1e\">length</a>()) {</div>\n\
...
<div class=\"line\">                mAnnotationIndex.<a name=\"a72\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string_array.html#a3db31367f989449bb9b121cd734dc0df\">insert</a>(TAnnotationIndex::value_type(std::string(varDesc.Name), idx));</div>\n\
<div class=\"line\">            }</div>\n\
<div class=\"line\">        }</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">}</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"><span class=\"keywordtype\">void</span> CUniformParameterBuilder::logUnsupportedTypeWarning(<span class=\"keyword\">const</span> <a name=\"_a73\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string_resource_id.html\">MStringResourceId</a>&amp; typeId)</div>\n\
<div class=\"line\">{</div>\n\
