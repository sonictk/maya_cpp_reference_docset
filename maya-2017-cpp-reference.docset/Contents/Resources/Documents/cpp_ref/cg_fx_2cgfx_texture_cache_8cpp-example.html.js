...
<html>\n\
   <head><script src=\"../scripts/yepnope.1.5.4-min.js\" type=\"text/javascript\"></script><script src=\"../scripts/lib/jquery-1.11.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\"><meta name=\"product\" content=\"MAYAUL\"><meta name=\"release\" content=\"2017\"><meta name=\"book\" content=\"Developer\"><meta name=\"created\" content=\"2016-06-16\"><meta name=\"topicid\" content=\"GUID-02DEF634-1E7B-48C6-8ACD-2C934CA97887\"><meta name=\"topic-type\" content=\"concept\">\n\
      <title>cgFx/cgfxTextureCache.cpp</title>\n\
   \n\
\n\
...
$(window).load( function() {\n\
 ...
 if (!tocSystemNeedsToBeLoaded) { cpp_ref_initializeToc(); }\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>cgFx/cgfxTextureCache.cpp</h1>\n\
         </div>\n\
\n\
...
<div class=\"line\">            path = cgfxFindFile(effectFile.<a name=\"a4\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_file_object.html#a4a5fc51336041210363dc02b26533452\">path</a>() + texFileName);</div>\n\
<div class=\"line\">        }</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">        gGLFT-&gt;<a name=\"a8\"></a>glGenTextures(1, &amp;val);</div>\n\
...
<div class=\"line\">                    image.load(path.<a name=\"a9\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html#aa9ab612f356c53479afc4c648c9ef94d\">asChar</a>(),<span class=\"keyword\">false</span>);</div>\n\
...
<div class=\"line\">                gGLFT-&gt;<a name=\"a10\"></a>glBindTexture(GL_TEXTURE_1D,textureId);</div>\n\
...
<div class=\"line\">                    gGLFT-&gt;<a name=\"a11\"></a>glTexParameteri(</div>\n\
...
<div class=\"line\">                    gGLFT-&gt;<a name=\"a12\"></a>glTexImage1D(</div>\n\
...
<div class=\"line\">                {</div>\n\
<div class=\"line\">                    <span class=\"comment\">// Load the image</span></div>\n\
<div class=\"line\">                    gGLFT-&gt;glTexParameteri(</div>\n\
...
<div class=\"line\">                    <span class=\"comment\">//</span></div>\n\
<div class=\"line\">                    <span class=\"keywordflow\">if</span> (textureNode != <a name=\"a13\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html#ae6af14e0aa2c92bdda88c81280e1d122\">MObject::kNullObj</a>)</div>\n\
<div class=\"line\">                    {</div>\n\
<div class=\"line\">                        <a name=\"_a14\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_image.html\">MImage</a> img;</div>\n\
<div class=\"line\">                        <span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span> width, height;</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">                        <span class=\"keywordflow\">if</span> (<a name=\"a15\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80af0536797208144380691e2b376ffc1d1\">MS::kSuccess</a> == img.<a name=\"a16\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_image.html#a3e3e6e8e454d2335a2206ea7fc6075d9\">readFromTextureNode</a>(textureNode))</div>\n\
<div class=\"line\">                        {</div>\n\
...
<div class=\"line\">                            {</div>\n\
<div class=\"line\">                                img.<a name=\"a17\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_image.html#ac84d6f0011d9b722d845eaa97042bca1\">verticalFlip</a>();</div>\n\
<div class=\"line\">                            }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">                            <a name=\"_a18\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html\">MStatus</a> status = img.<a name=\"a19\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_image.html#acab1f6acf34fc74e4d717322fa35241a\">getSize</a>( width, height);</div>\n\
<div class=\"line\">                            <span class=\"keywordflow\">if</span> (width &gt; 0 &amp;&amp; height &gt; 0 &amp;&amp; (status != <a name=\"a20\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80a1ef6c2d725fb4bec3e7e840d28adbc00\">MStatus::kFailure</a>) )</div>\n\
<div class=\"line\">                            {</div>\n\
...
<div class=\"line\">                                        img.<a name=\"a21\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_image.html#aa099a65eabd0fe2c81af181d5f96b71a\">resize</a>( p2Width, p2Height, <span class=\"keyword\">false</span> <span class=\"comment\">/* preserverAspectRatio */</span>);</div>\n\
<div class=\"line\">                                    }</div>\n\
<div class=\"line\">                                }</div>\n\
<div class=\"line\">                                gGLFT-&gt;glTexParameteri(GL_TEXTURE_2D, GL_GENERATE_MIPMAP_SGIS, <span class=\"keyword\">true</span>);</div>\n\
<div class=\"line\">                                gGLFT-&gt;<a name=\"a22\"></a>glTexImage2D(</div>\n\
<div class=\"line\">                                    GL_TEXTURE_2D, 0, GL_RGBA, width, height, 0,</div>\n\
<div class=\"line\">                                    GL_RGBA, GL_UNSIGNED_BYTE, img.<a name=\"a23\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_image.html#aba6def80dd70f1c9af3dbd348fe270ac\">pixels</a>());</div>\n\
<div class=\"line\">                                imageLoaded = <span class=\"keyword\">true</span>;</div>\n\
<div class=\"line\">                            }</div>\n\
<div class=\"line\">                        }</div>\n\
<div class=\"line\">                    }</div>\n\
...
<div class=\"line\">                    <span class=\"comment\">// Create a dummy stand-in texture</span></div>\n\
<div class=\"line\">                    gGLFT-&gt;glTexImage2D(</div>\n\
...
<div class=\"line\">                <span class=\"keywordflow\">else</span> {</div>\n\
<div class=\"line\">                    <span class=\"comment\">// Create a dummy stand-in texture</span></div>\n\
<div class=\"line\">                    gGLFT-&gt;<a name=\"a24\"></a>glTexImage3D(</div>\n\
...
<div class=\"line\">    );</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keyword\">virtual</span> <span class=\"keywordtype\">void</span> dump()<span class=\"keyword\"> const</span></div>\n\
<div class=\"line\"><span class=\"keyword\">    </span>{</div>\n\
