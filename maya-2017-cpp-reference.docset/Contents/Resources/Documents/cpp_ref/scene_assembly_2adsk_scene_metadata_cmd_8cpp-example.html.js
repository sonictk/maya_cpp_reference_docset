...
<html>\n\
   <head><script src=\"../scripts/yepnope.1.5.4-min.js\" type=\"text/javascript\"></script><script src=\"../scripts/lib/jquery-1.11.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\"><meta name=\"product\" content=\"MAYAUL\"><meta name=\"release\" content=\"2017\"><meta name=\"book\" content=\"Developer\"><meta name=\"created\" content=\"2016-06-16\"><meta name=\"topicid\" content=\"GUID-02DEF634-1E7B-48C6-8ACD-2C934CA97887\"><meta name=\"topic-type\" content=\"concept\">\n\
      <title>sceneAssembly/adskSceneMetadataCmd.cpp</title>\n\
   \n\
\n\
...
$(window).load( function() {\n\
 ...
 if (!tocSystemNeedsToBeLoaded) { cpp_ref_initializeToc(); }\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>sceneAssembly/adskSceneMetadataCmd.cpp</h1>\n\
         </div>\n\
\n\
...
<div class=\"line\">    <a name=\"_a15\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html\">MString</a> scenePath = objs[0];</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    std::auto_ptr&lt; Accessor &gt; accessor( getAccessorForScene( scenePath ) );</div>\n\
...
<div class=\"line\">    <a name=\"_a16\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/classadsk_1_1_data_1_1_associations.html\">Associations</a> associations;</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> ( <a name=\"a17\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80af0536797208144380691e2b376ffc1d1\">MS::kSuccess</a> != getSceneAssociations(*(accessor.get()), associations) )</div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">return</span> <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80a1ef6c2d725fb4bec3e7e840d28adbc00\">MS::kFailure</a>;</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    <a name=\"_a18\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/classadsk_1_1_data_1_1_channel.html\">Channel</a> *channel = associations.<a name=\"a19\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/classadsk_1_1_data_1_1_associations.html#afdf389cfedef552b73399ab8d4aea282\">findChannel</a>( channelName );</div>\n\
...
<div class=\"line\">        errorString.<a name=\"a20\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html#a07ae464181c795f43fa1bcc288acff91\">format</a>( errorString, fChannelName.arg() );</div>\n\
<div class=\"line\">        displayError( errorString );</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">return</span> <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80a1ef6c2d725fb4bec3e7e840d28adbc00\">MS::kFailure</a>;</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <a name=\"_a21\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/classadsk_1_1_data_1_1_stream.html\">Stream</a> *stream = channel-&gt;dataStream( 0 );</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    <span class=\"keywordflow\">if</span> ( 0 == stream-&gt;<a name=\"a22\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/classadsk_1_1_data_1_1_stream.html#a2cf54c09c7946e9fed5c17c5959c8e98\">elementCount</a>() )</div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">        <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html\">MStatus</a> resStatus;</div>\n\
...
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <a name=\"_a23\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/classadsk_1_1_data_1_1_handle.html\">Handle</a> handle = stream-&gt;<a name=\"a24\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/classadsk_1_1_data_1_1_stream.html#ae5ac2be84506f4117b59cff6554d85a3\">element</a>( 0 );</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"comment\">// Position the handle on our data of interest</span></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> ( <span class=\"keyword\">false</span> == handle.<a name=\"a25\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/classadsk_1_1_data_1_1_handle.html#ab72c3d5222528d68f876f43300382c64\">setPositionByMemberName</a>( gMemberName ) )</div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">        <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html\">MStatus</a> resStatus;</div>\n\
...
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> ( Member::kString != handle.<a name=\"a26\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/classadsk_1_1_data_1_1_handle.html#adcaa08b2590d3626ffe0ae9bb753337e\">dataType</a>() )</div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">        <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html\">MStatus</a> resStatus;</div>\n\
...
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordtype\">char</span> **strings = handle.<a name=\"a27\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/classadsk_1_1_data_1_1_handle.html#ad1774dcab460b16c19ee80506226b35c\">asString</a>();</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    <span class=\"keywordflow\">if</span> ( <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80af0536797208144380691e2b376ffc1d1\">MS::kSuccess</a> != getSceneAssociations(*(accessor.get()), associations) )</div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">        setResult( <span class=\"keyword\">false</span> );</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">return</span> <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80a1ef6c2d725fb4bec3e7e840d28adbc00\">MS::kFailure</a>;</div>\n\
<div class=\"line\">    }</div>\n\
...
<div class=\"line\">    <a name=\"_a28\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/classadsk_1_1_data_1_1_structure.html\">Structure</a> *structure = NULL;</div>\n\
...
<div class=\"line\">        structure-&gt;<a name=\"a29\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/classadsk_1_1_data_1_1_structure.html#ad79b3edf375d6aa09288510a4e024a64\">setName</a>( gStructureName );</div>\n\
<div class=\"line\">        structure-&gt;<a name=\"a30\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/classadsk_1_1_data_1_1_structure.html#acfbcfec5221077596fbb06a1772c035d\">addMember</a>( Member::kString, 1, gMemberName );</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    std::string channelName( fChannelName.arg().asChar() );</div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/classadsk_1_1_data_1_1_channel.html\">Channel</a> channel = associations.<a name=\"a31\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/classadsk_1_1_data_1_1_associations.html#acff69ff356746a2cd0288ebb4bf2950a\">channel</a>( channelName );</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    <span class=\"keywordflow\">if</span> ( 0 != handle.<a name=\"a32\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/classadsk_1_1_data_1_1_handle.html#a47c6bf88120d623e5e9d4b33d99a4531\">fromStr</a>( dataString, 0, errors ) )</div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">        <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html\">MStatus</a> resStatus;</div>\n\
...
<div class=\"line\">    stream.<a name=\"a33\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/classadsk_1_1_data_1_1_stream.html#af5b9bd96d037b7ceecb05bba5d646ee9\">setElement</a>( 0, handle );</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">}</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">std::auto_ptr&lt; Accessor &gt; AdskSceneMetadataCmd::getAccessorForScene( <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html\">MString</a> scenePath )</div>\n\
<div class=\"line\">{</div>\n\
<div class=\"line\">    <span class=\"comment\">// This string gets populated with errors by the Metadata library when they occur</span></div>\n\
<div class=\"line\">    std::string errors;</div>\n\
<div class=\"line\">    std::string stdScenePath( scenePath.<a name=\"a34\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html#aa9ab612f356c53479afc4c648c9ef94d\">asChar</a>() );</div>\n\
<div class=\"line\">    std::auto_ptr&lt; Accessor &gt; accessor( Accessor::accessorByExtension( stdScenePath ) );</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> ( NULL == accessor.get() ) </div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">        <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html\">MStatus</a> resStatus;</div>\n\
...
<div class=\"line\">        displayError( errorString );</div>\n\
<div class=\"line\">        </div>\n\
<div class=\"line\">        <span class=\"keywordflow\">return</span> std::auto_ptr&lt; Accessor &gt;();</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
