...
<html>\n\
   <head><script src=\"../scripts/yepnope.1.5.4-min.js\" type=\"text/javascript\"></script><script src=\"../scripts/lib/jquery-1.11.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\"><meta name=\"product\" content=\"MAYAUL\"><meta name=\"release\" content=\"2017\"><meta name=\"book\" content=\"Developer\"><meta name=\"created\" content=\"2016-06-16\"><meta name=\"topicid\" content=\"GUID-02DEF634-1E7B-48C6-8ACD-2C934CA97887\"><meta name=\"topic-type\" content=\"concept\">\n\
      <title>AbcExport/MayaUtility.cpp</title>\n\
   \n\
\n\
...
$(window).load( function() {\n\
 ...
 if (!tocSystemNeedsToBeLoaded) { cpp_ref_initializeToc(); }\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>AbcExport/MayaUtility.cpp</h1>\n\
         </div>\n\
\n\
...
<div class=\"line\">                <span class=\"keywordflow\">if</span> (incoming.<a name=\"a29\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a86ea067b523cb58b56699e1e334fa274\">isConnected</a>())</div>\n\
...
<div class=\"line\">                <span class=\"keywordflow\">if</span> (mutePlug.<a name=\"a31\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#aea1ddab8d4272d03146b3dad29be3af0\">asBool</a>())</div>\n\
<div class=\"line\">                    <span class=\"keywordflow\">return</span> 0;</div>\n\
<div class=\"line\">                <span class=\"comment\">// curve</span></div>\n\
<div class=\"line\">                <span class=\"keywordflow\">else</span></div>\n\
<div class=\"line\">                   <span class=\"keywordflow\">return</span> 2;</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> (stat!= <a name=\"a44\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80af0536797208144380691e2b376ffc1d1\">MS::kSuccess</a>)</div>\n\
<div class=\"line\">    {</div>\n\
...
<div class=\"line\">        <span class=\"keywordflow\">if</span> (!node.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html#af0af77f14f96d1134fb8e8e60dc7e420\">hasFn</a>(<a name=\"a68\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn.html#a1d1cfd8ffb84e947f82999c682b666a7a1fe410ba33fcc24e08a319ee3db38896\">MFn::kShadingEngine</a>))</div>\n\
<div class=\"line\">        {</div>\n\
<div class=\"line\">            <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html\">MPlug</a> plug = iter.thisPlug();</div>\n\
<div class=\"line\">            <a name=\"_a69\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_attribute.html\">MFnAttribute</a> attr(plug.<a name=\"a70\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a18baf7e7504bc90d54dea49a7d2d924b\">attribute</a>(), &amp;stat);</div>\n\
<div class=\"line\">            <span class=\"keywordtype\">bool</span> checkNodeParent = <span class=\"keyword\">false</span>;</div>\n\
<div class=\"line\">            <span class=\"keywordflow\">if</span> (stat == <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80af0536797208144380691e2b376ffc1d1\">MS::kSuccess</a> &amp;&amp; attr.isWorldSpace())</div>\n\
<div class=\"line\">            {</div>\n\
...
<div class=\"line\">    {</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span> (<a name=\"a71\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_anim_util.html#a44de0f1cf03a138aaf11ac495b01ba17\">MAnimUtil::isAnimated</a>(nodesToCheckAnimCurve[i].node, nodesToCheckAnimCurve[i].checkParent))</div>\n\
<div class=\"line\">        {</div>\n\
<div class=\"line\">            <span class=\"keywordflow\">return</span> <span class=\"keyword\">true</span>;</div>\n\
<div class=\"line\">        }</div>\n\
<div class=\"line\">    }</div>\n\
...
<div class=\"line\">}</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"><span class=\"keywordtype\">bool</span> util::isDrivenByFBIK(<span class=\"keyword\">const</span> <a name=\"_a72\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_ik_joint.html\">MFnIkJoint</a> &amp; iJoint)</div>\n\
<div class=\"line\">{</div>\n\
...
<div class=\"line\">    <span class=\"keywordflow\">if</span> (iJoint.<a name=\"a73\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_ik_joint.html#a10915465bf61324638e009e022882976\">hikJointName</a>(&amp;status).<a name=\"a74\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html#a580388f31f60c46fac867ca48a48da1e\">length</a>() &gt; 0 &amp;&amp; status) {</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">return</span> <span class=\"keyword\">true</span>;</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">return</span> <span class=\"keyword\">false</span>;</div>\n\
<div class=\"line\">}</div>\n\
...
<div class=\"line\">    msgPlug.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a3727c18c58fc5ba8be5fb2582b5d06f1\">connectedTo</a>(msgPlugDst, <span class=\"keyword\">false</span>, <span class=\"keyword\">true</span>);</div>\n\
...
<div class=\"line\">        <span class=\"keywordflow\">if</span> (!ikHandle.object().hasFn(<a name=\"a75\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn.html#a1d1cfd8ffb84e947f82999c682b666a7a74e8c14c13482affd3b22f24a89f85cf\">MFn::kIkHandle</a>)) <span class=\"keywordflow\">continue</span>;</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">        <span class=\"comment\">// find the ikSolver node.</span></div>\n\
<div class=\"line\">        <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html\">MPlug</a> ikSolverPlug = ikHandle.findPlug(<span class=\"stringliteral\">&quot;ikSolver&quot;</span>);</div>\n\
<div class=\"line\">        <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug_array.html\">MPlugArray</a> ikSolverDst;</div>\n\
<div class=\"line\">        ikSolverPlug.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a3727c18c58fc5ba8be5fb2582b5d06f1\">connectedTo</a>(ikSolverDst, <span class=\"keyword\">true</span>, <span class=\"keyword\">false</span>);</div>\n\
...
<div class=\"line\">    <a name=\"_a77\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_dag_node.html\">MFnDagNode</a> mFn(<span class=\"keywordtype\">object</span>);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <a name=\"_a78\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string_array.html\">MStringArray</a> strArray;</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> (iNodeName.<a name=\"a79\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html#ac914d138fc96d7065c687a4f8b40c263\">split</a>(<span class=\"charliteral\">&#39;:&#39;</span>, strArray) == <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80af0536797208144380691e2b376ffc1d1\">MS::kSuccess</a>)</div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">        <span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span> len = strArray.<a name=\"a80\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string_array.html#a580388f31f60c46fac867ca48a48da1e\">length</a>();</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\"><span class=\"stringliteral\">&quot;parameters with face varying scope.\\n&quot;</span></div>\n\
<div class=\"line\"><span class=\"stringliteral\">&quot;-wc / -writeCreases\\n&quot;</span></div>\n\
<div class=\"line\"><span class=\"stringliteral\">&quot;If this flag is present and the mesh has crease edges or crease vertices, \\n&quot;</span></div>\n\
