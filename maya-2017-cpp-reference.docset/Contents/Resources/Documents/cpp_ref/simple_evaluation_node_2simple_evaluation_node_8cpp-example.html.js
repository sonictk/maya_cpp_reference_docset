...
<html>\n\
   <head><script src=\"../scripts/yepnope.1.5.4-min.js\" type=\"text/javascript\"></script><script src=\"../scripts/lib/jquery-1.11.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\"><meta name=\"product\" content=\"MAYAUL\"><meta name=\"release\" content=\"2017\"><meta name=\"book\" content=\"Developer\"><meta name=\"created\" content=\"2016-06-16\"><meta name=\"topicid\" content=\"GUID-02DEF634-1E7B-48C6-8ACD-2C934CA97887\"><meta name=\"topic-type\" content=\"concept\">\n\
      <title>simpleEvaluationNode/simpleEvaluationNode.cpp</title>\n\
   \n\
\n\
...
$(window).load( function() {\n\
 ...
 if (!tocSystemNeedsToBeLoaded) { cpp_ref_initializeToc(); }\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>simpleEvaluationNode/simpleEvaluationNode.cpp</h1>\n\
         </div>\n\
\n\
...
<div class=\"line\">    <span class=\"keyword\">virtual</span>             ~simpleEvaluationNode(); </div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span>( returnStatus != <a name=\"a14\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80af0536797208144380691e2b376ffc1d1\">MS::kSuccess</a> )</div>\n\
<div class=\"line\">        {</div>\n\
...
<div class=\"line\">                {</div>\n\
<div class=\"line\">                    <a name=\"_a15\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_time.html\">MTime</a> time = inputTimeData.<a name=\"a16\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_data_handle.html#aaa4774146bfa48e040aea132d03b900c\">asTime</a>();</div>\n\
<div class=\"line\">                    cachedValue = doExpensiveCalculation( inputData.<a name=\"a17\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_data_handle.html#a43df510424a7de372dd130315d9f223c\">asFloat</a>() , (float) time.<a name=\"a18\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_time.html#a324b14b7506c6e4f47912161956974ed\">value</a>() );</div>\n\
<div class=\"line\">                    cachedValueIsValid = <span class=\"keyword\">true</span>;</div>\n\
<div class=\"line\">                }</div>\n\
<div class=\"line\">                <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_data_handle.html\">MDataHandle</a> outputHandle = data.<a name=\"a19\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_data_block.html#a5e4082d6ab961bee4ec0281676bb4834\">outputValue</a>( simpleEvaluationNode::output );</div>\n\
<div class=\"line\">                outputHandle.<a name=\"a20\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_data_handle.html#a2a75482f517f405a641c0eee0bd995ac\">set</a>( cachedValue );</div>\n\
...
<div class=\"line\">    {</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span>(<a name=\"a23\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_evaluation_manager.html#adf2d2aadac2bb5dc1f1bc9c3714ec8be\">MEvaluationManager::graphConstructionActive</a>())</div>\n\
<div class=\"line\">        {</div>\n\
<div class=\"line\">            cout &lt;&lt; <span class=\"stringliteral\">&quot;Evaluation Graph is being constructed&quot;</span> &lt;&lt; endl;</div>\n\
<div class=\"line\">        }</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">else</span> <span class=\"keywordflow\">if</span>(<a name=\"a24\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_evaluation_manager.html#a2f6f174196dcebf079651773e12a37ed\">MEvaluationManager::evaluationManagerActive</a>(MDGContext::fsNormal))</div>\n\
<div class=\"line\">        {</div>\n\
...
<div class=\"line\">}</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"><span class=\"comment\">// Turn this define on to see the evaluation work in Serial/Parallel modes</span></div>\n\
<div class=\"line\"><span class=\"comment\">// #define DO_PRE_EVAL</span></div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"comment\">// We use m_CachedValueIsValid only for normal context</span></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span>( !context.<a name=\"a25\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_d_g_context.html#a761a03ae58bbf2942f90578a0e61ada7\">isNormal</a>() ) </div>\n\
...
<div class=\"line\">                </div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span>( ( evaluationNode.<a name=\"a27\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_evaluation_node.html#aad069e4fae5beaab80d421a1e18505aa\">dirtyPlugExists</a>(input, &amp;status) &amp;&amp; status ) || </div>\n\
...
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html\">MStatus</a>             status;</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    input = nAttr.<a name=\"a30\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_numeric_attribute.html#a5c08a5ce5e7123cc444c95a0e4a50f29\">create</a>( <span class=\"stringliteral\">&quot;input&quot;</span>, <span class=\"stringliteral\">&quot;in&quot;</span>, <a name=\"a31\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_numeric_data.html#a1d1cfd8ffb84e947f82999c682b666a7a5686197bafb177bdc82550848416a1ad\">MFnNumericData::kFloat</a>, 2.0 );</div>\n\
<div class=\"line\">    nAttr.<a name=\"a32\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_attribute.html#a8d2be80de133a200a455bf9e2ac1b709\">setStorable</a>(<span class=\"keyword\">true</span>);</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    aTimeInput = uAttr.<a name=\"a33\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_unit_attribute.html#a31f804de81a968aa11b510a6231e7874\">create</a>( <span class=\"stringliteral\">&quot;inputTime&quot;</span>, <span class=\"stringliteral\">&quot;itm&quot;</span>, <a name=\"a34\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_unit_attribute.html#a1d1cfd8ffb84e947f82999c682b666a7a65c3a8bb75ba1a57e36c86855169752e\">MFnUnitAttribute::kTime</a>, 0.0 );</div>\n\
<div class=\"line\">    uAttr.<a name=\"a35\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_attribute.html#a98bb3089ec3b7442383da68a5ef424c7\">setWritable</a>(<span class=\"keyword\">true</span>);</div>\n\
...
<div class=\"line\">    uAttr.<a name=\"a36\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_attribute.html#af41aae76c0dc31dbcd1f4ecea52d694e\">setReadable</a>(<span class=\"keyword\">true</span>);</div>\n\
<div class=\"line\">    uAttr.<a name=\"a37\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_attribute.html#a9e68a8b4af016b37f6567cfa6d68e551\">setKeyable</a>(<span class=\"keyword\">true</span>);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">        <span class=\"keywordflow\">if</span> (!status) { status.<a name=\"a38\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a1f01a4748fea4d8bcced082df83f804d\">perror</a>(<span class=\"stringliteral\">&quot;addAttribute&quot;</span>); <span class=\"keywordflow\">return</span> status;}</div>\n\
