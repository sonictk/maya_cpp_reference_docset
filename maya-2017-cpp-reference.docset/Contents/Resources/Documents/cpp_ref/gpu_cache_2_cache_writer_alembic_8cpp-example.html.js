...
<div class=\"line\">                boost::shared_ptr&lt;const XformSample&gt; sample = it-&gt;second;</div>\n\
...
<div class=\"line\">                    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">                    boost::shared_ptr&lt;const XformSample&gt; prev = sample;</div>\n\
...
<div class=\"line\">            <span class=\"keywordflow\">if</span> (it != end) {</div>\n\
<div class=\"line\">                boost::shared_ptr&lt;const ShapeSample&gt; sample = it-&gt;second;</div>\n\
<div class=\"line\">                <span class=\"keywordtype\">double</span> time = fStartTimeInSeconds + 0.5f * fSecondsPerSample;</div>\n\
...
<div class=\"line\">                    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">                    boost::shared_ptr&lt;const ShapeSample&gt; prev = sample;</div>\n\
<div class=\"line\">                    sample = it-&gt;second;</div>\n\
...
<div class=\"line\">                ArchiveBoundsVisitor visitor(timeInSeconds, <a name=\"a4\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_matrix.html#a85de986c9f953535d185c6780cecb77e\">MMatrix::identity</a>);</div>\n\
...
<div class=\"line\"><span class=\"comment\">//==============================================================================</span></div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">boost::shared_ptr&lt;CacheWriter&gt; AlembicCacheWriter::create(</div>\n\
...
<div class=\"line\">{</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">return</span> boost::make_shared&lt;AlembicCacheWriter&gt;(file, compressLevel, dataFormat);</div>\n\
<div class=\"line\">}</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\"><span class=\"keywordtype\">void</span> AlembicXformWriter::write(</div>\n\
<div class=\"line\">    <span class=\"keyword\">const</span> boost::shared_ptr&lt;const XformSample&gt;&amp;  sample,</div>\n\
<div class=\"line\">    <span class=\"keyword\">const</span> boost::shared_ptr&lt;const XformSample&gt;&amp;  prev)</div>\n\
<div class=\"line\">{</div>\n\
...
<div class=\"line\"><span class=\"keywordtype\">void</span> AlembicMeshWriter::write(</div>\n\
<div class=\"line\">    <span class=\"keyword\">const</span> boost::shared_ptr&lt;const ShapeSample&gt;&amp;  sample,</div>\n\
<div class=\"line\">    <span class=\"keyword\">const</span> boost::shared_ptr&lt;const ShapeSample&gt;&amp;  prev)</div>\n\
<div class=\"line\">{</div>\n\
<div class=\"line\">    <span class=\"comment\">// create empty mesh samples</span></div>\n\
<div class=\"line\">    Alembic::AbcGeom::OPolyMeshSchema::Sample meshSample;</div>\n\
<div class=\"line\">    Alembic::Abc::Int32ArraySample wireIndicesSample;</div>\n\
...
<div class=\"line\">    BOOST_FOREACH (<span class=\"keyword\">const</span> MaterialGraph::NamedMap::value_type&amp; val, fGraph-&gt;getNodes()) {</div>\n\
