...
<p>Intel® Threading Building Blocks (TBB) is a relatively new higher level API for threading. It replaces the concept of threads with the concept of tasks, which are defined by the user and queued up. TBB then maps those tasks to threads efficiently.</p>\n\
