...
<ul>\n\
<li><a href=\'#!/url=./developer/Appendices/Appendix-E-Adding-Image-Plug-ins.html#overview\' title=\'\'>Overview</a></li>\n\
<li><a href=\'#!/url=./developer/Appendices/Appendix-E-Adding-Image-Plug-ins.html#about-entry-points\' title=\'\'>About entry points</a></li>\n\
<li><a href=\'#!/url=./developer/Appendices/Appendix-E-Adding-Image-Plug-ins.html#mandatory-entry-points\' title=\'\'>Mandatory entry points</a></li>\n\
<li><a href=\'#!/url=./developer/Appendices/Appendix-E-Adding-Image-Plug-ins.html#optional-entry-points\' title=\'\'>Optional entry points</a></li>\n\
<li><a href=\'#!/url=./developer/Appendices/Appendix-E-Adding-Image-Plug-ins.html#library-functions\' title=\'\'>Library Functions</a></li>\n\
<li><a href=\'#!/url=./developer/Appendices/Appendix-E-Adding-Image-Plug-ins.html#capability-settings\' title=\'\'>Capability settings</a></li>\n\
<li><a href=\'#!/url=./developer/Appendices/Appendix-E-Adding-Image-Plug-ins.html#data-structures\' title=\'\'>Data structures</a></li>\n\
<li><a href=\'#!/url=./developer/Appendices/Appendix-E-Adding-Image-Plug-ins.html#compiling-your-plug-in\' title=\'\'>Compiling your plug-in</a></li>\n\
</ul>\n\
...
<blockquote>\n\
<p>**<a href=\'#!/url=./developer/Appendices/Tip:**/\' title=\'\'>Tip:**</a> For your plug-in to be compatible with Maya, you only need to implement the mandatory entry points. The optional entry points of your plug-in may not be invoked by Maya, and therefore are not required.</p>\n\
</blockquote>\n\
...
<ul>\n\
<li><a href=\'#!/url=./developer/Appendices/Appendix-E-Adding-Image-Plug-ins.html#program\' title=\'\'>program</a></li>\n\
<li><a href=\'#!/url=./developer/Appendices/Appendix-E-Adding-Image-Plug-ins.html#type\' title=\'\'>type</a></li>\n\
<li><a href=\'#!/url=./developer/Appendices/Appendix-E-Adding-Image-Plug-ins.html#version\' title=\'\'>version</a></li>\n\
<li><a href=\'#!/url=./developer/Appendices/Appendix-E-Adding-Image-Plug-ins.html#imagekey\' title=\'\'>imageKey</a></li>\n\
<li><a href=\'#!/url=./developer/Appendices/Appendix-E-Adding-Image-Plug-ins.html#imageisfile\' title=\'\'>imageIsFile</a></li>\n\
<li><a href=\'#!/url=./developer/Appendices/Appendix-E-Adding-Image-Plug-ins.html#imagename\' title=\'\'>imageName</a></li>\n\
<li><a href=\'#!/url=./developer/Appendices/Appendix-E-Adding-Image-Plug-ins.html#imagereadopen\' title=\'\'>imageReadOpen</a> and its associated look-up table reading, scanline reading, and close functions (unless your plug-in cannot read as specified by the <a href=\'#!/url=./developer/Appendices/Appendix-E-Adding-Image-Plug-ins.html#imageaccess\' title=\'\'>imageAccess</a> entry point).</li>\n\
<li><a href=\'#!/url=./developer/Appendices/Appendix-E-Adding-Image-Plug-ins.html#imagewriteopen\' title=\'\'>imageWriteOpen</a> and its associated scanline writing and close functions (unless you specify otherwise with the <a href=\'#!/url=./developer/Appendices/Appendix-E-Adding-Image-Plug-ins.html#imageaccess\' title=\'\'>imageAccess</a> entry point).</li>\n\
</ul>\n\
...
<p><span class=\'code\'>}</span></p>\n\
<table cellpadding=\"0\" cellspacing=\"0\" class=\"ruled\"><colgroup><col width=\"33.333333333333336%\"> <col width=\"33.333333333333336%\"> <col width=\"33.333333333333336%\"> </colgroup><tbody><tr class=\"ruled-heading\"><th class=\"table-heading\">Parameter</th><th class=\"table-heading\">Type</th><th class=\"table-heading\">Description</th></tr><tr class=\"ruled-odd-row\"><td class=\"table-body\"><span class=\"code\" translate=\"no\">imf</span></td><td class=\"table-body\"><a name=\"WS73099CC142F48755-3D114B7511841AEFA9F3E3\"></a><p class=\"table-body\">Modified</p></td><td class=\"table-body\"><a name=\"WS73099CC142F48755-3D114B7511841AEFA9F3E4\"></a><p class=\"table-body\">Image File Header</p></td></tr><tr class=\"ruled-even-row\"><td class=\"table-body\">Return Value</td><td class=\"table-body\">&nbsp;</td><td class=\"table-body\"><a name=\"WS73099CC142F48755-3D114B7511841AEFA9F3E5\"></a><p class=\"table-body\"><span class=\"code\" translate=\"no\">IMF_C_NORMAL</span> if the image was successfully opened; <span class=\"code\" translate=\"no\">IMF_C_</span> if an error occurred.</p></td></tr></tbody></table>\n\
<p>Description</p>\n\
...
<li>If your file format defines input capabilities, extract those from <span class=\'code\'>imf-&gt;info.settings</span>. (See <a href=\'#!/url=./developer/Appendices/Appendix-E-Adding-Image-Plug-ins.html#imf_capability\' title=\'\'>IMF_CAPABILITY</a> for details.)</li>\n\
...
<p><span class=\'code\'>)</span></p>\n\
<table cellpadding=\"0\" cellspacing=\"0\" class=\"ruled\"><colgroup><col width=\"33.333333333333336%\"> <col width=\"33.333333333333336%\"> <col width=\"33.333333333333336%\"> </colgroup><tbody><tr class=\"ruled-heading\"><th class=\"table-heading\">Parameter</th><th class=\"table-heading\">Type</th><th class=\"table-heading\">Description</th></tr><tr class=\"ruled-odd-row\"><td class=\"table-body\"><span class=\"code\" translate=\"no\">data</span></td><td class=\"table-body\"><a name=\"WS73099CC142F48755-3D114B7511841AEFA9F409\"></a><p class=\"table-body\">Input</p></td><td class=\"table-body\"><a name=\"WS73099CC142F48755-3D114B7511841AEFA9F40A\"></a><p class=\"table-body\">The private data associated with your image.</p></td></tr><tr class=\"ruled-even-row\"><td class=\"table-body\"><span class=\"code\" translate=\"no\">scan</span></td><td class=\"table-body\">Input</td><td class=\"table-body\"><a name=\"WS73099CC142F48755-3D114B7511841AEFA9F40B\"></a><p class=\"table-body\">The scanline to read.</p></td></tr><tr class=\"ruled-odd-row\"><td class=\"table-body\"><span class=\"code\" translate=\"no\">line_buff</span></td><td class=\"table-body\">Output</td><td class=\"table-body\"><a name=\"WS73099CC142F48755-3D114B7511841AEFA9F40C\"></a><p class=\"table-body\">The scanline buffer allocated in <span class=\"code\" translate=\"no\">imageReadOpen</span>, containing the row of pixels read.</p></td></tr><tr class=\"ruled-even-row\"><td class=\"table-body\">Return Value</td><td class=\"table-body\">&nbsp;</td><td class=\"table-body\"><a name=\"WS73099CC142F48755-3D114B7511841AEFA9F40D\"></a><p class=\"table-body\"><span class=\"code\" translate=\"no\">IMF_C_BAD_SCAN</span> if scan is outside the image; <span class=\"code\" translate=\"no\">IMF_C_NORMAL</span> if the scanline was successfully read; and <span class=\"code\" translate=\"no\">IMF_C_READ_ERR</span> if an error occurred.</p></td></tr></tbody></table>\n\
<p>Description</p>\n\
...
<p><span class=\'code\'>IMF_OBJECT *imf</span></p>\n\
<p><span class=\'code\'>)</span></p>\n\
<table cellpadding=\"0\" cellspacing=\"0\" class=\"ruled\"><colgroup><col width=\"33.333333333333336%\"> <col width=\"33.333333333333336%\"> <col width=\"33.333333333333336%\"> </colgroup><tbody><tr class=\"ruled-heading\"><th class=\"table-heading\">Parameter</th><th class=\"table-heading\">Type</th><th class=\"table-heading\">Description</th></tr><tr class=\"ruled-odd-row\"><td class=\"table-body\"><span class=\"code\" translate=\"no\">imf</span></td><td class=\"table-body\"><a name=\"WS73099CC142F48755-3D114B7511841AEFA9F430\"></a><p class=\"table-body\">Modified</p></td><td class=\"table-body\"><a name=\"WS73099CC142F48755-3D114B7511841AEFA9F431\"></a><p class=\"table-body\">Image file descriptor.</p></td></tr><tr class=\"ruled-even-row\"><td class=\"table-body\">Return Value</td><td class=\"table-body\">&nbsp;</td><td class=\"table-body\"><a name=\"WS73099CC142F48755-3D114B7511841AEFA9F432\"></a><p class=\"table-body\"><span class=\"code\" translate=\"no\">IMF_C_NORMAL</span> if file closing and memory de-allocation was successful; <span class=\"code\" translate=\"no\">IMF_C_failure_code</span> if error occurred (for example <span class=\"code\" translate=\"no\">IMF_C_WRITE_ERR</span>).</p></td></tr></tbody></table>\n\
...
<p><span class=\'code\'>IMF_OBJECT *imf</span></p>\n\
<p><span class=\'code\'>)</span></p>\n\
<table cellpadding=\"0\" cellspacing=\"0\" class=\"ruled\"><colgroup><col width=\"33.333333333333336%\"> <col width=\"33.333333333333336%\"> <col width=\"33.333333333333336%\"> </colgroup><tbody><tr class=\"ruled-heading\"><th class=\"table-heading\">Parameter</th><th class=\"table-heading\">Type</th><th class=\"table-heading\">Description</th></tr><tr class=\"ruled-odd-row\"><td class=\"table-body\"><span class=\"code\" translate=\"no\">imf</span></td><td class=\"table-body\"><a name=\"WS73099CC142F48755-3D114B7511841AEFA9F43F\"></a><p class=\"table-body\">Modified</p></td><td class=\"table-body\"><a name=\"WS73099CC142F48755-3D114B7511841AEFA9F440\"></a><p class=\"table-body\">Image file descriptor.</p></td></tr><tr class=\"ruled-even-row\"><td class=\"table-body\">Return Value</td><td class=\"table-body\">&nbsp;</td><td class=\"table-body\"><a name=\"WS73099CC142F48755-3D114B7511841AEFA9F441\"></a><p class=\"table-body\"><span class=\"code\" translate=\"no\">TRUE</span> if the image was successfully opened; <span class=\"code\" translate=\"no\">FALSE</span> if an error occurred.</p></td></tr></tbody></table>\n\
<p>Description</p>\n\
...
<li>If your file format defines output capabilities, extract those from <span class=\'code\'>imf-&gt;info.settings</span>. (See <a href=\'#!/url=./developer/Appendices/Appendix-E-Adding-Image-Plug-ins.html#imf_capability\' title=\'\'>IMF_CAPABILITY</a> for details.)</li>\n\
...
<p><span class=\'code\'>POINTER *line_buff</span></p>\n\
<p><span class=\'code\'>)</span></p>\n\
<table cellpadding=\"0\" cellspacing=\"0\" class=\"ruled\"><colgroup><col width=\"33.333333333333336%\"> <col width=\"33.333333333333336%\"> <col width=\"33.333333333333336%\"> </colgroup><tbody><tr class=\"ruled-heading\"><th class=\"table-heading\">Parameter</th><th class=\"table-heading\">Type</th><th class=\"table-heading\">Description</th></tr><tr class=\"ruled-odd-row\"><td class=\"table-body\"><span class=\"code\" translate=\"no\">data</span></td><td class=\"table-body\"><a name=\"WS73099CC142F48755-3D114B7511841AEFA9F45F\"></a><p class=\"table-body\">Input</p></td><td class=\"table-body\"><a name=\"WS73099CC142F48755-3D114B7511841AEFA9F460\"></a><p class=\"table-body\">The private data associated with your image.</p></td></tr><tr class=\"ruled-even-row\"><td class=\"table-body\"><span class=\"code\" translate=\"no\">scan</span></td><td class=\"table-body\">Input</td><td class=\"table-body\"><a name=\"WS73099CC142F48755-3D114B7511841AEFA9F461\"></a><p class=\"table-body\">The scanline to be written.</p></td></tr><tr class=\"ruled-odd-row\"><td class=\"table-body\">line_buff</td><td class=\"table-body\">Output</td><td class=\"table-body\"><a name=\"WS73099CC142F48755-3D114B7511841AEFA9F462\"></a><p class=\"table-body\">Buffer containing the pixels for the current scanline.</p></td></tr><tr class=\"ruled-even-row\"><td class=\"table-body\">Return Value</td><td class=\"table-body\">&nbsp;</td><td class=\"table-body\"><a name=\"WS73099CC142F48755-3D114B7511841AEFA9F463\"></a><p class=\"table-body\"><span class=\"code\" translate=\"no\">IMF_C_BAD_SCAN</span> if scan is outside the image; <span class=\"code\" translate=\"no\">IMF_C_NORMAL</span> if the scanline is successfully written; and <span class=\"code\" translate=\"no\">IMF_C_WRITE_ERR</span> if an error occurs.</p></td></tr></tbody></table>\n\
<p>Description</p>\n\
...
<p>Information on adding image plug-ins continues in <a href=\'#!/url=./developer/Appendices/Appendix-E-Part-2.html\' title=\'\'>part 2 of Appendix E</a></p>\n\
