...
<p>Continues from <a href=\'#!/url=./developer/Appendices/Appendix-E-Adding-Image-Plug-ins.html\' title=\'\'>Appendix E: Adding Image Plug-ins</a>.</p>\n\
...
<p><span class=\'code\'>)</span></p>\n\
<table cellpadding=\"0\" cellspacing=\"0\" class=\"ruled\"><colgroup><col width=\"33.333333333333336%\"> <col width=\"33.333333333333336%\"> <col width=\"33.333333333333336%\"> </colgroup><tbody><tr class=\"ruled-heading\"><th class=\"table-heading\">Parameter</th><th class=\"table-heading\">Type</th><th class=\"table-heading\">Description</th></tr><tr class=\"ruled-odd-row\"><td class=\"table-body\"><span class=\"code\" translate=\"no\">capabilities</span></td><td class=\"table-body\"><a name=\"WS73099CC142F48755-3D114B7511841AEFA9F4A3\"></a><p class=\"table-body\">Output</p></td><td class=\"table-body\"><a name=\"WS73099CC142F48755-3D114B7511841AEFA9F4A4\"></a><p class=\"table-body\">Returns a pointer to the capabilities for this file type.</p></td></tr><tr class=\"ruled-even-row\"><td class=\"table-body\"><span class=\"code\" translate=\"no\">num_input</span></td><td class=\"table-body\">Output</td><td class=\"table-body\"><a name=\"WS73099CC142F48755-3D114B7511841AEFA9F4A5\"></a><p class=\"table-body\">The number of capabilities applicable to file reading.</p></td></tr><tr class=\"ruled-odd-row\"><td class=\"table-body\">num_output</td><td class=\"table-body\">Output</td><td class=\"table-body\"><a name=\"WS73099CC142F48755-3D114B7511841AEFA9F4A6\"></a><p class=\"table-body\">The number of capabilities applicable to file writing.</p></td></tr><tr class=\"ruled-even-row\"><td class=\"table-body\">total</td><td class=\"table-body\">Output</td><td class=\"table-body\"><a name=\"WS73099CC142F48755-3D114B7511841AEFA9F4A7\"></a><p class=\"table-body\">The total number of capabilities.</p></td></tr></tbody></table>\n\
<p>Description</p>\n\
<p>This function is called during initialization when Maya determines the capabilities to display in its menus. For more information on capabilities, see <a href=\'#!/url=./developer/Appendices/Appendix-E-Adding-Image-Plug-ins.html#imf_capability\' title=\'\'>IMF_CAPABILITY</a>.</p>\n\
<p>Example</p>\n\
...
<p><span class=\'code\'>}</span></p>\n\
<table cellpadding=\"0\" cellspacing=\"0\" class=\"ruled\"><colgroup><col width=\"33.333333333333336%\"> <col width=\"33.333333333333336%\"> <col width=\"33.333333333333336%\"> </colgroup><tbody><tr class=\"ruled-heading\"><th class=\"table-heading\">Parameter</th><th class=\"table-heading\">Type</th><th class=\"table-heading\">Description</th></tr><tr class=\"ruled-odd-row\"><td class=\"table-body\"><pre><code>fn\n\
</code></pre></td><td class=\"table-body\"><a name=\"WS73099CC142F48755-3D114B7511841AEFA9F4F5\"></a><p class=\"table-body\">char*</p></td><td class=\"table-body\"><a name=\"WS73099CC142F48755-3D114B7511841AEFA9F4F6\"></a><p class=\"table-body\">Filename, used only if <span class=\"code\" translate=\"no\">fp</span> is <span class=\"code\" translate=\"no\">NULL</span>.</p></td></tr><tr class=\"ruled-even-row\"><td class=\"table-body\"><pre><code>fp\n\
</code></pre></td><td class=\"table-body\">FILE*</td><td class=\"table-body\"><a name=\"WS73099CC142F48755-3D114B7511841AEFA9F4F7\"></a><p class=\"table-body\">File pointer.</p></td></tr><tr class=\"ruled-odd-row\"><td class=\"table-body\">Return Value</td><td class=\"table-body\">&nbsp;</td><td class=\"table-body\"><a name=\"WS73099CC142F48755-3D114B7511841AEFA9F4F8\"></a><p class=\"table-body\"><span class=\"code\" translate=\"no\">TRUE</span> if <span class=\"code\" translate=\"no\">fn</span> or <span class=\"code\" translate=\"no\">fp</span> refer to a file supported by this plug-in.</p></td></tr></tbody></table>\n\
<p>Description</p>\n\
...
<p><span class=\'code\'>)</span></p>\n\
<table cellpadding=\"0\" cellspacing=\"0\" class=\"ruled\"><colgroup><col width=\"33.333333333333336%\"> <col width=\"33.333333333333336%\"> <col width=\"33.333333333333336%\"> </colgroup><tbody><tr class=\"ruled-heading\"><th class=\"table-heading\">Parameter</th><th class=\"table-heading\">Type</th><th class=\"table-heading\">Description</th></tr><tr class=\"ruled-odd-row\"><td class=\"table-body\"><pre><code>data\n\
</code></pre></td><td class=\"table-body\"><a name=\"WS73099CC142F48755-3D114B7511841AEFA9F544\"></a><p class=\"table-body\">input</p></td><td class=\"table-body\"><a name=\"WS73099CC142F48755-3D114B7511841AEFA9F545\"></a><p class=\"table-body\">The private data associated with your image.</p></td></tr><tr class=\"ruled-even-row\"><td class=\"table-body\"><pre><code>imf_lut\n\
</code></pre></td><td class=\"table-body\">output</td><td class=\"table-body\"><a name=\"WS73099CC142F48755-3D114B7511841AEFA9F546\"></a><p class=\"table-body\">A pointer to a newly allocated look-up table.</p></td></tr><tr class=\"ruled-odd-row\"><td class=\"table-body\">Return Value</td><td class=\"table-body\">&nbsp;</td><td class=\"table-body\"><a name=\"WS73099CC142F48755-3D114B7511841AEFA9F547\"></a><p class=\"table-body\"><span class=\"code\" translate=\"no\">TRUE</span> if the <span class=\"code\" translate=\"no\">LUT</span> was successfully allocated and read; <span class=\"code\" translate=\"no\">FALSE</span> if an error occurred.</p></td></tr></tbody></table>\n\
<p>Description</p>\n\
...
<p>Information on adding image plug-ins continues in <a href=\'#!/url=./developer/Appendices/Appendix-E-Part-3.html\' title=\'\'>part three of Appendix E</a></p>\n\
