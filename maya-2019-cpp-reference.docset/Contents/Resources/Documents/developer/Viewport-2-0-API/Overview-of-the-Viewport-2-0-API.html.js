...
<ul>\n\
<li><a href=\'#!/url=./developer/Viewport-2-0-API/Overview-of-the-Viewport-2-0-API/Data-Classes.html\' title=\'\'>Data Classes</a> - the objects which describe and provide access to the geometry and shaders in the scene.</li>\n\
<li><a href=\'#!/url=./developer/Viewport-2-0-API/Overview-of-the-Viewport-2-0-API/Scene-Overrides.html\' title=\'\'>Scene Overrides</a> - the interfaces used to define custom drawing, shading and effects within the scene.</li>\n\
<li><a href=\'#!/url=./developer/Viewport-2-0-API/Overview-of-the-Viewport-2-0-API/Rendering-Overrides.html\' title=\'\'>Rendering Overrides</a> - the objects used to define custom rendering, multi-pass effects, and filtering.</li>\n\
<li><a href=\'#!/url=./developer/Viewport-2-0-API/Overview-of-the-Viewport-2-0-API/Framework-Classes.html\' title=\'\'>Framework Classes</a> - the objects that provide services and device state information to plug-ins.</li>\n\
</ul>\n\
<p>Following this, there are two subsections to help accelerate your transition to the new API:</p>\n\
<ul>\n\
<li><a href=\'#!/url=./developer/Viewport-2-0-API/Overview-of-the-Viewport-2-0-API/Transition-Guide.html\' title=\'\'>Transition Guide</a> - tips on moving from legacy interfaces to the new Viewport 2.0 API.</li>\n\
<li><a href=\'#!/url=./developer/Viewport-2-0-API/Overview-of-the-Viewport-2-0-API/Developer-Kit-Samples.html\' title=\'\'>Developer Kit Samples</a> - a brief overview of updated Developer Kit samples using the Viewport 2.0 API.</li>\n\
</ul>\n\
<p>All of the new classes reside in a new namespace within the Maya API called <span class=\'code\'><a href=\"javascript:void(0)\" data-symbol=\"MHWRender\" class=\"a_multireflink\" data-reflinkdata=\"[{&quot;path&quot;:&quot;cpp_ref/namespace_m_h_w_render.html&quot;,&quot;title&quot;:&quot;C++ API Reference&quot;,&quot;relpathtoroot&quot;:&quot;../../&quot;}]\">MHWRender</a></span> (all references to class names in this document assume the namespace). This makes it easy to locate all the classes related to viewport and batch hardware rendering and also makes it easy to differentiate them from the older hardware API classes which are not supported in Viewport 2.0 and Hardware Renderer 2.0.</p>\n\
