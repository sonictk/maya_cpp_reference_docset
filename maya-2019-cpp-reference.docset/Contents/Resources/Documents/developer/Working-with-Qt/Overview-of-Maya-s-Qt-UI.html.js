...
<blockquote>\n\
<p><strong>Note:</strong> As an alternative, PySide can be used in lieu of PyQt to create Qt widgets in Maya, and is available as part of the Qt distribution. For more information, see <a href=\'#!/url=./developer/Maya-Python-API/Working-with-PySide-in-Maya.html\' title=\'\'>Working with PySide in Maya</a>.</p>\n\
</blockquote>\n\
