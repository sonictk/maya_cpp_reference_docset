...
<blockquote>\n\
<p><strong>Note:</strong> If you edit an effects file in an external text editor <strong>after</strong> you have already loaded it in your scene, you must reload the file by clicking the <img src=\'developer/images/Icon_reload_file.png\' title=\'\'> icon in order for the shader to recognize your latest changes.</p>\n\
</blockquote>\n\
...
<blockquote>\n\
</blockquote></pre></div><p><strong>Note:</strong> See also <a href=\'#!/url=./developer/Viewport-2-0-API/Semantics-and-annotations.html\' title=\'\'>Semantics and annotations supported by the dx11Shader and glslShader plug-ins in Viewport 2.0</a> for more information regarding the semantics used above.</p>\n\
\n\
