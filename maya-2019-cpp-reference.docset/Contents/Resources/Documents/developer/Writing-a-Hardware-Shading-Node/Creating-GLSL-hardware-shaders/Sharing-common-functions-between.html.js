...
<p>As seen in <a href=\'#!/url=./developer/Writing-a-Hardware-Shading-Node/Creating-GLSL-hardware-shaders/Convert-existing-GLSL-shaders-to.html\' title=\'\'>Convert existing GLSL shaders to OGSFX format</a>, each shader stage has its own GLSLShader <em>block</em> that contains the function that it uses.</p>\n\
