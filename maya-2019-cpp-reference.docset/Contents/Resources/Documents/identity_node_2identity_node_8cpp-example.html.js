...
<div class=\"line\">    MPxGPUDeformer::DeformerStatus <a name=\"a18\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_px_g_p_u_deformer.html#a070259639bc552fd702c9e8e042f0331\">evaluate</a>(<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_data_block.html\">MDataBlock</a>&amp; block, <span class=\"keyword\">const</span> <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_evaluation_node.html\">MEvaluationNode</a>&amp; evaluationNode, <span class=\"keyword\">const</span> <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html\">MPlug</a>&amp; outputPlug, <span class=\"keyword\">const</span> <a name=\"_a19\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_g_p_u_deformer_data.html\">MGPUDeformerData</a>&amp; inputData, <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_g_p_u_deformer_data.html\">MGPUDeformerData</a>&amp; outputData) <span class=\"keyword\">override</span>;</div>\n\
<div class=\"line\">    <span class=\"keywordtype\">void</span> <a name=\"a20\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_px_g_p_u_deformer.html#a74a45d2648335936561898c390281a6a\">terminate</a>() <span class=\"keyword\">override</span>;</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"><span class=\"keyword\">private</span>:</div>\n\
<div class=\"line\">    <span class=\"comment\">// Kernel</span></div>\n\
<div class=\"line\">    <a name=\"_a21\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_auto_c_l_kernel.html\">MAutoCLKernel</a> fKernel;</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_px_g_p_u_deformer.html\">MPxGPUDeformer</a>* <a name=\"a22\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_g_p_u_deformer_registration_info.html#a69ee4850048ea760d9e03f2deaf957e4\">createGPUDeformer</a>()<span class=\"keyword\"> override</span></div>\n\
<div class=\"line\"><span class=\"keyword\">    </span>{</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">return</span> <span class=\"keyword\">new</span> identityGPUDeformer();</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordtype\">bool</span> <a name=\"a23\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_g_p_u_deformer_registration_info.html#af612f89c960cf432dc7be0d3f1be8d93\">validateNodeInGraph</a>(<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_data_block.html\">MDataBlock</a>&amp; block, <span class=\"keyword\">const</span> <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_evaluation_node.html\">MEvaluationNode</a>&amp; evaluationNode, <span class=\"keyword\">const</span> <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html\">MPlug</a>&amp; plug, <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string_array.html\">MStringArray</a>* messages)<span class=\"keyword\"> override</span></div>\n\
<div class=\"line\"><span class=\"keyword\">    </span>{</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> (!inputPositions.<a name=\"a27\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_g_p_u_deformer_buffer.html#aac1b70a2ed67ead038c4d3f5ac4d8a81\">isValid</a>() || !outputPositions.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_g_p_u_deformer_buffer.html#aac1b70a2ed67ead038c4d3f5ac4d8a81\">isValid</a>()) <span class=\"keywordflow\">return</span> MPxGPUDeformer::kDeformerFailure;</div>\n\
<div class=\"line\">    <span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span> numElements = inputPositions.<a name=\"a28\"></a>elementCount();</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">        <a name=\"_a29\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html\">MString</a> openCLKernelFile( mayaLocation );</div>\n\
<div class=\"line\">        openCLKernelFile +=<span class=\"stringliteral\">&quot;/../Extra/devkitBase/devkit/plug-ins/identityNode/identity.cl&quot;</span>;</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">        <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_auto_c_l_kernel.html\">MAutoCLKernel</a> kernel = <a name=\"a30\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_open_c_l_info.html#a9b9a0680620c0ecac7dd1b07159ee72f\">MOpenCLInfo::getOpenCLKernel</a>( openCLKernelFile, openCLKernelName );</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span> ( kernel.<a name=\"a31\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_auto_c_l_kernel.html#ac02f2a4d7312eb91f40980adfd4e31b2\">isNull</a>() )</div>\n\
<div class=\"line\">        {</div>\n\
...
<div class=\"line\">            <a name=\"a32\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_open_c_l_info.html#a7861622490349f1240dfbe76c21e3e0a\">MOpenCLInfo::getOpenCLDeviceId</a>(),</div>\n\
...
<div class=\"line\">            );</div>\n\
<div class=\"line\">        <a name=\"a33\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_open_c_l_info.html#a753d7277906776cd710b3723d74f8b64\">MOpenCLInfo::checkCLErrorStatus</a>(err);</div>\n\
...
<div class=\"line\">    <a name=\"_a34\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_open_c_l_info.html\">MOpenCLInfo</a>::checkCLErrorStatus(err);</div>\n\
...
<div class=\"line\">    <span class=\"keywordflow\">if</span> (inputPositions.<a name=\"a35\"></a>bufferReadyEvent().<a name=\"a36\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_auto_c_l_event.html#a9ae83b577cfbaa81ee19053c78dedccd\">get</a>() )</div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">        events[ eventCount++ ] = inputPositions.bufferReadyEvent().<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_auto_c_l_event.html#a9ae83b577cfbaa81ee19053c78dedccd\">get</a>();</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"comment\">// Run the kernel</span></div>\n\
<div class=\"line\">    <a name=\"_a37\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_auto_c_l_event.html\">MAutoCLEvent</a> kernelFinishedEvent;</div>\n\
<div class=\"line\">    err = clEnqueueNDRangeKernel(</div>\n\
<div class=\"line\">        <a name=\"a38\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_open_c_l_info.html#a93e129c1488b06f3347eaaad703ffe34\">MOpenCLInfo::getMayaDefaultOpenCLCommandQueue</a>() ,</div>\n\
<div class=\"line\">        fKernel.get() ,</div>\n\
...
<div class=\"line\">        kernelFinishedEvent.<a name=\"a39\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_auto_c_l_event.html#a5622645d1b16ac4ab77c233dcea5c5be\">getReferenceForAssignment</a>()</div>\n\
<div class=\"line\">        );</div>\n\
<div class=\"line\">    outputPositions.<a name=\"a40\"></a>setBufferReadyEvent(kernelFinishedEvent);</div>\n\
...
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    outputData.<a name=\"a41\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_g_p_u_deformer_data.html#a9710db42ff7918d4b588b0045fecdcd0\">setBuffer</a>(outputPositions);</div>\n\
...
<div class=\"line\">{</div>\n\
<div class=\"line\">    <a name=\"a42\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_open_c_l_info.html#a08df219d94dcf2dc03724eff7d5c6483\">MOpenCLInfo::releaseOpenCLKernel</a>(fKernel);</div>\n\
...
<div class=\"line\"><span class=\"comment\">//</span></div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html\">MStatus</a> initializePlugin( <a name=\"_a43\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html\">MObject</a> obj )</div>\n\
<div class=\"line\">{</div>\n\
...
<div class=\"line\">        <a name=\"a45\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_px_node.html#a1d1cfd8ffb84e947f82999c682b666a7a397b2fe312ffa55c207f8f9b12f616d3\">MPxNode::kDeformerNode</a></div>\n\
<div class=\"line\">        );</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    <a name=\"a46\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_g_p_u_deformer_registry.html#adea377dddd00bec03a6cdf70360f567f\">MGPUDeformerRegistry::registerGPUDeformerCreator</a>(</div>\n\
...
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html\">MString</a> nodeClassName(<span class=\"stringliteral\">&quot;identity&quot;</span>);</div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html\">MString</a> registrantId(<span class=\"stringliteral\">&quot;mayaPluginExample&quot;</span>);</div>\n\
<div class=\"line\">    <a name=\"a47\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_g_p_u_deformer_registry.html#aa290ea8dc9cb67e1056f132b8e441d5f\">MGPUDeformerRegistry::deregisterGPUDeformerCreator</a>(</div>\n\
<div class=\"line\">        nodeClassName,</div>\n\
<div class=\"line\">        registrantId</div>\n\
<div class=\"line\">        );</div>\n\
<div class=\"line\"></div>\n\
