...
<tr class=\"memdesc:a3d9b68da81d724902522fe2bf5f809c5\"><td class=\"mdescLeft\">&#160;</td><td class=\"mdescRight\">This method is called by Maya during the selection interpretation phase of Viewport 2.0 selection to allow specifying the selection path for a single instanced render item.  <a href=\"class_m_h_w_render_1_1_m_px_sub_scene_override.html#a3d9b68da81d724902522fe2bf5f809c5\">More...</a><br></td></tr>\n\
...
<p>It will be called once for each intersection between render items submitted in <a class=\"el\" translate=\"no\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_px_sub_scene_override.html#ac74e57c764a59c2fa2a8e6a5b72090d5\" title=\"This method is called by Maya on each frame as long as the implementation of MPxSubSceneOverride::req...\">MPxSubSceneOverride::update()</a> and the selection frustum. If none of the <a class=\"el\" translate=\"no\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_render_item.html\" title=\"A single renderable entity. \">MRenderItem</a> intersects, then this method will remain silent.</p>\n\
<p>The default implementation returns the path to the associated DAG object. If the DAG object is instanced, the default implementation returns the path of the instance based on the assumption where GPU instancing is used and the draw instances are in natural order regarding their DAG instance number (see <a class=\"el\" translate=\"no\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_px_sub_scene_override.html#a8866e6d0a0fd759fca57656b8d5d15ca\" title=\"Add an additional instance for a render item. \">MPxSubSceneOverride::addInstanceTransform</a> and <a class=\"el\" translate=\"no\" href=\"#!/url=./cpp_ref/class_m_dag_path.html#ac908055bb978bce38fcb5f1af6620760\" title=\"For an instanced object, this returns the instance number that this path represents in the DAG...\">MDagPath::instanceNumber</a>).</p>\n\
<p>In case the assumption is false for an implementation of <a class=\"el\" translate=\"no\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_px_sub_scene_override.html\" title=\"Base class for Viewport 2.0 drawing of DAG nodes which represent sub-scenes. \">MPxSubSceneOverride</a> the implementation must override this method (or <a class=\"el\" translate=\"no\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_px_sub_scene_override.html#a3d9b68da81d724902522fe2bf5f809c5\" title=\"This method is called by Maya during the selection interpretation phase of Viewport 2...\">getInstancedSelectionPath()</a> if GPU instancing is used) to return the valid selection path. If the implementation wants to reject selection, return true with a null DAG path.</p>\n\
<p>When selection filtering is active, or in case of single click selection it is possible that the DAG path will not be in the final selection list.</p>\n\
<dl class=\"params\"><dt>Parameters</dt><dd>\n\
  <table class=\"params\">\n\
...
\n\
<p>This method is called by Maya during the selection interpretation phase of Viewport 2.0 selection to allow specifying the selection path for a single instanced render item. </p>\n\
<p>It is identical to <a class=\"el\" translate=\"no\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_px_sub_scene_override.html#af3b88498daedce6cd2e55103c58160a4\" title=\"This method is called by Maya during the selection interpretation phase of Viewport 2...\">getSelectionPath()</a> but includes <a class=\"el\" translate=\"no\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_intersection.html\" title=\"Describes the intersection of a selection hit. \">MIntersection</a> information to properly distinguish between instances when the viewport is in GPU instancing mode.</p>\n\
...
<dl class=\"section return\"><dt>Returns</dt><dd>True if a DAG path was found for the instanced render item. </dd></dl>\n\
