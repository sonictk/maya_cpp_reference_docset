...
<div class=\"line\">                                         <a name=\"a48\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_dependency_node.html#a02f8ee0648b8421efbc74c67d840cac0a339f6c76d4f8cc279daf52097633a9ec\">MFnDependencyNode::kLocalDynamicAttr</a>);</div>\n\
...
<div class=\"line\">                }</div>\n\
<div class=\"line\">                abcFacesetNamePlug.<a name=\"a49\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a34ecedb049eec1fabe85dc486e20d8e6\">setValue</a>(faceSetName);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">                <a name=\"_a50\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_int_array_data.html\">MFnIntArrayData</a> fnData;</div>\n\
...
<div class=\"line\">        <span class=\"keywordflow\">if</span> ( status != MS::kSuccess )</div>\n\
<div class=\"line\">        {</div>\n\
<div class=\"line\">            <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html\">MString</a> theError = dagPath.<a name=\"a51\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_dag_path.html#a9aa2e126e83787f285f843fb528d82c6\">partialPathName</a>();</div>\n\
...
<div class=\"line\">            {</div>\n\
<div class=\"line\">                plug.<a name=\"a52\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a7ca6fc59c06e16950cdc9db4c7f5f1bf\">setBool</a>(visVal != 0);</div>\n\
<div class=\"line\">            }</div>\n\
<div class=\"line\">        }</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">                               <span class=\"keyword\">const</span> <a name=\"_a53\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string_array.html\">MStringArray</a> &amp; iPatterns)</div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">        <span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span> length = iPatterns.<a name=\"a54\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string_array.html#a580388f31f60c46fac867ca48a48da1e\">length</a>();</div>\n\
...
<div class=\"line\">            scriptStr.<a name=\"a55\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html#a07ae464181c795f43fa1bcc288acff91\">format</a>(<span class=\"stringliteral\">&quot;match \\&quot;^1s\\&quot; \\&quot;^2s\\&quot;;&quot;</span>, iPatterns[i], iName);</div>\n\
<div class=\"line\">            <a name=\"a56\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_global.html#a09e405631e7cf680f8ac9d934ad73434\">MGlobal::executeCommand</a>(scriptStr, result);</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">            <span class=\"comment\">// found a match!</span></div>\n\
<div class=\"line\">            <span class=\"keywordflow\">if</span> (result.<a name=\"a57\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html#a580388f31f60c46fac867ca48a48da1e\">length</a>() &gt; 0)</div>\n\
<div class=\"line\">            {</div>\n\
<div class=\"line\">                <span class=\"keywordflow\">return</span> <span class=\"keyword\">true</span>;</div>\n\
<div class=\"line\">            }</div>\n\
<div class=\"line\">        }</div>\n\
...
<div class=\"line\">        <a name=\"_a58\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_d_g_modifier.html\">MDGModifier</a> modifier;</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">        <a name=\"_a59\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_numeric_attribute.html\">MFnNumericAttribute</a> numericAttr;</div>\n\
<div class=\"line\">        <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html\">MObject</a> aioAttr = numericAttr.<a name=\"a60\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_numeric_attribute.html#a5c08a5ce5e7123cc444c95a0e4a50f29\">create</a>(</div>\n\
<div class=\"line\">            <span class=\"stringliteral\">&quot;AlembicIntermediateObject&quot;</span>, <span class=\"stringliteral\">&quot;aio&quot;</span>, <a name=\"a61\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_numeric_data.html#a1d1cfd8ffb84e947f82999c682b666a7a8cfc0ab572a96edfc9db7c02f0d025d7\">MFnNumericData::kBoolean</a>);</div>\n\
<div class=\"line\">        modifier.<a name=\"a62\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_d_g_modifier.html#ad714eb6c2e6f51659e3e50f176c75a91\">addAttribute</a>(ioFn.<a name=\"a63\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_base.html#a01c802c0a7fc219b5a9beff9787bcfa2\">object</a>(), aioAttr);</div>\n\
<div class=\"line\">        modifier.<a name=\"a64\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_d_g_modifier.html#a984345cd272bc1a32a9fc2e93a6678b2\">doIt</a>();</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">        <a name=\"_a69\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug_array.html\">MPlugArray</a> sources;</div>\n\
<div class=\"line\">        fn.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_dependency_node.html#aac29b4a3b51c9d236175e955638f7153\">findPlug</a>(<span class=\"stringliteral\">&quot;inMesh&quot;</span>).<a name=\"a70\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#acf1340576a4a0a78a0045e67ee4155bf\">connectedTo</a>(sources, <span class=\"keyword\">true</span>, <span class=\"keyword\">false</span>);</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span> (sources.<a name=\"a71\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug_array.html#a580388f31f60c46fac867ca48a48da1e\">length</a>() &gt; 0)</div>\n\
<div class=\"line\">        {</div>\n\
...
<div class=\"line\">                modifier.<a name=\"a72\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_d_g_modifier.html#a9e6962659554cd09e71b3d4ef2244404\">deleteNode</a>(io);</div>\n\
<div class=\"line\">                modifier.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_d_g_modifier.html#a984345cd272bc1a32a9fc2e93a6678b2\">doIt</a>();</div>\n\
<div class=\"line\">            }</div>\n\
<div class=\"line\">        }</div>\n\
<div class=\"line\">    }</div>\n\
...
<div class=\"line\">        <span class=\"keywordflow\">if</span> (iRootNodes.<a name=\"a73\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html#ac914d138fc96d7065c687a4f8b40c263\">split</a>(<span class=\"charliteral\">&#39; &#39;</span>, theArray) == MS::kSuccess)</div>\n\
<div class=\"line\">        {</div>\n\
...
<div class=\"line\">                    mRootNodes.insert(name.<a name=\"a74\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html#aa9ab612f356c53479afc4c648c9ef94d\">asChar</a>());</div>\n\
...
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    mExceptPatterns.<a name=\"a75\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#ac8bb3912a3ce86b15842e79d0b421204\">clear</a>();</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">    iMesh.<a name=\"a76\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_dag_node.html#ae19de6f173f69f8753fdca910e208dc7\">getConnectedSetsAndMembers</a>(iInst, sets, comps, <span class=\"keyword\">false</span>);</div>\n\
...
<div class=\"line\">            {</div>\n\
<div class=\"line\">                <span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span> numChildDags = dagPath.<a name=\"a77\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_dag_path.html#a4545b4a1547fa72221afb9fa9f149412\">childCount</a>();</div>\n\
...
<div class=\"line\">                {</div>\n\
<div class=\"line\">                    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html\">MObject</a> child = dagPath.<a name=\"a78\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_dag_path.html#acf3680f39b19e4b44fe459efa2b76219\">child</a>(j);</div>\n\
<div class=\"line\">                    dagPath.<a name=\"a79\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_dag_path.html#a82ffa451bdebeba69b2c4c55f924980b\">push</a>(child);</div>\n\
...
<div class=\"line\">{</div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html\">MStatus</a> status = MS::kSuccess;</div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html\">MObject</a> cameraObj = <a name=\"a80\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html#af2a707b4254eb54763167aeced863e63\">MObject::kNullObj</a>;</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">            xformObj = trans.<a name=\"a89\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_transform.html#aadb18f8588670c77223658e8d921d483\">create</a>(mParent, &amp;status);</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">            <span class=\"keywordflow\">if</span> (status != MS::kSuccess)</div>\n\
<div class=\"line\">            {</div>\n\
