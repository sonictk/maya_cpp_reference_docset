...
<div class=\"line\">    <span class=\"keywordflow\">if</span> (!plug.<a name=\"a10\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#ab7ec149d38b7c29ca55c5aa7b407d8f9\">isNull</a>())</div>\n\
<div class=\"line\">    {</div>\n\
...
<div class=\"line\">                        <a name=\"a61\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html#af2a707b4254eb54763167aeced863e63\">MObject::kNullObj</a>);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    <span class=\"keywordflow\">else</span></div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">        plug.<a name=\"a64\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a34ecedb049eec1fabe85dc486e20d8e6\">setValue</a>(val);</div>\n\
...
<div class=\"line\">    <span class=\"keywordflow\">if</span> (!plug.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#ab7ec149d38b7c29ca55c5aa7b407d8f9\">isNull</a>())</div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">        <span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span> numChildren = plug.<a name=\"a65\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a551981a427bd12471416599084791113\">numChildren</a>();</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span> (numChildren == 0)</div>\n\
<div class=\"line\">        {</div>\n\
<div class=\"line\">            plug.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a34ecedb049eec1fabe85dc486e20d8e6\">setValue</a>(val[0]);</div>\n\
<div class=\"line\">        }</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">else</span></div>\n\
<div class=\"line\">        {</div>\n\
<div class=\"line\">            <span class=\"keywordflow\">if</span> (numChildren &gt; extent)</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">            <span class=\"keywordflow\">for</span> (<span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span> i = 0; i &lt; numChildren; ++i)</div>\n\
<div class=\"line\">                plug.<a name=\"a66\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a482274cc996238a9a9e77be5781caa90\">child</a>(i).<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a34ecedb049eec1fabe85dc486e20d8e6\">setValue</a>(val[i]);</div>\n\
<div class=\"line\">        }</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">return</span> VALID_DONE;</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">else</span> <span class=\"keywordflow\">if</span> (extent == 1)</div>\n\
...
<div class=\"line\">            <span class=\"keywordflow\">for</span> (<span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span> i = 0; i &lt; numChildren; ++i)</div>\n\
<div class=\"line\">            {</div>\n\
<div class=\"line\">                plug.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a482274cc996238a9a9e77be5781caa90\">child</a>(i).<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a34ecedb049eec1fabe85dc486e20d8e6\">setValue</a>(val[i]);</div>\n\
<div class=\"line\">            }</div>\n\
<div class=\"line\">        }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">        <span class=\"keywordflow\">return</span> VALID_DONE;</div>\n\
...
<div class=\"line\">{</div>\n\
<div class=\"line\">    <a name=\"_a95\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html\">MStatus</a> status = MS::kSuccess;</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"comment\">// create a new AlembicNode and initialize all its input attributes</span></div>\n\
<div class=\"line\">    <a name=\"_a96\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_d_g_modifier.html\">MDGModifier</a> modifier;</div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html\">MPlug</a> srcPlug, dstPlug;</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html\">MObject</a> alembicNodeObj = modifier.<a name=\"a97\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_d_g_modifier.html#a4705595f671688d3a8148cfd0c8ab277\">createNode</a>(<span class=\"stringliteral\">&quot;AlembicNode&quot;</span>, &amp;status);</div>\n\
...
<div class=\"line\">    plug.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a34ecedb049eec1fabe85dc486e20d8e6\">setValue</a>(iArgData.mFileName);</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"comment\">// set sequence start and end in frames</span></div>\n\
<div class=\"line\">    <a name=\"_a98\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_time.html\">MTime</a> sec(1.0, <a name=\"a99\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_time.html#abceb2331ad056e3c5ad27894199a49eda3091d1a096c28d4993507f167253ebc7\">MTime::kSeconds</a>);</div>\n\
...
<div class=\"line\">    plug.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a34ecedb049eec1fabe85dc486e20d8e6\">setValue</a>(iArgData.mSequenceStartTime * sec.as(<a name=\"a100\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_time.html#a5b08f84ff68e42c0a32dbd8e0a2d6506\">MTime::uiUnit</a>()));</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    plug.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a34ecedb049eec1fabe85dc486e20d8e6\">setValue</a>(iArgData.mSequenceEndTime * sec.as(<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_time.html#a5b08f84ff68e42c0a32dbd8e0a2d6506\">MTime::uiUnit</a>()));</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    plug.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a34ecedb049eec1fabe85dc486e20d8e6\">setValue</a>(iArgData.mConnect);</div>\n\
...
<div class=\"line\">    plug.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a34ecedb049eec1fabe85dc486e20d8e6\">setValue</a>(iArgData.mCreateIfNotFound);</div>\n\
...
<div class=\"line\">    plug.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a34ecedb049eec1fabe85dc486e20d8e6\">setValue</a>(iArgData.mRemoveIfNoUpdate);</div>\n\
...
<div class=\"line\">    plug.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a34ecedb049eec1fabe85dc486e20d8e6\">setValue</a>(iArgData.mConnectRootNodes);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    status = modifier.<a name=\"a101\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_d_g_modifier.html#afbd18f066f70fcd1864ddb4af91f3c7b\">connect</a>(srcPlug, dstPlug);</div>\n\
<div class=\"line\">    status = modifier.<a name=\"a102\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_d_g_modifier.html#a984345cd272bc1a32a9fc2e93a6678b2\">doIt</a>();</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">            <a name=\"_a103\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_transform.html\">MFnTransform</a> mFn(mObject, &amp;status);</div>\n\
...
<div class=\"line\">            {</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">                srcPlug = srcArrayPlug.<a name=\"a104\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a17852838d9f319e8bbebaa723969d02c\">elementByLogicalIndex</a>(logicalIndex++);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">            <a name=\"_a105\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_mesh.html\">MFnMesh</a> mFn(iArgData.mData.mSubDObjList[i], &amp;status);</div>\n\
...
<div class=\"line\">        {</div>\n\
<div class=\"line\">            <a name=\"_a106\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_dag_node.html\">MFnDagNode</a> fnLocator(iArgData.mData.mLocObjList[i]);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">        {</div>\n\
<div class=\"line\">            <a name=\"_a107\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_camera.html\">MFnCamera</a> fnCamera(iArgData.mData.mCameraObjList[i]);</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">            srcPlug = srcArrayPlug.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a17852838d9f319e8bbebaa723969d02c\">elementByLogicalIndex</a>(logicalIndex++);</div>\n\
...
<div class=\"line\">                <span class=\"keywordflow\">if</span> (!dstPlug.<a name=\"a109\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a40a52cd1e2411064f234ac9a6559385b\">isConnected</a>())</div>\n\
<div class=\"line\">                {</div>\n\
...
<div class=\"line\">                <span class=\"keywordflow\">if</span> (status != MS::kSuccess)</div>\n\
<div class=\"line\">                {</div>\n\
<div class=\"line\">                    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html\">MString</a> theError(srcPlug.<a name=\"a110\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a58e7cf126b4fe51e9705cee4faaf59fc\">name</a>());</div>\n\
...
<div class=\"line\">        {</div>\n\
<div class=\"line\">            srcPlug = srcArrayPlug.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a17852838d9f319e8bbebaa723969d02c\">elementByLogicalIndex</a>(i);</div>\n\
<div class=\"line\">            <a name=\"_a111\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_nurbs_surface.html\">MFnNurbsSurface</a> fnNSurface(iArgData.mData.mNurbsObjList[i]);</div>\n\
...
<div class=\"line\">            {</div>\n\
<div class=\"line\">                <a name=\"_a112\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_nurbs_curve.html\">MFnNurbsCurve</a> fnNCurve(curveObj);</div>\n\
