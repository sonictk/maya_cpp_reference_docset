...
<div class=\"line\">        <span class=\"keywordflow\">return</span> <a name=\"a9\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80a598e4c5d4c234c1bf09367d64487519c\">MS::kNotImplemented</a>;</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"comment\">//</span></div>\n\
<div class=\"line\">    <span class=\"comment\">// Let&#39;s see if we can open the output file.</span></div>\n\
<div class=\"line\">    <span class=\"comment\">//</span></div>\n\
<div class=\"line\">    fstream output(file.<a name=\"a10\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_file_object.html#a7a1c6f1f04d612d126a4e7512ab62ca7\">fullName</a>().<a name=\"a11\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html#aa9ab612f356c53479afc4c648c9ef94d\">asChar</a>(), ios::out | ios::trunc);</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> (!output.good()) <span class=\"keywordflow\">return</span> <a name=\"a12\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80a022ff9973d2e2bb66c1f79b99a914fb6\">MS::kNotFound</a>;</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">       ( (<span class=\"keywordtype\">object</span>.apiType()==<a name=\"a14\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn.html#a1d1cfd8ffb84e947f82999c682b666a7ac3bee92500cdc3a4ccbec4cb35e91f2a\">MFn::kFileTexture</a>) || (<span class=\"keywordtype\">object</span>.apiType()==<a name=\"a15\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn.html#a1d1cfd8ffb84e947f82999c682b666a7a6efef0262eb038b0a8924d3b38128a5b\">MFn::kImagePlane</a>) ) )</div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">        <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html\">MStatus</a> status;</div>\n\
<div class=\"line\">        <a name=\"_a16\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_dependency_node.html\">MFnDependencyNode</a> texNode(<span class=\"keywordtype\">object</span>, &amp;status);</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">            <a name=\"_a17\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html\">MPlug</a> plug = texNode.findPlug(colorSpaceStr, &amp;status);</div>\n\
<div class=\"line\">            <span class=\"keywordflow\">if</span> (status &amp;&amp; !plug.<a name=\"a18\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a1c18142e8f09680711f472aa2ddf8ac6\">isNull</a>())</div>\n\
<div class=\"line\">            {</div>\n\
<div class=\"line\">                plug.<a name=\"a19\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a64f7093bfde5c5eb9d89b32635b772aa\">getValue</a>(inputColorSpace);</div>\n\
<div class=\"line\">            }</div>\n\
<div class=\"line\">        }</div>\n\
<div class=\"line\">    }</div>\n\
...
<div class=\"line\">{</div>\n\
<div class=\"line\">    <a name=\"_a20\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_it_dependency_nodes.html\">MItDependencyNodes</a>  nodeIter;</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    f &lt;&lt; <span class=\"stringliteral\">&quot;====================== Nodes with color space attribute =======================\\n&quot;</span>;</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">for</span> (; !nodeIter.<a name=\"a21\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_it_dependency_nodes.html#a8b6dbf6fbab6f4e7bf50a309124cbf4c\">isDone</a>(); nodeIter.<a name=\"a22\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_it_dependency_nodes.html#a73616f002814b8abe6d921db72d7a496\">next</a>())</div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">        <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html\">MObject</a>             node = nodeIter.<a name=\"a23\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_it_dependency_nodes.html#a4b34a109bcef556096df6059416f9e5f\">item</a>();</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span>(!node.<a name=\"a24\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html#ac02f2a4d7312eb91f40980adfd4e31b2\">isNull</a>() &amp;&amp; </div>\n\
<div class=\"line\">           ( (node.<a name=\"a25\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html#a7e5fd5d37dde6df8c0cf350e00ca0a75\">apiType</a>()==<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn.html#a1d1cfd8ffb84e947f82999c682b666a7ac3bee92500cdc3a4ccbec4cb35e91f2a\">MFn::kFileTexture</a>) || (node.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html#a7e5fd5d37dde6df8c0cf350e00ca0a75\">apiType</a>()==<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn.html#a1d1cfd8ffb84e947f82999c682b666a7a6efef0262eb038b0a8924d3b38128a5b\">MFn::kImagePlane</a>) ) )</div>\n\
<div class=\"line\">        {</div>\n\
...
<div class=\"line\">          </div>\n\
<div class=\"line\">          f &lt;&lt; <span class=\"stringliteral\">&quot;Found node with colorspace &quot;</span> &lt;&lt; inputColorSpace.<a name=\"a26\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html#a9b62657aaecded5f56277d2c407ec64e\">asUTF8</a>();</div>\n\
<div class=\"line\">          <span class=\"keywordflow\">if</span>(<a name=\"a27\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_color_management_utilities.html#a3948287742813f6a88a1424bc521cf9b\">MColorManagementUtilities::getColorTransformCacheIdForInputSpace</a>(</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span>(<a name=\"a28\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_color_management_utilities.html#a70f7c1528266267004ff7b7ff1f54d58\">MColorManagementUtilities::isColorManagementAvailable</a>())</div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">      <a name=\"_a29\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_color_management_utilities_1_1_m_color_transform_data.html\">MColorManagementUtilities::MColorTransformData</a> colorTransformData;</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">      f &lt;&lt; <span class=\"stringliteral\">&quot;Data block size: &quot;</span> &lt;&lt; colorTransformData.<a name=\"a30\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_color_management_utilities_1_1_m_color_transform_data.html#a02d751e4c308cd6396e62e68a71b702c\">getSize</a>() &lt;&lt; std::endl;</div>\n\
<div class=\"line\">      f.write(static_cast&lt;const char*&gt;(colorTransformData.<a name=\"a31\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_color_management_utilities_1_1_m_color_transform_data.html#aa8a760d91a442deaa2cf5d0addd8176b\">getData</a>()), colorTransformData.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_color_management_utilities_1_1_m_color_transform_data.html#a02d751e4c308cd6396e62e68a71b702c\">getSize</a>());</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">else</span> </div>\n\
<div class=\"line\">    {</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html\">MString</a> transformId;</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span>(<a name=\"a32\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_color_management_utilities.html#a3e64e5581da3b9e03a49953f62e74ad0\">MColorManagementUtilities::getColorTransformCacheIdForOutputTransform</a>(transformId))</div>\n\
<div class=\"line\">    {</div>\n\
...
<div class=\"line\">{</div>\n\
<div class=\"line\">    <a name=\"_a33\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_plugin.html\">MFnPlugin</a> plugin(obj, PLUGIN_COMPANY, <span class=\"stringliteral\">&quot;1.0&quot;</span>, <span class=\"stringliteral\">&quot;Any&quot;</span>);</div>\n\
<div class=\"line\"></div>\n\
