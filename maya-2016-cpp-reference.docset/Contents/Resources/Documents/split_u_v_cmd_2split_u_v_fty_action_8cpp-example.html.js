...
<div class=\"line\"><span class=\"comment\">//</span></div>\n\
<div class=\"line\">{</div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html\">MStatus</a> status = <a name=\"a1\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80af0536797208144380691e2b376ffc1d1\">MS::kSuccess</a>;</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"comment\">// Declare our processing variables //</span></div>\n\
<div class=\"line\"><span class=\"comment\"></span></div>\n\
<div class=\"line\">    <a name=\"_a2\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html\">MString</a>     selUVSet;</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"comment\">// Face Id and Face Offset map to the selected UVs</span></div>\n\
<div class=\"line\">    <span class=\"comment\">//</span></div>\n\
<div class=\"line\">    <a name=\"_a3\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_int_array.html\">MIntArray</a>   selUVFaceIdMap;</div>\n\
...
<div class=\"line\"><span class=\"comment\"></span></div>\n\
<div class=\"line\">    <a name=\"_a4\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_mesh.html\">MFnMesh</a> meshFn( fMesh );</div>\n\
<div class=\"line\">    meshFn.<a name=\"a5\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_mesh.html#a63d1cbfe5459d728ec2594ccf9baf5a4\">getCurrentUVSetName</a>( selUVSet );</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">    <a name=\"_a6\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_it_mesh_polygon.html\">MItMeshPolygon</a> polyIter( fMesh );</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">for</span>( i = 0; i &lt; selUVsCount; i++ )</div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">        selUVFaceOffsetMap.<a name=\"a7\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_int_array.html#a11568087ac2ca16f4106cee62f65afd7\">append</a>(offset);</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">        <span class=\"keywordflow\">for</span>( polyIter.<a name=\"a8\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_it_mesh_polygon.html#ac734f26ff1c92ecec3572a31f5e4435c\">reset</a>(); !polyIter.<a name=\"a9\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_it_mesh_polygon.html#ac0f0d6fc806b11d246e05cb94e886b38\">isDone</a>(); polyIter.<a name=\"a10\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_it_mesh_polygon.html#a73616f002814b8abe6d921db72d7a496\">next</a>() )</div>\n\
<div class=\"line\">        {</div>\n\
<div class=\"line\">            <span class=\"keywordflow\">if</span>( polyIter.<a name=\"a11\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_it_mesh_polygon.html#aa93237aec198ded879d4bd0853b7bc39\">hasUVs</a>() )</div>\n\
<div class=\"line\">            {</div>\n\
<div class=\"line\">                <span class=\"keywordtype\">int</span> polyVertCount = polyIter.<a name=\"a12\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_it_mesh_polygon.html#ad1ea1656441c1d30dd0e3fc87229d71d\">polygonVertexCount</a>();</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">                    polyIter.<a name=\"a13\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_it_mesh_polygon.html#af6930b5fb20019b73fdf6a3af7281fc3\">getUVIndex</a>(j, UVIndex);</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">                    <span class=\"keywordflow\">if</span>( UVIndex == fSelUVs[i] )</div>\n\
<div class=\"line\">                    {</div>\n\
<div class=\"line\">                        selUVFaceIdMap.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_int_array.html#a11568087ac2ca16f4106cee62f65afd7\">append</a>( polyIter.<a name=\"a14\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_it_mesh_polygon.html#afdd8d04245960d9763609469ed0d21cb\">index</a>() );</div>\n\
...
<div class=\"line\"><span class=\"comment\"></span></div>\n\
<div class=\"line\">    <span class=\"keywordtype\">int</span> currentUVCount = meshFn.<a name=\"a15\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_mesh.html#a8ec9383ddfdf01902e7d5c8affd0c14c\">numUVs</a>( selUVSet );</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">for</span>( i = 0; i &lt; selUVsCount; i++ )</div>\n\
<div class=\"line\">    {</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">        meshFn.<a name=\"a16\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_mesh.html#acca758d84edf1ddc2af1177c4a6ffc2f\">getUV</a>( uvId, u, v, &amp;selUVSet );</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">        {</div>\n\
<div class=\"line\">            meshFn.<a name=\"a17\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_mesh.html#afe8bc4718af88a29cca9ca0729c8395a\">setUV</a>( currentUVCount, u, v, &amp;selUVSet );</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">            meshFn.<a name=\"a18\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_mesh.html#aa8f5741f8b319715af87211e8274ea79\">assignUV</a>( faceId, localVertId, currentUVCount, &amp;selUVSet );</div>\n\
<div class=\"line\"></div>\n\
