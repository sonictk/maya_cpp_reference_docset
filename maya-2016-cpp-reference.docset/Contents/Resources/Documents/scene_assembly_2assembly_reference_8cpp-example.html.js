...
<div class=\"line\">   <span class=\"comment\">// to get setInternalValueInContext() to be called.</span></div>\n\
...
<div class=\"line\"><span class=\"comment\">//------------------------------------------------------------------------------</span></div>\n\
<div class=\"line\"><span class=\"comment\">//</span></div>\n\
<div class=\"line\"><span class=\"keywordtype\">bool</span> AssemblyReference::setInternalValueInContext(</div>\n\
<div class=\"line\">   <span class=\"keyword\">const</span> <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html\">MPlug</a>&amp; plug, <span class=\"keyword\">const</span> <a name=\"_a24\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_data_handle.html\">MDataHandle</a>&amp; dataHandle, <a name=\"_a25\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_d_g_context.html\">MDGContext</a>&amp; <span class=\"comment\">/* ctx */</span></div>\n\
<div class=\"line\">)</div>\n\
<div class=\"line\">{</div>\n\
...
<div class=\"line\">        <span class=\"keywordflow\">if</span>( <a name=\"a26\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_file_i_o.html#a30bf5678402012d5607a6b0f22d2c2a5\">MFileIO::isOpeningFile</a>() || <a name=\"a27\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_file_i_o.html#accbcaffc37fcbee9f7974aae80c8014b\">MFileIO::isReadingFile</a>() ) {</div>\n\
...
<div class=\"line\">        fDefnFile = dataHandle.<a name=\"a28\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_data_handle.html#a858b071eda071f265c130e30d0b98622\">asString</a>();</div>\n\
...
<div class=\"line\">        <a name=\"_a29\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_assembly.html\">MFnAssembly</a> aFn(thisMObject());</div>\n\
...
<div class=\"line\">        plug.<a name=\"a30\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a64f7093bfde5c5eb9d89b32635b772aa\">getValue</a>(oldNS);</div>\n\
<div class=\"line\">        <span class=\"comment\">// Early-out if the plug value is empty: the namespace has not been created yet.</span></div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span> (0 == oldNS.<a name=\"a31\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html#a9f0f85031c628ef5111739fe8573003b\">numChars</a>())</div>\n\
<div class=\"line\">        {</div>\n\
<div class=\"line\">            <span class=\"keywordflow\">return</span> <span class=\"keyword\">false</span>;</div>\n\
<div class=\"line\">        }</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">            oldNS = <a name=\"a32\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_px_assembly.html#a02d592bb931ae1052701478cea052740\">MPxAssembly::getRepNamespace</a>();</div>\n\
<div class=\"line\">        }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">        <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html\">MString</a> newNS = dataHandle.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_data_handle.html#a858b071eda071f265c130e30d0b98622\">asString</a>();</div>\n\
...
<div class=\"line\">        <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html\">MStatus</a> status;</div>\n\
<div class=\"line\">        <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html\">MString</a> validNewNS = <a name=\"a33\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_namespace.html#a43a85d2eaf4ef2bf701cff29349a0c57\">MNamespace::validateName</a>(newNS, &amp;status);</div>\n\
...
<div class=\"line\">            <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_data_handle.html\">MDataHandle</a>* nonConstHandle  = (<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_data_handle.html\">MDataHandle</a>*) &amp;dataHandle;</div>\n\
<div class=\"line\">            nonConstHandle-&gt;<a name=\"a34\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_data_handle.html#a2a75482f517f405a641c0eee0bd995ac\">set</a>(newNS);</div>\n\
<div class=\"line\">        }</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">            status = <a name=\"a35\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_namespace.html#aa52081accd048c81ef04ab837df2aac4\">MNamespace::renameNamespace</a>(oldNS, newNS);</div>\n\
<div class=\"line\">            <span class=\"keywordflow\">if</span> (status != <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80af0536797208144380691e2b376ffc1d1\">MStatus::kSuccess</a>) {</div>\n\
...
<div class=\"line\">           <a name=\"a36\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_global.html#a7b35236b639518320b2885b4fd673bab\">MGlobal::optionVarIntValue</a>(<span class=\"stringliteral\">&quot;fileIgnoreVersion&quot;</span>) == 1;</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">       <a name=\"_a37\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_container_node.html\">MFnContainerNode</a> contFn(thisMObject());</div>\n\
<div class=\"line\">       <a name=\"_a38\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object_array.html\">MObjectArray</a> members;</div>\n\
...
<div class=\"line\">       <span class=\"keyword\">const</span> <span class=\"keywordtype\">int</span> nbMembers = <span class=\"keyword\">static_cast&lt;</span><span class=\"keywordtype\">int</span><span class=\"keyword\">&gt;</span>(members.<a name=\"a39\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object_array.html#a580388f31f60c46fac867ca48a48da1e\">length</a>());</div>\n\
...
<div class=\"line\">       <span class=\"keyword\">const</span> <span class=\"keywordtype\">int</span> nbReps = defnRepresentations.<a name=\"a40\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string_array.html#a580388f31f60c46fac867ca48a48da1e\">length</a>();</div>\n\
...
<div class=\"line\">           }</div>\n\
<div class=\"line\">           fDefnFileCacheEntry = cache.<a name=\"a41\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string_array.html#a3db31367f989449bb9b121cd734dc0df\">insert</a>(defnFile, repCreationArgsList);</div>\n\
<div class=\"line\">       }</div>\n\
<div class=\"line\">   </div>\n\
<div class=\"line\">       <span class=\"comment\">// Get rid of imported asset definition.</span></div>\n\
<div class=\"line\">       status = contFn.<a name=\"a42\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#ac8bb3912a3ce86b15842e79d0b421204\">clear</a>();</div>\n\
<div class=\"line\">       <span class=\"keywordflow\">if</span> (status != <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80af0536797208144380691e2b376ffc1d1\">MStatus::kSuccess</a>) {</div>\n\
<div class=\"line\">           <span class=\"keywordflow\">return</span>;</div>\n\
<div class=\"line\">       }</div>\n\
<div class=\"line\">   }</div>\n\
...
<div class=\"line\">   <span class=\"keywordflow\">if</span> (fInitialRep)</div>\n\
<div class=\"line\">   {</div>\n\
<div class=\"line\">       fInitialRep-&gt;<a name=\"a43\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html#ac8bb3912a3ce86b15842e79d0b421204\">clear</a>(thisMObject());</div>\n\
...
<div class=\"line\"><span class=\"comment\">//------------------------------------------------------------------------------</span></div>\n\
<div class=\"line\"><span class=\"comment\">//</span></div>\n\
<div class=\"line\"><span class=\"keywordtype\">void</span> AssemblyReference::definitionError(<span class=\"keyword\">const</span> <a name=\"_a44\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string_resource_id.html\">MStringResourceId</a>&amp; <span class=\"keywordtype\">id</span>)</div>\n\
<div class=\"line\">{</div>\n\
...
<div class=\"line\">   <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html\">MString</a> errorString = <a name=\"a45\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string_resource.html#a121315f443a9c4ea512738dc1d39414d\">MStringResource::getString</a>(<span class=\"keywordtype\">id</span>, status);</div>\n\
<div class=\"line\">   errorString.<a name=\"a46\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html#a07ae464181c795f43fa1bcc288acff91\">format</a>(errorString, defnFile, contFn.name());</div>\n\
<div class=\"line\">   <a name=\"a47\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_global.html#a4ddbe97e58a90e1ab05d45a62c006cf0\">MGlobal::displayError</a>(errorString);</div>\n\
...
<div class=\"line\">       </div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> ( !repNamespaceStr.<a name=\"a48\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html#a580388f31f60c46fac867ca48a48da1e\">length</a>() ) {</div>\n\
<div class=\"line\">        <span class=\"comment\">// defaults to the MPxAssembly implementation</span></div>\n\
