...
<div class=\"line\">    <span class=\"keyword\">static</span> boost::shared_ptr&lt;FlipNormalsProgram&gt; getInstance();</div>\n\
...
<div class=\"line\">    <span class=\"keyword\">static</span> boost::shared_ptr&lt;FlipNormalsProgram&gt; fsFlipNormalsProgram;</div>\n\
...
<div class=\"line\">    <span class=\"stringliteral\">&quot;}\\n\\n&quot;</span> ;</div>\n\
<div class=\"line\">boost::shared_ptr&lt;FlipNormalsProgram&gt; FlipNormalsProgram::fsFlipNormalsProgram;</div>\n\
<div class=\"line\">    </div>\n\
<div class=\"line\"><span class=\"comment\">//------------------------------------------------------------------------------</span></div>\n\
<div class=\"line\"><span class=\"comment\">//</span></div>\n\
<div class=\"line\">boost::shared_ptr&lt;FlipNormalsProgram&gt; FlipNormalsProgram::getInstance()</div>\n\
<div class=\"line\">{</div>\n\
...
<div class=\"line\">        <span class=\"keywordflow\">return</span> boost::shared_ptr&lt;FlipNormalsProgram&gt;();;</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\">    </div>\n\
<div class=\"line\">    <span class=\"comment\">// create a new transform feedback program</span></div>\n\
<div class=\"line\">    boost::shared_ptr&lt;FlipNormalsProgram&gt; prog(<span class=\"keyword\">new</span> FlipNormalsProgram());</div>\n\
...
<div class=\"line\">{</div>\n\
<div class=\"line\">    boost::shared_ptr&lt;FlipNormalsProgram&gt; prog = FlipNormalsProgram::getInstance();</div>\n\
...
<div class=\"line\">    boost::shared_ptr&lt;const VBOBuffer&gt; find(</div>\n\
...
<div class=\"line\">                boost::shared_ptr&lt;const VBOBuffer&gt; result = it-&gt;second;</div>\n\
...
<div class=\"line\">        }</div>\n\
<div class=\"line\">        </div>\n\
<div class=\"line\">        <span class=\"keywordflow\">return</span> boost::shared_ptr&lt;const VBOBuffer&gt;();</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"comment\">// Insert the given buffer in the registry.</span></div>\n\
<div class=\"line\">    <span class=\"keywordtype\">void</span> insert(boost::shared_ptr&lt;const VBOBuffer&gt;&amp; buffer)</div>\n\
<div class=\"line\">    {</div>\n\
...
<div class=\"line\">            tbb::mutex::scoped_lock lock(fBuffersToDeleteMutex);</div>\n\
<div class=\"line\">            BOOST_FOREACH (<span class=\"keyword\">const</span> Key&amp; key, fBuffersToDelete) {</div>\n\
...
<div class=\"line\">        BOOST_FOREACH(<span class=\"keyword\">const</span> Map::value_type&amp; v,</div>\n\
...
<div class=\"line\">        boost::shared_ptr&lt;const VBOBuffer&gt;,</div>\n\
...
<div class=\"line\">    boost::unordered_set&lt;Key, KeyHash, KeyEqualTo&gt; fBuffersToDelete;</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    boost::mt19937_64 fRandomEvictionIndex;</div>\n\
<div class=\"line\">};</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    fsMayaExitCallbackId = <a name=\"a0\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_scene_message.html#a0f4760368de3989378ce9cec3943ae6d\">MSceneMessage::addCallback</a>(</div>\n\
...
<div class=\"line\">{</div>\n\
<div class=\"line\">    boost::shared_ptr&lt;const VBOBuffer&gt; result =</div>\n\
...
<div class=\"line\">        boost::shared_ptr&lt;ReadableArray&lt;unsigned int&gt; &gt; readable = buffer-&gt;array()-&gt;getReadableArray();</div>\n\
...
<div class=\"line\">            boost::shared_ptr&lt;Array&lt;unsigned int&gt; &gt; array(readable);</div>\n\
...
<div class=\"line\">        result = boost::make_shared&lt;VBOBuffer&gt;(</div>\n\
...
<div class=\"line\">    <span class=\"keywordflow\">if</span> (!result) {</div>\n\
<div class=\"line\"><span class=\"preprocessor\">#ifdef DOWNCONVERT_SSO_TO_SOFTWARE</span></div>\n\
<div class=\"line\">        boost::shared_ptr&lt;ReadableArray&lt;float&gt; &gt; readable = buffer-&gt;array()-&gt;getReadableArray();</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span> (!buffer-&gt;array()-&gt;isReadable()) {</div>\n\
<div class=\"line\">            <span class=\"comment\">// We are converting from viewport 2.0 SubSceneOverride non-readable arrays back to VBOBuffers.</span></div>\n\
<div class=\"line\">            <span class=\"comment\">// So graft the SharedArray copy of the data back into the VertexBuffer.  This happens when changing</span></div>\n\
<div class=\"line\">            <span class=\"comment\">// the viewport mode from vp2.0 to the default viewport and allows the vp2.0 buffer to be freed.</span></div>\n\
<div class=\"line\">            boost::shared_ptr&lt;Array&lt;float&gt; &gt; array(readableArray);</div>\n\
<div class=\"line\">            buffer-&gt;ReplaceArrayInstance(array);</div>\n\
<div class=\"line\">        }</div>\n\
<div class=\"line\"><span class=\"preprocessor\">#else </span></div>\n\
...
<div class=\"line\">    <span class=\"keyword\">const</span> <span class=\"keywordtype\">bool</span> isTemporary)</div>\n\
<div class=\"line\">{</div>\n\
<div class=\"line\">    boost::shared_ptr&lt;const VBOBuffer&gt; flippedVBO =</div>\n\
...
<div class=\"line\">        boost::shared_ptr&lt;const VBOBuffer&gt; unflippedVBO = create(buffer, isTemporary);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">            flippedVBO = boost::make_shared&lt;VBOBuffer&gt;(</div>\n\
...
<div class=\"line\">    </div>\n\
<div class=\"line\">    boost::shared_ptr&lt;const VBOBuffer&gt; vboIndices;</div>\n\
<div class=\"line\">    boost::shared_ptr&lt;const VBOBuffer&gt; vboPositions;</div>\n\
<div class=\"line\">    boost::shared_ptr&lt;const VBOBuffer&gt; vboNormals;</div>\n\
<div class=\"line\">    boost::shared_ptr&lt;const VBOBuffer&gt; vboUVs;</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">                    boost::shared_ptr&lt;const VBOBuffer&gt; unflippedNormals =</div>\n\
...
<div class=\"line\">        sample-&gt;positions(),</div>\n\
<div class=\"line\">        normalsMode != kNoNormals ? sample-&gt;normals() : boost::shared_ptr&lt;VertexBuffer&gt;(),</div>\n\
<div class=\"line\">        uvsMode != kNoUVs         ? sample-&gt;uvs()     : boost::shared_ptr&lt;VertexBuffer&gt;(),</div>\n\
