...
<div class=\"line\"></div>\n\
<div class=\"line\"><span class=\"comment\">//</span></div>\n\
<div class=\"line\"><span class=\"comment\">// helixTool.cpp</span></div>\n\
<div class=\"line\"><span class=\"comment\">//</span></div>\n\
<div class=\"line\"><span class=\"comment\">// Description:</span></div>\n\
<div class=\"line\"><span class=\"comment\">//     Interactive tool to draw a helix.</span></div>\n\
<div class=\"line\"><span class=\"comment\">//     Uses OpenGL to draw a guideline for the helix.</span></div>\n\
<div class=\"line\"><span class=\"comment\">//</span></div>\n\
<div class=\"line\"><span class=\"comment\">//</span></div>\n\
<div class=\"line\"><span class=\"comment\">// Steps in creating a tool command</span></div>\n\
<div class=\"line\"><span class=\"comment\">//</span></div>\n\
...
<div class=\"line\">    <span class=\"keyword\">virtual</span>         ~helixTool(); </div>\n\
...
<div class=\"line\">            status.<a name=\"a16\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a1f01a4748fea4d8bcced082df83f804d\">perror</a>(<span class=\"stringliteral\">&quot;pitch flag parsing failed&quot;</span>);</div>\n\
<div class=\"line\">            <span class=\"keywordflow\">return</span> status;</div>\n\
<div class=\"line\">        }</div>\n\
...
<div class=\"line\">    <a name=\"_a17\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_point_array.html\">MPointArray</a>     controlVertices;</div>\n\
<div class=\"line\">    <a name=\"_a18\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_double_array.html\">MDoubleArray</a>    knotSequences;</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">        controlVertices.<a name=\"a19\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_point_array.html#abe5a9fe36b4651af38a4a26c85f46e1a\">append</a>(<a name=\"_a20\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_point.html\">MPoint</a>(radius * cos((<span class=\"keywordtype\">double</span>) i),</div>\n\
...
<div class=\"line\">        knotSequences.<a name=\"a21\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_double_array.html#aafcfe8ff7afecc2dee4defccbdfb8e55\">append</a>((<span class=\"keywordtype\">double</span>) i);</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"comment\">// Now create the curve</span></div>\n\
<div class=\"line\">    <span class=\"comment\">//</span></div>\n\
<div class=\"line\">    <a name=\"_a22\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_nurbs_curve.html\">MFnNurbsCurve</a> curveFn;</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    curveFn.<a name=\"a23\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_nurbs_curve.html#a4b11e346021c91845e781e9d7d06859f\">create</a>(controlVertices, knotSequences, deg, </div>\n\
<div class=\"line\">                   <a name=\"a24\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_nurbs_curve.html#a99f5203c7742378941e34926280c8e66a7fb3bf49ba349ca1a266be41df447b5b\">MFnNurbsCurve::kOpen</a>, <span class=\"keyword\">false</span>, <span class=\"keyword\">false</span>, </div>\n\
<div class=\"line\">                   <a name=\"a25\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html#ae6af14e0aa2c92bdda88c81280e1d122\">MObject::kNullObj</a>, &amp;stat);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    stat = curveFn.<a name=\"a26\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_dag_node.html#adfb40b1f56af23ad94c4ca77c9a147b5\">getPath</a>( path );</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">return</span> stat;</div>\n\
<div class=\"line\">}</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">{</div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html\">MStatus</a> stat; </div>\n\
<div class=\"line\">    <a name=\"_a27\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html\">MObject</a> transform = path.transform();</div>\n\
<div class=\"line\">    stat = <a name=\"a28\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_global.html#a3d83d29ca400045849d777aecafda70c\">MGlobal::deleteNode</a>( transform );</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">return</span> stat;</div>\n\
<div class=\"line\">}</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    command.<a name=\"a29\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_arg_list.html#a4e6cac2a8066c27dd3c214ed50f86b5a\">addArg</a>(commandString());</div>\n\
<div class=\"line\">    command.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_arg_list.html#a4e6cac2a8066c27dd3c214ed50f86b5a\">addArg</a>(<a name=\"_a30\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html\">MString</a>(kRadiusFlag));</div>\n\
...
<div class=\"line\">    <span class=\"keywordflow\">return</span> <a name=\"a31\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_px_tool_command.html#a453a8fb7a2285d97888cf2a60fa64712\">MPxToolCommand::doFinalize</a>( command );</div>\n\
<div class=\"line\">}</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\"><span class=\"keyword\">class </span>helixContext : <span class=\"keyword\">public</span> <a name=\"_a32\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_px_context.html\">MPxContext</a></div>\n\
<div class=\"line\">{</div>\n\
<div class=\"line\"><span class=\"keyword\">public</span>:</div>\n\
<div class=\"line\">                    helixContext();</div>\n\
<div class=\"line\">    <span class=\"keyword\">virtual</span> <span class=\"keywordtype\">void</span>    <a name=\"a33\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_px_context.html#a658f83d3a196c6c8e77e7ed2655eb6d7\">toolOnSetup</a>(<a name=\"_a34\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_event.html\">MEvent</a> &amp;event);</div>\n\
<div class=\"line\">    <span class=\"keyword\">virtual</span> <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html\">MStatus</a> <a name=\"a35\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_px_context.html#a0207c206f23f9ed9ba2cd52afd01cd0f\">doPress</a>(<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_event.html\">MEvent</a> &amp;event);</div>\n\
<div class=\"line\">    <span class=\"keyword\">virtual</span> <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html\">MStatus</a> <a name=\"a36\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_px_context.html#a531f370c5c8612e10b504a4858c44c60\">doDrag</a>(<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_event.html\">MEvent</a> &amp;event);</div>\n\
<div class=\"line\">    <span class=\"keyword\">virtual</span> <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html\">MStatus</a> <a name=\"a37\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_px_context.html#a560e1136f32f260f7de42b579ad1f27b\">doRelease</a>(<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_event.html\">MEvent</a> &amp;event);</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keyword\">virtual</span> <span class=\"keywordtype\">void</span>    <a name=\"a39\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_px_context.html#a79eb9c170168f8755d68c3147d6c1676\">getClassName</a>(<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html\">MString</a> &amp; name) <span class=\"keyword\">const</span>;</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordtype\">void</span>            setNumCVs(<span class=\"keywordtype\">unsigned</span> newNumCVs);</div>\n\
<div class=\"line\">    <span class=\"keywordtype\">void</span>            setUpsideDown(<span class=\"keywordtype\">bool</span> newUpsideDown);</div>\n\
...
<div class=\"line\">    <a name=\"_a40\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m3d_view.html\">M3dView</a>         view;</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">    setCursor( <a name=\"a41\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_cursor.html#a8b3c57a641b7787df0e0064a6b9ae76e\">MCursor::defaultCursor</a> );</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    setImage(<span class=\"stringliteral\">&quot;helixTool.xpm&quot;</span>, <a name=\"a42\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_px_context.html#a5680fcec77b562f3c18fbd3001f4f29dab537113dbc917348d5d70fe16eaba09b\">MPxContext::kImage1</a> );</div>\n\
<div class=\"line\">}</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    view = <a name=\"a43\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m3d_view.html#a3cda809eff914b04ff47de958c365f09\">M3dView::active3dView</a>();</div>\n\
...
<div class=\"line\">    name.<a name=\"a44\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html#acee761fe098fc30a5ac1437e3aca5bc0\">set</a>(<span class=\"stringliteral\">&quot;helix&quot;</span>);</div>\n\
<div class=\"line\">}</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">{</div>\n\
<div class=\"line\">    numCV = newNumCVs;</div>\n\
<div class=\"line\">    <a name=\"a45\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_tools_info.html#afc06e5e83a38fd464a506b4ec70c0b25\">MToolsInfo::setDirtyFlag</a>(*<span class=\"keyword\">this</span>);</div>\n\
<div class=\"line\">}</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">{</div>\n\
<div class=\"line\">    upDown = newUpsideDown;</div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_tools_info.html#afc06e5e83a38fd464a506b4ec70c0b25\">MToolsInfo::setDirtyFlag</a>(*<span class=\"keyword\">this</span>);</div>\n\
<div class=\"line\">}</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\"><span class=\"comment\"></span></div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"><span class=\"keyword\">class </span>helixContextCmd : <span class=\"keyword\">public</span> <a name=\"_a46\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_px_context_command.html\">MPxContextCommand</a></div>\n\
<div class=\"line\">{</div>\n\
<div class=\"line\"><span class=\"keyword\">public</span>: </div>\n\
...
<div class=\"line\">    <span class=\"keyword\">virtual</span> <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_px_context.html\">MPxContext</a>* <a name=\"a49\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_px_context_command.html#a69d6fc56205518e4be6c0ced911e6523\">makeObj</a>();</div>\n\
<div class=\"line\">    <span class=\"keyword\">virtual</span> <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html\">MStatus</a>     <a name=\"a50\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_px_context_command.html#aebce411ed7652b491d2b7c1938b8042c\">appendSyntax</a>();</div>\n\
<div class=\"line\">    <span class=\"keyword\">static</span> <span class=\"keywordtype\">void</span>*        creator();</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    </div>\n\
<div class=\"line\">    <a name=\"_a51\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_arg_parser.html\">MArgParser</a> argData = parser();</div>\n\
<div class=\"line\">    </div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> (argData.<a name=\"a52\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_arg_parser.html#aa38abc6623182dacee0fcb4136e403b8\">isFlagSet</a>(kNumberCVsFlag)) {</div>\n\
<div class=\"line\">        <span class=\"keywordtype\">unsigned</span> numCVs;</div>\n\
<div class=\"line\">        status = argData.<a name=\"a53\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_arg_parser.html#a74bdc5edb84381a46ce3a0de74230938\">getFlagArgument</a>(kNumberCVsFlag, 0, numCVs);</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span> (!status) {</div>\n\
<div class=\"line\">            status.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a1f01a4748fea4d8bcced082df83f804d\">perror</a>(<span class=\"stringliteral\">&quot;numCVs flag parsing failed.&quot;</span>);</div>\n\
<div class=\"line\">            <span class=\"keywordflow\">return</span> status;</div>\n\
<div class=\"line\">        }</div>\n\
...
<div class=\"line\">    </div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> (<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80af0536797208144380691e2b376ffc1d1\">MS::kSuccess</a> != mySyntax.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_syntax.html#aeaeaac3794bb4de8004afb1ac1829488\">addFlag</a>(kNumberCVsFlag, kNumberCVsFlagLong,</div>\n\
...
<div class=\"line\">        <span class=\"keywordflow\">return</span> <a name=\"a54\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80a1ef6c2d725fb4bec3e7e840d28adbc00\">MS::kFailure</a>;</div>\n\
<div class=\"line\">    }</div>\n\
