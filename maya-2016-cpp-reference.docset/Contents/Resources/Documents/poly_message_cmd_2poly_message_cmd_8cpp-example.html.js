...
<html>\n\
   <head><script src=\"../scripts/yepnope.1.5.4-min.js\" type=\"text/javascript\"></script><script src=\"../scripts/lib/jquery-1.11.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\"><meta name=\"product\" content=\"MAYAUL\"><meta name=\"release\" content=\"2016\"><meta name=\"book\" content=\"Developer\"><meta name=\"created\" content=\"2015-10-14\"><meta name=\"topicid\" content=\"GUID-02DEF634-1E7B-48C6-8ACD-2C934CA97887\"><meta name=\"topic-type\" content=\"concept\">\n\
      <title>polyMessageCmd/polyMessageCmd.cpp</title>\n\
   \n\
\n\
...
$(window).load( function() {\n\
 ...
 if (!tocSystemNeedsToBeLoaded) { cpp_ref_initializeToc(); }\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>polyMessageCmd/polyMessageCmd.cpp</h1>\n\
         </div>\n\
\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\"><span class=\"comment\">//</span></div>\n\
<div class=\"line\"><span class=\"comment\">// polyMessageCmd.cpp</span></div>\n\
<div class=\"line\"><span class=\"comment\">//</span></div>\n\
<div class=\"line\"><span class=\"comment\">// Description:</span></div>\n\
<div class=\"line\"><span class=\"comment\">//     Sample plug-in that demonstrates how to register/de-register</span></div>\n\
<div class=\"line\"><span class=\"comment\">//     a callback with the MPolyMessage class.</span></div>\n\
<div class=\"line\"><span class=\"comment\">//</span></div>\n\
<div class=\"line\"><span class=\"comment\">//     This plug-in will register a new command in maya called</span></div>\n\
<div class=\"line\"><span class=\"comment\">//     &quot;polyMessage&quot; which adds a callback for the all nodes on</span></div>\n\
<div class=\"line\"><span class=\"comment\">//     the active selection list. A message is printed to stdout</span></div>\n\
<div class=\"line\"><span class=\"comment\">//     whenever a component id of one of the poly nodes is modified.</span></div>\n\
<div class=\"line\"><span class=\"comment\">//</span></div>\n\
...
<div class=\"line\">    </div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> ( count != <a name=\"a2\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_poly_message.html#a05589fbab0657f08285ebdfe93f5ec9ea1c55b131cb0f64620c16c77704ef1755\">MPolyMessage::kLastErrorIndex</a> )</div>\n\
...
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_uint_array.html\">MUintArray</a> vertexIds = componentIds[<a name=\"a4\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_poly_message.html#a05589fbab0657f08285ebdfe93f5ec9eadfae90212226124b70c1773022d888b6\">MPolyMessage::kVertexIndex</a>];</div>\n\
...
<div class=\"line\">    }</div>\n\
<div class=\"line\">    </div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_uint_array.html\">MUintArray</a> edgeIds = componentIds[<a name=\"a6\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_poly_message.html#a05589fbab0657f08285ebdfe93f5ec9eae08ef52c4e53504b79f32cbc3e8ef67c\">MPolyMessage::kEdgeIndex</a>];</div>\n\
...
<div class=\"line\">    }</div>\n\
<div class=\"line\">    </div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_uint_array.html\">MUintArray</a> faceIds = componentIds[<a name=\"a7\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_poly_message.html#a05589fbab0657f08285ebdfe93f5ec9eab0da48fd486a3ee708b335090ff3c08a\">MPolyMessage::kFaceIndex</a>];</div>\n\
...
<div class=\"line\">    <span class=\"keyword\">virtual</span>         ~polyMessageCmd(); </div>\n\
...
<div class=\"line\">        <span class=\"keywordflow\">if</span> ( <a name=\"a18\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80af0536797208144380691e2b376ffc1d1\">MS::kSuccess</a> == <a name=\"a19\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_dag_path.html#a422aa5ec02565f757c13fe2873ed25d7\">MDagPath::getAPathTo</a>( node, dp ) )</div>\n\
<div class=\"line\">            <span class=\"keywordflow\">if</span> ( <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80af0536797208144380691e2b376ffc1d1\">MS::kSuccess</a> == dp.<a name=\"a20\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_dag_path.html#a658d9664035ff84ffefa217c0e45cc88\">extendToShape</a>() )</div>\n\
<div class=\"line\">                shapeNode = dp.<a name=\"a21\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_dag_path.html#ad1aa507eb8e63e89e8d46a0abc18aa8c\">node</a>();</div>\n\
<div class=\"line\">        </div>\n\
<div class=\"line\">        <span class=\"keywordtype\">bool</span> wantIdChanges[3];</div>\n\
<div class=\"line\">        wantIdChanges[<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_poly_message.html#a05589fbab0657f08285ebdfe93f5ec9eadfae90212226124b70c1773022d888b6\">MPolyMessage::kVertexIndex</a>] = <span class=\"keyword\">true</span>;</div>\n\
<div class=\"line\">        wantIdChanges[<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_poly_message.html#a05589fbab0657f08285ebdfe93f5ec9eae08ef52c4e53504b79f32cbc3e8ef67c\">MPolyMessage::kEdgeIndex</a>] = <span class=\"keyword\">true</span>;        </div>\n\
<div class=\"line\">        wantIdChanges[<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_poly_message.html#a05589fbab0657f08285ebdfe93f5ec9eab0da48fd486a3ee708b335090ff3c08a\">MPolyMessage::kFaceIndex</a>] = <span class=\"keyword\">true</span>;</div>\n\
<div class=\"line\">        </div>\n\
<div class=\"line\">        <span class=\"keywordtype\">id</span> = <a name=\"a22\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_poly_message.html#a84fbcde65c8352f1e3afdfc232d5d2c6\">MPolyMessage::addPolyComponentIdChangedCallback</a>( shapeNode,</div>\n\
...
<div class=\"line\">            callbackIds.<a name=\"a23\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_callback_id_array.html#a21e9b777b17a3dfd715d96599376ecfa\">append</a>( <span class=\"keywordtype\">id</span> );</div>\n\
...
<div class=\"line\">{</div>\n\
<div class=\"line\">    <a name=\"_a24\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_plugin.html\">MFnPlugin</a> plugin(obj, PLUGIN_COMPANY, <span class=\"stringliteral\">&quot;6.0&quot;</span>, <span class=\"stringliteral\">&quot;Any&quot;</span>);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    <span class=\"comment\">//</span></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">for</span> (<span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span> i=0; i&lt;callbackIds.<a name=\"a25\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_callback_id_array.html#a580388f31f60c46fac867ca48a48da1e\">length</a>(); i++ ) {</div>\n\
<div class=\"line\">        <a name=\"a26\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_message.html#a50fe995add3ce133b8b56551abb4ed09\">MMessage::removeCallback</a>( (MCallbackId)callbackIds[i] );</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
