...
<div class=\"line\">    }</div>\n\
<div class=\"line\">    <span class=\"keywordtype\">double</span> xVal = xPlug.<a name=\"a4\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#acb5276d3f8a82a3b48f4fcddb277a275\">asDouble</a>();</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    }</div>\n\
<div class=\"line\">    <span class=\"keywordtype\">double</span> yVal = yPlug.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#acb5276d3f8a82a3b48f4fcddb277a275\">asDouble</a>();</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    }</div>\n\
<div class=\"line\">    <span class=\"keywordtype\">double</span> zVal = zPlug.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#acb5276d3f8a82a3b48f4fcddb277a275\">asDouble</a>();</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">        }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">        <span class=\"keywordtype\">double</span> plugVal = plug.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#acb5276d3f8a82a3b48f4fcddb277a275\">asDouble</a>();</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    }</div>\n\
<div class=\"line\">    <span class=\"keywordtype\">double</span> xyVal = xyPlug.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#acb5276d3f8a82a3b48f4fcddb277a275\">asDouble</a>();</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    }</div>\n\
<div class=\"line\">    <span class=\"keywordtype\">double</span> xzVal = xzPlug.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#acb5276d3f8a82a3b48f4fcddb277a275\">asDouble</a>();</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    }</div>\n\
<div class=\"line\">    <span class=\"keywordtype\">double</span> yzVal = yzPlug.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#acb5276d3f8a82a3b48f4fcddb277a275\">asDouble</a>();</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"comment\">// this is to handle the case where there is a connection to the parent</span></div>\n\
<div class=\"line\">    <span class=\"comment\">// plug but not to the child plugs, if the connection is there then all</span></div>\n\
<div class=\"line\">    <span class=\"comment\">// of the children are considered animated</span></div>\n\
...
<div class=\"line\">            xSamp = 1;</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\">    <span class=\"keywordtype\">double</span> xVal = xPlug.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#acb5276d3f8a82a3b48f4fcddb277a275\">asDouble</a>();</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html\">MPlug</a> yPlug = iTrans.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_dependency_node.html#aac29b4a3b51c9d236175e955638f7153\">findPlug</a>(yName);</div>\n\
<div class=\"line\">    <span class=\"keywordtype\">int</span> ySamp = 0;</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> (!forceStatic)</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> (iDag.<a name=\"a6\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_dag_path.html#abea5b1e5057d0e1088877be2573be47b\">hasFn</a>(<a name=\"a7\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn.html#a1d1cfd8ffb84e947f82999c682b666a7ab8b14d1ed753088b316e8ee8c5d38ca9\">MFn::kJoint</a>))</div>\n\
<div class=\"line\">    {</div>\n\
...
<div class=\"line\">            <span class=\"keywordflow\">if</span> (!inheritPlug.<a name=\"a10\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a1c18142e8f09680711f472aa2ddf8ac6\">isNull</a>())</div>\n\
<div class=\"line\">            {</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">                mSample.setInheritsXforms(inheritPlug.<a name=\"a11\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#aea1ddab8d4272d03146b3dad29be3af0\">asBool</a>());</div>\n\
<div class=\"line\">            }</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">            <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html\">MPlug</a> inheritPlug = dagNode.findPlug(<span class=\"stringliteral\">&quot;inheritsTransform&quot;</span>);</div>\n\
<div class=\"line\">            <span class=\"keywordflow\">if</span> (!inheritPlug.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a1c18142e8f09680711f472aa2ddf8ac6\">isNull</a>())</div>\n\
<div class=\"line\">            {</div>\n\
<div class=\"line\">                <span class=\"keywordflow\">if</span> (util::getSampledType(inheritPlug) != 0)</div>\n\
<div class=\"line\">                    mInheritsPlug = inheritPlug;</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">                mSample.setInheritsXforms(inheritPlug.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#aea1ddab8d4272d03146b3dad29be3af0\">asBool</a>());</div>\n\
<div class=\"line\">            }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">            <span class=\"comment\">// everything is default, don&#39;t write anything</span></div>\n\
...
<div class=\"line\">        <span class=\"keywordflow\">if</span> (!inheritPlug.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a1c18142e8f09680711f472aa2ddf8ac6\">isNull</a>() &amp;&amp; !inheritPlug.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#aea1ddab8d4272d03146b3dad29be3af0\">asBool</a>())</div>\n\
...
<div class=\"line\">    mRotateAxisOpIndex[0]  = mRotateAxisOpIndex[1]  = mRotateAxisOpIndex[2]  = ~size_t(0);</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> (iDag.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_dag_path.html#abea5b1e5057d0e1088877be2573be47b\">hasFn</a>(<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn.html#a1d1cfd8ffb84e947f82999c682b666a7ab8b14d1ed753088b316e8ee8c5d38ca9\">MFn::kJoint</a>))</div>\n\
<div class=\"line\">    {</div>\n\
...
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_transformation_matrix.html#af3d74c777e523f2725cdf87c15a4b5bc\">MTransformationMatrix::RotationOrder</a> eRotOrder(iTrans.<a name=\"a17\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_transform.html#aae1d6e29da22c8226d757a56aa00d9e1\">rotationOrder</a>());</div>\n\
...
<div class=\"line\">    <a name=\"_a19\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html\">MStatus</a> status = <a name=\"a20\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80af0536797208144380691e2b376ffc1d1\">MS::kSuccess</a>;</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> (iJoint.<a name=\"a21\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_ik_joint.html#a10915465bf61324638e009e022882976\">hikJointName</a>(&amp;status).<a name=\"a22\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html#a580388f31f60c46fac867ca48a48da1e\">length</a>() &gt; 0 &amp;&amp; status) {</div>\n\
...
<div class=\"line\">    <span class=\"keywordflow\">if</span> (scaleCompensatePlug.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#aea1ddab8d4272d03146b3dad29be3af0\">asBool</a>())</div>\n\
<div class=\"line\">    {</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">    iJoint.<a name=\"a23\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_ik_joint.html#a0f41ef4fb484400b2472a6d9c1c5afcb\">getOrientation</a>(vals, eJointOrientOrder);</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"comment\">// if this returns false then the rotation order was kInvalid or kLast</span></div>\n\
<div class=\"line\">    eRotOrder = iJoint.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_transform.html#aae1d6e29da22c8226d757a56aa00d9e1\">rotationOrder</a>();</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> (util::getRotOrder(eRotOrder, rotOrder[0], rotOrder[1],</div>\n\
<div class=\"line\">        rotOrder[2]))</div>\n\
<div class=\"line\">    {</div>\n\
...
<div class=\"line\">    rotateNames[2] = <span class=\"stringliteral\">&quot;rotateAxisZ&quot;</span>;</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    iJoint.<a name=\"a24\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_ik_joint.html#a77418f351887f797ea214317a0c6e1bd\">getScaleOrientation</a>(vals, eRotateAxisOrder);</div>\n\
...
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_transformation_matrix.html#af3d74c777e523f2725cdf87c15a4b5bc\">MTransformationMatrix::RotationOrder</a> eRotOrder = <a name=\"a25\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_transformation_matrix.html#af3d74c777e523f2725cdf87c15a4b5bcacfa82ee0eaf4075f3cda4152dd020d99\">MTransformationMatrix::kXYZ</a>;</div>\n\
<div class=\"line\">    <span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span> rotOrder[3];</div>\n\
<div class=\"line\"></div>\n\
