...
<div class=\"line\">    <span class=\"keyword\">virtual</span>                 ~viewCallbackTest(); </div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">            args.<a name=\"a13\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_arg_list.html#adc169cdc872457a2664c3d66c29cf504\">get</a>(i, operationString );</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">                status.<a name=\"a14\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a1f01a4748fea4d8bcced082df83f804d\">perror</a>(<span class=\"stringliteral\">&quot;Invalid operation specified. Using invert by default.&quot;</span>);</div>\n\
<div class=\"line\">        }</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">        = <a name=\"a16\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_ui_message.html#af55a37b0bf511201f58c91b5f64ebea7\">MUiMessage::add3dViewDestroyMsgCallback</a>(panelName,</div>\n\
...
<div class=\"line\">        <a name=\"a19\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_message.html#a50fe995add3ce133b8b56551abb4ed09\">MMessage::removeCallback</a>(mDeleteId);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">    cout&lt;&lt;<span class=\"stringliteral\">&quot;In delete view callback for view &quot;</span>&lt;&lt;panelName.<a name=\"a20\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html#aa9ab612f356c53479afc4c648c9ef94d\">asChar</a>()</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">    <a name=\"_a21\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m3d_view.html\">M3dView</a> view;</div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html\">MStatus</a> status = <a name=\"a22\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m3d_view.html#a6f8dcac6993b14738fc6259cfd50a3b8\">M3dView::getM3dViewFromModelPanel</a>(panelName, view);</div>\n\
...
<div class=\"line\">    width = view.<a name=\"a23\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m3d_view.html#a09f01ebd9a52d4e74196c90fd3c1316c\">portWidth</a>( &amp;status );</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> (status != <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80af0536797208144380691e2b376ffc1d1\">MS::kSuccess</a> || (width &lt; 2))</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">return</span>;</div>\n\
<div class=\"line\">    height = view.<a name=\"a24\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m3d_view.html#a419e60769b8303476d6d25853b3b5f6f\">portHeight</a>( &amp;status );</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> (status != <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80af0536797208144380691e2b376ffc1d1\">MS::kSuccess</a> || (height &lt; 2))</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">return</span>;</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    status = view.<a name=\"a25\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m3d_view.html#a4043cdd4c78b1c6ceafe8ae9f496763c\">pushViewport</a> (vx, vy, vwidth, vheight);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">        <a name=\"_a26\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_point.html\">MPoint</a> origin;</div>\n\
<div class=\"line\">        status = view.<a name=\"a27\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m3d_view.html#a1d533091a31a590ee4599fde04fa65d7\">drawText</a>( <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html\">MString</a>(<span class=\"stringliteral\">&quot;Pre render callback: &quot;</span>) + panelName, origin );</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    view.<a name=\"a28\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m3d_view.html#a59c2e5dd7b3333946848be138928482b\">popViewport</a>();</div>\n\
<div class=\"line\">}</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">        status = view.<a name=\"a29\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m3d_view.html#a9dd85add630aeee817d42c1018261fa8\">readDepthMap</a>( 0,0, width, height, (<span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">char</span> *)depthPixels, <a name=\"a30\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m3d_view.html#ad56b45f8cc57c6a124a10b503fc2e4c0abe791237370d665961491053ac27285f\">M3dView::kDepth_Float</a> );</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span> (status != <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80af0536797208144380691e2b376ffc1d1\">MS::kSuccess</a>)</div>\n\
<div class=\"line\">        {</div>\n\
<div class=\"line\">            <span class=\"keyword\">delete</span> [] depthPixels;</div>\n\
...
<div class=\"line\">        }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">        <a name=\"_a31\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_image.html\">MImage</a> image;</div>\n\
<div class=\"line\">        image.<a name=\"a32\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_image.html#a41d909431057599c48be86e57440bcec\">setPixels</a>( colorPixels, width, height );</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">        status = view.<a name=\"a33\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m3d_view.html#a1a329cac7ac49083ab198cc78c38fa1f\">writeColorBuffer</a>( image, 5, 5 );</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span> (depthPixels)</div>\n\
<div class=\"line\">            <span class=\"keyword\">delete</span> [] depthPixels;</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span> (colorPixels)</div>\n\
...
<div class=\"line\">        status = view.<a name=\"a34\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m3d_view.html#a02ea5cc758421097ddafe883c64e30ee\">readColorBuffer</a>( image, readAsRGBA );</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span> (status != <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80af0536797208144380691e2b376ffc1d1\">MS::kSuccess</a>)</div>\n\
<div class=\"line\">            <span class=\"keywordflow\">return</span>;</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">        <span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">char</span> *pixelPtr = (<span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">char</span>*)image.<a name=\"a35\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_image.html#aba6def80dd70f1c9af3dbd348fe270ac\">pixels</a>();</div>\n\
...
<div class=\"line\">            image.<a name=\"a36\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_image.html#acab1f6acf34fc74e4d717322fa35241a\">getSize</a>( width, height );</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">            <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_image.html\">MImage</a> image2;</div>\n\
<div class=\"line\">            image2.<a name=\"a37\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_image.html#a903ff4fa0918f6c6438c4889025b7c91\">create</a>( width, height );</div>\n\
