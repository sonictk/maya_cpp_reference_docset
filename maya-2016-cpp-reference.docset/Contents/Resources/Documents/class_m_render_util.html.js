...
<dl class=\"deprecated\"><dt><b><a class=\"el\" translate=\"no\" href=\"#!/url=./cpp_ref/deprecated.html#_deprecated000178\">Deprecated:</a></b></dt><dd>Context (owner Node full name) must be provided to the Maya resolver. Use the one with the contextNodeFullName input param.</dd></dl>\n\
...
<p>obsolete, use the one with contextNodeFullName param </p>\n\
<p><b>This method is obsolete.</b></p>\n\
<dl class=\"deprecated\"><dt><b><a class=\"el\" translate=\"no\" href=\"#!/url=./cpp_ref/deprecated.html#_deprecated000179\">Deprecated:</a></b></dt><dd>Context (owner Node full name) must be provided to the Maya resolver. Use the one with the contextNodeFullName input param.</dd></dl>\n\
<p>Attempts to resolve the file name specified into an absolute path to a file on disk. The function applies exactly the same logic that is used by the file texture node internally for resolving the image file path.</p>\n\
<dl class=\"params\"><dt>Parameters</dt><dd>\n\
  <table class=\"params\">\n\
    <tr><td class=\"paramdir\">[in]</td><td class=\"paramname\">baseName</td><td>a file name to be resolved </td></tr>\n\
