...
<html>\n\
   <head><script src=\"../scripts/yepnope.1.5.4-min.js\" type=\"text/javascript\"></script><script src=\"../scripts/lib/jquery-1.11.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\"><meta name=\"product\" content=\"MAYAUL\"><meta name=\"release\" content=\"2016\"><meta name=\"book\" content=\"Developer\"><meta name=\"created\" content=\"2015-10-14\"><meta name=\"topicid\" content=\"GUID-02DEF634-1E7B-48C6-8ACD-2C934CA97887\"><meta name=\"topic-type\" content=\"concept\">\n\
      <title>componentScaleManip/componentScaleManip.cpp</title>\n\
   \n\
\n\
...
$(window).load( function() {\n\
 ...
 if (!tocSystemNeedsToBeLoaded) { cpp_ref_initializeToc(); }\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>componentScaleManip/componentScaleManip.cpp</h1>\n\
         </div>\n\
\n\
...
<div class=\"line\"><span class=\"comment\">    ----------------------</span></div>\n\
<div class=\"line\"><span class=\"comment\"></span></div>\n\
<div class=\"line\"><span class=\"comment\">    The component scale manipulator context can be created </span></div>\n\
<div class=\"line\"><span class=\"comment\">    with the following mel commands:</span></div>\n\
<div class=\"line\"><span class=\"comment\"></span></div>\n\
...
<div class=\"line\"><span class=\"comment\">    tool button then select some object components.  If non-components are </span></div>\n\
...
<div class=\"line\"><span class=\"comment\">    should appear at the centroid of the components.  Then the manipulator can</span></div>\n\
<div class=\"line\"><span class=\"comment\">    be used much like the built-in scale manipulator.</span></div>\n\
<div class=\"line\"><span class=\"comment\"></span></div>\n\
<div class=\"line\"><span class=\"comment\">    Currently this plugin only works correctly for nurbs surfaces where the </span></div>\n\
<div class=\"line\"><span class=\"comment\">    parametization has distance 1.0 corresponding to the distance between CVs.</span></div>\n\
...
<div class=\"line\"><span class=\"comment\"></span></div>\n\
<div class=\"line\"><span class=\"comment\">    Note that undo and redo are not supported in this example plugin.</span></div>\n\
<div class=\"line\"><span class=\"comment\">    </span></div>\n\
<div class=\"line\"><span class=\"comment\">*/</span></div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    <span class=\"keyword\">virtual</span> ~componentScaleManip();</div>\n\
<div class=\"line\">    </div>\n\
...
<div class=\"line\">    <span class=\"keyword\">virtual</span> <a name=\"_a17\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_manip_data.html\">MManipData</a> <a name=\"a18\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_px_manip_container.html#a2a60d544847ebfcd3089b522f725f674\">manipToPlugConversion</a>(<span class=\"keywordtype\">unsigned</span> index);</div>\n\
<div class=\"line\">    <span class=\"keyword\">virtual</span> <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_manip_data.html\">MManipData</a> <a name=\"a19\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_px_manip_container.html#ae8971a0ce1f86325682a2bf24c84ac6a\">plugToManipConversion</a>(<span class=\"keywordtype\">unsigned</span> index);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">        <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html\">MPlug</a> controlPointArrayPlug = nodeFn.findPlug(<span class=\"stringliteral\">&quot;controlPoints&quot;</span>, &amp;stat);</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span> (controlPointArrayPlug.<a name=\"a29\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a1c18142e8f09680711f472aa2ddf8ac6\">isNull</a>())</div>\n\
<div class=\"line\">        {</div>\n\
...
<div class=\"line\">            controlPointArrayPlug.<a name=\"a31\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a69c9b843aafeadbcaa3cdad274b9aeb8\">elementByLogicalIndex</a>(iter.index(), &amp;stat);</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span> (controlPointPlug.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a1c18142e8f09680711f472aa2ddf8ac6\">isNull</a>())</div>\n\
<div class=\"line\">        {</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">    <a name=\"_a32\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_scale_manip.html\">MFnScaleManip</a> scaleManip(fScaleManip);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html\">MObject</a> obj = <a name=\"a33\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html#ae6af14e0aa2c92bdda88c81280e1d122\">MObject::kNullObj</a>;</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">        numericData.<a name=\"a37\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_numeric_data.html#a5a8685975c5472876e8e3558911a7b7b\">setData</a>(centroid.x,centroid.y,centroid.z);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html\">MObject</a> obj = <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html#ae6af14e0aa2c92bdda88c81280e1d122\">MObject::kNullObj</a>;</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_scale_manip.html\">MFnScaleManip</a> scaleManip(fScaleManip);</div>\n\
...
<div class=\"line\">        <span class=\"comment\">//</span></div>\n\
<div class=\"line\">        <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_vector.html\">MVector</a> newPosition(positionVec.x*scaleVal.<a name=\"a38\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_vector.html#af88b946fb90d5f08b5fb740c70e98c10\">x</a>, </div>\n\
<div class=\"line\">            positionVec.y*scaleVal.<a name=\"a39\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_vector.html#ab927965981178aa1fba979a37168db2a\">y</a>, positionVec.z*scaleVal.<a name=\"a40\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_vector.html#ab3e6ed577a7c669c19de1f9c1b46c872\">z</a>);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\"><span class=\"comment\">//</span></div>\n\
<div class=\"line\"><span class=\"comment\"></span></div>\n\
<div class=\"line\"><span class=\"keyword\">class </span>ComponentScaleContext : <span class=\"keyword\">public</span> <a name=\"_a41\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_px_selection_context.html\">MPxSelectionContext</a></div>\n\
<div class=\"line\">{</div>\n\
<div class=\"line\"><span class=\"keyword\">public</span>:</div>\n\
<div class=\"line\">    ComponentScaleContext();</div>\n\
<div class=\"line\">    <span class=\"keyword\">virtual</span> <span class=\"keywordtype\">void</span>    <a name=\"a42\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_px_context.html#a658f83d3a196c6c8e77e7ed2655eb6d7\">toolOnSetup</a>(<a name=\"_a43\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_event.html\">MEvent</a> &amp;event);</div>\n\
<div class=\"line\">    <span class=\"keyword\">virtual</span> <span class=\"keywordtype\">void</span>    <a name=\"a44\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_px_context.html#a1a7ea794ab903ce98dfe7498619a2518\">toolOffCleanup</a>();</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">{</div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html\">MStatus</a> status;</div>\n\
<div class=\"line\">    status = <a name=\"a47\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_message.html#a50fe995add3ce133b8b56551abb4ed09\">MModelMessage::removeCallback</a>(id1);</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> (!status) {</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">    <a name=\"_a48\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_selection_list.html\">MSelectionList</a> list;</div>\n\
<div class=\"line\">    stat = <a name=\"a49\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_global.html#a6d81d38246555884897fb153c93aaf42\">MGlobal::getActiveSelectionList</a>(list);</div>\n\
<div class=\"line\">    <a name=\"_a50\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_it_selection_list.html\">MItSelectionList</a> iter(list, <a name=\"a51\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn.html#a1d1cfd8ffb84e947f82999c682b666a7a94dd08feda7b2cf0ff8262312c4fcc09\">MFn::kInvalid</a>, &amp;stat);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">                <span class=\"keywordflow\">if</span> (!manipulator-&gt;connectToDependNode(dagPath.<a name=\"a55\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_dag_path.html#ad1aa507eb8e63e89e8d46a0abc18aa8c\">node</a>()))</div>\n\
<div class=\"line\">                {</div>\n\
...
<div class=\"line\"><span class=\"comment\">//</span></div>\n\
<div class=\"line\"><span class=\"comment\"></span></div>\n\
<div class=\"line\"><span class=\"keyword\">class </span>componentScaleContext : <span class=\"keyword\">public</span> <a name=\"_a56\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_px_context_command.html\">MPxContextCommand</a></div>\n\
<div class=\"line\">{</div>\n\
<div class=\"line\"><span class=\"keyword\">public</span>:</div>\n\
<div class=\"line\">    componentScaleContext() {};</div>\n\
