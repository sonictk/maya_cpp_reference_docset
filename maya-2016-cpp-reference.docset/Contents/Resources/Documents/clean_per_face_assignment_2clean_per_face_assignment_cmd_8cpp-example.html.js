...
<div class=\"line\"><span class=\"comment\">//</span></div>\n\
<div class=\"line\">{</div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html\">MStatus</a> stat = <a name=\"a2\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80af0536797208144380691e2b376ffc1d1\">MS::kSuccess</a>;</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    <a name=\"_a5\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_it_selection_list.html\">MItSelectionList</a> listIt( list);</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">for</span> ( listIt.<a name=\"a6\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_it_selection_list.html#ac734f26ff1c92ecec3572a31f5e4435c\">reset</a>(); !listIt.<a name=\"a7\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_it_selection_list.html#ac0f0d6fc806b11d246e05cb94e886b38\">isDone</a>() ; listIt.<a name=\"a8\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_it_selection_list.html#a73616f002814b8abe6d921db72d7a496\">next</a>() ){</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">        listIt.<a name=\"a10\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_it_selection_list.html#acea3f9b4576b874442d489458ac310c0\">getDagPath</a>( path );</div>\n\
<div class=\"line\">        path.<a name=\"a11\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_dag_path.html#a658d9664035ff84ffefa217c0e45cc88\">extendToShape</a>();</div>\n\
<div class=\"line\">    </div>\n\
<div class=\"line\">        <span class=\"comment\">// if a DAG Path is MFn::kMesh, it tries to obtain its material</span></div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span> ( path.<a name=\"a12\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_dag_path.html#acc0e9a55cf76f4baed1120fc3fb296d6\">apiType</a>() == <a name=\"a13\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn.html#a1d1cfd8ffb84e947f82999c682b666a7a19fd562fc0900a60162e6073df36cb62\">MFn::kMesh</a> ){</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">            <a name=\"_a14\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_mesh.html\">MFnMesh</a> meshFn( path );</div>\n\
<div class=\"line\">            <a name=\"_a15\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object_array.html\">MObjectArray</a> sets, comps;</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">            <span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span> instanceNumber = path.<a name=\"a16\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_dag_path.html#a67956f985586f518f84688ceda292cad\">instanceNumber</a>();</div>\n\
<div class=\"line\">            meshFn.<a name=\"a17\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_dag_node.html#ae19de6f173f69f8753fdca910e208dc7\">getConnectedSetsAndMembers</a>( instanceNumber, sets, comps, 1 );</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"><span class=\"preprocessor\">#ifdef _DEBUG</span></div>\n\
<div class=\"line\">            <span class=\"comment\">// Debug output</span></div>\n\
<div class=\"line\">            <span class=\"keywordflow\">for</span> ( <span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span> i = 0; i &lt; sets.<a name=\"a18\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object_array.html#a580388f31f60c46fac867ca48a48da1e\">length</a>() ; i++ ){</div>\n\
<div class=\"line\">                <a name=\"_a19\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_set.html\">MFnSet</a> setFn ( sets[i]);</div>\n\
<div class=\"line\">                <a name=\"_a20\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_it_mesh_polygon.html\">MItMeshPolygon</a> faceIt( path, comps[i] );</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">                cout &lt;&lt; <span class=\"stringliteral\">&quot;--------------&gt;&quot;</span> &lt;&lt; endl;</div>\n\
<div class=\"line\">                cout &lt;&lt; setFn.<a name=\"a21\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_dependency_node.html#a049384adbea0396ea2f03d1ad4d69df1\">name</a>() &lt;&lt; endl;</div>\n\
<div class=\"line\">                cout &lt;&lt; <span class=\"stringliteral\">&quot;FaceCount:&quot;</span> &lt;&lt; faceIt.<a name=\"a22\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_it_mesh_polygon.html#a7c5647ef2c0afdbc571d04a75136d2d8\">count</a>() &lt;&lt; endl;</div>\n\
<div class=\"line\">                <span class=\"keywordflow\">for</span> ( faceIt.<a name=\"a23\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_it_mesh_polygon.html#ac734f26ff1c92ecec3572a31f5e4435c\">reset</a>() ; !faceIt.<a name=\"a24\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_it_mesh_polygon.html#ac0f0d6fc806b11d246e05cb94e886b38\">isDone</a>() ; faceIt.<a name=\"a25\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_it_mesh_polygon.html#a73616f002814b8abe6d921db72d7a496\">next</a>() ){</div>\n\
<div class=\"line\">                    cout &lt;&lt; faceIt.<a name=\"a26\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_it_mesh_polygon.html#afdd8d04245960d9763609469ed0d21cb\">index</a>() &lt;&lt; <span class=\"stringliteral\">&quot; &quot;</span>;</div>\n\
<div class=\"line\">                }</div>\n\
...
<div class=\"line\">            <a name=\"_a27\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string_array.html\">MStringArray</a> SGNames;       <span class=\"comment\">// Stores Shading Group name</span></div>\n\
<div class=\"line\">            <a name=\"_a28\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_int_array.html\">MIntArray</a> sameConnectionFlag;   <span class=\"comment\">// a flag to check if Shading Group has same names</span></div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">            sameConnectionFlag.<a name=\"a29\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_int_array.html#ad5522f028dde0080b753279426415a4a\">clear</a>();</div>\n\
...
<div class=\"line\">                SGNames.<a name=\"a30\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string_array.html#a18d06b3d0af1426e654ac2cc1dc86c60\">append</a>( setFn.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_dependency_node.html#a049384adbea0396ea2f03d1ad4d69df1\">name</a>() );</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">                sameConnectionFlag.<a name=\"a31\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_int_array.html#a11568087ac2ca16f4106cee62f65afd7\">append</a>( -1 );</div>\n\
<div class=\"line\">                </div>\n\
<div class=\"line\">                </div>\n\
...
<div class=\"line\">                <a name=\"_a32\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html\">MString</a> aMemberFaceName;</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">                <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html\">MString</a> pathName = path.<a name=\"a33\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_dag_path.html#ac4b316731c4019c927aa63731d4749e8\">fullPathName</a>();</div>\n\
...
<div class=\"line\">            <span class=\"keywordflow\">while</span>( tail &lt; sameConnectionFlag.<a name=\"a34\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_int_array.html#a580388f31f60c46fac867ca48a48da1e\">length</a>() ){</div>\n\
<div class=\"line\">                <span class=\"keywordflow\">if</span> ( sameSGFaceCount[tail] == 0 ){</div>\n\
<div class=\"line\">                    SGNames.<a name=\"a35\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string_array.html#af05b9926a5e8e7b8e7a9e98a13c839b6\">remove</a>( tail );</div>\n\
...
<div class=\"line\">                    sameConnectionFlag.<a name=\"a36\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_int_array.html#af05b9926a5e8e7b8e7a9e98a13c839b6\">remove</a>( tail );</div>\n\
...
<div class=\"line\">                    resultString = (<span class=\"stringliteral\">&quot;select -r &quot;</span> + path.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_dag_path.html#ac4b316731c4019c927aa63731d4749e8\">fullPathName</a>()  +<span class=\"stringliteral\">&quot;;&quot;</span> );</div>\n\
<div class=\"line\">                } <span class=\"keywordflow\">else</span> {</div>\n\
...
<div class=\"line\">                    <a name=\"a37\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_global.html#a09e405631e7cf680f8ac9d934ad73434\">MGlobal::executeCommand</a>( resultString );</div>\n\
<div class=\"line\"></div>\n\
