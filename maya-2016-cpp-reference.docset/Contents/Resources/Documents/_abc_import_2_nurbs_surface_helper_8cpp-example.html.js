...
<div class=\"line\">        <a name=\"_a2\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object_array.html\">MObjectArray</a> deleteAfterTrim;</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">        iFnSurface.<a name=\"a3\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_nurbs_surface.html#a98ab3e5051ac89bf753456b0ab8e5784\">getKnotDomain</a>(startU, endU, startV, endV);</div>\n\
<div class=\"line\">        <span class=\"keywordtype\">double</span> offsetV = startV + endV;</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">        <a name=\"_a4\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html\">MStatus</a> status = <a name=\"a5\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80af0536797208144380691e2b376ffc1d1\">MS::kSuccess</a>;</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">        {</div>\n\
<div class=\"line\">            <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object_array.html\">MObjectArray</a> trimLoop;</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">                <a name=\"_a6\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_point_array.html\">MPointArray</a> cvs;</div>\n\
<div class=\"line\">                cvs.<a name=\"a7\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_point_array.html#a8c66dfa06f3736b2a214c5aed58bd216\">setLength</a>(numVerts);</div>\n\
...
<div class=\"line\">                    cvs.<a name=\"a8\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_point_array.html#a44867c987d14cbe9223c87bb598d31c1\">set</a>(k, x, offsetV-y, 0.0, w);</div>\n\
<div class=\"line\">                }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">                <a name=\"_a9\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_double_array.html\">MDoubleArray</a> dknots;</div>\n\
<div class=\"line\">                dknots.<a name=\"a10\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_double_array.html#a8c66dfa06f3736b2a214c5aed58bd216\">setLength</a>(numKnots - 2);</div>\n\
...
<div class=\"line\">                {</div>\n\
<div class=\"line\">                    dknots.<a name=\"a11\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_double_array.html#a8f0a19dc13ef5224620b5653a82371d3\">set</a>((*knots)[curKnot], k - 1);</div>\n\
<div class=\"line\">                }</div>\n\
<div class=\"line\">                ++curKnot;</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">                <a name=\"_a12\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_nurbs_curve.html\">MFnNurbsCurve</a> fnCurve;</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">                <a name=\"_a13\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html\">MObject</a> curve2D = fnCurve.<a name=\"a14\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_nurbs_curve.html#a4b11e346021c91845e781e9d7d06859f\">create</a>(cvs, dknots, degree,</div>\n\
<div class=\"line\">                    <a name=\"a15\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_nurbs_curve.html#a99f5203c7742378941e34926280c8e66a7fb3bf49ba349ca1a266be41df447b5b\">MFnNurbsCurve::kOpen</a>, <span class=\"keyword\">true</span>, <span class=\"keyword\">true</span>,</div>\n\
<div class=\"line\">                    <a name=\"a16\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html#ae6af14e0aa2c92bdda88c81280e1d122\">MObject::kNullObj</a>, &amp;status);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">                {</div>\n\
<div class=\"line\">                    <a name=\"_a17\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_transform.html\">MFnTransform</a> trans(curve2D, &amp;status);</div>\n\
<div class=\"line\">                    <span class=\"keywordflow\">if</span> (status == <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80af0536797208144380691e2b376ffc1d1\">MS::kSuccess</a>)</div>\n\
<div class=\"line\">                    {</div>\n\
<div class=\"line\">                        trimLoop.<a name=\"a18\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object_array.html#a3694392863ba632bca5d76cbbf190ef5\">append</a>(trans.<a name=\"a19\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_dag_node.html#aaba05ce0a6791c69b8c850afaeb3bf67\">child</a>(0));</div>\n\
<div class=\"line\">                        deleteAfterTrim.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object_array.html#a3694392863ba632bca5d76cbbf190ef5\">append</a>(curve2D);</div>\n\
<div class=\"line\">                    }</div>\n\
<div class=\"line\">                }</div>\n\
<div class=\"line\">            }</div>\n\
<div class=\"line\">            trimBoundaryArray.<a name=\"a20\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_trim_boundary_array.html#a58aa0ffd87a8ca32834b827e1452f23e\">append</a>(trimLoop);</div>\n\
<div class=\"line\">        }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">        <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_trim_boundary_array.html\">MTrimBoundaryArray</a> oneRegion;</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">for</span> (<span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span> i = 0; i &lt; trimBoundaryArray.<a name=\"a21\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_trim_boundary_array.html#a580388f31f60c46fac867ca48a48da1e\">length</a>(); i++)</div>\n\
<div class=\"line\">        {</div>\n\
<div class=\"line\">            <span class=\"keywordflow\">if</span> (i &gt; 0)</div>\n\
<div class=\"line\">            {</div>\n\
<div class=\"line\">                <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html\">MObject</a> loopData = trimBoundaryArray.<a name=\"a22\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_trim_boundary_array.html#a8c5c9d056371db0b771e14526c08b520\">getMergedBoundary</a>(i, &amp;status);</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">                <span class=\"keywordtype\">double</span>       length  = loop.<a name=\"a23\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_nurbs_curve.html#acdf47b43a3196b3eb5f7b78a64003ba9\">length</a>();</div>\n\
<div class=\"line\">                <span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span> segment = std::max(loop.<a name=\"a24\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_nurbs_curve.html#addc4a2b6312ad1c7265478f2680b7566\">numCVs</a>(), 10);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">                {</div>\n\
<div class=\"line\">                    <span class=\"keywordtype\">double</span> param = loop.<a name=\"a25\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_nurbs_curve.html#a6fc77e351e95b453079bbad771940d9f\">findParamFromLength</a>(length * j / segment);</div>\n\
<div class=\"line\">                    loop.<a name=\"a26\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_nurbs_curve.html#ab2f1acb5a0653b12d7430d5786ef2e3e\">getPointAtParam</a>(param, curvePoints[j]);</div>\n\
<div class=\"line\">                }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">                <span class=\"comment\">// Find the right most curve point</span></div>\n\
<div class=\"line\">                <a name=\"_a27\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_point.html\">MPoint</a>       rightMostPoint = curvePoints[0];</div>\n\
...
<div class=\"line\">                {</div>\n\
<div class=\"line\">                    <span class=\"keywordflow\">if</span> (rightMostPoint.<a name=\"a28\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_point.html#af88b946fb90d5f08b5fb740c70e98c10\">x</a> &lt; curvePoints[j].x)</div>\n\
<div class=\"line\">                    {</div>\n\
...
<div class=\"line\">                <a name=\"_a29\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_vector.html\">MVector</a> vector1 = curvePoints[beforeIndex] - curvePoints[rightMostIndex];</div>\n\
...
<div class=\"line\">                    status = iFnSurface.<a name=\"a30\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_nurbs_surface.html#a7034e46990f9fb46a2c9a03dba876f8e\">trimWithBoundaries</a>(oneRegion);</div>\n\
...
<div class=\"line\">                    <span class=\"keywordflow\">if</span> (status != <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80af0536797208144380691e2b376ffc1d1\">MS::kSuccess</a>)</div>\n\
<div class=\"line\">                    {</div>\n\
<div class=\"line\">                        <a name=\"a31\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_global.html#a4ddbe97e58a90e1ab05d45a62c006cf0\">MGlobal::displayError</a>(</div>\n\
<div class=\"line\">                            <span class=\"stringliteral\">&quot;Trimming Nurbs Surface outer failed.&quot;</span>);</div>\n\
<div class=\"line\">                    }</div>\n\
<div class=\"line\">                    oneRegion.<a name=\"a32\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_trim_boundary_array.html#ad5522f028dde0080b753279426415a4a\">clear</a>();</div>\n\
<div class=\"line\">                }</div>\n\
<div class=\"line\">            }</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">        }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">        <span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span> length = deleteAfterTrim.<a name=\"a33\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object_array.html#a580388f31f60c46fac867ca48a48da1e\">length</a>();</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">for</span> (<span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span> l=0; l&lt;length; l++)</div>\n\
<div class=\"line\">        {</div>\n\
<div class=\"line\">            <a name=\"a34\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_global.html#a3d83d29ca400045849d777aecafda70c\">MGlobal::deleteNode</a>(deleteAfterTrim[l]);</div>\n\
<div class=\"line\">        }</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\">}</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">    <a name=\"_a35\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html\">MString</a> surfaceName(iNode.getName().c_str());</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span> degreeU  = samp.getUOrder() - 1;</div>\n\
<div class=\"line\">    <span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span> degreeV  = samp.getVOrder() - 1;</div>\n\
...
<div class=\"line\">                formU = <a name=\"a37\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_nurbs_surface.html#a99f5203c7742378941e34926280c8e66a7fb3bf49ba349ca1a266be41df447b5b\">MFnNurbsSurface::kOpen</a>;</div>\n\
...
<div class=\"line\">        formU = <a name=\"a38\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_nurbs_surface.html#a99f5203c7742378941e34926280c8e66a44be8f61450ed22be5adcc881a95570f\">MFnNurbsSurface::kClosed</a>;</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">for</span> (<span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span> v = 0; v &lt; numCVInV; v++) {</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span> numKnotsInU = <span class=\"keyword\">static_cast&lt;</span><span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span><span class=\"keyword\">&gt;</span>(uKnot-&gt;size() - 2);</div>\n\
...
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span> numKnotsInV = <span class=\"keyword\">static_cast&lt;</span><span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span><span class=\"keyword\">&gt;</span>(vKnot-&gt;size() - 2);</div>\n\
...
<div class=\"line\">    obj = mFn.<a name=\"a39\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_nurbs_surface.html#a6a3e914fe9c070228f4df8f4a593b4c8\">create</a>(controlVertices, uKnotSequences, vKnotSequences,</div>\n\
...
<div class=\"line\">    <span class=\"keywordflow\">if</span> (status == <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80af0536797208144380691e2b376ffc1d1\">MS::kSuccess</a>)</div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">        mFn.<a name=\"a40\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_dependency_node.html#a386bb83443e16a98e6fa10c683e76b6c\">setName</a>(surfaceName);</div>\n\
<div class=\"line\">    }</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> (!obj.<a name=\"a41\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html#ac02f2a4d7312eb91f40980adfd4e31b2\">isNull</a>())</div>\n\
<div class=\"line\">    {</div>\n\
