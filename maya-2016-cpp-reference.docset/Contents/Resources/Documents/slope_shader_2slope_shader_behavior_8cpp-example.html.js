...
<div class=\"line\"><span class=\"comment\">//</span></div>\n\
<div class=\"line\">{</div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html\">MStatus</a> result = <a name=\"a11\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80a1ef6c2d725fb4bec3e7e840d28adbc00\">MS::kFailure</a>;</div>\n\
...
<div class=\"line\">        <a name=\"_a12\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object_array.html\">MObjectArray</a> shaderNodes;</div>\n\
<div class=\"line\">        shaderNodes.<a name=\"a13\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object_array.html#ad5522f028dde0080b753279426415a4a\">clear</a>();</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">        <span class=\"comment\">//if the source node was a lambert</span></div>\n\
<div class=\"line\">        <span class=\"comment\">//than we will check the downstream connections to see </span></div>\n\
<div class=\"line\">        <span class=\"comment\">//if a slope shader is assigned to it.</span></div>\n\
...
<div class=\"line\">                {</div>\n\
<div class=\"line\">                    shaderNodes.<a name=\"a14\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object_array.html#a3694392863ba632bca5d76cbbf190ef5\">append</a>(currentnode);</div>\n\
<div class=\"line\">                }</div>\n\
<div class=\"line\">            }</div>\n\
<div class=\"line\">        }</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">        <span class=\"comment\">//</span></div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span>(shaderNodes.<a name=\"a15\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object_array.html#a580388f31f60c46fac867ca48a48da1e\">length</a>() &gt; 0)</div>\n\
<div class=\"line\">        {</div>\n\
...
<div class=\"line\">                {</div>\n\
<div class=\"line\">                    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html\">MPlug</a> srcPlug = dest.findPlug(<span class=\"stringliteral\">&quot;worldMesh&quot;</span>);</div>\n\
<div class=\"line\">                    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html\">MPlug</a> destPlug = <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_dependency_node.html\">MFnDependencyNode</a>(shaderNodes[i]).<a name=\"a16\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_dependency_node.html#aac29b4a3b51c9d236175e955638f7153\">findPlug</a>(<span class=\"stringliteral\">&quot;dirtyShaderPlug&quot;</span>);</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">                    <span class=\"keywordflow\">if</span>(!srcPlug.<a name=\"a17\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a1c18142e8f09680711f472aa2ddf8ac6\">isNull</a>() &amp;&amp; !destPlug.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a1c18142e8f09680711f472aa2ddf8ac6\">isNull</a>())</div>\n\
<div class=\"line\">                    {</div>\n\
<div class=\"line\">                        <a name=\"_a18\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html\">MString</a> cmd = <span class=\"stringliteral\">&quot;connectAttr -na &quot;</span>;</div>\n\
<div class=\"line\">                        cmd += srcPlug.<a name=\"a19\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a049384adbea0396ea2f03d1ad4d69df1\">name</a>() + <span class=\"stringliteral\">&quot; &quot;</span>;</div>\n\
<div class=\"line\">                        cmd += destPlug.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a049384adbea0396ea2f03d1ad4d69df1\">name</a>();</div>\n\
<div class=\"line\">                        <a name=\"a20\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_global.html#a09e405631e7cf680f8ac9d934ad73434\">MGlobal::executeCommand</a>(cmd);</div>\n\
<div class=\"line\">                    }</div>\n\
<div class=\"line\">                }</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">                    cmd += <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_dependency_node.html\">MFnDependencyNode</a>(shadingEngine).<a name=\"a21\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_dependency_node.html#a049384adbea0396ea2f03d1ad4d69df1\">name</a>() + <span class=\"stringliteral\">&quot; &quot;</span>;</div>\n\
<div class=\"line\">                    cmd += <a name=\"_a22\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_dag_node.html\">MFnDagNode</a>(destinationNode).<a name=\"a23\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_dag_node.html#a6e9ba8c60415451d03d26e01accaca81\">partialPathName</a>();</div>\n\
...
<div class=\"line\">            <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_dependency_node.html\">MFnDependencyNode</a> dest(destinationNode);</div>\n\
<div class=\"line\">            <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html\">MPlug</a> srcPlug = dest.findPlug(<span class=\"stringliteral\">&quot;worldMesh&quot;</span>);</div>\n\
<div class=\"line\">            <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html\">MPlug</a> destPlug = src.findPlug(<span class=\"stringliteral\">&quot;dirtyShaderPlug&quot;</span>);</div>\n\
<div class=\"line\">            <span class=\"keywordflow\">if</span>(!srcPlug.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a1c18142e8f09680711f472aa2ddf8ac6\">isNull</a>() &amp;&amp; !destPlug.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a1c18142e8f09680711f472aa2ddf8ac6\">isNull</a>())</div>\n\
<div class=\"line\">            {</div>\n\
...
<div class=\"line\">                cmd += srcPlug.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a049384adbea0396ea2f03d1ad4d69df1\">name</a>() + <span class=\"stringliteral\">&quot; &quot;</span>;</div>\n\
<div class=\"line\">                cmd += destPlug.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a049384adbea0396ea2f03d1ad4d69df1\">name</a>();</div>\n\
<div class=\"line\">                result = <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_global.html#a09e405631e7cf680f8ac9d934ad73434\">MGlobal::executeCommand</a>(cmd);</div>\n\
<div class=\"line\">            }</div>\n\
<div class=\"line\">        }</div>\n\
...
<div class=\"line\"><span class=\"comment\">//</span></div>\n\
<div class=\"line\">{</div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html\">MStatus</a> result = <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80a1ef6c2d725fb4bec3e7e840d28adbc00\">MS::kFailure</a>;</div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_dependency_node.html\">MFnDependencyNode</a> src(sourceNode);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    <span class=\"comment\">//</span></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span>(destinationPlug.<a name=\"a24\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#ad1aa507eb8e63e89e8d46a0abc18aa8c\">node</a>().<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html#af0af77f14f96d1134fb8e8e60dc7e420\">hasFn</a>(<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn.html#a1d1cfd8ffb84e947f82999c682b666a7a2af9af308555c50cf68e2c14595b680b\">MFn::kLambert</a>)) {</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span>(src.typeName() == <span class=\"stringliteral\">&quot;slopeShader&quot;</span>)</div>\n\
<div class=\"line\">        {</div>\n\
<div class=\"line\">            <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html\">MPlug</a> srcPlug = src.findPlug(<span class=\"stringliteral\">&quot;outColor&quot;</span>);</div>\n\
<div class=\"line\">            <span class=\"keywordflow\">if</span>(!srcPlug.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a1c18142e8f09680711f472aa2ddf8ac6\">isNull</a>() &amp;&amp; !destinationPlug.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a1c18142e8f09680711f472aa2ddf8ac6\">isNull</a>())</div>\n\
<div class=\"line\">            {</div>\n\
...
<div class=\"line\">                cmd += srcPlug.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a049384adbea0396ea2f03d1ad4d69df1\">name</a>() + <span class=\"stringliteral\">&quot; &quot;</span>;</div>\n\
<div class=\"line\">                cmd += destinationPlug.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a049384adbea0396ea2f03d1ad4d69df1\">name</a>();</div>\n\
<div class=\"line\">                result = <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_global.html#a09e405631e7cf680f8ac9d934ad73434\">MGlobal::executeCommand</a>(cmd);</div>\n\
<div class=\"line\">            }</div>\n\
<div class=\"line\">        }</div>\n\
...
<div class=\"line\">        <span class=\"comment\">//</span></div>\n\
<div class=\"line\">        <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html\">MObject</a> destinationNode = destinationPlug.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#ad1aa507eb8e63e89e8d46a0abc18aa8c\">node</a>();</div>\n\
...
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html\">MPlug</a> srcPlug = nodeFn.findPlug(<span class=\"stringliteral\">&quot;outColor&quot;</span>);</div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug_array.html\">MPlugArray</a> nodeConnections;</div>\n\
<div class=\"line\">    srcPlug.<a name=\"a25\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a3727c18c58fc5ba8be5fb2582b5d06f1\">connectedTo</a>(nodeConnections, <span class=\"keyword\">false</span>, <span class=\"keyword\">true</span>);</div>\n\
