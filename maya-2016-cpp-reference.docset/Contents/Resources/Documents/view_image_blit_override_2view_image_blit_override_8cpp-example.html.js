...
<div class=\"line\">    }</div>\n\
<div class=\"line\">    <a name=\"_a8\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_render_operation.html\">MHWRender::MRenderOperation</a> *RenderOverride::renderOperation()</div>\n\
<div class=\"line\">    {</div>\n\
...
<div class=\"line\">        <span class=\"keywordflow\">if</span> (<a name=\"a10\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_global.html#aba6c13d47a4c052cdd5915f45fed39b6\">MGlobal::getOptionVarValue</a>(<span class=\"stringliteral\">&quot;VIBO_LoadImagesFromDisk&quot;</span>, val))</div>\n\
<div class=\"line\">        {</div>\n\
...
<div class=\"line\">            {</div>\n\
<div class=\"line\">                image.<a name=\"a12\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_image.html#a6c0b6d3f857fa6adc999243f3ff6283a\">readFromFile</a>( colorImageFileName );</div>\n\
<div class=\"line\">                image.<a name=\"a13\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_image.html#acab1f6acf34fc74e4d717322fa35241a\">getSize</a>( targetWidth, targetHeight );</div>\n\
<div class=\"line\">                textureData = image.<a name=\"a14\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_image.html#aba6def80dd70f1c9af3dbd348fe270ac\">pixels</a>();       </div>\n\
<div class=\"line\">            }</div>\n\
...
<div class=\"line\">            mColorTexture.texture = textureManager-&gt;<a name=\"a15\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_texture_manager.html#a04aa3cfef217948abc8edd0f19565f95\">acquireTexture</a>( <span class=\"stringliteral\">&quot;&quot;</span>, mColorTextureDesc, textureData );</div>\n\
<div class=\"line\">            <span class=\"keywordflow\">if</span> (mColorTexture.texture)</div>\n\
<div class=\"line\">                mColorTexture.texture-&gt;<a name=\"a16\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_texture.html#ad1b6f25f4fb913a233b1c2bff46a62a1\">textureDescription</a>( mColorTextureDesc );</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">            <span class=\"keywordflow\">if</span> (!mLoadImagesFromDisk)</div>\n\
<div class=\"line\">            {</div>\n\
...
<div class=\"line\">            <span class=\"keywordtype\">bool</span> updateOnEveryRefresh = !mLoadImagesFromDisk;</div>\n\
...
<div class=\"line\">                    {</div>\n\
<div class=\"line\">                        image.<a name=\"a17\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_image.html#a903ff4fa0918f6c6438c4889025b7c91\">create</a>(targetWidth, targetHeight, 4, <a name=\"a18\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_image.html#a01e74e17cc52f661123b8a2a4da770c1a46b9941f17f513de8e30e46ac53e684b\">MImage::kByte</a>);</div>\n\
...
<div class=\"line\">            <span class=\"keywordflow\">if</span> (mLoadImagesFromDisk)</div>\n\
<div class=\"line\">            {</div>\n\
<div class=\"line\">                image.<a name=\"a19\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_image.html#a437f057cbc3f9a972584760824cfd336\">readDepthMap</a>( depthImageFileName );</div>\n\
<div class=\"line\">                image.<a name=\"a20\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_image.html#ae5a5927b9cf73717281d10d6b5f37e2a\">getDepthMapSize</a>( targetWidth, targetHeight );</div>\n\
<div class=\"line\">                <a name=\"_a21\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_depth_normalization_description.html\">MHWRender::MDepthNormalizationDescription</a> normalizationDesc;</div>\n\
<div class=\"line\">                mDepthTexture.texture = textureManager-&gt;<a name=\"a22\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_texture_manager.html#a069050f9521fe273263d287139a33fee\">acquireDepthTexture</a>(<span class=\"stringliteral\">&quot;&quot;</span>, </div>\n\
...
<div class=\"line\">                    {</div>\n\
<div class=\"line\">                        image.<a name=\"a23\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_image.html#ac16276012a292f0921ae8d0b2e45d4ec\">setDepthMap</a>( textureData, targetWidth, targetHeight );</div>\n\
...
<div class=\"line\">    <span class=\"comment\">//</span></div>\n\
<div class=\"line\">    <a name=\"_a24\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html\">MStatus</a> RenderOverride::setup( <span class=\"keyword\">const</span> <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html\">MString</a> &amp; destination )</div>\n\
<div class=\"line\">    {</div>\n\
...
<div class=\"line\">            <span class=\"keywordflow\">return</span> <a name=\"a25\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80a1ef6c2d725fb4bec3e7e840d28adbc00\">MStatus::kFailure</a>;</div>\n\
...
<div class=\"line\">            mOperations[2] = (<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_render_operation.html\">MHWRender::MRenderOperation</a> *) <span class=\"keyword\">new</span> <a name=\"_a26\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_present_target.html\">MHWRender::MPresentTarget</a>(  mOperationNames[2] );</div>\n\
<div class=\"line\">        }</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span> (!mOperations[0] || </div>\n\
...
<div class=\"line\">        <span class=\"comment\">//</span></div>\n\
<div class=\"line\">        <a name=\"_a27\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m3d_view.html\">M3dView</a> view;       </div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span> (destination.<a name=\"a28\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html#a580388f31f60c46fac867ca48a48da1e\">length</a>() &amp;&amp; </div>\n\
...
<div class=\"line\">        {</div>\n\
<div class=\"line\">            <span class=\"keywordflow\">if</span> (view.<a name=\"a31\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m3d_view.html#afb7d316c985d928b3095eaf25ba818a3\">displayStyle</a>() != <a name=\"a32\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m3d_view.html#a1b68f8823b8e275a4b548fdd27263e8aa620925ec70781a5f5de890d906660d24\">M3dView::kGouraudShaded</a>)</div>\n\
<div class=\"line\">            {</div>\n\
<div class=\"line\">                view.<a name=\"a33\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m3d_view.html#a22744817eafc94f0cb55c0cc9ac7188d\">setDisplayStyle</a>(<a class=\"code\" href=\"#!/url=./cpp_ref/class_m3d_view.html#a1b68f8823b8e275a4b548fdd27263e8aa620925ec70781a5f5de890d906660d24\">M3dView::kGouraudShaded</a>);</div>\n\
<div class=\"line\">            }</div>\n\
<div class=\"line\">        }</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">        {</div>\n\
<div class=\"line\">            <span class=\"keyword\">const</span> <a name=\"_a34\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_shader_manager.html\">MHWRender::MShaderManager</a>* shaderMgr = renderer-&gt;<a name=\"a35\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_renderer.html#a4603e18a1b89b798a2e4a4f36d9b5125\">getShaderManager</a>();</div>\n\
<div class=\"line\">            <span class=\"keywordflow\">if</span> (shaderMgr)</div>\n\
<div class=\"line\">            {</div>\n\
<div class=\"line\">                shaderMgr-&gt;<a name=\"a36\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_shader_manager.html#a0c7deb55edc231cbb2365b271ecd55f8\">releaseShader</a>(mShaderInstance);</div>\n\
<div class=\"line\">            }</div>\n\
<div class=\"line\">            mShaderInstance = NULL;</div>\n\
<div class=\"line\">        }</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">        {</div>\n\
<div class=\"line\">            <a name=\"a37\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_state_manager.html#a1ab255028fb2b2440bb6b7300713c15f\">MHWRender::MStateManager::releaseDepthStencilState</a>( mDepthStencilState );</div>\n\
<div class=\"line\">            mDepthStencilState = NULL;</div>\n\
<div class=\"line\">        }</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keyword\">const</span> <a name=\"_a38\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_shader_instance.html\">MHWRender::MShaderInstance</a> * SceneBlit::shader()</div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span> (!mShaderInstance)</div>\n\
<div class=\"line\">        {</div>\n\
<div class=\"line\">            <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_renderer.html\">MHWRender::MRenderer</a>* renderer = <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_renderer.html#a4678a72ac6959ed21d422d27928d0343\">MHWRender::MRenderer::theRenderer</a>();</div>\n\
...
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <a name=\"_a40\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_clear_operation.html\">MHWRender::MClearOperation</a> &amp; SceneBlit::clearOperation()</div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">        mClearOperation.<a name=\"a41\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_clear_operation.html#a0eb426378a3484ea204ea50ad2daa547\">setClearGradient</a>( <span class=\"keyword\">false</span> );</div>\n\
<div class=\"line\">        mClearOperation.setMask( (<span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span>) <a name=\"a42\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_clear_operation.html#a55b92d9e088b6065ff2e762739b064f9aa9836daa6e01048fcf03e7023c0654d2\">MHWRender::MClearOperation::kClearAll</a> );</div>\n\
...
<div class=\"line\">    <span class=\"comment\">//</span></div>\n\
<div class=\"line\">    <span class=\"keyword\">const</span> <a name=\"_a43\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_depth_stencil_state.html\">MHWRender::MDepthStencilState</a> *SceneBlit::depthStencilStateOverride()</div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span> (!mDepthStencilState)</div>\n\
<div class=\"line\">        {</div>\n\
<div class=\"line\">            <a name=\"_a44\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_depth_stencil_state_desc.html\">MHWRender::MDepthStencilStateDesc</a> desc;</div>\n\
<div class=\"line\">            desc.<a name=\"a45\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_depth_stencil_state_desc.html#a63deb05e0b27e537fcd7ecb470b68725\">depthEnable</a> = <span class=\"keyword\">true</span>;</div>\n\
<div class=\"line\">            desc.<a name=\"a46\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_depth_stencil_state_desc.html#a1944b0918378af218375dd45c1f191d1\">depthWriteEnable</a> = <span class=\"keyword\">true</span>;</div>\n\
<div class=\"line\">            desc.<a name=\"a47\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_depth_stencil_state_desc.html#aece62b93b1909efb0c8f3a2a0d9f7fff\">depthFunc</a> = <a name=\"a48\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_state_manager.html#af4045f11e8887dda083d0122d24df4f6add4cd12eb49bf27fbb725a2d015f0f81\">MHWRender::MStateManager::kCompareAlways</a>;</div>\n\
<div class=\"line\">            mDepthStencilState = <a name=\"a49\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_state_manager.html#a4fae5c76bc6698abb77b9ffec01bc21a\">MHWRender::MStateManager::acquireDepthStencilState</a>(desc);  </div>\n\
<div class=\"line\">        }</div>\n\
...
<div class=\"line\">    : <a name=\"_a50\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_scene_render.html\">MHWRender::MSceneRender</a>(name)</div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    UIDraw::objectTypeExclusions()</div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">        <span class=\"comment\">// Exclude drawing the grid and image planes</span></div>\n\
<div class=\"line\">        <span class=\"keywordflow\">return</span> (<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_scene_render.html#abe19e9c85c46e56786772492a4ce62eb\">MHWRender::MSceneRender::MObjectTypeExclusions</a>)(<a name=\"a51\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_scene_render.html#abe19e9c85c46e56786772492a4ce62ebaf999bbe1535cefb9a930eb917b2fc412\">MHWRender::MSceneRender::kExcludeGrid</a> | <a name=\"a52\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_scene_render.html#abe19e9c85c46e56786772492a4ce62ebaffb4a66716a8ee6bae9babb563463f32\">MHWRender::MSceneRender::kExcludeImagePlane</a>);</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">        mClearOperation.<a name=\"a53\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_clear_operation.html#a55f714c9e4e24d416b345bfadf133783\">setMask</a>((<span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span>)<a name=\"a54\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_clear_operation.html#a55b92d9e088b6065ff2e762739b064f9aaae58611b37c34f59ffa59bed613ca20\">MHWRender::MClearOperation::kClearNone</a>);</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">return</span> mClearOperation;</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
