...
<div class=\"line\">    {</div>\n\
<div class=\"line\">        BOOST_FOREACH(<span class=\"keyword\">const</span> Callback&amp; callback, creationCallbacks) {</div>\n\
...
<div class=\"line\">    {</div>\n\
<div class=\"line\">        BOOST_FOREACH(<span class=\"keyword\">const</span> Callback&amp; callback, destructionCallbacks) {</div>\n\
<div class=\"line\">            (*callback)(key);</div>\n\
<div class=\"line\">        }</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\">    </div>\n\
...
<div class=\"line\">    </div>\n\
<div class=\"line\">    boost::shared_ptr&lt;Array&lt;T&gt; &gt; lookup(</div>\n\
...
<div class=\"line\">        boost::shared_ptr&lt;Array&lt;T&gt; &gt; ret = lookupNonReadable(digest, size);</div>\n\
...
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    boost::shared_ptr&lt;Array&lt;T&gt; &gt; lookupNonReadable(</div>\n\
<div class=\"line\">        <span class=\"keyword\">const</span> Digest&amp; digest,</div>\n\
<div class=\"line\">        <span class=\"keywordtype\">size_t</span> size</div>\n\
<div class=\"line\">    )</div>\n\
<div class=\"line\">    {</div>\n\
...
<div class=\"line\">            boost::shared_ptr&lt;Array&lt;T&gt; &gt; ret = it-&gt;second.lock();</div>\n\
<div class=\"line\">            <span class=\"keywordflow\">if</span> (!ret) {</div>\n\
...
<div class=\"line\">            <span class=\"keywordflow\">return</span> boost::shared_ptr&lt;Array&lt;T&gt; &gt;();</div>\n\
<div class=\"line\">        }</div>\n\
<div class=\"line\">    }   </div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    boost::shared_ptr&lt;ReadableArray&lt;T&gt; &gt; lookupReadable(</div>\n\
<div class=\"line\">        <span class=\"keyword\">const</span> Digest&amp; digest,</div>\n\
<div class=\"line\">        <span class=\"keywordtype\">size_t</span> size</div>\n\
<div class=\"line\">    )</div>\n\
<div class=\"line\">    {</div>\n\
...
<div class=\"line\">            <span class=\"comment\">// Might return null if the weak_ptr&lt;&gt; is now dangling</span></div>\n\
<div class=\"line\">            <span class=\"comment\">// but not yet removed from the map...</span></div>\n\
<div class=\"line\">            boost::shared_ptr&lt;ReadableArray&lt;T&gt; &gt; ret = it-&gt;second.lock();</div>\n\
<div class=\"line\">            <span class=\"keywordflow\">if</span> (!ret) {</div>\n\
...
<div class=\"line\">        }</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">else</span> {</div>\n\
<div class=\"line\">            <span class=\"keywordflow\">return</span> boost::shared_ptr&lt;ReadableArray&lt;T&gt; &gt;();</div>\n\
<div class=\"line\">        }</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordtype\">void</span> insert(boost::shared_ptr&lt;Array&lt;T&gt; &gt; array)</div>\n\
<div class=\"line\">    {</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\"><span class=\"keyword\">private</span>:</div>\n\
<div class=\"line\">    <span class=\"keyword\">typedef</span> boost::unordered_map&lt;</div>\n\
<div class=\"line\">        Key,</div>\n\
<div class=\"line\">        boost::weak_ptr&lt;Array&lt;T&gt; &gt;,</div>\n\
<div class=\"line\">        KeyHash,</div>\n\
<div class=\"line\">        KeyEqualTo&gt; Map;</div>\n\
<div class=\"line\">    <span class=\"keyword\">typedef</span> boost::unordered_map&lt;</div>\n\
<div class=\"line\">        Key,</div>\n\
<div class=\"line\">        boost::weak_ptr&lt;ReadableArray&lt;T&gt; &gt;,</div>\n\
<div class=\"line\">        KeyHash,</div>\n\
...
<div class=\"line\">    </div>\n\
<div class=\"line\">    </div>\n\
<div class=\"line\">    boost::shared_ptr&lt;IndexBuffer&gt; lookup(</div>\n\
...
<div class=\"line\">            <span class=\"comment\">// Might return null if the weak_ptr&lt;&gt; is now dangling</span></div>\n\
<div class=\"line\">            <span class=\"comment\">// but not yet removed from the map...</span></div>\n\
<div class=\"line\">            boost::shared_ptr&lt;IndexBuffer&gt; ret = it-&gt;second.lock();</div>\n\
<div class=\"line\">            <span class=\"keywordflow\">if</span> (!ret) {</div>\n\
<div class=\"line\">                <span class=\"comment\">// Get rid of the stalled entry so that insert() can</span></div>\n\
<div class=\"line\">                <span class=\"comment\">// work properly.</span></div>\n\
...
<div class=\"line\">        }</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">else</span> {</div>\n\
<div class=\"line\">            <span class=\"keywordflow\">return</span> boost::shared_ptr&lt;IndexBuffer&gt;();</div>\n\
<div class=\"line\">        }</div>\n\
<div class=\"line\">    }   </div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordtype\">void</span> insert(boost::shared_ptr&lt;IndexBuffer&gt; buffer)</div>\n\
<div class=\"line\">    {</div>\n\
...
<div class=\"line\">        BOOST_FOREACH(<span class=\"keyword\">const</span> Map::value_type&amp; v, fMap) {</div>\n\
<div class=\"line\">            boost::shared_ptr&lt;IndexBuffer&gt; buf = v.second.lock();</div>\n\
...
<div class=\"line\">    <span class=\"keyword\">typedef</span> boost::unordered_map&lt;</div>\n\
<div class=\"line\">        Key,</div>\n\
<div class=\"line\">        boost::weak_ptr&lt;IndexBuffer&gt;,</div>\n\
<div class=\"line\">        KeyHash,</div>\n\
...
<div class=\"line\">    { <span class=\"keywordflow\">return</span> fMutex; }</div>\n\
<div class=\"line\">    </div>\n\
<div class=\"line\">    boost::shared_ptr&lt;VertexBuffer&gt; lookup(</div>\n\
...
<div class=\"line\">            <span class=\"comment\">// Might return null if the weak_ptr&lt;&gt; is now dangling</span></div>\n\
<div class=\"line\">            <span class=\"comment\">// but not yet removed from the map...</span></div>\n\
<div class=\"line\">            boost::shared_ptr&lt;VertexBuffer&gt; ret = it-&gt;second.lock();</div>\n\
<div class=\"line\">            <span class=\"keywordflow\">if</span> (!ret) {</div>\n\
<div class=\"line\">                <span class=\"comment\">// Get rid of the stalled entry so that insert() can</span></div>\n\
<div class=\"line\">                <span class=\"comment\">// work properly.</span></div>\n\
<div class=\"line\">                fMap.erase(it);</div>\n\
...
<div class=\"line\">        }</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">else</span> {</div>\n\
<div class=\"line\">            <span class=\"keywordflow\">return</span> boost::shared_ptr&lt;VertexBuffer&gt;();</div>\n\
<div class=\"line\">        }</div>\n\
<div class=\"line\">    }   </div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordtype\">void</span> insert(boost::shared_ptr&lt;VertexBuffer&gt; buffer)</div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">        fMap.insert(</div>\n\
<div class=\"line\">            std::make_pair(</div>\n\
...
<div class=\"line\">        <span class=\"keywordtype\">size_t</span> bytes = 0;</div>\n\
<div class=\"line\">        BOOST_FOREACH(<span class=\"keyword\">const</span> Map::value_type&amp; v, fMap) {</div>\n\
<div class=\"line\">            boost::shared_ptr&lt;VertexBuffer&gt; buf = v.second.lock();</div>\n\
<div class=\"line\">            <span class=\"keywordflow\">if</span> (buf) {</div>\n\
<div class=\"line\">                bytes += buf-&gt;bytes();</div>\n\
<div class=\"line\">            }</div>\n\
<div class=\"line\">        }</div>\n\
...
<div class=\"line\">    <span class=\"keyword\">typedef</span> boost::unordered_map&lt;</div>\n\
<div class=\"line\">        Key,</div>\n\
<div class=\"line\">        boost::weak_ptr&lt;VertexBuffer&gt;,</div>\n\
<div class=\"line\">        KeyHash,</div>\n\
<div class=\"line\">        KeyEqualTo</div>\n\
<div class=\"line\">    &gt; Map;</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\"><span class=\"keyword\">template</span> &lt;<span class=\"keyword\">typename</span> T&gt;</div>\n\
<div class=\"line\">boost::shared_ptr&lt;Array&lt;T&gt; &gt; ArrayRegistry&lt;T&gt;::lookup(</div>\n\
<div class=\"line\">    <span class=\"keyword\">const</span> Digest&amp; digest,</div>\n\
<div class=\"line\">    <span class=\"keywordtype\">size_t</span> size</div>\n\
<div class=\"line\">)</div>\n\
<div class=\"line\">{</div>\n\
<div class=\"line\">    boost::shared_ptr&lt;Array&lt;T&gt; &gt; result =</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\"><span class=\"keyword\">template</span> &lt;<span class=\"keyword\">typename</span> T&gt;</div>\n\
<div class=\"line\">boost::shared_ptr&lt;Array&lt;T&gt; &gt; ArrayRegistry&lt;T&gt;::lookupNonReadable(</div>\n\
<div class=\"line\">    <span class=\"keyword\">const</span> Digest&amp; digest,</div>\n\
<div class=\"line\">    <span class=\"keywordtype\">size_t</span> size</div>\n\
<div class=\"line\">)</div>\n\
<div class=\"line\">{</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\"><span class=\"keyword\">template</span> &lt;<span class=\"keyword\">typename</span> T&gt;</div>\n\
<div class=\"line\"> boost::shared_ptr&lt;ReadableArray&lt;T&gt; &gt;  ArrayRegistry&lt;T&gt;::lookupReadable(</div>\n\
<div class=\"line\">    <span class=\"keyword\">const</span> Digest&amp; digest,</div>\n\
<div class=\"line\">    <span class=\"keywordtype\">size_t</span> size</div>\n\
<div class=\"line\">)</div>\n\
<div class=\"line\">{</div>\n\
<div class=\"line\">    boost::shared_ptr&lt;ReadableArray&lt;T&gt; &gt; result =</div>\n\
...
<div class=\"line\">    boost::shared_ptr&lt;Array&lt;T&gt; &gt; array</div>\n\
<div class=\"line\">)</div>\n\
<div class=\"line\">{</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\"><span class=\"keyword\">template</span> &lt;<span class=\"keyword\">typename</span> T&gt;</div>\n\
<div class=\"line\">boost::shared_ptr&lt;ReadableArray&lt;T&gt; &gt;</div>\n\
...
<div class=\"line\">        </div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span> (!ret) {</div>\n\
<div class=\"line\">            ret = boost::make_shared&lt;SharedArray&lt;T&gt; &gt;(</div>\n\
...
<div class=\"line\"><span class=\"comment\">//==============================================================================</span></div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">boost::shared_ptr&lt;IndexBuffer&gt; IndexBuffer::create(</div>\n\
<div class=\"line\">    <span class=\"keyword\">const</span> boost::shared_ptr&lt;Array&lt;index_t&gt; &gt;&amp; array,</div>\n\
<div class=\"line\">    <span class=\"keyword\">const</span> <span class=\"keywordtype\">size_t</span> beginIdx,</div>\n\
<div class=\"line\">    <span class=\"keyword\">const</span> <span class=\"keywordtype\">size_t</span> endIdx</div>\n\
<div class=\"line\">)</div>\n\
...
<div class=\"line\">    <span class=\"comment\">// cache. If so, we return the cached array to promote sharing as</span></div>\n\
<div class=\"line\">    <span class=\"comment\">// much as possible.</span></div>\n\
<div class=\"line\">    boost::shared_ptr&lt;IndexBuffer&gt; ret;</div>\n\
<div class=\"line\">    {</div>\n\
...
<div class=\"line\">        </div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span> (!ret) {</div>\n\
<div class=\"line\">            ret = boost::make_shared&lt;IndexBuffer&gt;(</div>\n\
<div class=\"line\">                array, beginIdx, endIdx);</div>\n\
...
<div class=\"line\">}</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"><span class=\"keywordtype\">void</span> IndexBuffer::ReplaceArrayInstance(boost::shared_ptr&lt;Array&lt;index_t&gt; &gt;&amp; newArray)<span class=\"keyword\"> const</span></div>\n\
<div class=\"line\"><span class=\"keyword\"></span>{</div>\n\
...
<div class=\"line\">        boost::shared_ptr&lt;Array&lt;index_t&gt; &gt;&amp; nonConstArray = <span class=\"keyword\">const_cast&lt;</span>boost::shared_ptr&lt;Array&lt;index_t&gt; <span class=\"keyword\">&gt;</span>&amp; &gt;(fArray);</div>\n\
...
<div class=\"line\">    <span class=\"comment\">// cache. If so, we return the cached array to promote sharing as</span></div>\n\
<div class=\"line\">    <span class=\"comment\">// much as possible.</span></div>\n\
<div class=\"line\">    boost::shared_ptr&lt;VertexBuffer&gt; ret;</div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">        tbb::mutex::scoped_lock lock(</div>\n\
...
<div class=\"line\">        </div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span> (!ret) {</div>\n\
<div class=\"line\">            ret = boost::make_shared&lt;VertexBuffer&gt;(</div>\n\
...
<div class=\"line\">}</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"><span class=\"keywordtype\">void</span> VertexBuffer::ReplaceArrayInstance(boost::shared_ptr&lt;Array&lt;float&gt; &gt;&amp; newArray)<span class=\"keyword\"> const</span></div>\n\
<div class=\"line\"><span class=\"keyword\"></span>{</div>\n\
<div class=\"line\">    assert(ArrayBase::KeyEqualTo()(fArray-&gt;key(), newArray-&gt;key()));</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> (fArray != newArray) {</div>\n\
<div class=\"line\">        boost::shared_ptr&lt;Array&lt;float&gt; &gt;&amp; nonConstArray = <span class=\"keyword\">const_cast&lt;</span>boost::shared_ptr&lt;Array&lt;float&gt; <span class=\"keyword\">&gt;</span>&amp; &gt;(fArray);</div>\n\
<div class=\"line\">        nonConstArray = newArray;</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\">}</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">      std::vector&lt;boost::shared_ptr&lt;IndexBuffer&gt; &gt;(1, triangleVertIndices)),</div>\n\
...
<div class=\"line\">    <span class=\"keyword\">const</span> boost::shared_ptr&lt;VertexBuffer&gt;&amp; normals</div>\n\
<div class=\"line\">)</div>\n\
<div class=\"line\">{</div>\n\
...
<div class=\"line\">    <span class=\"keyword\">const</span> boost::shared_ptr&lt;VertexBuffer&gt;&amp; uvs</div>\n\
<div class=\"line\">)</div>\n\
<div class=\"line\">{</div>\n\
