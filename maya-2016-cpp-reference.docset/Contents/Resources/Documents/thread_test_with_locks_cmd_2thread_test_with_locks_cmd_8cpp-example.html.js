...
<html>\n\
   <head><script src=\"../scripts/yepnope.1.5.4-min.js\" type=\"text/javascript\"></script><script src=\"../scripts/lib/jquery-1.11.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\"><meta name=\"product\" content=\"MAYAUL\"><meta name=\"release\" content=\"2016\"><meta name=\"book\" content=\"Developer\"><meta name=\"created\" content=\"2015-10-14\"><meta name=\"topicid\" content=\"GUID-02DEF634-1E7B-48C6-8ACD-2C934CA97887\"><meta name=\"topic-type\" content=\"concept\">\n\
      <title>threadTestWithLocksCmd/threadTestWithLocksCmd.cpp</title>\n\
   \n\
\n\
...
$(window).load( function() {\n\
 ...
 if (!tocSystemNeedsToBeLoaded) { cpp_ref_initializeToc(); }\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>threadTestWithLocksCmd/threadTestWithLocksCmd.cpp</h1>\n\
         </div>\n\
\n\
...
<div class=\"line\"><span class=\"preprocessor\">#include &lt;unistd.h&gt;</span>     <span class=\"comment\">// for sleep</span></div>\n\
...
<div class=\"line\">    <a name=\"_a2\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_mutex_lock.html\">MMutexLock</a> *mutexLock;</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">        <a name=\"a3\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_thread_pool.html#a611da972604ffe306fdb87b4ab06ed16\">MThreadPool::createTask</a>(Pi, (<span class=\"keywordtype\">void</span> *)&amp;tdata[i], root);</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <a name=\"a4\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_thread_pool.html#ae9e9c1be8def42f1040adf93edf4d5e7\">MThreadPool::executeAndJoin</a>(root);</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">for</span>( <span class=\"keywordtype\">int</span> i = 0; i &lt; NUM_TASKS; ++i )</div>\n\
<div class=\"line\">    {</div>\n\
...
<div class=\"line\">    </div>\n\
<div class=\"line\">    <a name=\"_a5\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html\">MStatus</a> pr = <a name=\"a6\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_thread_pool.html#aad848133155102b2152f346cea3eb7d6\">MThreadPool::init</a>();</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span>( <a name=\"a7\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80af0536797208144380691e2b376ffc1d1\">MStatus::kSuccess</a> == pr )</div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">        tdata.iterations  = iterations;</div>\n\
<div class=\"line\">        tdata.totalPi     = 0;</div>\n\
<div class=\"line\">        </div>\n\
<div class=\"line\">        <a name=\"a8\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_thread_pool.html#a943a1eb7bb753be409a66388900890e4\">MThreadPool::newParallelRegion</a>(DecomposePi, (<span class=\"keywordtype\">void</span> *)&amp;tdata);</div>\n\
<div class=\"line\">        </div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_spin_lock.html\">MSpinLock</a>* spinLock = <span class=\"keyword\">new</span> <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_spin_lock.html\">MSpinLock</a>();</div>\n\
...
<div class=\"line\">            tdata[i].end         = ( limit &lt; taskD-&gt;iterations) ? limit : taskD-&gt;iterations;</div>\n\
<div class=\"line\">            tdata[i].step        = step;</div>\n\
<div class=\"line\">            tdata[i].spinLock       = spinLock;</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    <span class=\"comment\">//</span></div>\n\
<div class=\"line\">    <span class=\"keyword\">delete</span> spinLock;</div>\n\
<div class=\"line\">}</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">        pi += 4.0 / (1.0 + x*x);</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\">    myData-&gt;mutexLock-&gt;<a name=\"a10\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_spin_lock.html#aa81aed607133209dade63a226818224d\">lock</a>();</div>\n\
<div class=\"line\">    (*myData-&gt;globalPi) += pi;</div>\n\
...
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html\">MStatus</a> pr = <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80af0536797208144380691e2b376ffc1d1\">MStatus::kSuccess</a>;</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_mutex_lock.html\">MMutexLock</a>* mutexLock = <span class=\"keyword\">new</span> <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_mutex_lock.html\">MMutexLock</a>();</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span>( <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80af0536797208144380691e2b376ffc1d1\">MStatus::kSuccess</a> == pr )</div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">        threadData tdata[NUM_TASKS];</div>\n\
...
<div class=\"line\">    <span class=\"keywordtype\">double</span>              Pi = 0;</div>\n\
<div class=\"line\">    taskData            tdata;</div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html\">MStatus</a> pr = <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_thread_pool.html#aad848133155102b2152f346cea3eb7d6\">MThreadPool::init</a>();</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span>( <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80af0536797208144380691e2b376ffc1d1\">MStatus::kSuccess</a> == pr )</div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">        tdata.iterations  = iterations;</div>\n\
<div class=\"line\">        tdata.totalPi     = 0;</div>\n\
...
<div class=\"line\">{</div>\n\
<div class=\"line\">    asyncSpinLock.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_spin_lock.html#aa81aed607133209dade63a226818224d\">lock</a>();</div>\n\
<div class=\"line\">    g_async_count++;</div>\n\
<div class=\"line\">    asyncSpinLock.<a name=\"a11\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_spin_lock.html#a9278be8203e1c42e2619179882ae4403\">unlock</a>();</div>\n\
<div class=\"line\">}</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html\">MStatus</a> pr = <a name=\"a12\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_thread_async.html#aad848133155102b2152f346cea3eb7d6\">MThreadAsync::init</a>();</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span>( <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80af0536797208144380691e2b376ffc1d1\">MStatus::kSuccess</a> == pr )</div>\n\
<div class=\"line\">    {</div>\n\
...
<div class=\"line\">            pr = <a name=\"a13\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_thread_async.html#ad805f347e198954c15fa9c384a2bd5e5\">MThreadAsync::createTask</a>(AsyncPi, (<span class=\"keywordtype\">void</span> *)&amp;tdata[i], </div>\n\
<div class=\"line\">                                          AsyncCB, NULL);</div>\n\
...
<div class=\"line\">        <a name=\"a14\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_thread_async.html#a23b477d0e2d399f75d585d154c346591\">MThreadAsync::release</a>(); <span class=\"comment\">// release async thread</span></div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_thread_async.html#a23b477d0e2d399f75d585d154c346591\">MThreadAsync::release</a>(); <span class=\"comment\">// shut down threads</span></div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">return</span> Pi;</div>\n\
<div class=\"line\">}</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"><span class=\"comment\">// MSimple command that invokes the serial and parallel thread calculations</span></div>\n\
<div class=\"line\"><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html\">MStatus</a> threadTestWithLocksCmd::doIt( <span class=\"keyword\">const</span> <a name=\"_a15\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_arg_list.html\">MArgList</a>&amp; args )</div>\n\
<div class=\"line\">{</div>\n\
<div class=\"line\">    <a name=\"_a16\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html\">MString</a> str = <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html\">MString</a>(<span class=\"stringliteral\">&quot;Computation of pi using the Maya API\\n&quot;</span>);</div>\n\
<div class=\"line\">    <a name=\"a17\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_global.html#a3d14e9f9ed022a80f664eac0136c2f7a\">MGlobal::displayInfo</a>(str);</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span>(args.<a name=\"a18\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_arg_list.html#a99dd6a54b909ede1d11702fe58977e2a\">length</a>() != 1) {</div>\n\
...
<div class=\"line\">        <a name=\"a19\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_global.html#a4ddbe97e58a90e1ab05d45a62c006cf0\">MGlobal::displayError</a>(str);</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordtype\">int</span> iterations = args.<a name=\"a21\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_arg_list.html#a54e9c6d91b7b999624b2384bc52f12a2\">asInt</a>( 0, &amp;stat );</div>\n\
...
<div class=\"line\">    <a name=\"_a22\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_timer.html\">MTimer</a> timer;</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"comment\">// run single threaded</span></div>\n\
<div class=\"line\">    timer.<a name=\"a23\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_timer.html#ac336e3fea7e0479c0496beccd27ba152\">beginTimer</a>();</div>\n\
<div class=\"line\">    pi = CalcPiSingleThreaded(iterations);</div>\n\
<div class=\"line\">    timer.<a name=\"a24\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_timer.html#ab1cd82365475316c3b987f456df5e14c\">endTimer</a>();</div>\n\
<div class=\"line\">    elapsedTime = timer.<a name=\"a25\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_timer.html#af216bfafd4829e364522a4c93e737fe8\">elapsedTime</a>();</div>\n\
<div class=\"line\">    piStr.<a name=\"a26\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html#acee761fe098fc30a5ac1437e3aca5bc0\">set</a>(pi, 10); <span class=\"comment\">// 10 digits of precision</span></div>\n\
