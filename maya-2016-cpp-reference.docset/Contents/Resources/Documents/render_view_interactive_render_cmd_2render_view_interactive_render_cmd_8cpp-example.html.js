...
<div class=\"line\">{                                                           </div>\n\
<div class=\"line\">    <a name=\"_a17\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_plugin.html\">MFnPlugin</a>   plugin( obj, PLUGIN_COMPANY, <span class=\"stringliteral\">&quot;4.5&quot;</span> );   </div>\n\
...
<div class=\"line\">        stat.<a name=\"a18\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a1f01a4748fea4d8bcced082df83f804d\">perror</a>( <span class=\"stringliteral\">&quot;registerCommand&quot;</span> );</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    plugin.registerUI(<span class=\"stringliteral\">&quot;registerSampleRenderer&quot;</span>, <span class=\"stringliteral\">&quot;&quot;</span>);</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    timeChangeCallbackID = <a name=\"a19\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_d_g_message.html#afa9ac531604456cec3e065991484e817\">MDGMessage::addTimeChangeCallback</a>(renderViewInteractiveRender::timeChangeCB, NULL, &amp;stat);</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span>( !stat )</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">    stat = <a name=\"a20\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_message.html#a50fe995add3ce133b8b56551abb4ed09\">MDGMessage::removeCallback</a>(timeChangeCallbackID);</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> ( !stat )                                    </div>\n\
...
<div class=\"line\">    pixel.<a name=\"a21\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/struct_r_v___p_i_x_e_l.html#a4788d82c901b9367dd5c0daff8a7616b\">r</a> = color1.r * percent + color2.r * (1-percent);</div>\n\
<div class=\"line\">    pixel.<a name=\"a22\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/struct_r_v___p_i_x_e_l.html#a8cf17d727651616de6f2b79ef32170cd\">g</a> = color1.g * percent + color2.g * (1-percent);</div>\n\
<div class=\"line\">    pixel.<a name=\"a23\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/struct_r_v___p_i_x_e_l.html#a83fc1af92e29717b4513d121b0c72c7d\">b</a> = color1.b * percent + color2.b * (1-percent);</div>\n\
<div class=\"line\">    pixel.<a name=\"a24\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/struct_r_v___p_i_x_e_l.html#a4aec1a5be9d9a4a394a2e49e9744286e\">a</a> = 255.0f;</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    <span class=\"comment\">//</span></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> (!<a name=\"a25\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_render_view.html#a2fe9d82b7ea7afdeb8b3c0b534c2f585\">MRenderView::doesRenderEditorExist</a>())</div>\n\
<div class=\"line\">    {</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> (<a name=\"a28\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_render_view.html#a83fe29675c567275fe349381ee1f6f2d\">MRenderView::startRender</a>( image_width, image_height, </div>\n\
<div class=\"line\">        doNotClearBackground, </div>\n\
<div class=\"line\">        immediateRefresh) != <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80af0536797208144380691e2b376ffc1d1\">MS::kSuccess</a>)</div>\n\
<div class=\"line\">    {</div>\n\
...
<div class=\"line\">                <span class=\"comment\">//</span></div>\n\
<div class=\"line\">                <span class=\"keywordflow\">if</span> (<a name=\"a29\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_render_view.html#a43020ec6829729869e63e7d894453a5b\">MRenderView::startRegionRender</a>( width, height, left, right-1, bottom, top-1, <span class=\"keyword\">true</span>, <span class=\"keyword\">false</span>) != <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80af0536797208144380691e2b376ffc1d1\">MS::kSuccess</a>)</div>\n\
<div class=\"line\">                {</div>\n\
...
<div class=\"line\">                    st =<a name=\"a30\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_render_view.html#a146003ed92b5f9f1572fa619557709ed\">MRenderView::refresh</a>(0, image_width-1, 0, image_height-1);</div>\n\
<div class=\"line\">                <span class=\"keywordflow\">else</span></div>\n\
...
<div class=\"line\">                <span class=\"keywordflow\">if</span> (st != <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80af0536797208144380691e2b376ffc1d1\">MS::kSuccess</a>)</div>\n\
<div class=\"line\">                {</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> (<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_render_view.html#a83fe29675c567275fe349381ee1f6f2d\">MRenderView::startRender</a>( width, height, doNotClearBackground, <span class=\"keyword\">true</span>) != <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80af0536797208144380691e2b376ffc1d1\">MS::kSuccess</a>)</div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">        displayError(<span class=\"stringliteral\">&quot;renderViewInteractiveRender: error occurred in startRender.&quot;</span>);</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">return</span> <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80a1ef6c2d725fb4bec3e7e840d28adbc00\">MS::kFailure</a>;</div>\n\
<div class=\"line\">    }</div>\n\
...
<div class=\"line\">    }<span class=\"keywordflow\">else</span></div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">        <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_time.html\">MTime</a> currentTimeObj = <a name=\"a31\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_anim_control.html#a8cb1e013d828c1d012fee789b14e0060\">MAnimControl::currentTime</a>();</div>\n\
<div class=\"line\">        <span class=\"keywordtype\">double</span> currentTime = currentTimeObj.<a name=\"a32\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_time.html#a324b14b7506c6e4f47912161956974ed\">value</a>();</div>\n\
...
<div class=\"line\">    <span class=\"keywordflow\">if</span> (<a name=\"a33\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_render_view.html#a933dc6f93a84fdd9ebb889d1af7b9a6a\">MRenderView::updatePixels</a>(left, right - 1, bottom, top - 1, pixels) </div>\n\
