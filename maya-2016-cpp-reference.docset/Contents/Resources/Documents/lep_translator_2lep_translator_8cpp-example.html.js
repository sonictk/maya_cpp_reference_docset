...
<html>\n\
   <head><script src=\"../scripts/yepnope.1.5.4-min.js\" type=\"text/javascript\"></script><script src=\"../scripts/lib/jquery-1.11.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\"><meta name=\"product\" content=\"MAYAUL\"><meta name=\"release\" content=\"2016\"><meta name=\"book\" content=\"Developer\"><meta name=\"created\" content=\"2015-10-14\"><meta name=\"topicid\" content=\"GUID-02DEF634-1E7B-48C6-8ACD-2C934CA97887\"><meta name=\"topic-type\" content=\"concept\">\n\
      <title>lepTranslator/lepTranslator.cpp</title>\n\
   \n\
\n\
...
$(window).load( function() {\n\
 ...
 if (!tocSystemNeedsToBeLoaded) { cpp_ref_initializeToc(); }\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>lepTranslator/lepTranslator.cpp</h1>\n\
         </div>\n\
\n\
...
<div class=\"line\"><span class=\"comment\">//  In this example, the user can create one or more nurbsSpheres, nurbsCylinders or nurbsCones.</span></div>\n\
<div class=\"line\"><span class=\"comment\">//  The user can translate them around.</span></div>\n\
<div class=\"line\"><span class=\"comment\">//</span></div>\n\
<div class=\"line\"><span class=\"comment\">//  The LEP files can be referenced by Maya files.</span></div>\n\
<div class=\"line\"><span class=\"comment\">//  </span></div>\n\
<div class=\"line\"><span class=\"comment\">//  It is to be noted that this example was made to be simple.  Hence, there are limitations.</span></div>\n\
...
<div class=\"line\"><span class=\"comment\">//  geometries we can export, we search by name, hence, if a polygon cube contains in its </span></div>\n\
<div class=\"line\"><span class=\"comment\">//  named the string &quot;nurbsSphere&quot;, it will be written out as a nurbs sphere.</span></div>\n\
<div class=\"line\"><span class=\"comment\">//</span></div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    <span class=\"keyword\">virtual</span>            ~LepTranslator () {};</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    <span class=\"keywordtype\">bool</span> <a name=\"a1\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_px_file_translator.html#a5bdde07c444bcc490367efe4f3424ade\">haveReadMethod</a>()<span class=\"keyword\"> const </span>{ <span class=\"keywordflow\">return</span> <span class=\"keyword\">true</span>; }</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    <span class=\"keywordtype\">bool</span> <a name=\"a2\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_px_file_translator.html#ab58322cfe1d3437d3fc627be3a49121c\">haveWriteMethod</a>()<span class=\"keyword\"> const </span>{ <span class=\"keywordflow\">return</span> <span class=\"keyword\">true</span>; }</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    <span class=\"keywordtype\">bool</span> <a name=\"a3\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_px_file_translator.html#a43ef24125f987f9f3a27639afe4b6ffc\">haveReferenceMethod</a>()<span class=\"keyword\"> const </span>{ <span class=\"keywordflow\">return</span> <span class=\"keyword\">false</span>; }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"comment\">//If this method returns true, it means we support namespaces.</span></div>\n\
<div class=\"line\">    <span class=\"keywordtype\">bool</span> <a name=\"a4\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_px_file_translator.html#afca676f2056a1a37aac4bf499d82b793\">haveNamespaceSupport</a>()<span class=\"keyword\">    const </span>{ <span class=\"keywordflow\">return</span> <span class=\"keyword\">true</span>; }</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    <a name=\"_a5\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html\">MString</a> <a name=\"a6\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_px_file_translator.html#a48074cfa41f4caf87bfa0bc533ea6f25\">defaultExtension</a> () <span class=\"keyword\">const</span>;</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    <span class=\"keywordtype\">bool</span> <a name=\"a7\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_px_file_translator.html#a21cb60f2121ebce3f21367325c940fbc\">canBeOpened</a>()<span class=\"keyword\"> const </span>{ <span class=\"keywordflow\">return</span> <span class=\"keyword\">true</span>; }</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">                                <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_px_file_translator.html#a248681daa33e11b68c934862cfe49417\">MPxFileTranslator::FileAccessMode</a> mode)</div>\n\
<div class=\"line\">{    </div>\n\
<div class=\"line\">    <span class=\"keyword\">const</span> <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html\">MString</a> fname = file.<a name=\"a13\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_file_object.html#a7a1c6f1f04d612d126a4e7512ab62ca7\">fullName</a>();</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html\">MStatus</a> rval(<a name=\"a14\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80af0536797208144380691e2b376ffc1d1\">MS::kSuccess</a>);</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">    ifstream inputfile(fname.<a name=\"a15\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html#aa9ab612f356c53479afc4c648c9ef94d\">asChar</a>(), ios::in);</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> (!inputfile) {</div>\n\
<div class=\"line\">        <span class=\"comment\">// open failed</span></div>\n\
<div class=\"line\">        cerr &lt;&lt; fname &lt;&lt; <span class=\"stringliteral\">&quot;: could not be opened for reading\\n&quot;</span>;</div>\n\
...
<div class=\"line\">        cerr &lt;&lt; <span class=\"stringliteral\">&quot;file &quot;</span> &lt;&lt; fname &lt;&lt; <span class=\"stringliteral\">&quot; contained no lines ... aborting\\n&quot;</span>;</div>\n\
...
<div class=\"line\">        cerr &lt;&lt; <span class=\"stringliteral\">&quot;first line of file &quot;</span> &lt;&lt; fname;</div>\n\
<div class=\"line\">        cerr &lt;&lt; <span class=\"stringliteral\">&quot; did not contain &quot;</span> &lt;&lt; magic.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html#aa9ab612f356c53479afc4c648c9ef94d\">asChar</a>() &lt;&lt; <span class=\"stringliteral\">&quot; ... aborting\\n&quot;</span>;</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">return</span> <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80a1ef6c2d725fb4bec3e7e840d28adbc00\">MS::kFailure</a>;</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">        cmdString.<a name=\"a17\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html#acee761fe098fc30a5ac1437e3aca5bc0\">set</a>(buf);</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span> (!<a name=\"a18\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_global.html#a09e405631e7cf680f8ac9d934ad73434\">MGlobal::executeCommand</a>(cmdString))</div>\n\
<div class=\"line\">            rval = <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80a1ef6c2d725fb4bec3e7e840d28adbc00\">MS::kFailure</a>;</div>\n\
<div class=\"line\">    }</div>\n\
...
<div class=\"line\">    <span class=\"keyword\">const</span> <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html\">MString</a> fname = file.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_file_object.html#a7a1c6f1f04d612d126a4e7512ab62ca7\">fullName</a>();</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    ofstream newf(fname.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html#aa9ab612f356c53479afc4c648c9ef94d\">asChar</a>(), ios::out);</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> (!newf) {</div>\n\
<div class=\"line\">        <span class=\"comment\">// open failed</span></div>\n\
<div class=\"line\">        cerr &lt;&lt; fname &lt;&lt; <span class=\"stringliteral\">&quot;: could not be opened for reading\\n&quot;</span>;</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">return</span> <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80a1ef6c2d725fb4bec3e7e840d28adbc00\">MS::kFailure</a>;</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\">    newf.setf(ios::unitbuf);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">        <a name=\"_a20\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string_array.html\">MStringArray</a> optionList;</div>\n\
<div class=\"line\">        <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string_array.html\">MStringArray</a> theOption;</div>\n\
<div class=\"line\">        options.<a name=\"a21\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html#ac914d138fc96d7065c687a4f8b40c263\">split</a>(<span class=\"charliteral\">&#39;;&#39;</span>, optionList);    <span class=\"comment\">// break out all the options.</span></div>\n\
<div class=\"line\">        </div>\n\
<div class=\"line\">        <span class=\"keywordflow\">for</span>( i = 0; i &lt; optionList.<a name=\"a22\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string_array.html#a580388f31f60c46fac867ca48a48da1e\">length</a>(); ++i ){</div>\n\
<div class=\"line\">            theOption.<a name=\"a23\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string_array.html#ad5522f028dde0080b753279426415a4a\">clear</a>();</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">    <a name=\"_a24\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_it_dag.html\">MItDag</a> dagIterator( <a name=\"a25\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_it_dag.html#a1545968b4f810358b53ae9844bce6bd1a8ad4d0a286855b50181b12df48942291\">MItDag::kBreadthFirst</a>, <a name=\"a26\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn.html#a1d1cfd8ffb84e947f82999c682b666a7a94dd08feda7b2cf0ff8262312c4fcc09\">MFn::kInvalid</a>, &amp;status);</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> ( !status) {</div>\n\
<div class=\"line\">        status.<a name=\"a27\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a1f01a4748fea4d8bcced082df83f804d\">perror</a> (<span class=\"stringliteral\">&quot;Failure in DAG iterator setup&quot;</span>);</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">return</span> <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80a1ef6c2d725fb4bec3e7e840d28adbc00\">MS::kFailure</a>;</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <a name=\"_a28\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_selection_list.html\">MSelectionList</a> selection;</div>\n\
<div class=\"line\">    <a name=\"a29\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_global.html#a6d81d38246555884897fb153c93aaf42\">MGlobal::getActiveSelectionList</a> (selection);</div>\n\
<div class=\"line\">    <a name=\"_a30\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_it_selection_list.html\">MItSelectionList</a> selIterator (selection, <a name=\"a31\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn.html#a1d1cfd8ffb84e947f82999c682b666a7a7f6b3e140a92b64ca6c088012cca49af\">MFn::kDagNode</a>);</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordtype\">bool</span> done = <span class=\"keyword\">false</span>;</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">while</span> (<span class=\"keyword\">true</span>) </div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">        <a name=\"_a32\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html\">MObject</a> currentNode;</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">switch</span> (mode)</div>\n\
<div class=\"line\">        {</div>\n\
<div class=\"line\">            <span class=\"keywordflow\">case</span> <a name=\"a33\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_px_file_translator.html#a248681daa33e11b68c934862cfe49417a64282dfea3d1ae99cd9c8220dfa5d0a7\">MPxFileTranslator::kSaveAccessMode</a>:</div>\n\
<div class=\"line\">            <span class=\"keywordflow\">case</span> <a name=\"a34\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_px_file_translator.html#a248681daa33e11b68c934862cfe49417a2b6cc89b2e3d91b69ec9af440ef0bc94\">MPxFileTranslator::kExportAccessMode</a>:</div>\n\
<div class=\"line\">                <span class=\"keywordflow\">if</span> (dagIterator.isDone ())</div>\n\
<div class=\"line\">                    done = <span class=\"keyword\">true</span>;</div>\n\
<div class=\"line\">                <span class=\"keywordflow\">else</span> {</div>\n\
<div class=\"line\">                    currentNode = dagIterator.item ();</div>\n\
<div class=\"line\">                    dagIterator.next ();</div>\n\
<div class=\"line\">                }</div>\n\
<div class=\"line\">                <span class=\"keywordflow\">break</span>;</div>\n\
<div class=\"line\">            <span class=\"keywordflow\">case</span> <a name=\"a35\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_px_file_translator.html#a248681daa33e11b68c934862cfe49417ab8316a826501eb9bae9132346b5db59f\">MPxFileTranslator::kExportActiveAccessMode</a>:</div>\n\
...
<div class=\"line\">                cerr &lt;&lt; <span class=\"stringliteral\">&quot;Unrecognized write mode: &quot;</span> &lt;&lt; mode &lt;&lt; endl;</div>\n\
<div class=\"line\">                <span class=\"keywordflow\">break</span>;</div>\n\
<div class=\"line\">        }</div>\n\
...
<div class=\"line\">        <a name=\"_a36\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_transform.html\">MFnTransform</a> dagNode(currentNode, &amp;status);</div>\n\
...
<div class=\"line\">        {</div>\n\
<div class=\"line\">            <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html\">MString</a> nodeNameNoNamespace=<a name=\"a37\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_namespace.html#a3d06313c5ef9f98cc8feaef331cae7ec\">MNamespace::stripNamespaceFromName</a>(dagNode.name());</div>\n\
<div class=\"line\">            <span class=\"keywordflow\">for</span> (i = 0; i &lt; numPrimitives; ++i) {                </div>\n\
<div class=\"line\">                <span class=\"keywordflow\">if</span>(nodeNameNoNamespace.<a name=\"a38\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html#aaa76dfd27998dc2ff937d3690d11391c\">indexW</a>(primitiveStrings[i]) &gt;= 0){</div>\n\
<div class=\"line\">                    <span class=\"comment\">// This is a node we support</span></div>\n\
<div class=\"line\">                    newf &lt;&lt; primitiveCommands[i] &lt;&lt; <span class=\"stringliteral\">&quot; -n &quot;</span> &lt;&lt; nodeNameNoNamespace &lt;&lt; endl;</div>\n\
<div class=\"line\">                    <span class=\"keywordflow\">if</span> (showPositions) {</div>\n\
<div class=\"line\">                        <a name=\"_a39\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_vector.html\">MVector</a> pos;</div>\n\
<div class=\"line\">                        pos = dagNode.getTranslation(<a name=\"a40\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_space.html#ab11a1dda34491acff014ddfc9e6bafb8ad74f4c7c6562dc3f8339a8bba2d28dd0\">MSpace::kObject</a>);</div>\n\
<div class=\"line\">                        newf &lt;&lt; <span class=\"stringliteral\">&quot;move &quot;</span> &lt;&lt; pos.<a name=\"a41\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_vector.html#af88b946fb90d5f08b5fb740c70e98c10\">x</a> &lt;&lt; <span class=\"stringliteral\">&quot; &quot;</span> &lt;&lt; pos.<a name=\"a42\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_vector.html#ab927965981178aa1fba979a37168db2a\">y</a> &lt;&lt; <span class=\"stringliteral\">&quot; &quot;</span> &lt;&lt; pos.<a name=\"a43\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_vector.html#ab3e6ed577a7c669c19de1f9c1b46c872\">z</a> &lt;&lt; endl;</div>\n\
<div class=\"line\">                    }</div>\n\
<div class=\"line\">                }</div>\n\
<div class=\"line\">            }</div>\n\
