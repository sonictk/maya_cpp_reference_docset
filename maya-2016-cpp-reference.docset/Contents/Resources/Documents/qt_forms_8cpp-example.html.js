...
<div class=\"line\"><span class=\"preprocessor\">#include &lt;QtGui/QComboBox&gt;</span></div>\n\
...
<div class=\"line\"><span class=\"preprocessor\">#include &lt;QtGui/QLabel&gt;</span></div>\n\
<div class=\"line\"><span class=\"preprocessor\">#include &lt;QtGui/QLineEdit&gt;</span></div>\n\
<div class=\"line\"><span class=\"preprocessor\">#include &lt;QtCore/QLocale&gt;</span></div>\n\
<div class=\"line\"><span class=\"preprocessor\">#include &lt;QtGui/QPushButton&gt;</span></div>\n\
<div class=\"line\"><span class=\"preprocessor\">#include &lt;QtUiTools/QtUiTools&gt;</span></div>\n\
<div class=\"line\"><span class=\"preprocessor\">#include &lt;QtGui/QVBoxLayout&gt;</span></div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">QPointer&lt;ObjectTypeDialog&gt;  qtFormsCmd::objectCreator;</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"><span class=\"keyword\">const</span> <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html\">MString</a>           qtFormsCmd::commandName(<span class=\"stringliteral\">&quot;qtForms&quot;</span>);</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">{</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> (!objectCreator.isNull()) <span class=\"keyword\">delete</span> objectCreator;</div>\n\
<div class=\"line\">}</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    <span class=\"keywordflow\">if</span> (objectCreator.isNull()) {</div>\n\
<div class=\"line\">        objectCreator = <span class=\"keyword\">new</span> ObjectTypeDialog();</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">else</span> {</div>\n\
<div class=\"line\">        objectCreator-&gt;showNormal();</div>\n\
<div class=\"line\">        objectCreator-&gt;raise();</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\"><span class=\"comment\">// ==========================================================================</span></div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html\">MStatus</a> initializePlugin(<a name=\"_a6\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html\">MObject</a> plugin)</div>\n\
<div class=\"line\">{</div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html\">MStatus</a>     st;</div>\n\
<div class=\"line\">    <a name=\"_a7\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_plugin.html\">MFnPlugin</a>   pluginFn(plugin, <span class=\"stringliteral\">&quot;Autodesk, Inc.&quot;</span>, <span class=\"stringliteral\">&quot;1.0&quot;</span>, <span class=\"stringliteral\">&quot;Any&quot;</span>, &amp;st);</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> (!st) {</div>\n\
<div class=\"line\">        <a name=\"a8\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_global.html#a4ddbe97e58a90e1ab05d45a62c006cf0\">MGlobal::displayError</a>(</div>\n\
...
<div class=\"line\">            + st.<a name=\"a9\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#ad57d0c926a6ff0c782bfa67278925863\">errorString</a>()</div>\n\
<div class=\"line\">        );</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">return</span> st;</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"comment\">//  Register the command.</span></div>\n\
<div class=\"line\">    st = pluginFn.registerCommand(qtFormsCmd::commandName, qtFormsCmd::creator);</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> (!st) {</div>\n\
...
<div class=\"line\">            + qtFormsCmd::commandName + <span class=\"stringliteral\">&quot;&#39; command: &quot;</span></div>\n\
...
<div class=\"line\">    st = pluginFn.deregisterCommand(qtFormsCmd::commandName);</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> (!st) {</div>\n\
<div class=\"line\">        <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_global.html#a4ddbe97e58a90e1ab05d45a62c006cf0\">MGlobal::displayError</a>(</div>\n\
