...
<div class=\"line\">        {</div>\n\
<div class=\"line\">            <span class=\"keyword\">const</span> <span class=\"keywordtype\">double</span>* d = &amp;<a name=\"a10\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_matrix.html#a85de986c9f953535d185c6780cecb77e\">MMatrix::identity</a>[0][0];</div>\n\
...
<div class=\"line\">            oAttr = tAttr.<a name=\"a54\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_typed_attribute.html#af785af0a66bd4a4da1d9f7bd74d4de0a\">create</a>(fName, fName, <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_data.html#a1d1cfd8ffb84e947f82999c682b666a7afab53ea4a643325262b9c140af093279\">MFnData::kString</a>,</div>\n\
<div class=\"line\">                <a name=\"a55\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html#ae6af14e0aa2c92bdda88c81280e1d122\">MObject::kNullObj</a>, &amp;status );</div>\n\
...
<div class=\"line\">                {</div>\n\
<div class=\"line\">                    nAttr.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_attribute.html#a9e68a8b4af016b37f6567cfa6d68e551\">setKeyable</a>( <span class=\"keyword\">true</span> );</div>\n\
<div class=\"line\">                    nAttr.<a name=\"a56\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_attribute.html#a4a44548ca2e5b1e7613a992a6b96a147\">setUsedAsColor</a>( <span class=\"keyword\">true</span> );</div>\n\
<div class=\"line\">                }</div>\n\
...
<div class=\"line\">            <span class=\"comment\">//</span></div>\n\
<div class=\"line\">            oAttr = mAttr.<a name=\"a57\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_matrix_attribute.html#acccc043a2ac80be8fe8e32bcc36b8696\">create</a>(fName, fName,</div>\n\
<div class=\"line\">                <a name=\"a58\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_matrix_attribute.html#a1d1cfd8ffb84e947f82999c682b666a7a5686197bafb177bdc82550848416a1ad\">MFnMatrixAttribute::kFloat</a>, &amp;status );</div>\n\
<div class=\"line\">            M_CHECK( status );</div>\n\
...
<div class=\"line\">                    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html#ae6af14e0aa2c92bdda88c81280e1d122\">MObject::kNullObj</a>, &amp;status );</div>\n\
<div class=\"line\">                M_CHECK( status );</div>\n\
<div class=\"line\">                tAttr.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_attribute.html#a0810da59cbaac7ecbd26ba0a43d0ac35\">setAffectsAppearance</a>( <span class=\"keyword\">true</span> );</div>\n\
<div class=\"line\">            }</div>\n\
<div class=\"line\">            <span class=\"keywordflow\">else</span></div>\n\
...
<div class=\"line\">        <span class=\"comment\">//</span></div>\n\
<div class=\"line\">        status = mod-&gt;<a name=\"a59\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_d_g_modifier.html#ad714eb6c2e6f51659e3e50f176c75a91\">addAttribute</a>( oNode, oAttr );</div>\n\
<div class=\"line\">        M_CHECK( status );</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">        {</div>\n\
<div class=\"line\">            status = mod-&gt;<a name=\"a60\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_d_g_modifier.html#afbd18f066f70fcd1864ddb4af91f3c7b\">connect</a>(oSrcNode, oSrcAttr, oDstNode, oDstAttr);</div>\n\
<div class=\"line\">            M_CHECK( status );</div>\n\
<div class=\"line\">        }</div>\n\
...
<div class=\"line\">    status = dgMod-&gt;<a name=\"a61\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_d_g_modifier.html#ab5595b225c59b15d902dc34b849d90d0\">removeAttribute</a>( oNode, fAttr );</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    fAttr  = <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html#ae6af14e0aa2c92bdda88c81280e1d122\">MObject::kNullObj</a>;  </div>\n\
<div class=\"line\">    fAttr2 = <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html#ae6af14e0aa2c92bdda88c81280e1d122\">MObject::kNullObj</a>;  </div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">return</span> status == <a name=\"a62\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80af0536797208144380691e2b376ffc1d1\">MStatus::kSuccess</a>;</div>\n\
...
<div class=\"line\">        <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_dependency_node.html\">MFnDependencyNode</a> fnNode( oNode );</div>\n\
<div class=\"line\">        <a name=\"_a63\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_attribute.html\">MFnAttribute</a>      fnAttr;</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">        <span class=\"comment\">// </span></div>\n\
<div class=\"line\">        dgMod-&gt;<a name=\"a64\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_d_g_modifier.html#a984345cd272bc1a32a9fc2e93a6678b2\">doIt</a>();</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">        attributeList.<a name=\"a65\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string_array.html#ad5522f028dde0080b753279426415a4a\">clear</a>();</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">            <span class=\"keyword\">const</span> <span class=\"keywordtype\">char</span>* bp = tmpStr.<a name=\"a66\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html#aa9ab612f356c53479afc4c648c9ef94d\">asChar</a>();</div>\n\
<div class=\"line\">            <span class=\"keyword\">const</span> <span class=\"keywordtype\">char</span>* ep;</div>\n\
<div class=\"line\">            <span class=\"keywordflow\">for</span> ( ep = bp + tmpStr.<a name=\"a67\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html#a580388f31f60c46fac867ca48a48da1e\">length</a>(); bp &lt; ep; --ep )</div>\n\
...
<div class=\"line\">        <span class=\"keywordflow\">if</span> ( fType == kAttrTypeMatrix )</div>\n\
<div class=\"line\">        {</div>\n\
<div class=\"line\">            thatNumericDef = &amp;<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_matrix.html#a85de986c9f953535d185c6780cecb77e\">MMatrix::identity</a>.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_matrix.html#a527b102f4eb0951cf4f391f828d3ca34\">matrix</a>[0][0];</div>\n\
...
<div class=\"line\">                        fnNumeric.<a name=\"a68\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_numeric_attribute.html#aba21b33176bb831de026b78605c1dcf3\">setMin</a>( aDef-&gt;fNumericMin[0] );</div>\n\
...
<div class=\"line\">                        fnNumeric.<a name=\"a69\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_numeric_attribute.html#adab95fd85497b1dad3a4ba7a842ce9d8\">setMax</a>( aDef-&gt;fNumericMax[0] );</div>\n\
...
<div class=\"line\">                        fnNumeric.<a name=\"a70\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_numeric_attribute.html#af72ddb0704d27319ad52a28bdcd9f2a5\">setSoftMin</a>( aDef-&gt;fNumericSoftMin[0] );</div>\n\
...
<div class=\"line\">                        fnNumeric.<a name=\"a71\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_numeric_attribute.html#acd6abf61e5a1e573a57a516bf81bb2dc\">setSoftMax</a>( aDef-&gt;fNumericSoftMax[0] );</div>\n\
...
<div class=\"line\">                }</div>\n\
<div class=\"line\">                <span class=\"keywordflow\">else</span></div>\n\
<div class=\"line\">                    aDef-&gt;setValue( oNode, <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_matrix.html#a85de986c9f953535d185c6780cecb77e\">MMatrix::identity</a> );</div>\n\
<div class=\"line\">            }</div>\n\
<div class=\"line\">        }</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">catch</span> ( cgfxShaderCommon::InternalError* e )   </div>\n\
<div class=\"line\">        {</div>\n\
...
<div class=\"line\">    {</div>\n\
<div class=\"line\">        cgfxAttrDef* aDef = (*it);</div>\n\
<div class=\"line\">        aDef-&gt;fAttr  = <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html#ae6af14e0aa2c92bdda88c81280e1d122\">MObject::kNullObj</a>;</div>\n\
<div class=\"line\">        aDef-&gt;fAttr2 = <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html#ae6af14e0aa2c92bdda88c81280e1d122\">MObject::kNullObj</a>;</div>\n\
<div class=\"line\">    }</div>\n\
...
<div class=\"line\">    M_CHECK( status );</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <a name=\"_a73\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_numeric_data.html\">MFnNumericData</a> fnData(oData, &amp;status);</div>\n\
<div class=\"line\">    M_CHECK( status );</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\"><span class=\"keywordtype\">void</span></div>\n\
<div class=\"line\">cgfxAttrDef::getValue( <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html\">MObject</a>&amp; oNode, <a name=\"_a74\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_image.html\">MImage</a>&amp; value )<span class=\"keyword\"> const</span></div>\n\
<div class=\"line\"><span class=\"keyword\"></span>{</div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html\">MStatus</a> status = <a name=\"a75\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80a1ef6c2d725fb4bec3e7e840d28adbc00\">MS::kFailure</a>;</div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html\">MPlug</a> plug(oNode, fAttr);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">        <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html\">MObject</a> oSrcNode = srcPlug.<a name=\"a78\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#ad1aa507eb8e63e89e8d46a0abc18aa8c\">node</a>();</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">                iter.thisPlug().<a name=\"a88\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a3727c18c58fc5ba8be5fb2582b5d06f1\">connectedTo</a>( src, <span class=\"keyword\">true</span>, <span class=\"keyword\">false</span>);</div>\n\
...
<div class=\"line\">                        uvPlug.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a3727c18c58fc5ba8be5fb2582b5d06f1\">connectedTo</a>( placementNode, <span class=\"keyword\">true</span>, <span class=\"keyword\">false</span>, &amp;status);</div>\n\
<div class=\"line\">                        M_CHECK( status );</div>\n\
<div class=\"line\"></div>\n\
