...
<html>\n\
   <head><script src=\"../scripts/yepnope.1.5.4-min.js\" type=\"text/javascript\"></script><script src=\"../scripts/lib/jquery-1.11.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\"><meta name=\"product\" content=\"MAYAUL\"><meta name=\"release\" content=\"2016\"><meta name=\"book\" content=\"Developer\"><meta name=\"created\" content=\"2015-10-14\"><meta name=\"topicid\" content=\"GUID-02DEF634-1E7B-48C6-8ACD-2C934CA97887\"><meta name=\"topic-type\" content=\"concept\">\n\
      <title>gpuCache/gpuCacheSample.h</title>\n\
   \n\
\n\
...
$(window).load( function() {\n\
 ...
 if (!tocSystemNeedsToBeLoaded) { cpp_ref_initializeToc(); }\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>gpuCache/gpuCacheSample.h</h1>\n\
         </div>\n\
\n\
...
<div class=\"line\"><span class=\"preprocessor\">#include &lt;boost/enable_shared_from_this.hpp&gt;</span></div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\"><span class=\"preprocessor\">#include &quot;gpuCacheMakeSharedHelper.h&quot;</span></div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"comment\">// Helper classes for implementing boost::unordered_map of</span></div>\n\
...
<div class=\"line\">        : std::unary_function&lt;Key, std::size_t&gt;</div>\n\
<div class=\"line\">    {</div>\n\
...
<div class=\"line\">            boost::hash_combine(seed, key.fBytes);</div>\n\
<div class=\"line\">            boost::hash_combine(seed, key.fDigest.words[0]);</div>\n\
<div class=\"line\">            boost::hash_combine(seed, key.fDigest.words[1]);</div>\n\
<div class=\"line\">            <span class=\"keywordflow\">return</span> seed;</div>\n\
<div class=\"line\">        }</div>\n\
<div class=\"line\">    };</div>\n\
<div class=\"line\">    </div>\n\
<div class=\"line\">    <span class=\"keyword\">struct </span>KeyEqualTo</div>\n\
<div class=\"line\">        : std::binary_function&lt;Key, Key, bool&gt;</div>\n\
<div class=\"line\">    {</div>\n\
...
<div class=\"line\">    <span class=\"keyword\">virtual</span> ~Array();</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    <span class=\"keyword\">virtual</span> boost::shared_ptr&lt;const ArrayReadInterface&lt;T&gt; &gt; getReadable() <span class=\"keyword\">const</span> = 0;</div>\n\
<div class=\"line\">    <span class=\"keyword\">virtual</span> boost::shared_ptr&lt;ReadableArray&lt;T&gt; &gt; getReadableArray() <span class=\"keyword\">const</span> = 0;</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\"><span class=\"keyword\">template</span> &lt;<span class=\"keyword\">typename</span> T&gt;</div>\n\
<div class=\"line\"><span class=\"keyword\">class </span>ReadableArray : <span class=\"keyword\">public</span> Array&lt;T&gt;, <span class=\"keyword\">public</span> ArrayReadInterface&lt;T&gt;, <span class=\"keyword\">public</span> boost::enable_shared_from_this&lt;ReadableArray&lt;T&gt; &gt;</div>\n\
<div class=\"line\">{</div>\n\
<div class=\"line\"><span class=\"keyword\">public</span>:</div>\n\
<div class=\"line\">    <span class=\"keyword\">typedef</span> <span class=\"keyword\">typename</span> Array&lt;T&gt;::Digest Digest;</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keyword\">virtual</span> ~ReadableArray() {}</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    <span class=\"keyword\">static</span> tbb::mutex&amp; mutex();</div>\n\
<div class=\"line\">    </div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keyword\">static</span> boost::shared_ptr&lt;Array&lt;T&gt; &gt; lookup(</div>\n\
<div class=\"line\">        <span class=\"keyword\">const</span> Digest&amp; digest,</div>\n\
<div class=\"line\">        <span class=\"keywordtype\">size_t</span> size</div>\n\
<div class=\"line\">    );</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keyword\">static</span> boost::shared_ptr&lt;Array&lt;T&gt; &gt; lookupNonReadable(</div>\n\
<div class=\"line\">        <span class=\"keyword\">const</span> Digest&amp; digest,</div>\n\
<div class=\"line\">        <span class=\"keywordtype\">size_t</span> size</div>\n\
<div class=\"line\">    );</div>\n\
<div class=\"line\">    <span class=\"keyword\">static</span> boost::shared_ptr&lt;ReadableArray&lt;T&gt; &gt; lookupReadable(</div>\n\
<div class=\"line\">        <span class=\"keyword\">const</span> Digest&amp; digest,</div>\n\
<div class=\"line\">        <span class=\"keywordtype\">size_t</span> size</div>\n\
<div class=\"line\">    );</div>\n\
<div class=\"line\">    </div>\n\
...
<div class=\"line\">    <span class=\"keyword\">static</span> <span class=\"keywordtype\">void</span> insert(boost::shared_ptr&lt;Array&lt;T&gt; &gt; array);</div>\n\
<div class=\"line\">};</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    <span class=\"keyword\">static</span> boost::shared_ptr&lt;ReadableArray&lt;T&gt; &gt; create(</div>\n\
...
<div class=\"line\">    <span class=\"comment\">/*----- member functions -----*/</span></div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keyword\">virtual</span> ~SharedArray();</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keyword\">virtual</span> <span class=\"keyword\">const</span> T* <span class=\"keyword\">get</span>() <span class=\"keyword\">const</span>;</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"><span class=\"keyword\">private</span>:</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"comment\">/*----- member functions -----*/</span></div>\n\
...
<div class=\"line\">        <span class=\"keyword\">const</span> boost::shared_array&lt;T&gt;&amp; data,</div>\n\
<div class=\"line\">        <span class=\"keywordtype\">size_t</span> size,</div>\n\
<div class=\"line\">        <span class=\"keyword\">const</span> Digest&amp; digest</div>\n\
...
<div class=\"line\">    <span class=\"comment\">/*----- data members -----*/</span></div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keyword\">const</span> boost::shared_array&lt;T&gt; fData;</div>\n\
<div class=\"line\">};</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"><span class=\"comment\">/*==============================================================================</span></div>\n\
...
<div class=\"line\">    <span class=\"keyword\">typedef</span> boost::shared_ptr&lt;const ReadableArray&lt;index_t&gt; &gt; ReadableArrayPtr;</div>\n\
<div class=\"line\">    <span class=\"keyword\">typedef</span> boost::shared_ptr&lt;const ArrayReadInterface&lt;index_t&gt; &gt; ReadInterfacePtr;</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"comment\">/*----- classes -----*/</span></div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"comment\">// Helper classes for implementing boost::unordered_map of</span></div>\n\
...
<div class=\"line\">            <span class=\"keyword\">const</span> boost::shared_ptr&lt;Array&lt;index_t&gt; &gt;&amp; array,</div>\n\
...
<div class=\"line\"><span class=\"keyword\">        </span>{</div>\n\
<div class=\"line\">            std::size_t seed = 0;</div>\n\
<div class=\"line\">            boost::hash_combine(seed, ArrayBase::KeyHash()(key.fArrayKey));</div>\n\
<div class=\"line\">            boost::hash_combine(seed, key.fBeginIdx);</div>\n\
<div class=\"line\">            boost::hash_combine(seed, key.fEndIdx);</div>\n\
<div class=\"line\">            <span class=\"keywordflow\">return</span> seed;</div>\n\
<div class=\"line\">        }</div>\n\
<div class=\"line\">    };</div>\n\
<div class=\"line\">    </div>\n\
...
<div class=\"line\">    <span class=\"comment\">/*----- static member functions -----*/</span></div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keyword\">static</span> boost::shared_ptr&lt;IndexBuffer&gt; create(</div>\n\
<div class=\"line\">        <span class=\"keyword\">const</span> boost::shared_ptr&lt;Array&lt;index_t&gt; &gt;&amp; array</div>\n\
<div class=\"line\">    ) </div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keyword\">const</span> boost::shared_ptr&lt;Array&lt;index_t&gt; &gt;&amp; array()<span class=\"keyword\"> const</span></div>\n\
...
<div class=\"line\">    <span class=\"keywordtype\">void</span> ReplaceArrayInstance(boost::shared_ptr&lt;Array&lt;index_t&gt; &gt;&amp; newArray) <span class=\"keyword\">const</span>;</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"><span class=\"keyword\">private</span>:</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"comment\">/*----- member functions -----*/</span></div>\n\
...
<div class=\"line\">    <span class=\"comment\">/*----- data members -----*/</span></div>\n\
<div class=\"line\">    </div>\n\
<div class=\"line\">    <span class=\"keyword\">const</span>   boost::shared_ptr&lt;Array&lt;index_t&gt; &gt;          fArray;</div>\n\
<div class=\"line\">    <span class=\"keyword\">const</span>   <span class=\"keywordtype\">size_t</span>                                      fBeginIdx;</div>\n\
<div class=\"line\">    <span class=\"keyword\">const</span>   <span class=\"keywordtype\">size_t</span>                                      fEndIdx;</div>\n\
<div class=\"line\">};</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\"><span class=\"keyword\">public</span>:</div>\n\
<div class=\"line\">    <span class=\"keyword\">typedef</span> Alembic::Util::Digest Digest;</div>\n\
<div class=\"line\">    <span class=\"keyword\">typedef</span> boost::shared_ptr&lt;const ReadableArray&lt;float&gt; &gt; ReadableArrayPtr;</div>\n\
<div class=\"line\">    <span class=\"keyword\">typedef</span> boost::shared_ptr&lt;const ArrayReadInterface&lt;float&gt; &gt; ReadInterfacePtr;</div>\n\
<div class=\"line\">    </div>\n\
<div class=\"line\">    <span class=\"comment\">/*----- classes -----*/</span></div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"comment\">// Helper classes for implementing boost::unordered_map of</span></div>\n\
...
<div class=\"line\">    {</div>\n\
<div class=\"line\">        Key(</div>\n\
<div class=\"line\">            <span class=\"keyword\">const</span> boost::shared_ptr&lt;Array&lt;float&gt; &gt;&amp;     array,</div>\n\
...
<div class=\"line\">            std::size_t seed = 0;</div>\n\
<div class=\"line\">            boost::hash_combine(seed, ArrayBase::KeyHash()(key.fArrayKey));</div>\n\
<div class=\"line\">            boost::hash_combine(seed, key.fName);</div>\n\
<div class=\"line\">            boost::hash_combine(seed, key.fSemantic);</div>\n\
<div class=\"line\">            boost::hash_combine(seed, key.fDataType);</div>\n\
<div class=\"line\">            boost::hash_combine(seed, key.fDimension);</div>\n\
<div class=\"line\">            boost::hash_combine(seed, key.fOffset);</div>\n\
<div class=\"line\">            boost::hash_combine(seed, key.fStride);</div>\n\
<div class=\"line\">            <span class=\"keywordflow\">return</span> seed;</div>\n\
<div class=\"line\">        }</div>\n\
<div class=\"line\">    };</div>\n\
<div class=\"line\">    </div>\n\
...
<div class=\"line\">    <span class=\"comment\">/*----- static member functions -----*/</span></div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keyword\">static</span> boost::shared_ptr&lt;VertexBuffer&gt; createPositions(</div>\n\
<div class=\"line\">        <span class=\"keyword\">const</span> boost::shared_ptr&lt;Array&lt;float&gt; &gt;&amp; array);</div>\n\
<div class=\"line\">    </div>\n\
<div class=\"line\">    <span class=\"keyword\">static</span> boost::shared_ptr&lt;VertexBuffer&gt; createNormals(</div>\n\
<div class=\"line\">        <span class=\"keyword\">const</span> boost::shared_ptr&lt;Array&lt;float&gt; &gt;&amp; array);</div>\n\
<div class=\"line\">    </div>\n\
<div class=\"line\">    <span class=\"keyword\">static</span> boost::shared_ptr&lt;VertexBuffer&gt; createUVs(</div>\n\
<div class=\"line\">        <span class=\"keyword\">const</span> boost::shared_ptr&lt;Array&lt;float&gt; &gt;&amp; array);</div>\n\
<div class=\"line\">    </div>\n\
<div class=\"line\">    <span class=\"comment\">// Return the number of currently allocated IndexBuffer</span></div>\n\
<div class=\"line\">    <span class=\"comment\">// within the process.</span></div>\n\
...
<div class=\"line\">    </div>\n\
<div class=\"line\">    <span class=\"keyword\">const</span> boost::shared_ptr&lt;Array&lt;float&gt; &gt;&amp; array()<span class=\"keyword\"> const</span></div>\n\
<div class=\"line\"><span class=\"keyword\">    </span>{ <span class=\"keywordflow\">return</span> fArray; }</div>\n\
<div class=\"line\">    </div>\n\
...
<div class=\"line\">    <span class=\"comment\">// same contents as the old buffer.</span></div>\n\
<div class=\"line\">    <span class=\"comment\">// Note:  this breaks const conventions.</span></div>\n\
<div class=\"line\">    <span class=\"keywordtype\">void</span> ReplaceArrayInstance(boost::shared_ptr&lt;Array&lt;float&gt; &gt;&amp; newArray) <span class=\"keyword\">const</span>;</div>\n\
<div class=\"line\">    </div>\n\
<div class=\"line\"><span class=\"keyword\">private</span>:</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"comment\">// The constructor is declare private to force user to go through</span></div>\n\
...
<div class=\"line\">    <span class=\"comment\">/*----- static member functions -----*/</span></div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keyword\">static</span> boost::shared_ptr&lt;VertexBuffer&gt; create(</div>\n\
<div class=\"line\">        <span class=\"keyword\">const</span> boost::shared_ptr&lt;Array&lt;float&gt; &gt;&amp;     array,</div>\n\
...
<div class=\"line\">    <span class=\"comment\">/*----- data members -----*/</span></div>\n\
<div class=\"line\">    </div>\n\
<div class=\"line\">    <span class=\"keyword\">const</span>   boost::shared_ptr&lt;Array&lt;float&gt; &gt;            fArray;</div>\n\
...
<div class=\"line\">    <span class=\"comment\">/*----- static member functions -----*/</span></div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keyword\">static</span> boost::shared_ptr&lt;ShapeSample&gt; create(</div>\n\
...
<div class=\"line\">        <span class=\"keyword\">const</span> boost::shared_ptr&lt;IndexBuffer&gt;&amp;  wireVertIndices,</div>\n\
<div class=\"line\">        <span class=\"keyword\">const</span> boost::shared_ptr&lt;IndexBuffer&gt;&amp;  triangleVertIndices,</div>\n\
<div class=\"line\">        <span class=\"keyword\">const</span> boost::shared_ptr&lt;VertexBuffer&gt;&amp; positions,</div>\n\
...
<div class=\"line\">    {</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">return</span> boost::make_shared&lt;ShapeSample&gt;(</div>\n\
...
<div class=\"line\">        <span class=\"keywordtype\">size_t</span> numVerts,</div>\n\
<div class=\"line\">        <span class=\"keyword\">const</span> boost::shared_ptr&lt;IndexBuffer&gt;&amp;  wireVertIndices,</div>\n\
<div class=\"line\">        <span class=\"keyword\">const</span> std::vector&lt;boost::shared_ptr&lt;IndexBuffer&gt; &gt;&amp;  triangleVertIndices,</div>\n\
<div class=\"line\">        <span class=\"keyword\">const</span> boost::shared_ptr&lt;VertexBuffer&gt;&amp; positions,</div>\n\
...
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keyword\">static</span> boost::shared_ptr&lt;ShapeSample&gt; createEmptySample( </div>\n\
<div class=\"line\">        <span class=\"keywordtype\">double</span> timeInSeconds)</div>\n\
<div class=\"line\">    {</div>\n\
...
<div class=\"line\">            0,</div>\n\
<div class=\"line\">            boost::shared_ptr&lt;IndexBuffer&gt;(),</div>\n\
<div class=\"line\">            boost::shared_ptr&lt;IndexBuffer&gt;(),</div>\n\
<div class=\"line\">            boost::shared_ptr&lt;VertexBuffer&gt;(),</div>\n\
...
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keyword\">static</span> boost::shared_ptr&lt;ShapeSample&gt; createBoundingBoxPlaceHolderSample(</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordtype\">void</span> setNormals(<span class=\"keyword\">const</span> boost::shared_ptr&lt;VertexBuffer&gt;&amp; normals);</div>\n\
<div class=\"line\">    <span class=\"keywordtype\">void</span> setUVs(<span class=\"keyword\">const</span> boost::shared_ptr&lt;VertexBuffer&gt;&amp; uvs);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    </div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keyword\">const</span> boost::shared_ptr&lt;IndexBuffer&gt;&amp; wireVertIndices()<span class=\"keyword\"> const</span></div>\n\
<div class=\"line\"><span class=\"keyword\">    </span>{ <span class=\"keywordflow\">return</span> fWireVertIndices; }</div>\n\
<div class=\"line\">    <span class=\"keyword\">const</span> boost::shared_ptr&lt;IndexBuffer&gt;&amp; triangleVertIndices(<span class=\"keywordtype\">size_t</span> groupId)<span class=\"keyword\"> const</span></div>\n\
<div class=\"line\"><span class=\"keyword\">    </span>{ <span class=\"keywordflow\">return</span> fTriangleVertIndices[groupId]; }</div>\n\
<div class=\"line\">    <span class=\"keyword\">const</span> std::vector&lt;boost::shared_ptr&lt;IndexBuffer&gt; &gt;&amp; triangleVertexIndexGroups()<span class=\"keyword\"> const</span></div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keyword\">const</span> boost::shared_ptr&lt;VertexBuffer&gt;&amp; positions()<span class=\"keyword\"> const</span></div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keyword\">const</span> boost::shared_ptr&lt;VertexBuffer&gt;&amp; normals()<span class=\"keyword\"> const</span></div>\n\
<div class=\"line\"><span class=\"keyword\">    </span>{ <span class=\"keywordflow\">return</span> fNormals; }</div>\n\
<div class=\"line\">    <span class=\"keyword\">const</span> boost::shared_ptr&lt;VertexBuffer&gt;&amp; uvs()<span class=\"keyword\"> const</span></div>\n\
...
<div class=\"line\">    <span class=\"comment\">// The constructor is declare private to force user to go through</span></div>\n\
<div class=\"line\">    <span class=\"comment\">// the create() factory member function.</span></div>\n\
<div class=\"line\">    GPUCACHE_DECLARE_MAKE_SHARED_FRIEND_9;</div>\n\
<div class=\"line\">    </div>\n\
<div class=\"line\">    ShapeSample(</div>\n\
<div class=\"line\">        <span class=\"keywordtype\">double</span> timeInSeconds,</div>\n\
<div class=\"line\">        <span class=\"keywordtype\">size_t</span> numWires,</div>\n\
...
<div class=\"line\">    <span class=\"keyword\">const</span> boost::shared_ptr&lt;IndexBuffer&gt;                fWireVertIndices;</div>\n\
<div class=\"line\">    <span class=\"keyword\">const</span> std::vector&lt;boost::shared_ptr&lt;IndexBuffer&gt; &gt;  fTriangleVertIndices;</div>\n\
<div class=\"line\">    <span class=\"keyword\">const</span> boost::shared_ptr&lt;VertexBuffer&gt;               fPositions;</div>\n\
...
<div class=\"line\">    boost::shared_ptr&lt;VertexBuffer&gt;                     fNormals;</div>\n\
<div class=\"line\">    boost::shared_ptr&lt;VertexBuffer&gt;                     fUVs;</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    <span class=\"comment\">/*----- static member functions -----*/</span></div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keyword\">static</span> boost::shared_ptr&lt;XformSample&gt; create(</div>\n\
<div class=\"line\">        <span class=\"keywordtype\">double</span>              timeInSeconds,</div>\n\
...
<div class=\"line\">        <span class=\"keywordtype\">bool</span>                visibility)</div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">return</span> boost::make_shared&lt;XformSample&gt;(</div>\n\
...
<div class=\"line\">    <span class=\"comment\">// The constructor is declare private to force user to go through</span></div>\n\
<div class=\"line\">    <span class=\"comment\">// the create() factory member function.</span></div>\n\
<div class=\"line\">    GPUCACHE_DECLARE_MAKE_SHARED_FRIEND_4;</div>\n\
<div class=\"line\"></div>\n\
