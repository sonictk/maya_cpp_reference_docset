...
<div class=\"line\">        assert(!visibilityPlug.<a name=\"a2\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a1c18142e8f09680711f472aa2ddf8ac6\">isNull</a>());</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span> (!visibilityPlug.<a name=\"a3\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#aea1ddab8d4272d03146b3dad29be3af0\">asBool</a>()) {</div>\n\
...
<div class=\"line\">        assert(!drawOverridePlug.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a1c18142e8f09680711f472aa2ddf8ac6\">isNull</a>());</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">        <a name=\"_a4\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug_array.html\">MPlugArray</a> displayLayers;</div>\n\
<div class=\"line\">        drawOverridePlug.<a name=\"a5\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a3727c18c58fc5ba8be5fb2582b5d06f1\">connectedTo</a>(displayLayers, <span class=\"keyword\">true</span>, <span class=\"keyword\">false</span>);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">                assert(!visibilityPlug.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a1c18142e8f09680711f472aa2ddf8ac6\">isNull</a>());</div>\n\
<div class=\"line\">                <span class=\"keywordflow\">if</span> (!visibilityPlug.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#aea1ddab8d4272d03146b3dad29be3af0\">asBool</a>()) {</div>\n\
<div class=\"line\">                    <span class=\"keywordflow\">return</span> <span class=\"keyword\">false</span>;</div>\n\
<div class=\"line\">                }</div>\n\
<div class=\"line\">            }</div>\n\
<div class=\"line\">        }</div>\n\
...
<div class=\"line\">        boost::unordered_set&lt;WirePair, typename WirePair::Hash, typename WirePair::EqualTo&gt;</div>\n\
...
<div class=\"line\">        BOOST_FOREACH(<span class=\"keyword\">const</span> WirePair&amp; pair, wireSet) {</div>\n\
...
<div class=\"line\">        <span class=\"keyword\">typedef</span> boost::unordered_map&lt;IndexTuple,size_t,typename IndexTuple::Hash,typename IndexTuple::EqualTo&gt; IndicesMap;</div>\n\
...
<div class=\"line\">        BOOST_FOREACH(<span class=\"keyword\">const</span> <span class=\"keyword\">typename</span> IndicesMap::value_type&amp; pair, indicesMap) {</div>\n\
...
<div class=\"line\">            assert(status == <a name=\"a19\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80af0536797208144380691e2b376ffc1d1\">MS::kSuccess</a>);</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">            <span class=\"comment\">// Copy Maya arrays</span></div>\n\
<div class=\"line\">            numFaceCounts             = mayaVertexCount.<a name=\"a20\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_int_array.html#a580388f31f60c46fac867ca48a48da1e\">length</a>();</div>\n\
...
<div class=\"line\">        {</div>\n\
<div class=\"line\">            <a name=\"_a21\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_float_point_array.html\">MFloatPointArray</a> mayaPositions;</div>\n\
...
<div class=\"line\">            <span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span> numPositions = mayaPositions.<a name=\"a22\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_float_point_array.html#a580388f31f60c46fac867ca48a48da1e\">length</a>();</div>\n\
...
<div class=\"line\">                <a name=\"_a23\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_float_point.html\">MFloatPoint</a>&amp; point = mayaPositions[i];</div>\n\
<div class=\"line\">                positions[i * 3 + 0] = point.<a name=\"a24\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_float_point.html#ad0da36b2558901e21e7a30f6c227a45e\">x</a>;</div>\n\
<div class=\"line\">                positions[i * 3 + 1] = point.<a name=\"a25\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_float_point.html#aa4f0d3eebc3c443f9be81bf48561a217\">y</a>;</div>\n\
<div class=\"line\">                positions[i * 3 + 2] = point.<a name=\"a26\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_float_point.html#af73583b1e980b0aa03f9884812e9fd4d\">z</a>;</div>\n\
<div class=\"line\">            }</div>\n\
<div class=\"line\">        }</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">        {</div>\n\
<div class=\"line\">            <a name=\"_a27\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_float_vector_array.html\">MFloatVectorArray</a> mayaNormals;</div>\n\
...
<div class=\"line\">            <span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span> numNormals   = mayaNormals.<a name=\"a28\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_float_vector_array.html#a580388f31f60c46fac867ca48a48da1e\">length</a>();</div>\n\
...
<div class=\"line\">            <a name=\"_a29\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_float_array.html\">MFloatArray</a> mayaUArray, mayaVArray;</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">            <span class=\"comment\">// Allocate memory for normals</span></div>\n\
<div class=\"line\">            <span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span> numUVs   = mayaUArray.<a name=\"a30\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_float_array.html#a580388f31f60c46fac867ca48a48da1e\">length</a>();</div>\n\
...
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    boost::shared_ptr&lt;ReadableArray&lt;index_type&gt; &gt;&amp; triangleIndices()</div>\n\
<div class=\"line\">    { <span class=\"keywordflow\">return</span> fTriangleIndices; }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    boost::shared_ptr&lt;ReadableArray&lt;index_type&gt; &gt;&amp; wireIndices()</div>\n\
<div class=\"line\">    { <span class=\"keywordflow\">return</span> fWireIndices; }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    boost::shared_ptr&lt;ReadableArray&lt;float&gt; &gt;&amp; positions()</div>\n\
<div class=\"line\">    { <span class=\"keywordflow\">return</span> fPositions; }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    boost::shared_ptr&lt;ReadableArray&lt;float&gt; &gt;&amp; normals()</div>\n\
<div class=\"line\">    { <span class=\"keywordflow\">return</span> fNormals; }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    boost::shared_ptr&lt;ReadableArray&lt;float&gt; &gt;&amp; uvs()</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"comment\">// Input</span></div>\n\
<div class=\"line\">    <a name=\"_a31\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_mesh.html\">MFnMesh</a> fPolyMesh;</div>\n\
<div class=\"line\">    <span class=\"keywordtype\">bool</span>    fWantUVs;</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"comment\">// Output</span></div>\n\
<div class=\"line\">    boost::shared_ptr&lt;ReadableArray&lt;index_type&gt; &gt; fTriangleIndices;</div>\n\
<div class=\"line\">    boost::shared_ptr&lt;ReadableArray&lt;index_type&gt; &gt; fWireIndices;</div>\n\
<div class=\"line\">    boost::shared_ptr&lt;ReadableArray&lt;float&gt; &gt;      fPositions;</div>\n\
<div class=\"line\">    boost::shared_ptr&lt;ReadableArray&lt;float&gt; &gt;      fNormals;</div>\n\
<div class=\"line\">    boost::shared_ptr&lt;ReadableArray&lt;float&gt; &gt;      fUVs;</div>\n\
<div class=\"line\">};</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    <span class=\"keyword\">virtual</span> ~SubNodeTransparentTypeVisitor() {}</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    {}</div>\n\
<div class=\"line\">    <span class=\"keyword\">virtual</span> ~BoundingBoxVisitor() {}</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"comment\">// Returns the current bounding box.</span></div>\n\
<div class=\"line\">    <span class=\"keyword\">const</span> <a name=\"_a32\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_bounding_box.html\">MBoundingBox</a>&amp; boundingBox()<span class=\"keyword\"> const</span></div>\n\
...
<div class=\"line\">    {}</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keyword\">virtual</span> ~ShapePathVisitor() </div>\n\
<div class=\"line\">    {}</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keyword\">virtual</span> <span class=\"keywordtype\">void</span> visit(<span class=\"keyword\">const</span> XformData&amp; xform,</div>\n\
<div class=\"line\">                       <span class=\"keyword\">const</span> SubNode&amp;   subNode)</div>\n\
...
<div class=\"line\">        <a name=\"_a33\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html\">MString</a> path;</div>\n\
...
<div class=\"line\">    <a name=\"_a34\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string_array.html\">MStringArray</a> steps;</div>\n\
<div class=\"line\">    path.<a name=\"a35\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html#ac914d138fc96d7065c687a4f8b40c263\">split</a>(<span class=\"charliteral\">&#39;|&#39;</span>, steps);</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"comment\">// Invalid path</span></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> (steps.<a name=\"a36\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string_array.html#a580388f31f60c46fac867ca48a48da1e\">length</a>() == 0) <span class=\"keywordflow\">return</span> <span class=\"keyword\">false</span>;</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">        BOOST_FOREACH (<span class=\"keyword\">const</span> SubNode::Ptr&amp; child, top-&gt;getChildren()) {</div>\n\
...
<div class=\"line\">        BOOST_FOREACH (<span class=\"keyword\">const</span> SubNode::Ptr&amp; child, current-&gt;getChildren()) {</div>\n\
...
<div class=\"line\">    SubNode::MPtr mCurrent = boost::const_pointer_cast&lt;SubNode&gt;(current);</div>\n\
<div class=\"line\">    SubNode::MPtr mNode    = boost::const_pointer_cast&lt;SubNode&gt;(node);</div>\n\
...
<div class=\"line\">                copyChild = boost::const_pointer_cast&lt;SubNode&gt;(current);</div>\n\
<div class=\"line\">            }</div>\n\
