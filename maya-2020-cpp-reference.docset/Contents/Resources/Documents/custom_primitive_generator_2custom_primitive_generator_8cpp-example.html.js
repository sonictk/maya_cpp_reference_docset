...
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    MGeometry::Primitive generateIndexing(<span class=\"keyword\">const</span> <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html\">MObject</a>&amp; <span class=\"keywordtype\">object</span>, <span class=\"keyword\">const</span> <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html\">MObject</a>&amp; component,</div>\n\
...
<div class=\"line\">        <span class=\"keywordflow\">if</span> (!status) <span class=\"keywordflow\">return</span> MGeometry::kInvalidPrimitive; <span class=\"comment\">// failed </span></div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">        <span class=\"keywordflow\">for</span> (<span class=\"keywordtype\">int</span> x = 0; x &lt; targetIndexing.<a name=\"a7\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_component_data_indexing_list.html#a57b988236ee6a3a5e572d126d3fbccc1\">length</a>(); ++x)</div>\n\
<div class=\"line\">        {</div>\n\
<div class=\"line\">            <span class=\"keyword\">const</span> <a name=\"_a8\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_component_data_indexing.html\">MComponentDataIndexing</a>* target = targetIndexing[x];</div>\n\
<div class=\"line\">            <span class=\"keywordflow\">if</span> (target-&gt;<a name=\"a9\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_component_data_indexing.html#a330af2f0831eb13655cd7134eb49fd2e\">componentType</a>() == MComponentDataIndexing::kFaceVertex)</div>\n\
<div class=\"line\">            {</div>\n\
<div class=\"line\">                <span class=\"comment\">// Get Triangles</span></div>\n\
<div class=\"line\">                <a name=\"_a10\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_int_array.html\">MIntArray</a> triCounts;</div>\n\
<div class=\"line\">                <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_int_array.html\">MIntArray</a> triVertIDs;</div>\n\
<div class=\"line\">                mesh.<a name=\"a11\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_mesh.html#a21f54d9e1ca3cbed6492f576f9f61215\">getTriangleOffsets</a>(triCounts, triVertIDs);</div>\n\
<div class=\"line\">                <span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span> numTriVerts = triVertIDs.<a name=\"a12\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_int_array.html#a580388f31f60c46fac867ca48a48da1e\">length</a>();</div>\n\
<div class=\"line\">  </div>\n\
<div class=\"line\">                <span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span> customNumTriVerts = numTriVerts * 2;</div>\n\
<div class=\"line\">                <span class=\"keywordtype\">void</span>* indexData = indexBuffer.<a name=\"a13\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_index_buffer.html#aff9e3c2ed40ad0c0f0fe55668670d071\">acquire</a>(customNumTriVerts, <span class=\"keyword\">true</span> <span class=\"comment\">/*writeOnly - we don&#39;t need the current buffer values*/</span>);</div>\n\
<div class=\"line\">                <span class=\"keywordflow\">if</span> (indexData == NULL)</div>\n\
<div class=\"line\">                    <span class=\"keywordflow\">return</span> MGeometry::kInvalidPrimitive;</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">                <span class=\"keyword\">const</span> <a name=\"_a14\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_uint_array.html\">MUintArray</a>&amp; sharedIndices = target-&gt;<a name=\"a15\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_component_data_indexing.html#add6ba44a469f954709b358f65584542f\">indices</a>();</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">                <span class=\"keywordflow\">for</span>(<span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span> idx = 0; idx &lt; sharedIndices.<a name=\"a16\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_uint_array.html#a580388f31f60c46fac867ca48a48da1e\">length</a>(); ++idx)</div>\n\
...
<div class=\"line\">                    <span class=\"keywordflow\">if</span> (indexBuffer.<a name=\"a17\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_index_buffer.html#abc7588a483f61d3d4a1e8204ca14d6f6\">dataType</a>() == MGeometry::kUnsignedInt32) {</div>\n\
...
<div class=\"line\">                    }</div>\n\
<div class=\"line\">                    <span class=\"keywordflow\">else</span> <span class=\"keywordflow\">if</span> (indexBuffer.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_index_buffer.html#abc7588a483f61d3d4a1e8204ca14d6f6\">dataType</a>() == MGeometry::kUnsignedChar) {</div>\n\
...
<div class=\"line\">                }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">                indexBuffer.<a name=\"a18\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_index_buffer.html#aafb3736206f8a73c0fc74757919cfb83\">commit</a>(indexData);</div>\n\
<div class=\"line\">                primitiveStride = 3;</div>\n\
<div class=\"line\">                <span class=\"keywordflow\">return</span> MGeometry::kTriangles;</div>\n\
<div class=\"line\">            }</div>\n\
<div class=\"line\">        }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">        <span class=\"keywordflow\">return</span> MGeometry::kInvalidPrimitive;</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"><span class=\"keyword\">class </span>MyCustomPositionBufferGenerator : <span class=\"keyword\">public</span> <a name=\"_a19\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_px_vertex_buffer_generator.html\">MPxVertexBufferGenerator</a></div>\n\
<div class=\"line\">{</div>\n\
<div class=\"line\"><span class=\"keyword\">public</span>:</div>\n\
...
<div class=\"line\">        vertices.<a name=\"a20\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_uint_array.html#a8c66dfa06f3736b2a214c5aed58bd216\">setLength</a>(vertCount);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">        sourceIndexing.<a name=\"a21\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_component_data_indexing.html#a5a0c45f0f5203d71fc23d2ca2a8976d4\">setComponentType</a>(MComponentDataIndexing::kFaceVertex);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">        <a name=\"_a22\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string_array.html\">MStringArray</a> &amp;sourceStreams)<span class=\"keyword\"> const override</span></div>\n\
<div class=\"line\"><span class=\"keyword\">    </span>{</div>\n\
...
<div class=\"line\">        <span class=\"keywordtype\">int</span> dimension = descriptor.<a name=\"a28\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_vertex_buffer_descriptor.html#ae5acbe47d704ceb866e3717e2ac9422f\">dimension</a>();</div>\n\
...
<div class=\"line\">        <span class=\"keywordflow\">if</span> (descriptor.<a name=\"a29\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_vertex_buffer_descriptor.html#abc8db8e8585a67a40d57c26811aaf8e2\">semantic</a>() != MGeometry::kPosition)</div>\n\
<div class=\"line\">            <span class=\"keywordflow\">return</span>;</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">        <span class=\"comment\">// get the mesh from the current path</span></div>\n\
<div class=\"line\">        <span class=\"comment\">// if it is not a mesh we do nothing.</span></div>\n\
...
<div class=\"line\">        <span class=\"keywordtype\">float</span>* customBuffer = (<span class=\"keywordtype\">float</span>*)vertexBuffer.<a name=\"a30\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_vertex_buffer.html#aff9e3c2ed40ad0c0f0fe55668670d071\">acquire</a>(newVertexCount, <span class=\"keyword\">true</span> <span class=\"comment\">/*writeOnly - we don&#39;t need the current buffer values*/</span>);</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">                customBuffer[vertId * dimension] = (float)point.<a name=\"a32\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_point.html#af88b946fb90d5f08b5fb740c70e98c10\">x</a>;</div>\n\
<div class=\"line\">                customBuffer[vertId * dimension + 1] = (<span class=\"keywordtype\">float</span>)point.<a name=\"a33\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_point.html#ab927965981178aa1fba979a37168db2a\">y</a>;</div>\n\
<div class=\"line\">                customBuffer[vertId * dimension + 2] = (float)point.<a name=\"a34\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_point.html#ab3e6ed577a7c669c19de1f9c1b46c872\">z</a>;</div>\n\
<div class=\"line\">            }</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">            }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">            vertexBuffer.<a name=\"a35\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_vertex_buffer.html#aafb3736206f8a73c0fc74757919cfb83\">commit</a>(customBufferStart);</div>\n\
<div class=\"line\">        }</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\">};</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">        <span class=\"keywordflow\">if</span> (descriptor.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_vertex_buffer_descriptor.html#abc8db8e8585a67a40d57c26811aaf8e2\">semantic</a>() != MGeometry::kNormal)</div>\n\
<div class=\"line\">            <span class=\"keywordflow\">return</span>;</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">        <span class=\"comment\">// get the mesh from the current path</span></div>\n\
<div class=\"line\">        <span class=\"comment\">// if it is not a mesh we do nothing.</span></div>\n\
...
<div class=\"line\">            <span class=\"keywordtype\">float</span>* customBufferStart = customBuffer;</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">            <a name=\"_a36\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_float_vector_array.html\">MFloatVectorArray</a> normals;</div>\n\
...
<div class=\"line\">            <span class=\"keywordflow\">for</span>(; vertId &lt; vertexCount; ++vertId)</div>\n\
<div class=\"line\">            {</div>\n\
<div class=\"line\">                <span class=\"keyword\">const</span> <a name=\"_a37\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_float_vector.html\">MFloatVector</a>&amp; normal = normals[vertId];</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">                customBuffer[vertId * dimension] = normal.<a name=\"a38\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_float_vector.html#ad0da36b2558901e21e7a30f6c227a45e\">x</a>;</div>\n\
<div class=\"line\">                customBuffer[vertId * dimension + 1] = normal.<a name=\"a39\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_float_vector.html#aa4f0d3eebc3c443f9be81bf48561a217\">y</a>;</div>\n\
<div class=\"line\">                customBuffer[vertId * dimension + 2] = normal.<a name=\"a40\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_float_vector.html#af73583b1e980b0aa03f9884812e9fd4d\">z</a>;</div>\n\
<div class=\"line\">            }</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">{</div>\n\
<div class=\"line\">    <a name=\"a41\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_draw_registry.html#a3c98934dba009882c753986dcfeaa422\">MDrawRegistry::registerPrimitiveGenerator</a>(<span class=\"stringliteral\">&quot;customPrimitiveTest&quot;</span>, createMyCustomPrimitiveGenerator);</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <a name=\"a42\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_draw_registry.html#aad2a7378bd3b995cf222d665030a08f0\">MDrawRegistry::registerVertexBufferGenerator</a>(<span class=\"stringliteral\">&quot;customPositionStream&quot;</span>, createMyCustomPositionBufferGenerator);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">{</div>\n\
<div class=\"line\">    <a name=\"a43\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_draw_registry.html#af120d99c2aa438645f361c625f5975a5\">MDrawRegistry::deregisterPrimitiveGenerator</a>(<span class=\"stringliteral\">&quot;customPrimitiveTest&quot;</span>);</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <a name=\"a44\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_draw_registry.html#a9c4ddee2564a6aa587a2407f8ba301b8\">MDrawRegistry::deregisterVertexBufferGenerator</a>(<span class=\"stringliteral\">&quot;customPositionStream&quot;</span>);</div>\n\
<div class=\"line\"></div>\n\
