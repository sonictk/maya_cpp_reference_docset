...
<p>The helix plug-in generates a simple curve, but it always produces the same curve (see <a href=\'#!/url=./dev_help/Maya-API-introduction/Important-plug-in-features.html#building-a-curve-using-a-plug-in\' title=\'\'>Building a curve using a plug-in</a>).</p>\n\
