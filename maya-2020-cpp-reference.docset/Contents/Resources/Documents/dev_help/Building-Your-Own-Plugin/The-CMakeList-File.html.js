...
<div class=\"codeBlock\"><pre class=\"prettyprint lang-sh\">cmake_minimum_required(VERSION 2.8)</pre></div></li>\n\
...
<p>```sh cmake_minimum_required(VERSION 2.8)</p>\n\
...
<li><p>A list of required 3rd party packages added using the <a href=\'#!/url=./dev_help/Building-Your-Own-Plugin/LibraryMacros.html\' title=\'\'><span class=\'code\'>find_&lt;package_name&gt;</span></a> macros or the <a href=\'#!/url=./dev_help/Building-Your-Own-Plugin/ThirdPartyLibs.html\' title=\'\'><span class=\'code\'>find_package()</span></a> call.</p>\n\
