...
<blockquote>\n\
<p><strong>Tip:</strong> If you are using the Browse button in the Plug-in Manager to load your plug-in, you must set Files of type to All Files (instead of Plug-in Files) in the Load Plugin browser window to see your <span class=\'code\'>.nll.dll</span> plug-ins.</p>\n\
</blockquote></li>\n\
</ul>\n\
