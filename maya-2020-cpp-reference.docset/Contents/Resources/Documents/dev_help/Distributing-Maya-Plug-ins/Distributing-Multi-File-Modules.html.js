...
<p>See <a href=\'#!/url=./dev_help/Distributing-Maya-Plug-ins/Maya-module-paths-folders-and.html\' title=\'\'>Specifying the conditions for loading the module</a> for more information.</p>\n\
...
<p>There are three approaches to doing this which are identical to those discussed for the MAYA_PLUG_IN_PATH variable in <a href=\'#!/url=./dev_help/Distributing-Maya-Plug-ins/Distributing-individual-files.html\' title=\'\'>Distributing individual files</a>.</p>\n\
...
<p>You can also set an environment variable to a directory of your choice. To do so, you must create a <span class=\'code\'>Maya.env</span> file. See <a href=\'#!/url=./dev_help/Setting-up-your-build.html\' title=\'\'>Setting up your build environment</a> for information about <span class=\'code\'>Maya.env</span>.</p>\n\
</blockquote>\n\
