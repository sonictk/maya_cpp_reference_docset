...
<blockquote>\n\
<p><strong>Tip:</strong> To summarize, the four environment variables described above are: - MAYA_PLUG_IN_PATH - directories to search for plug-ins - MAYA_SCRIPT_PATH - directories to search for MEL and Python scripts - XBMLANGPATH - directories to search for icons - MAYA_PRESET_PATH - directories to search for Maya presets</p>\n\
</blockquote>\n\
...
</pre></div><p>You can also set an environment variable to a directory of your choice. To do so, you must create a <span class=\'code\'>Maya.env</span> file. See <a href=\'#!/url=./dev_help/Setting-up-your-build.html\' title=\'\'>Setting up your build environment</a> for information about <span class=\'code\'>Maya.env</span>.</p>\n\
<div class=\'section\'><a id=\"related-topics\"></a><h2 id=\"related-topics\">Related topics</h2></div>\n\
<ul>\n\
<li><a href=\'#!/url=./dev_help/Setting-up-your-build.html\' title=\'\'>Setting up your build environment</a></li>\n\
<li><a href=\'#!/url=./dev_help/Installing-Maya-plug-ins.html\' title=\'\'>Installing Maya plug-ins</a></li>\n\
</ul>\n\
