...
<tr class=\"memdesc:a7540acbbc56b2f60e83bb5e0cc7c75eb\"><td class=\"mdescLeft\">&#160;</td><td class=\"mdescRight\">The method is called by Maya when creating the subscene.  <a href=\"class_m_h_w_render_1_1_m_px_sub_scene_override.html#a7540acbbc56b2f60e83bb5e0cc7c75eb\">More...</a><br></td></tr>\n\
...
<p>When a geometry is completely defined by its vertex buffers, like when drawing all points in a MGeometry::kPoints render item, it is possible to provide an empty <a class=\"el\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_index_buffer.html\" title=\"Index buffer for use with MGeometry. \">MIndexBuffer</a>. The geometry will then be drawn using a non-indexed draw call like glDrawArrays() or ID3D11DeviceContext::Draw().</p>\n\
<dl class=\"params\"><dt>Parameters</dt><dd>\n\
  <table class=\"params\">\n\
