...
<div class=\"line\">    MGlobal::MSelectionMode fPreviousSelectionMode;</div>\n\
...
<div class=\"line\">{</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> ( event.<a name=\"a20\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_event.html#a80d4daf707c95e6f64086aab4af1ea89\">mouseButton</a>() != MEvent::kLeftMouse || </div>\n\
...
<div class=\"line\">        <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_selection_mask.html\">MSelectionMask</a> mask = MSelectionMask::kSelectMeshUVs;</div>\n\
...
<div class=\"line\">        <a name=\"_a21\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_selection_list.html\">MSelectionList</a>  selectionList;</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">        <span class=\"keywordtype\">bool</span> bSelect = <a name=\"a22\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_px_tex_context.html#a2393d05257129bd75cbce23928978515\">MPxTexContext::getMarqueeSelection</a>( x - fBrushConfig.size(), y - fBrushConfig.size(), </div>\n\
...
<div class=\"line\">        {</div>\n\
<div class=\"line\">            <a name=\"_a23\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html\">MObject</a> component;</div>\n\
<div class=\"line\">            selectionList.<a name=\"a24\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_selection_list.html#a16dda1a34d5f10be257d8421ac6deabd\">getDagPath</a>( 0, fDagPath, component );</div>\n\
<div class=\"line\">            fDagPath.extendToShape();</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">            <a name=\"_a25\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_mesh.html\">MFnMesh</a> mesh(fDagPath);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">            <span class=\"keywordflow\">if</span>( component.<a name=\"a26\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html#a7e5fd5d37dde6df8c0cf350e00ca0a75\">apiType</a>() == <a name=\"a27\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn.html#a1d1cfd8ffb84e947f82999c682b666a7a0b774c2a128a8b2365fff164212f2e43\">MFn::kMeshMapComponent</a> )</div>\n\
<div class=\"line\">            {</div>\n\
<div class=\"line\">                <a name=\"_a28\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_single_indexed_component.html\">MFnSingleIndexedComponent</a> compFn( component );</div>\n\
<div class=\"line\">                compFn.getElements( UVsToTest );</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">                <span class=\"keywordflow\">for</span> (<span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span> i = 0; i &lt; UVsToTest.<a name=\"a29\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_int_array.html#a580388f31f60c46fac867ca48a48da1e\">length</a>(); ++i)</div>\n\
<div class=\"line\">                {</div>\n\
...
<div class=\"line\">{</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> (event.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_event.html#a80d4daf707c95e6f64086aab4af1ea89\">mouseButton</a>() != MEvent::kLeftMouse || </div>\n\
<div class=\"line\">        !<span class=\"keyword\">event</span>.isModifierNone() )</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">return</span> MS::kFailure;</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">        fBrushCenterScreenPoint = <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_point.html\">MPoint</a>( x, y );</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">        <a name=\"_a30\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_float_array.html\">MFloatArray</a> uUVsExported;</div>\n\
<div class=\"line\">        <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_float_array.html\">MFloatArray</a> vUVsExported;</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">        <span class=\"keyword\">const</span> <a name=\"_a31\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_vector.html\">MVector</a> vec = fCurrentPoint - fLastPoint;</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span> (!fCommand)</div>\n\
<div class=\"line\">        {</div>\n\
...
<div class=\"line\">            <a name=\"_a32\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_double_array.html\">MDoubleArray</a> pinData;</div>\n\
<div class=\"line\">            <a name=\"_a33\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_uint_array.html\">MUintArray</a> uvPinIds;</div>\n\
...
<div class=\"line\">            <span class=\"keywordtype\">int</span> len = pinData.<a name=\"a34\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_double_array.html#a580388f31f60c46fac867ca48a48da1e\">length</a>();</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">            fullPinData.<a name=\"a35\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_double_array.html#a8c66dfa06f3736b2a214c5aed58bd216\">setLength</a>(nbUVs);</div>\n\
...
<div class=\"line\">                    uValues.<a name=\"a36\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_float_array.html#a6d61a0ea5cd7a087db5ee81a990d4307\">append</a>( u );</div>\n\
...
<div class=\"line\">    drawMgr.<a name=\"a37\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_u_i_draw_manager.html#a9008ebfa63c02670625076230d77c3f9\">beginDrawable</a>();</div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">        drawMgr.<a name=\"a38\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_u_i_draw_manager.html#a9baede3e37abe9551e50a8c6be65ec4d\">setColor</a>( <a name=\"_a39\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_color.html\">MColor</a>(1.f, 1.f, 1.f) ); </div>\n\
<div class=\"line\">        drawMgr.<a name=\"a40\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_u_i_draw_manager.html#a00a63eea91630b196deea094e30c0f42\">setLineWidth</a>( 2.0f );</div>\n\
<div class=\"line\">        drawMgr.<a name=\"a41\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_u_i_draw_manager.html#ab7d5ddc19d298f47247624c95647e7d1\">circle2d</a>(<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_point.html\">MPoint</a>(fBrushCenterScreenPoint.x, fBrushCenterScreenPoint.y), fBrushConfig.size());</div>\n\
<div class=\"line\">    }               </div>\n\
<div class=\"line\">    drawMgr.<a name=\"a42\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_u_i_draw_manager.html#a78c343c25a05be7e46dd4b7ebab82ff6\">endDrawable</a>();</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">return</span> MS::kSuccess;</div>\n\
<div class=\"line\">}</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\"><span class=\"keyword\"></span>{</div>\n\
<div class=\"line\">    name.<a name=\"a43\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html#acee761fe098fc30a5ac1437e3aca5bc0\">set</a>(<span class=\"stringliteral\">&quot;grabUV&quot;</span>);</div>\n\
<div class=\"line\">}</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\"><span class=\"comment\">//---------------------------------------------</span></div>\n\
<div class=\"line\"><span class=\"keyword\">class </span>grabUVContextCommand : <span class=\"keyword\">public</span> <a name=\"_a44\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_px_context_command.html\">MPxContextCommand</a></div>\n\
<div class=\"line\">{</div>\n\
<div class=\"line\"><span class=\"keyword\">public</span>:  </div>\n\
<div class=\"line\">                        grabUVContextCommand();</div>\n\
<div class=\"line\">    <span class=\"keyword\">virtual</span> <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html\">MStatus</a>     <a name=\"a45\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_px_context_command.html#a8398b14f3ec13c9f7b12ff06b7b5bc60\">doEditFlags</a>();</div>\n\
<div class=\"line\">    <span class=\"keyword\">virtual</span> <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html\">MStatus</a>     <a name=\"a46\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_px_context_command.html#aac27812cb6ea1797b391dde62d2a6359\">doQueryFlags</a>();</div>\n\
<div class=\"line\">    <span class=\"keyword\">virtual</span> <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html\">MStatus</a>     <a name=\"a47\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_px_context_command.html#aebce411ed7652b491d2b7c1938b8042c\">appendSyntax</a>();</div>\n\
<div class=\"line\">    <span class=\"keyword\">virtual</span> <a name=\"_a48\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_px_context.html\">MPxContext</a>* <a name=\"a49\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_px_context_command.html#a69d6fc56205518e4be6c0ced911e6523\">makeObj</a>();</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> (argData.<a name=\"a51\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_arg_parser.html#aa38abc6623182dacee0fcb4136e403b8\">isFlagSet</a>(kSizeFlag)) {</div>\n\
<div class=\"line\">        <span class=\"keywordtype\">double</span> size;</div>\n\
<div class=\"line\">        status = argData.<a name=\"a52\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_arg_parser.html#a74bdc5edb84381a46ce3a0de74230938\">getFlagArgument</a>(kSizeFlag, 0, size);</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span> (!status) {</div>\n\
<div class=\"line\">            status.<a name=\"a53\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a1f01a4748fea4d8bcced082df83f804d\">perror</a>(<span class=\"stringliteral\">&quot;size flag parsing failed.&quot;</span>);</div>\n\
...
<div class=\"line\">{</div>\n\
<div class=\"line\">    <a name=\"_a54\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_syntax.html\">MSyntax</a> mySyntax = syntax();</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> (MS::kSuccess != mySyntax.<a name=\"a55\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_syntax.html#aeaeaac3794bb4de8004afb1ac1829488\">addFlag</a>(kSizeFlag, kSizeFlagLong,</div>\n\
...
<div class=\"line\">    <a name=\"_a56\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_plugin.html\">MFnPlugin</a> plugin( obj, <span class=\"stringliteral\">&quot;&quot;</span>, <span class=\"stringliteral\">&quot;2015&quot;</span>, <span class=\"stringliteral\">&quot;Any&quot;</span>);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">    <a name=\"a57\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/group___macros.html#ga2f3f1ac62ed663f5efd20ff99991335b\">CHECK_MSTATUS_AND_RETURN_IT</a>(status);</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">return</span> status;</div>\n\
<div class=\"line\">}</div>\n\
<div class=\"line\"></div>\n\
