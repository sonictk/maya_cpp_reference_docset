...
<html>\n\
   <head><script src=\"../scripts/yepnope.1.5.4-min.js\" type=\"text/javascript\"></script><script src=\"../scripts/lib/jquery-1.11.1.min.js\" type=\"text/javascript\"></script>\n\
      <title>C++ API Reference: hwRenderPostEffect/hwRenderPostEffect.cpp</title>\n\
      \n\
	  \n\
      \n\
      \n\
...
$(window).load( function() {\n\
 ...
 if (!tocSystemNeedsToBeLoaded) { cpp_ref_initializeToc(); }\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>C++ API Reference: hwRenderPostEffect/hwRenderPostEffect.cpp</h1>\n\
         </div>\n\
\n\
...
<div class=\"line\">        <a name=\"_a3\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_hardware_renderer.html\">MHardwareRenderer</a> *pRenderer = <a name=\"a4\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_hardware_renderer.html#a93fef222f7278c123e8df750f7f0ea5b\">MHardwareRenderer::theRenderer</a>();</div>\n\
...
<div class=\"line\">                pRenderer-&gt;removeDrawProcedure( backEndStr, ePtr, ePtr-&gt;mLocation );</div>\n\
...
<div class=\"line\">            <span class=\"keyword\">const</span> <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html\">MString</a> &amp; backEndStr = pRenderer-&gt;backEndString();</div>\n\
<div class=\"line\">            <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_hardware_renderer.html#a14dafbca9ec0aa5132598b888511bfcb\">MHardwareRenderer::DrawProcedureStatusCode</a> result = </div>\n\
<div class=\"line\">                pRenderer-&gt;addDrawProcedure( backEndStr, ePtr, location );</div>\n\
...
<div class=\"line\">        pRenderer-&gt;getBufferSize( backEndStr, width, height );</div>\n\
...
<div class=\"line\">    pRenderer-&gt;getCurrentExposureNumber( backEndStr, exposureNum );</div>\n\
<div class=\"line\">    pRenderer-&gt;getTotalExposureCount( backEndStr, totalExposureCount );</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    <span class=\"keywordflow\">if</span> ( xxxx &amp;&amp; mLocation == <a name=\"a6\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_hardware_renderer.html#a0526f0a40dc8240e14bfb22ebf93d986a40faa5492f345487e604f7fd7196f019\">MHardwareRenderer::kPostRendering</a> )</div>\n\
<div class=\"line\">    {</div>\n\
...
<div class=\"line\">        stat = pRenderer-&gt;getColorBufferPixelFormat( backEndStr, colFmt );</div>\n\
...
<div class=\"line\">            <span class=\"keywordflow\">return</span> <span class=\"keyword\">false</span>;</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span> (colFmt == <a name=\"a7\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_hardware_renderer.html#a9e9dd2b7e61c97fa71a280792980f7daa3f2006edd7ae9e9783a9e850c2ef2963\">MHardwareRenderer::kRGBA_Fix8</a>)</div>\n\
<div class=\"line\">        {</div>\n\
...
<div class=\"line\">        <span class=\"keywordflow\">else</span> <span class=\"keywordflow\">if</span> (<a name=\"a8\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_hardware_renderer.html#a9e9dd2b7e61c97fa71a280792980f7daad2a6f3e6707b26d54e5bf286461a4bd5\">MHardwareRenderer::kRGBA_Float16</a>)</div>\n\
<div class=\"line\">        {       </div>\n\
...
<div class=\"line\">        <span class=\"keywordflow\">if</span> ( (mLocation == <a name=\"a9\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_hardware_renderer.html#a0526f0a40dc8240e14bfb22ebf93d986aef844aa5884692f98da12f4b6498b98f\">MHardwareRenderer::kPreRendering</a> ) ||</div>\n\
<div class=\"line\">             ( mLocation == <a name=\"a10\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_hardware_renderer.html#a0526f0a40dc8240e14bfb22ebf93d986a6742f06270edc03dc6e4fab458575a65\">MHardwareRenderer::kPreExposure</a>) )</div>\n\
<div class=\"line\">        {</div>\n\
<div class=\"line\">            cout&lt;&lt;<span class=\"stringliteral\">&quot;Call EXP[&quot;</span>&lt;&lt;exposureNum&lt;&lt;<span class=\"stringliteral\">&quot;/&quot;</span>&lt;&lt;totalExposureCount</div>\n\
<div class=\"line\">                &lt;&lt;<span class=\"stringliteral\">&quot;] hwRenderEffect::execute(&quot;</span>&lt;&lt;width&lt;&lt;<span class=\"stringliteral\">&quot;, &quot;</span>&lt;&lt;height</div>\n\
<div class=\"line\">                &lt;&lt;<span class=\"stringliteral\">&quot;) -- &quot;</span>&lt;&lt;fName.asChar()&lt;&lt;endl;</div>\n\
...
<div class=\"line\">        <span class=\"keywordflow\">else</span> <span class=\"keywordflow\">if</span> ( mLocation == <a name=\"a11\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_hardware_renderer.html#a0526f0a40dc8240e14bfb22ebf93d986aa719507f97eea20e5fce2da8660fdeac\">MHardwareRenderer::kPostExposure</a> )</div>\n\
<div class=\"line\">        {</div>\n\
<div class=\"line\">            cout&lt;&lt;<span class=\"stringliteral\">&quot;Call EXP[&quot;</span>&lt;&lt;exposureNum&lt;&lt;<span class=\"stringliteral\">&quot;/&quot;</span>&lt;&lt;totalExposureCount</div>\n\
