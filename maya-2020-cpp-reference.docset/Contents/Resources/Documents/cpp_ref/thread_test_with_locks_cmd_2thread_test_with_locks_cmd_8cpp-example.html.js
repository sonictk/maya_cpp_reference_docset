...
<div class=\"line\">        pi += 4.0 / (1.0 + x*x);</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\">    myData-&gt;mutexLock-&gt;<a name=\"a9\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_spin_lock.html#aa81aed607133209dade63a226818224d\">lock</a>();</div>\n\
<div class=\"line\">    (*myData-&gt;globalPi) += pi;</div>\n\
...
<div class=\"line\">            pr = <a name=\"a12\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_thread_async.html#ad805f347e198954c15fa9c384a2bd5e5\">MThreadAsync::createTask</a>(AsyncPi, (<span class=\"keywordtype\">void</span> *)&amp;tdata[i], </div>\n\
