...
<div class=\"line\">    c1.<a name=\"a29\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_int_array.html#a11568087ac2ca16f4106cee62f65afd7\">append</a> (MRampAttribute::kLinear);</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"comment\">// Add it to the curve ramp</span></div>\n\
<div class=\"line\">    ramp.<a name=\"a30\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_ramp_attribute.html#a28478bb78e4da037ed552386348f06fa\">addEntries</a> (a1, b1, c1, &amp;stat);</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> ( MS::kSuccess != stat)</div>\n\
<div class=\"line\">    {</div>\n\
...
<div class=\"line\">    ramp.<a name=\"a32\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_ramp_attribute.html#af96c0f4781b8837c19fb08055ecc6f88\">getValueAtPosition</a>(.3f, newVal, &amp;stat);</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> ( MS::kSuccess != stat )</div>\n\
<div class=\"line\">    {</div>\n\
...
<div class=\"line\">    ramp.<a name=\"a33\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_ramp_attribute.html#a540584f3533c9f19f370e41b97787c38\">deleteEntries</a> (entriesToDelete, &amp;stat);</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> ( MS::kSuccess != stat )</div>\n\
<div class=\"line\">    {</div>\n\
...
<div class=\"line\">    entriesToDelete.<a name=\"a34\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_int_array.html#ad5522f028dde0080b753279426415a4a\">clear</a>();</div>\n\
<div class=\"line\">    entriesToDelete.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_int_array.html#a11568087ac2ca16f4106cee62f65afd7\">append</a> (0);</div>\n\
...
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    ramp.<a name=\"a35\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_ramp_attribute.html#a8ca654781819a8028cd336ed339a09be\">setPositionAtIndex</a> (0.0f, d2[0], &amp;stat);</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> ( MS::kSuccess != stat)</div>\n\
<div class=\"line\">    {</div>\n\
...
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    ramp.<a name=\"a36\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_ramp_attribute.html#ab6b392d6b8b4262c8a8ca291316cd3c8\">setValueAtIndex</a> (1.0f, d2[0], &amp;stat);</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> ( MS::kSuccess != stat)</div>\n\
<div class=\"line\">    {</div>\n\
...
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    ramp.<a name=\"a37\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_ramp_attribute.html#a50d94081e53d921917ae979c70bf673f\">setInterpolationAtIndex</a> (MRampAttribute::kNone, d2[0], &amp;stat);</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> ( MS::kSuccess != stat)</div>\n\
<div class=\"line\">    {</div>\n\
...
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_ramp_attribute.html\">MRampAttribute</a> ramp2 = light.<a name=\"a38\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_volume_light.html#a8c8ad99bf3a32a58659cfd564bf41251\">colorRamp</a> (&amp;stat);</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> ( MS::kSuccess != stat)</div>\n\
<div class=\"line\">    {</div>\n\
...
<div class=\"line\">    <a name=\"_a39\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_color_array.html\">MColorArray</a> b3;</div>\n\
...
<div class=\"line\">    b4.<a name=\"a40\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_color_array.html#a9740f98aca5891832ee7b8bfc5839106\">append</a> (<a name=\"_a41\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_color.html\">MColor</a> (0.0f, 0.0f, 0.75f));</div>\n\
<div class=\"line\">    c4.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_int_array.html#a11568087ac2ca16f4106cee62f65afd7\">append</a> (MRampAttribute::kLinear);</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"comment\">// Add it to the curve ramp</span></div>\n\
...
<div class=\"line\">    ramp2.<a name=\"a42\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_ramp_attribute.html#aefd4c705ddb01b1c98590d843f5fc4f2\">getColorAtPosition</a>(.3f, newCol, &amp;stat);</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> ( MS::kSuccess != stat )</div>\n\
<div class=\"line\">    {</div>\n\
...
<div class=\"line\">    ramp2.<a name=\"a43\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_ramp_attribute.html#a7bd77c46ea41241cf199608b4f42dc90\">setColorAtIndex</a> (clr, d5[0], &amp;stat);</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> ( MS::kSuccess != stat)</div>\n\
<div class=\"line\">    {</div>\n\
...
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    ramp2.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_ramp_attribute.html#a50d94081e53d921917ae979c70bf673f\">setInterpolationAtIndex</a> (MRampAttribute::kSpline, d5[1], &amp;stat);</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> ( MS::kSuccess != stat)</div>\n\
<div class=\"line\">    {</div>\n\
...
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">for</span> (<span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span> i=0; i&lt;colors.<a name=\"a44\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_color_array.html#a580388f31f60c46fac867ca48a48da1e\">length</a>(); i++)</div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">        colors[i] = colors[i]*2;</div>\n\
<div class=\"line\">        interps[i] = MRampAttribute::kSpline;</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"comment\">// set color ramp with new values</span></div>\n\
<div class=\"line\">    stat = ramp2.<a name=\"a45\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_ramp_attribute.html#aa58634ab9423b54b441333a30ec7a1f1\">setRamp</a>( colors, pos, interps );</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> ( MS::kSuccess != stat)</div>\n\
<div class=\"line\">    {</div>\n\
...
<div class=\"line\">    stat = ramp2.<a name=\"a46\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_ramp_attribute.html#a4da23488afc771635de2b18abd51503d\">sort</a>( <span class=\"keyword\">true</span> );</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> ( MS::kSuccess != stat)</div>\n\
<div class=\"line\">    {</div>\n\
...
<div class=\"line\">    <span class=\"keywordflow\">if</span> ( ramp2.<a name=\"a47\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_ramp_attribute.html#ac9a84eabdd3e248266600cbcf0c940cc\">hasIndex</a>( 0 ) )</div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">        ramp2.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_ramp_attribute.html#a50d94081e53d921917ae979c70bf673f\">setInterpolationAtIndex</a> (MRampAttribute::kSpline, 0 );</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    {</div>\n\
<div class=\"line\">        ramp2.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_ramp_attribute.html#a50d94081e53d921917ae979c70bf673f\">setInterpolationAtIndex</a>( MRampAttribute::kSpline, 56 );</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">return</span> stat;</div>\n\
<div class=\"line\">}</div>\n\
