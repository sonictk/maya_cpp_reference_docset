...
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn.html#a1d1cfd8ffb84e947f82999c682b666a7\">MFn::Type</a>               filter        = <a name=\"a7\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn.html#a1d1cfd8ffb84e947f82999c682b666a7a94dd08feda7b2cf0ff8262312c4fcc09\">MFn::kInvalid</a>;</div>\n\
...
<div class=\"line\">        filter = <a name=\"a10\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn.html#a1d1cfd8ffb84e947f82999c682b666a7af2731fae06310295129a8fb3dba5fbb2\">MFn::kCamera</a>;</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">else</span> <span class=\"keywordflow\">if</span> (argData.isFlagSet(kLightFlag))</div>\n\
<div class=\"line\">        filter = <a name=\"a11\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn.html#a1d1cfd8ffb84e947f82999c682b666a7a4b1026889ac8a8c906a6f3a53301bbbc\">MFn::kLight</a>;</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">else</span> <span class=\"keywordflow\">if</span> (argData.isFlagSet(kNurbsSurfaceFlag))</div>\n\
<div class=\"line\">        filter = <a name=\"a12\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn.html#a1d1cfd8ffb84e947f82999c682b666a7a016a93d2c00725d6ca8021dffbd2a0a8\">MFn::kNurbsSurface</a>;</div>\n\
<div class=\"line\">        </div>\n\
...
<div class=\"line\">}</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html\">MStatus</a> scanDagSyntax::doScan( <span class=\"keyword\">const</span> MItDag::TraversalType traversalType,</div>\n\
<div class=\"line\">                               <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn.html#a1d1cfd8ffb84e947f82999c682b666a7\">MFn::Type</a> filter,</div>\n\
<div class=\"line\">                               <span class=\"keywordtype\">bool</span> quiet)</div>\n\
<div class=\"line\">{   </div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html\">MStatus</a> status;</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <a name=\"_a13\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_it_dag.html\">MItDag</a> dagIterator( traversalType, filter, &amp;status);</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> ( !status) {</div>\n\
<div class=\"line\">        status.<a name=\"a14\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a1f01a4748fea4d8bcced082df83f804d\">perror</a>(<span class=\"stringliteral\">&quot;MItDag constructor&quot;</span>);</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">return</span> status;</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">        }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">        <a name=\"_a15\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_dag_node.html\">MFnDagNode</a> dagNode(dagPath, &amp;status);</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span> ( !status ) {</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span> (!quiet)</div>\n\
<div class=\"line\">            cout &lt;&lt; <span class=\"stringliteral\">&quot;  dagPath: &quot;</span> &lt;&lt; dagPath.<a name=\"a16\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_dag_path.html#a7cffb69661adc6ae7ac9e03c297caf01\">fullPathName</a>() &lt;&lt; endl;</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">        objectCount += 1;</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span> (dagPath.<a name=\"a17\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_dag_path.html#a5901f0fa543d32fb13756c2d004f37ae\">hasFn</a>(<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn.html#a1d1cfd8ffb84e947f82999c682b666a7af2731fae06310295129a8fb3dba5fbb2\">MFn::kCamera</a>)) {</div>\n\
<div class=\"line\">            <a name=\"_a18\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_camera.html\">MFnCamera</a> camera (dagPath, &amp;status);</div>\n\
<div class=\"line\">            <span class=\"keywordflow\">if</span> ( !status ) {</div>\n\
...
<div class=\"line\">            <a name=\"_a19\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_light.html\">MFnLight</a> light (dagPath, &amp;status);</div>\n\
<div class=\"line\">            <span class=\"keywordflow\">if</span> ( !status ) {</div>\n\
...
<div class=\"line\">            <a name=\"_a20\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_color.html\">MColor</a> color;</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">            color = light.color();</div>\n\
<div class=\"line\">            <span class=\"keywordflow\">if</span> (!quiet)</div>\n\
<div class=\"line\">            {</div>\n\
<div class=\"line\">                cout &lt;&lt; <span class=\"stringliteral\">&quot;  color: [&quot;</span></div>\n\
<div class=\"line\">                     &lt;&lt; color.<a name=\"a21\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_color.html#a4788d82c901b9367dd5c0daff8a7616b\">r</a> &lt;&lt; <span class=\"stringliteral\">&quot;, &quot;</span></div>\n\
<div class=\"line\">                     &lt;&lt; color.<a name=\"a22\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_color.html#a8cf17d727651616de6f2b79ef32170cd\">g</a> &lt;&lt; <span class=\"stringliteral\">&quot;, &quot;</span></div>\n\
<div class=\"line\">                     &lt;&lt; color.<a name=\"a23\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_color.html#a83fc1af92e29717b4513d121b0c72c7d\">b</a> &lt;&lt; <span class=\"stringliteral\">&quot;]\\n&quot;</span>;</div>\n\
<div class=\"line\">            }</div>\n\
...
<div class=\"line\">            <a name=\"_a24\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_nurbs_surface.html\">MFnNurbsSurface</a> surface (dagPath, &amp;status);</div>\n\
<div class=\"line\">            <span class=\"keywordflow\">if</span> ( !status ) {</div>\n\
...
<div class=\"line\">{</div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html\">MStatus</a>     status;</div>\n\
<div class=\"line\">    <a name=\"_a25\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html\">MObject</a>     transformNode = dagPath.<a name=\"a26\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_dag_path.html#a13f88add2c589379a22d5aaaa4a39fb4\">transform</a>(&amp;status);</div>\n\
<div class=\"line\">    <span class=\"comment\">// This node has no transform - i.e., it&#39;s the world node</span></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> (!status &amp;&amp; status.<a name=\"a27\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a6040f0420421c317bced8b857b413f47\">statusCode</a> () == <a name=\"a28\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a02ab596f4febca68da503aaf8dde3a80af8c5f748892ec74b32719c8fba7767e1\">MStatus::kInvalidParameter</a>)</div>\n\
...
<div class=\"line\">        <span class=\"keywordflow\">return</span>;</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\">    <a name=\"_a29\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_transformation_matrix.html\">MTransformationMatrix</a>   matrix (transform.transformationMatrix());</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> (!quiet)</div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">        cout &lt;&lt; <span class=\"stringliteral\">&quot;  translation: &quot;</span> &lt;&lt; matrix.<a name=\"a30\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_transformation_matrix.html#ad4b705bafd14e424d2a2e42a53b493fe\">getTranslation</a>(MSpace::kWorld)</div>\n\
<div class=\"line\">             &lt;&lt; endl;</div>\n\
<div class=\"line\">    }</div>\n\
