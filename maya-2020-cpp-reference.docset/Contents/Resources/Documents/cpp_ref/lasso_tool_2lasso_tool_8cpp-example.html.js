...
<div class=\"line\">    setImage(<span class=\"stringliteral\">&quot;lassoTool.xpm&quot;</span>, MPxContext::kImage1 );</div>\n\
<div class=\"line\">}</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">lassoTool::~lassoTool() {}</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    <span class=\"keywordflow\">if</span> (event.<a name=\"a9\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_event.html#a64775a125eaf8ec9e67e50242e103a88\">isModifierShift</a>() || <span class=\"keyword\">event</span>.isModifierControl() ) {</div>\n\
...
<div class=\"line\">            <span class=\"keywordflow\">if</span> ( event.<a name=\"a10\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_event.html#a4d394a4b2239de7b92b1e36fbe617655\">isModifierControl</a>() ) {</div>\n\
...
<div class=\"line\">    <span class=\"comment\">//</span></div>\n\
<div class=\"line\">    view = <a name=\"a11\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m3d_view.html#a3cda809eff914b04ff47de958c365f09\">M3dView::active3dView</a>();</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">{</div>\n\
<div class=\"line\">    view.beginXorDrawing(<span class=\"keyword\">true</span>, <span class=\"keyword\">true</span>, 1.0f, M3dView::kStippleDashed);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    <a name=\"_a12\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_selection_list.html\">MSelectionList</a>                  incomingList, boundingBoxList, newList;</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> (!firstDraw) {</div>\n\
...
<div class=\"line\">    <a name=\"a13\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_global.html#a6d81d38246555884897fb153c93aaf42\">MGlobal::getActiveSelectionList</a>(incomingList);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    MGlobal::selectFromScreen( min.h, min.v, max.h, max.v,</div>\n\
...
<div class=\"line\">    <a name=\"a14\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_global.html#a33e6a7c8fa1c06fd64063bd08d4e4aef\">MGlobal::setActiveSelectionList</a>(incomingList, MGlobal::kReplaceList);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    <a name=\"_a15\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_it_selection_list.html\">MItSelectionList</a> iter(boundingBoxList);</div>\n\
<div class=\"line\">    newList.<a name=\"a16\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_selection_list.html#ad5522f028dde0080b753279426415a4a\">clear</a>();</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">        <a name=\"_a18\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html\">MObject</a>     component;</div>\n\
<div class=\"line\">        <a name=\"_a19\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_point.html\">MPoint</a>      point;</div>\n\
...
<div class=\"line\">            {</div>\n\
<div class=\"line\">                <a name=\"_a23\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_it_curve_c_v.html\">MItCurveCV</a> curveCVIter( dagPath, component, &amp;stat );</div>\n\
<div class=\"line\">                <span class=\"keywordflow\">for</span> ( ; !curveCVIter.isDone(); curveCVIter.next() ) {</div>\n\
<div class=\"line\">                    point = curveCVIter.position(MSpace::kWorld, &amp;stat );</div>\n\
<div class=\"line\">                    view.worldToView( point, pt.h, pt.v, &amp;stat );</div>\n\
<div class=\"line\">                    <span class=\"keywordflow\">if</span> (!stat) {</div>\n\
<div class=\"line\">                        stat.<a name=\"a24\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a1f01a4748fea4d8bcced082df83f804d\">perror</a>(<span class=\"stringliteral\">&quot;Could not get position&quot;</span>);</div>\n\
...
<div class=\"line\">                        newList.<a name=\"a25\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_selection_list.html#a23929aeafb29672f2652128eac9c4dec\">add</a> (dagPath, singleComponent);</div>\n\
<div class=\"line\">                    }</div>\n\
<div class=\"line\">                }</div>\n\
...
<div class=\"line\">            {</div>\n\
<div class=\"line\">                <a name=\"_a27\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_it_surface_c_v.html\">MItSurfaceCV</a> surfCVIter( dagPath, component, <span class=\"keyword\">true</span>, &amp;stat );</div>\n\
<div class=\"line\">                <span class=\"keywordflow\">for</span> ( ; !surfCVIter.isDone(); surfCVIter.next() ) {</div>\n\
<div class=\"line\">                    point = surfCVIter.position(MSpace::kWorld, &amp;stat );</div>\n\
<div class=\"line\">                    view.worldToView( point, pt.h, pt.v, &amp;stat );</div>\n\
<div class=\"line\">                    <span class=\"keywordflow\">if</span> (!stat) {</div>\n\
...
<div class=\"line\">            {</div>\n\
<div class=\"line\">                <a name=\"_a29\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_it_mesh_vertex.html\">MItMeshVertex</a> vertexIter( dagPath, component, &amp;stat );</div>\n\
<div class=\"line\">                <span class=\"keywordflow\">for</span> ( ; !vertexIter.isDone(); vertexIter.next() ) {</div>\n\
<div class=\"line\">                    point = vertexIter.position(MSpace::kWorld, &amp;stat );</div>\n\
<div class=\"line\">                    view.worldToView( point, pt.h, pt.v, &amp;stat );</div>\n\
<div class=\"line\">                    <span class=\"keywordflow\">if</span> (!stat) {</div>\n\
<div class=\"line\">                        stat.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a1f01a4748fea4d8bcced082df83f804d\">perror</a>(<span class=\"stringliteral\">&quot;Could not get position&quot;</span>);</div>\n\
<div class=\"line\">                        <span class=\"keywordflow\">continue</span>;</div>\n\
...
<div class=\"line\">            }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">        <span class=\"keywordflow\">case</span> <a name=\"a30\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn.html#a1d1cfd8ffb84e947f82999c682b666a7a18f788d50a75ca81a0dc5a2538f364ae\">MFn::kMeshEdgeComponent</a>:</div>\n\
<div class=\"line\">            {</div>\n\
<div class=\"line\">                <a name=\"_a31\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_it_mesh_edge.html\">MItMeshEdge</a> edgeIter( dagPath, component, &amp;stat );</div>\n\
<div class=\"line\">                <span class=\"keywordflow\">for</span> ( ; !edgeIter.isDone(); edgeIter.next() ) {</div>\n\
<div class=\"line\">                    point = edgeIter.center(MSpace::kWorld, &amp;stat );</div>\n\
<div class=\"line\">                    view.worldToView( point, pt.h, pt.v, &amp;stat );</div>\n\
<div class=\"line\">                    <span class=\"keywordflow\">if</span> (!stat) {</div>\n\
<div class=\"line\">                        stat.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a1f01a4748fea4d8bcced082df83f804d\">perror</a>(<span class=\"stringliteral\">&quot;Could not get position&quot;</span>);</div>\n\
<div class=\"line\">                        <span class=\"keywordflow\">continue</span>;</div>\n\
...
<div class=\"line\">            }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">        <span class=\"keywordflow\">case</span> <a name=\"a32\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn.html#a1d1cfd8ffb84e947f82999c682b666a7a5ddabf9726f89e07cff62014221fe6fb\">MFn::kMeshPolygonComponent</a>:</div>\n\
<div class=\"line\">            {</div>\n\
<div class=\"line\">                <a name=\"_a33\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_it_mesh_polygon.html\">MItMeshPolygon</a> polygonIter( dagPath, component, &amp;stat );</div>\n\
<div class=\"line\">                <span class=\"keywordflow\">for</span> ( ; !polygonIter.isDone(); polygonIter.next() ) {</div>\n\
<div class=\"line\">                    point = polygonIter.center(MSpace::kWorld, &amp;stat );</div>\n\
<div class=\"line\">                    view.worldToView( point, pt.h, pt.v, &amp;stat );</div>\n\
<div class=\"line\">                    <span class=\"keywordflow\">if</span> (!stat) {</div>\n\
<div class=\"line\">                        stat.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a1f01a4748fea4d8bcced082df83f804d\">perror</a>(<span class=\"stringliteral\">&quot;Could not get position&quot;</span>);</div>\n\
<div class=\"line\">                        <span class=\"keywordflow\">continue</span>;</div>\n\
...
<div class=\"line\">                 &lt;&lt; <span class=\"stringliteral\">&quot;): &quot;</span> &lt;&lt; component.<a name=\"a34\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html#a3dad4d354c5b968cf4eccfffcdb824f4\">apiTypeStr</a>() &lt;&lt; endl;</div>\n\
...
<div class=\"line\">        <a name=\"a35\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_global.html#acb043e7fc4eb7fc0f39833d31364b8a4\">MGlobal::displayWarning</a>(<span class=\"stringliteral\">&quot;lassoTool can only select components, not entire objects.&quot;</span>);</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"comment\">// Update the selection list as indicated by the modifier keys.</span></div>\n\
<div class=\"line\">    <a name=\"a36\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_global.html#a527b2aeb16d0fbbe515ff407383f31a1\">MGlobal::selectCommand</a>(newList, listAdjustment);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\"><span class=\"comment\"></span></div>\n\
<div class=\"line\"><span class=\"keyword\">class </span>lassoContextCmd : <span class=\"keyword\">public</span> <a name=\"_a37\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_px_context_command.html\">MPxContextCommand</a></div>\n\
<div class=\"line\">{</div>\n\
<div class=\"line\"><span class=\"keyword\">public</span>: </div>\n\
<div class=\"line\">                        lassoContextCmd() {};</div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_px_context.html\">MPxContext</a>* <a name=\"a38\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_px_context_command.html#a69d6fc56205518e4be6c0ced911e6523\">makeObj</a>() <span class=\"keyword\">override</span>;</div>\n\
