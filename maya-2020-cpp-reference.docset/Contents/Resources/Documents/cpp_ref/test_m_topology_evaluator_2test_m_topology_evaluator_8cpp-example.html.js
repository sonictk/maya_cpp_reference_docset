...
<div class=\"line\"><span class=\"comment\">//----------------------------------------------------------------------</span></div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">MPxNode::SchedulingType TestMTopologyEvaluator_Node::schedulingType()<span class=\"keyword\"> const</span></div>\n\
<div class=\"line\"><span class=\"keyword\"></span>{</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">return</span> MPxNode::kParallel;</div>\n\
<div class=\"line\">}</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"><span class=\"comment\">//----------------------------------------------------------------------</span></div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">        attrInputs.emplace_back(mAttr.<a name=\"a31\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_numeric_attribute.html#a5c08a5ce5e7123cc444c95a0e4a50f29\">create</a>(attrLongName, attrShortName, MFnNumericData::kDouble, 0, &amp;stat));</div>\n\
<div class=\"line\">        mAttr.<a name=\"a32\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_attribute.html#a9e68a8b4af016b37f6567cfa6d68e551\">setKeyable</a>(<span class=\"keyword\">true</span>);</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">        attrShortName += (i+1);</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">        attrOutputs.emplace_back(mAttr.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_numeric_attribute.html#a5c08a5ce5e7123cc444c95a0e4a50f29\">create</a>(attrLongName, attrShortName, MFnNumericData::kDouble, 0, &amp;stat));</div>\n\
<div class=\"line\">        mAttr.<a name=\"a33\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_attribute.html#a98bb3089ec3b7442383da68a5ef424c7\">setWritable</a>(<span class=\"keyword\">false</span>);</div>\n\
<div class=\"line\">        mAttr.<a name=\"a34\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_attribute.html#a8d2be80de133a200a455bf9e2ac1b709\">setStorable</a>(<span class=\"keyword\">false</span>);</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    attrComputeCount = mAttr.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_numeric_attribute.html#a5c08a5ce5e7123cc444c95a0e4a50f29\">create</a>(attrLongName, attrShortName, MFnNumericData::kInt, 0, &amp;stat);</div>\n\
<div class=\"line\">    mAttr.<a name=\"a35\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_attribute.html#af41aae76c0dc31dbcd1f4ecea52d694e\">setReadable</a>(<span class=\"keyword\">true</span>);</div>\n\
...
<div class=\"line\">    mAttr.<a name=\"a36\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_attribute.html#ae27cf2fd28a3c69b880b1096ea9e0103\">setInternal</a>(<span class=\"keyword\">true</span>);</div>\n\
...
<div class=\"line\">    mAttr.<a name=\"a37\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_attribute.html#ab1986dcbce4e2fd86c5cb0bff5119dc0\">setConnectable</a>(<span class=\"keyword\">false</span>);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    attrPushComputeCount = mAttr.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_numeric_attribute.html#a5c08a5ce5e7123cc444c95a0e4a50f29\">create</a>(attrLongName, attrShortName, MFnNumericData::kInt, 0, &amp;stat);</div>\n\
...
<div class=\"line\">    attrDoPushCompute = mAttr.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_numeric_attribute.html#a5c08a5ce5e7123cc444c95a0e4a50f29\">create</a>(attrLongName, attrShortName, MFnNumericData::kBoolean, <span class=\"keyword\">false</span>, &amp;stat);</div>\n\
<div class=\"line\">    mAttr.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_attribute.html#af41aae76c0dc31dbcd1f4ecea52d694e\">setReadable</a>(<span class=\"keyword\">true</span>);</div>\n\
...
<div class=\"line\">    <a name=\"_a38\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_plugin.html\">MFnPlugin</a> plugin( obj, <span class=\"stringliteral\">&quot;Autodesk&quot;</span>, <span class=\"stringliteral\">&quot;3.0&quot;</span>, <span class=\"stringliteral\">&quot;Any&quot;</span>);</div>\n\
...
<div class=\"line\">    }</div>\n\
<div class=\"line\">    </div>\n\
<div class=\"line\">    status = plugin.registerTopologyEvaluator(<span class=\"stringliteral\">&quot;TestMTopologyEvaluator&quot;</span>, 40 <span class=\"comment\">/* unused */</span>, TestMTopologyEvaluator_Evaluator::creator);</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> (!status)</div>\n\
<div class=\"line\">    {</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\"><span class=\"comment\">//----------------------------------------------------------------------</span></div>\n\
<div class=\"line\"><a name=\"_a42\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_px_topology_evaluator.html\">MPxTopologyEvaluator</a>* TestMTopologyEvaluator_Evaluator::creator()</div>\n\
<div class=\"line\">{</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">return</span> <span class=\"keyword\">new</span> TestMTopologyEvaluator_Evaluator();</div>\n\
<div class=\"line\">}</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"><span class=\"comment\">//----------------------------------------------------------------------</span></div>\n\
<div class=\"line\"><span class=\"keywordtype\">bool</span> TestMTopologyEvaluator_Evaluator::makeTopology(<a name=\"_a43\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_topology_cluster_node.html\">MTopologyClusterNode</a>* cluster)</div>\n\
<div class=\"line\">{</div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html\">MStatus</a> stat = MS::kSuccess;</div>\n\
<div class=\"line\">    <a name=\"_a44\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_graph_node_iterator.html\">MGraphNodeIterator</a> iterator(cluster, &amp;stat);</div>\n\
...
<div class=\"line\">            {</div>\n\
<div class=\"line\">                <a name=\"_a45\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_profiling_scope.html\">MProfilingScope</a> profilingScopeForInit(_profilerCategory, MProfiler::kColorD_L1, <span class=\"stringliteral\">&quot;Reset counters&quot;</span>);</div>\n\
<div class=\"line\">                testNode-&gt;computeCount = 0;</div>\n\
<div class=\"line\">                testNode-&gt;pushComputeCount = 0;</div>\n\
<div class=\"line\">            };</div>\n\
<div class=\"line\">            <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_evaluation_node.html\">MEvaluationNode</a> initExec = cluster-&gt;<a name=\"a46\"></a>createNode(<span class=\"stringliteral\">&quot;InitExec&quot;</span>, initExecFn, MPxNode::kParallel, <span class=\"keyword\">nullptr</span>, <span class=\"keyword\">false</span>);</div>\n\
<div class=\"line\">            <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_evaluation_node.html\">MEvaluationNode</a> endExec = cluster-&gt;createNode(<span class=\"stringliteral\">&quot;EndExec&quot;</span>, currEvalNode, MPxNode::kParallel);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">                    {</div>\n\
<div class=\"line\">                        <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_profiling_scope.html\">MProfilingScope</a> profilingScopeForCompute(_profilerCategory, MProfiler::kColorD_L1, nodeName.<a name=\"a47\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html#aa9ab612f356c53479afc4c648c9ef94d\">asChar</a>());</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">                        <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html\">MStatus</a> computeStat = MS::kSuccess;</div>\n\
<div class=\"line\">                        <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_data_block.html\">MDataBlock</a> data = currEvalNode.<a name=\"a48\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_evaluation_node.html#a8020acf5e607c87d867f1707544505e8\">datablock</a>(&amp;computeStat);</div>\n\
...
<div class=\"line\">                    {</div>\n\
<div class=\"line\">                        <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_evaluation_node.html\">MEvaluationNode</a> inConnection = cluster-&gt;<a name=\"a49\"></a>connectionPort(parentNode, currEvalNode);</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">                        <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_evaluation_node.html\">MEvaluationNode</a> pushComputeExec = cluster-&gt;createNode(nodeName.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html#aa9ab612f356c53479afc4c648c9ef94d\">asChar</a>(), pushComputeFn, MPxNode::kParallel, &amp;currEvalNode, <span class=\"keyword\">false</span>);</div>\n\
<div class=\"line\">                        initExec.<a name=\"a50\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_evaluation_node.html#a278eb08035433924667ef1be8342c699\">connect</a>(pushComputeExec);      <span class=\"comment\">//init will always execute before any other node in this cluster</span></div>\n\
...
<div class=\"line\">                        <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_evaluation_node.html\">MEvaluationNode</a> outConnection = cluster-&gt;connectionPort(childNode, currEvalNode);</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">                        <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_evaluation_node.html\">MEvaluationNode</a> computeExec = cluster-&gt;createNode(nodeName.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html#aa9ab612f356c53479afc4c648c9ef94d\">asChar</a>(), computeFn, MPxNode::kParallel, &amp;currEvalNode, <span class=\"keyword\">true</span>);</div>\n\
...
<div class=\"line\">            }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">            <a name=\"_a51\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_evaluation_graph.html\">MEvaluationGraph</a> evalGraph = <a name=\"a52\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_evaluation_graph.html#a1be9e9b8f32a234c97837ce51a1818d0\">MEvaluationGraph::ownerGraph</a>(currEvalNode);</div>\n\
<div class=\"line\">            <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_evaluation_node.html\">MEvaluationNode</a> rootConnection = cluster-&gt;connectionPort(evalGraph.<a name=\"a53\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_evaluation_graph.html#a551a86767a4b6c77be866abe02d2997f\">rootNode</a>(), evalGraph.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_evaluation_graph.html#a551a86767a4b6c77be866abe02d2997f\">rootNode</a>());</div>\n\
