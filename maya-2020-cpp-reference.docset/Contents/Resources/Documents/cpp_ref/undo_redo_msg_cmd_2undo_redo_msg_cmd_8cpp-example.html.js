...
<html>\n\
   <head><script src=\"../scripts/yepnope.1.5.4-min.js\" type=\"text/javascript\"></script><script src=\"../scripts/lib/jquery-1.11.1.min.js\" type=\"text/javascript\"></script>\n\
      <title>C++ API Reference: undoRedoMsgCmd/undoRedoMsgCmd.cpp</title>\n\
      \n\
	  \n\
      \n\
      \n\
...
$(window).load( function() {\n\
 ...
 if (!tocSystemNeedsToBeLoaded) { cpp_ref_initializeToc(); }\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>C++ API Reference: undoRedoMsgCmd/undoRedoMsgCmd.cpp</h1>\n\
         </div>\n\
\n\
...
<div class=\"line\">        info += (unsigned)(uintptr_t)clientData;</div>\n\
...
<div class=\"line\">            {</div>\n\
<div class=\"line\">                MCallbackId undoId = <a name=\"a9\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_event_message.html#a8d22c58b90484867755273c2f7ffc6ec\">MEventMessage::addEventCallback</a>( UndoString, undoCB, NULL, &amp;result );</div>\n\
...
<div class=\"line\">                </div>\n\
<div class=\"line\">                MCallbackId redoId = <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_event_message.html#a8d22c58b90484867755273c2f7ffc6ec\">MEventMessage::addEventCallback</a>( RedoString, redoCB, NULL, &amp;result );</div>\n\
<div class=\"line\">                <span class=\"keywordflow\">if</span> ( MS::kSuccess != result )</div>\n\
<div class=\"line\">                    <span class=\"keywordflow\">return</span> MS::kFailure;    </div>\n\
