...
<div class=\"line\">                MSpace::kWorld);</div>\n\
<div class=\"line\">            averageNormal += vertexNormal;</div>\n\
<div class=\"line\">        }</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span> (averageNormal.<a name=\"a12\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_vector.html#ad207cb443e371f73f07e874c504f60c1\">length</a>() &lt; 0.001)</div>\n\
<div class=\"line\">            averageNormal = <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_vector.html\">MVector</a>(0.0, 1.0, 0.0);</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">else</span> averageNormal.<a name=\"a13\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_vector.html#ab66b0c7697d96a278da9bca810f4dee1\">normalize</a>();</div>\n\
...
<div class=\"line\">        status = meshFn.<a name=\"a14\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_mesh.html#a25616dd654e9807fe6e74e16d84e2611\">subdivideEdges</a>(fComponentIDs, divisionCount);</div>\n\
<div class=\"line\">        CHECK_STATUS(status);</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">break</span>; }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">case</span> kSubdivideFaces: {</div>\n\
<div class=\"line\">        status = meshFn.<a name=\"a15\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_mesh.html#a8a4e8dfe0bd906b2ac2551e2fb2690f3\">subdivideFaces</a>(fComponentIDs, divisionCount);</div>\n\
<div class=\"line\">        CHECK_STATUS(status);</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">break</span>; }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">case</span> kExtrudeEdges: {</div>\n\
<div class=\"line\">        status = meshFn.<a name=\"a16\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_mesh.html#a35423618f98694bb2a6230e5430f4e5d\">extrudeEdges</a>(fComponentIDs, divisionCount,</div>\n\
<div class=\"line\">            &amp;translation, extrudeTogether);</div>\n\
<div class=\"line\">        CHECK_STATUS(status);</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">break</span>; }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">case</span> kExtrudeFaces: {</div>\n\
<div class=\"line\">        status = meshFn.<a name=\"a17\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_mesh.html#ab15cb5975fdab32d083f0636266ca555\">extrudeFaces</a>(fComponentIDs, divisionCount,</div>\n\
<div class=\"line\">            &amp;translation, extrudeTogether);</div>\n\
<div class=\"line\">        CHECK_STATUS(status);</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">break</span>; }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">case</span> kCollapseEdges: {</div>\n\
<div class=\"line\">        status = meshFn.<a name=\"a18\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_mesh.html#a68fec76262010b57a32acb44623cd0e9\">collapseEdges</a>(fComponentIDs);</div>\n\
<div class=\"line\">        CHECK_STATUS(status);</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">break</span>; }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">case</span> kCollapseFaces: {</div>\n\
<div class=\"line\">        status = meshFn.<a name=\"a19\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_mesh.html#a334445a339b2f817b87ac5c87f51cdb1\">collapseFaces</a>(fComponentIDs);</div>\n\
<div class=\"line\">        CHECK_STATUS(status);</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">break</span>; }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">case</span> kDuplicateFaces: {</div>\n\
<div class=\"line\">        status = meshFn.<a name=\"a20\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_mesh.html#ae0c0818607c11b7d2f484a81e475fd66\">duplicateFaces</a>(fComponentIDs, &amp;translation);</div>\n\
<div class=\"line\">        CHECK_STATUS(status);</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">break</span>; }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">case</span> kExtractFaces: {</div>\n\
<div class=\"line\">        status = meshFn.<a name=\"a21\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_mesh.html#a8888ea2f9c68478882f0ff4c90c1d40b\">extractFaces</a>(fComponentIDs, &amp;translation);</div>\n\
<div class=\"line\">        CHECK_STATUS(status);</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">break</span>; }</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    <a name=\"_a22\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_float_array.html\">MFloatArray</a> edgeFactors;</div>\n\
<div class=\"line\">    <a name=\"_a23\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_float_point_array.html\">MFloatPointArray</a> internalPoints;</div>\n\
<div class=\"line\">    </div>\n\
...
<div class=\"line\">    <span class=\"comment\">// </span></div>\n\
<div class=\"line\">    <a name=\"_a24\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_it_mesh_polygon.html\">MItMeshPolygon</a> itPoly(fMesh);</div>\n\
...
<div class=\"line\">    <a name=\"_a25\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_point.html\">MPoint</a> innerVert0, innerVert1;</div>\n\
...
<div class=\"line\">        <a name=\"_a26\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_it_mesh_edge.html\">MItMeshEdge</a> itEdge(fMesh, <a name=\"a27\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html#af2a707b4254eb54763167aeced863e63\">MObject::kNullObj</a> );</div>\n\
...
<div class=\"line\">        <span class=\"comment\">//</span></div>\n\
<div class=\"line\">        <span class=\"keywordtype\">double</span> distMax = edge0vert0.<a name=\"a28\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_point.html#a2afaa6122ee5ec4a0bff234d499b4c63\">distanceTo</a>(edge1vert0);</div>\n\
...
<div class=\"line\">        <span class=\"comment\">//</span></div>\n\
<div class=\"line\">        placements.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_int_array.html#a11568087ac2ca16f4106cee62f65afd7\">append</a>((<span class=\"keywordtype\">int</span>) MFnMesh::kOnEdge);</div>\n\
...
<div class=\"line\">        </div>\n\
<div class=\"line\">        edgeFactors.<a name=\"a29\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_float_array.html#a6d61a0ea5cd7a087db5ee81a990d4307\">append</a>(0.5f);</div>\n\
...
<div class=\"line\">        </div>\n\
<div class=\"line\">        <a name=\"_a30\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_float_point.html\">MFloatPoint</a> point1((<span class=\"keywordtype\">float</span>)innerVert0[0], (<span class=\"keywordtype\">float</span>)innerVert0[1],</div>\n\
...
<div class=\"line\">        internalPoints.<a name=\"a31\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_float_point_array.html#a9a607c73c20aca58b154cd5d40befbb7\">append</a>(point1);</div>\n\
...
<div class=\"line\">    <span class=\"comment\">//</span></div>\n\
<div class=\"line\">    <span class=\"keyword\">delete</span> [] faceTouched;</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">return</span> meshFn.<a name=\"a32\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_mesh.html#aa0fab620139a3143447ead1927936248\">split</a>(placements, edgeIDs, edgeFactors, internalPoints);</div>\n\
<div class=\"line\">}</div>\n\
