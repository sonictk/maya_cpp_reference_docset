...
<div class=\"line\">    {</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span> (meshIO.<a name=\"a44\"></a>createUVSetDataMesh(iSetName) != MS::kSuccess)</div>\n\
<div class=\"line\">        {</div>\n\
...
<div class=\"line\">        MFnMesh::MColorRepresentation iRepr)</div>\n\
<div class=\"line\">    {</div>\n\
...
<div class=\"line\">        setColor(ioMesh, colorList, indices, colorSetName, MFnMesh::kRGB);</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">        Alembic::Abc::UInt32ArraySamplePtr indices = samp.getIndices();</div>\n\
<div class=\"line\">        setColor(ioMesh, colorList, indices, colorSetName, MFnMesh::kRGBA);</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">        ioMesh.<a name=\"a54\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_mesh.html#a2f32f69a6f2b124ac085df4b067c76de\">getUVSetNames</a>(uvSetNames);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">            <span class=\"keywordflow\">if</span> (uvSetName.<a name=\"a55\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html#a580388f31f60c46fac867ca48a48da1e\">length</a>() == 0)</div>\n\
<div class=\"line\">            {</div>\n\
...
<div class=\"line\">                ioMesh.<a name=\"a56\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_mesh.html#a880eb944dc60e145d27dad4468c9fd11\">setCurrentUVSetName</a>(uvSetName);</div>\n\
<div class=\"line\">                uvSetNames.<a name=\"a57\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string_array.html#a18d06b3d0af1426e654ac2cc1dc86c60\">append</a>(uvSetName);</div>\n\
<div class=\"line\">            }</div>\n\
...
<div class=\"line\">        ioMesh.<a name=\"a58\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_mesh.html#aa5f322f25f97f76df932054bf5847c8e\">getColorSetNames</a>(colorSetNames);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">        <span class=\"keywordtype\">int</span> numEdges = ioMesh.<a name=\"a59\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_mesh.html#a742ce017199905f06ad07c178375a2d8\">numEdges</a>();</div>\n\
...
<div class=\"line\">            ioMesh.<a name=\"a60\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_mesh.html#a603d73f3637830a372ab3678d24ca6e6\">getEdgeVertices</a>(i, vertexList);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">        <a name=\"_a61\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_uint_array.html\">MUintArray</a> edgeIds;</div>\n\
<div class=\"line\">        <a name=\"_a62\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_double_array.html\">MDoubleArray</a> creaseData;</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">                {</div>\n\
<div class=\"line\">                    creaseData.<a name=\"a63\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_double_array.html#aafcfe8ff7afecc2dee4defccbdfb8e55\">append</a>(creaseSharpness);</div>\n\
<div class=\"line\">                    edgeIds.<a name=\"a64\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_uint_array.html#a29ccefc020c96f15e099924ebe83eb07\">append</a>(iter-&gt;second);</div>\n\
<div class=\"line\">                }</div>\n\
<div class=\"line\">            }</div>\n\
<div class=\"line\">        }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span> (ioMesh.<a name=\"a65\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_mesh.html#a62355f26f350f9725bccd7eaa7542df3\">setCreaseEdges</a>(edgeIds, creaseData) != MS::kSuccess)</div>\n\
<div class=\"line\">        {</div>\n\
...
<div class=\"line\">        }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span> (ioMesh.<a name=\"a66\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_mesh.html#a34be7d28408b76c1011d4122a90786ff\">setCreaseVertices</a>(vertIds, cornerData) != MS::kSuccess)</div>\n\
<div class=\"line\">        {</div>\n\
...
<div class=\"line\">        }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span> (ioMesh.<a name=\"a67\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_mesh.html#a5be791c0049247ab13e27cdffff5185a\">setInvisibleFaces</a>(holeData) != MS::kSuccess)</div>\n\
<div class=\"line\">        {</div>\n\
...
<div class=\"line\">        fillHoles(ioMesh, iNode, samp.<a name=\"a68\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_mesh.html#ab0e871427039e4f00635a3c5b4af19f1\">getHoles</a>());</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">       {</div>\n\
<div class=\"line\">           ioMesh.<a name=\"a69\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_mesh.html#a739dfbdbe4935389ac2d3e72d8c1f7dd\">setPoints</a>(pointArray, MSpace::kObject);</div>\n\
<div class=\"line\">       }</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">        fillPoints(pointArray, points, ceilPoints, alpha);</div>\n\
<div class=\"line\">        ioMesh.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_mesh.html#a739dfbdbe4935389ac2d3e72d8c1f7dd\">setPoints</a>(pointArray, MSpace::kObject);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    fnMesh.<a name=\"a70\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_dag_node.html#a6b2301b53683a8e8f56dd0b9cb088b0f\">setObject</a>(iMeshObject);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">        fnMesh.<a name=\"a71\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_dependency_node.html#a386bb83443e16a98e6fa10c683e76b6c\">setName</a>(name);</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">else</span></div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">        Alembic::AbcCoreAbstract::index_t index, ceilIndex;</div>\n\
...
<div class=\"line\">            schema.<a name=\"a72\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_float_point_array.html#ad86e61cd0b53ec369e132303f6c44823\">get</a>(ceilSamp, Alembic::Abc::ISampleSelector(ceilIndex));</div>\n\
...
<div class=\"line\">    {</div>\n\
<div class=\"line\">        <a name=\"_a73\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_numeric_attribute.html\">MFnNumericAttribute</a> attr;</div>\n\
...
<div class=\"line\">        <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html\">MObject</a> attrObj = attr.<a name=\"a74\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_numeric_attribute.html#a5c08a5ce5e7123cc444c95a0e4a50f29\">create</a>(attrName, attrName,</div>\n\
<div class=\"line\">        MFnNumericData::kBoolean, <span class=\"keyword\">true</span>);</div>\n\
...
<div class=\"line\">        MFnNumericData::kBoolean, 1);</div>\n\
...
<div class=\"line\">        attrObj = numAttr.create(attrName, attrName, MFnNumericData::kBoolean,</div>\n\
