...
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> (!inputPositions.<a name=\"a28\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_g_p_u_deformer_buffer.html#aac1b70a2ed67ead038c4d3f5ac4d8a81\">isValid</a>() || !outputPositions.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_g_p_u_deformer_buffer.html#aac1b70a2ed67ead038c4d3f5ac4d8a81\">isValid</a>()) <span class=\"keywordflow\">return</span> MPxGPUDeformer::kDeformerFailure;</div>\n\
<div class=\"line\">    <span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span> numElements = inputPositions.<a name=\"a29\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_g_p_u_deformer_buffer.html#ac9580a2ec3ad9690d0fb0ea0b3179fec\">elementCount</a>();</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">        <a name=\"_a30\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html\">MString</a> openCLKernelFile( mayaLocation );</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">        <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_auto_c_l_kernel.html\">MAutoCLKernel</a> kernel = <a name=\"a31\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_open_c_l_info.html#a9b9a0680620c0ecac7dd1b07159ee72f\">MOpenCLInfo::getOpenCLKernel</a>( openCLKernelFile, openCLKernelName );</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span> ( kernel.<a name=\"a32\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_auto_c_l_kernel.html#ac02f2a4d7312eb91f40980adfd4e31b2\">isNull</a>() )</div>\n\
<div class=\"line\">        {</div>\n\
...
<div class=\"line\">            <a name=\"a33\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_open_c_l_info.html#a7861622490349f1240dfbe76c21e3e0a\">MOpenCLInfo::getOpenCLDeviceId</a>(),</div>\n\
...
<div class=\"line\">            );</div>\n\
<div class=\"line\">        <a name=\"a34\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_open_c_l_info.html#a753d7277906776cd710b3723d74f8b64\">MOpenCLInfo::checkCLErrorStatus</a>(err);</div>\n\
...
<div class=\"line\">    <a name=\"_a35\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_open_c_l_info.html\">MOpenCLInfo</a>::checkCLErrorStatus(err);</div>\n\
...
<div class=\"line\">    <span class=\"keywordflow\">if</span> (inputPositions.<a name=\"a36\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_g_p_u_deformer_buffer.html#ac80e15ff48577dcb6db7ba2db5788427\">bufferReadyEvent</a>().<a name=\"a37\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_auto_c_l_event.html#a9ae83b577cfbaa81ee19053c78dedccd\">get</a>() )</div>\n\
<div class=\"line\">    {</div>\n\
...
<div class=\"line\">    <a name=\"_a38\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_auto_c_l_event.html\">MAutoCLEvent</a> kernelFinishedEvent;</div>\n\
<div class=\"line\">    err = clEnqueueNDRangeKernel(</div>\n\
<div class=\"line\">        <a name=\"a39\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_open_c_l_info.html#a93e129c1488b06f3347eaaad703ffe34\">MOpenCLInfo::getMayaDefaultOpenCLCommandQueue</a>() ,</div>\n\
<div class=\"line\">        fKernel.get() ,</div>\n\
...
<div class=\"line\">        kernelFinishedEvent.<a name=\"a40\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_auto_c_l_event.html#a5622645d1b16ac4ab77c233dcea5c5be\">getReferenceForAssignment</a>()</div>\n\
<div class=\"line\">        );</div>\n\
<div class=\"line\">    outputPositions.<a name=\"a41\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_g_p_u_deformer_buffer.html#ac46e36b6959e261802c9603be6137302\">setBufferReadyEvent</a>(kernelFinishedEvent);</div>\n\
...
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    outputData.<a name=\"a42\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_g_p_u_deformer_data.html#a9710db42ff7918d4b588b0045fecdcd0\">setBuffer</a>(outputPositions);</div>\n\
...
<div class=\"line\">{</div>\n\
<div class=\"line\">    <a name=\"a43\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_open_c_l_info.html#a08df219d94dcf2dc03724eff7d5c6483\">MOpenCLInfo::releaseOpenCLKernel</a>(fKernel);</div>\n\
...
<div class=\"line\"><span class=\"comment\">//</span></div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html\">MStatus</a> initializePlugin( <a name=\"_a44\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html\">MObject</a> obj )</div>\n\
<div class=\"line\">{</div>\n\
...
<div class=\"line\">        MPxNode::kDeformerNode</div>\n\
<div class=\"line\">        );</div>\n\
<div class=\"line\"></div>\n\
