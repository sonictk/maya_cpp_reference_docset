...
<div class=\"line\">        {</div>\n\
<div class=\"line\">            <a name=\"_a55\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_int_array_data.html\">MFnIntArrayData</a> arr(iPlug.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#ada03566ab064058c7ef435ae306d3809\">asMObject</a>());</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">            <span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span> length = arr.<a name=\"a56\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_int_array_data.html#a99dd6a54b909ede1d11702fe58977e2a\">length</a>();</div>\n\
...
<div class=\"line\">        {</div>\n\
<div class=\"line\">            <a name=\"_a57\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_point_array_data.html\">MFnPointArrayData</a> arr(iPlug.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#ada03566ab064058c7ef435ae306d3809\">asMObject</a>());</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">            <span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span> length = arr.<a name=\"a58\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_point_array_data.html#a99dd6a54b909ede1d11702fe58977e2a\">length</a>();</div>\n\
...
<div class=\"line\">            <span class=\"keywordflow\">for</span> (<span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span> i = 0; i &lt; length; i++)</div>\n\
<div class=\"line\">            {</div>\n\
<div class=\"line\">                <a name=\"_a59\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_point.html\">MPoint</a> pt(arr[i]);</div>\n\
<div class=\"line\">                val[extent*i] = pt.<a name=\"a60\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_point.html#af88b946fb90d5f08b5fb740c70e98c10\">x</a>;</div>\n\
<div class=\"line\">                val[extent*i+1] = pt.<a name=\"a61\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_point.html#ab927965981178aa1fba979a37168db2a\">y</a>;</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">                <span class=\"keywordflow\">if</span> (extent &gt; 2)</div>\n\
<div class=\"line\">                    val[extent*i+2] = pt.<a name=\"a62\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_point.html#ab3e6ed577a7c669c19de1f9c1b46c872\">z</a>;</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">                <span class=\"keywordflow\">if</span> (extent &gt; 3)</div>\n\
<div class=\"line\">                    val[extent*i+3] = pt.<a name=\"a63\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_point.html#afb3248bab1c7ee0ad97e9d4c275b4c67\">w</a>;</div>\n\
<div class=\"line\">            }</div>\n\
<div class=\"line\">            AbcA::ArraySample samp(&amp;(val.front()), oProp.getDataType(),</div>\n\
<div class=\"line\">                Alembic::Util::Dimensions(length));</div>\n\
<div class=\"line\">            oProp.set(samp);</div>\n\
...
<div class=\"line\">        {</div>\n\
<div class=\"line\">            <a name=\"_a64\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_vector_array_data.html\">MFnVectorArrayData</a> arr(iPlug.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#ada03566ab064058c7ef435ae306d3809\">asMObject</a>());</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">            <span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span> length = arr.<a name=\"a65\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_vector_array_data.html#a99dd6a54b909ede1d11702fe58977e2a\">length</a>();</div>\n\
<div class=\"line\">            <span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span> extent = oProp.getDataType().getExtent();</div>\n\
<div class=\"line\">            std::vector&lt; double &gt; val(length*extent);</div>\n\
<div class=\"line\">            <span class=\"keywordflow\">for</span> (<span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span> i = 0; i &lt; length; i++)</div>\n\
<div class=\"line\">            {</div>\n\
<div class=\"line\">                <a name=\"_a66\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_vector.html\">MVector</a> v(arr[i]);</div>\n\
<div class=\"line\">                val[extent*i] = v.<a name=\"a67\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_vector.html#af88b946fb90d5f08b5fb740c70e98c10\">x</a>;</div>\n\
<div class=\"line\">                val[extent*i+1] = v.<a name=\"a68\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_vector.html#ab927965981178aa1fba979a37168db2a\">y</a>;</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">                <span class=\"keywordflow\">if</span> (extent &gt; 2)</div>\n\
<div class=\"line\">                   val[extent*i+2] = v.<a name=\"a69\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_vector.html#ab3e6ed577a7c669c19de1f9c1b46c872\">z</a>;</div>\n\
<div class=\"line\">            }</div>\n\
<div class=\"line\">            AbcA::ArraySample samp(&amp;(val.front()), oProp.getDataType(),</div>\n\
<div class=\"line\">                Alembic::Util::Dimensions(length));</div>\n\
<div class=\"line\">            oProp.set(samp);</div>\n\
...
<div class=\"line\">                                   Abc::OScalarProperty &amp; oProp)</div>\n\
<div class=\"line\">{</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> (iAttr.<a name=\"a70\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html#af0af77f14f96d1134fb8e8e60dc7e420\">hasFn</a>(<a name=\"a71\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn.html#a1d1cfd8ffb84e947f82999c682b666a7adead26e1b827316155632e4cb27c848b\">MFn::kTypedAttribute</a>))</div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">        <a name=\"_a72\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_typed_attribute.html\">MFnTypedAttribute</a> typedAttr(iAttr);</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">return</span> MFnTypedDataToSample(typedAttr.<a name=\"a73\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_typed_attribute.html#aa3bf2ba724f9aaf87976b1fb896fd700\">attrType</a>(), iPlug, oProp);</div>\n\
<div class=\"line\">    }</div>\n\
...
<div class=\"line\">    {</div>\n\
<div class=\"line\">        <a name=\"_a75\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_numeric_attribute.html\">MFnNumericAttribute</a> numAttr(iAttr);</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">return</span> MFnNumericDataToSample(numAttr.<a name=\"a76\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_numeric_attribute.html#a475558f03040cb41c9af196253650823\">unitType</a>(), iPlug, oProp);</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">else</span> <span class=\"keywordflow\">if</span> (iAttr.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html#af0af77f14f96d1134fb8e8e60dc7e420\">hasFn</a>(<a name=\"a77\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn.html#a1d1cfd8ffb84e947f82999c682b666a7a1f483b65a79a5100d8f7a91e2c4c68a3\">MFn::kUnitAttribute</a>))</div>\n\
<div class=\"line\">    {</div>\n\
...
<div class=\"line\">                                   std::vector &lt; PlugAndObjArray &gt; &amp; oArrays)</div>\n\
<div class=\"line\">{</div>\n\
<div class=\"line\">    <a name=\"_a79\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html\">MStatus</a> stat;</div>\n\
<div class=\"line\">    std::string plugName = iPlug.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a3694e3dcc355fb7d654a0bb6a8a3ff1c\">partialName</a>(0, 0, 0, 0, 0, 1).<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html#aa9ab612f356c53479afc4c648c9ef94d\">asChar</a>();</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">            err += iAttr.<a name=\"a80\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html#a3dad4d354c5b968cf4eccfffcdb824f4\">apiTypeStr</a>();</div>\n\
<div class=\"line\">            <a name=\"a81\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_global.html#a4ddbe97e58a90e1ab05d45a62c006cf0\">MGlobal::displayError</a>(err);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">                <a name=\"a82\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_global.html#acb043e7fc4eb7fc0f39833d31364b8a4\">MGlobal::displayWarning</a>(msg);</div>\n\
<div class=\"line\">            }</div>\n\
<div class=\"line\">            <span class=\"keywordflow\">break</span>;</div>\n\
<div class=\"line\">        }</div>\n\
<div class=\"line\">    }</div>\n\
...
<div class=\"line\">    <span class=\"keywordflow\">if</span> (iPlug.<a name=\"a83\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#ad8079bb3afa94060b5e42af75df9f1b4\">isElement</a>())</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">return</span>;</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    <span class=\"keyword\">const</span> <a name=\"_a84\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_dependency_node.html\">MFnDependencyNode</a> &amp; iNode,</div>\n\
<div class=\"line\">    Alembic::Util::uint32_t iTimeIndex,</div>\n\
<div class=\"line\">    <span class=\"keyword\">const</span> JobArgs &amp; iArgs)</div>\n\
<div class=\"line\">{</div>\n\
<div class=\"line\">    PlugAndObjScalar visPlug;</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span> attrCount = iNode.<a name=\"a85\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_dependency_node.html#af762f251eae844405571ed86ab9d1509\">attributeCount</a>();</div>\n\
...
<div class=\"line\">    {</div>\n\
<div class=\"line\">        <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html\">MObject</a> attr = iNode.<a name=\"a86\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_dependency_node.html#a6117a63ae3bb2d03aa976dc8732d93a5\">attribute</a>(i);</div>\n\
<div class=\"line\">        <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_attribute.html\">MFnAttribute</a> mfnAttr(attr);</div>\n\
<div class=\"line\">        <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html\">MPlug</a> plug = iNode.<a name=\"a87\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_dependency_node.html#aac29b4a3b51c9d236175e955638f7153\">findPlug</a>(attr, <span class=\"keyword\">true</span>);</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">        <span class=\"comment\">// if it is not readable, then bail without any more checking</span></div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span> (!mfnAttr.isReadable() || plug.<a name=\"a88\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#ab7ec149d38b7c29ca55c5aa7b407d8f9\">isNull</a>())</div>\n\
...
<div class=\"line\">            ( !iPlug.<a name=\"a89\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a839768abda6d6ba21e549302208943bd\">isChild</a>() || !isDataAttr(iPlug.<a name=\"a90\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#aa2338038d1c59dc4d35f37f918aabfab\">parent</a>()) ))</div>\n\
<div class=\"line\">        {</div>\n\
