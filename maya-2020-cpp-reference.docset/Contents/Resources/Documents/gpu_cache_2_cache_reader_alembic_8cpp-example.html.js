...
<div class=\"line\">        MFnNurbsSurface::Form uForm = MFnNurbsSurface::kPeriodic;</div>\n\
<div class=\"line\">        MFnNurbsSurface::Form vForm = MFnNurbsSurface::kPeriodic;</div>\n\
...
<div class=\"line\">                    uForm = MFnNurbsSurface::kOpen;</div>\n\
<div class=\"line\">                    notOpen = <span class=\"keyword\">false</span>;</div>\n\
<div class=\"line\">                    <span class=\"keywordflow\">break</span>;</div>\n\
<div class=\"line\">                }</div>\n\
<div class=\"line\">            }</div>\n\
<div class=\"line\">        }</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span> (uForm == MFnNurbsSurface::kOpen) {</div>\n\
<div class=\"line\">            uForm = MFnNurbsSurface::kClosed;</div>\n\
<div class=\"line\">            <span class=\"keywordflow\">for</span> (<span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span> v = 0; v &lt; numV; v++) {</div>\n\
...
<div class=\"line\">                <span class=\"keywordflow\">if</span> (!mayaPositions[firstIndex].isEquivalent(mayaPositions[lastPeriodicIndex])) {</div>\n\
<div class=\"line\">                    vForm = MFnNurbsSurface::kOpen;</div>\n\
<div class=\"line\">                    notOpen = <span class=\"keyword\">false</span>;</div>\n\
<div class=\"line\">                    <span class=\"keywordflow\">break</span>;</div>\n\
<div class=\"line\">                }</div>\n\
<div class=\"line\">            }</div>\n\
<div class=\"line\">        }</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span> (vForm == MFnNurbsSurface::kOpen) {</div>\n\
<div class=\"line\">            vForm = MFnNurbsSurface::kClosed;</div>\n\
<div class=\"line\">            <span class=\"keywordflow\">for</span> (<span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span> u = 0; u &lt; numU; u++) {</div>\n\
...
<div class=\"line\">        <span class=\"keyword\">const</span> <span class=\"keywordtype\">float</span>* uKnot    = fUKnotCache.getValue()-&gt;<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_point_array.html#aab050cd677ada1564ca558d3840628cd\">get</a>();</div>\n\
<div class=\"line\">        <span class=\"keyword\">const</span> <span class=\"keywordtype\">float</span>* vKnot    = fVKnotCache.getValue()-&gt;get();</div>\n\
<div class=\"line\">        <a name=\"_a8\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_double_array.html\">MDoubleArray</a> mayaUKnots(uKnot + 1, numUKnot - 2);</div>\n\
...
<div class=\"line\">        <a name=\"_a9\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html\">MObject</a> nurbsData = fNurbsData.create();</div>\n\
...
<div class=\"line\">        <span class=\"keywordflow\">if</span> (status != MS::kSuccess || nurbs.<a name=\"a10\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html#ac02f2a4d7312eb91f40980adfd4e31b2\">isNull</a>()) {</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">            <a name=\"_a11\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_trim_boundary_array.html\">MTrimBoundaryArray</a> boundaryArray;</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">                    fTrimNumCurvesCache.getValue()-&gt;<a name=\"a12\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_trim_boundary_array.html#af99b4425d90f73b88634ec50327ae48a\">get</a>();</div>\n\
...
<div class=\"line\">                    fTrimNumVerticesCache.getValue()-&gt;<a name=\"a13\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object_array.html#a8223a66b2c37fdf38b8a95b53566a7a7\">get</a>();</div>\n\
...
<div class=\"line\">                <a name=\"_a14\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object_array.html\">MObjectArray</a> boundary(numCurves);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">                    <a name=\"_a15\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_nurbs_curve_data.html\">MFnNurbsCurveData</a> curveData;</div>\n\
<div class=\"line\">                    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html\">MObject</a> curveDataObject = curveData.<a name=\"a16\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_nurbs_curve_data.html#af1adb4abaf5243c6c0749bcca7b5c418\">create</a>();</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">                    <a name=\"_a17\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_nurbs_curve.html\">MFnNurbsCurve</a> curve;</div>\n\
<div class=\"line\">                    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html\">MObject</a> curveObject  = curve.<a name=\"a18\"></a>create(controlPoints, knots, degree,</div>\n\
<div class=\"line\">                            MFnNurbsCurve::kOpen, <span class=\"keyword\">true</span>, <span class=\"keyword\">true</span>, curveDataObject, &amp;status);</div>\n\
...
<div class=\"line\">                }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">                boundaryArray.<a name=\"a19\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_trim_boundary_array.html#a58aa0ffd87a8ca32834b827e1452f23e\">append</a>(boundary);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">            <span class=\"keywordflow\">for</span> (<span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span> i = 0; i &lt; boundaryArray.<a name=\"a20\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_trim_boundary_array.html#a580388f31f60c46fac867ca48a48da1e\">length</a>(); i++) {</div>\n\
<div class=\"line\">                <span class=\"keywordflow\">if</span> (i &gt; 0) {</div>\n\
<div class=\"line\">                    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html\">MObject</a> loopData = boundaryArray.<a name=\"a21\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_trim_boundary_array.html#a8c5c9d056371db0b771e14526c08b520\">getMergedBoundary</a>(i, &amp;status);</div>\n\
...
<div class=\"line\">                        <span class=\"keywordflow\">if</span> (rightMostPoint.<a name=\"a22\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_point.html#af88b946fb90d5f08b5fb740c70e98c10\">x</a> &lt; curvePoints[j].x) {</div>\n\
...
<div class=\"line\">                    <a name=\"_a23\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_vector.html\">MVector</a> vector1 = curvePoints[beforeIndex] - curvePoints[rightMostIndex];</div>\n\
...
<div class=\"line\">                            <span class=\"keywordflow\">return</span>;</div>\n\
<div class=\"line\">                        }</div>\n\
<div class=\"line\">                        oneRegion.<a name=\"a24\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_trim_boundary_array.html#ad5522f028dde0080b753279426415a4a\">clear</a>();</div>\n\
<div class=\"line\">                    }</div>\n\
<div class=\"line\">                }</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    <a name=\"_a25\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_tesselation_params.html\">MTesselationParams</a> params(</div>\n\
<div class=\"line\">        <a name=\"a26\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_tesselation_params.html#a5b2a7c1776e72b64f6b50fc95871c146a0d4e0874a457fb879a20aa067222b65b\">MTesselationParams::kStandardFitFormat</a>, <a name=\"a27\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_tesselation_params.html#a05266719b7393f22777306c9b4faf514aa2c70dd76c8172a9298334473c914304\">MTesselationParams::kTriangles</a>);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    <a name=\"_a30\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_int_array.html\">MIntArray</a> mayaCounts, mayaConnects;</div>\n\
<div class=\"line\">    mayaCounts.<a name=\"a31\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_int_array.html#a8c66dfa06f3736b2a214c5aed58bd216\">setLength</a>((<span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span>)numFaceCounts);</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">    </div>\n\
<div class=\"line\">    <a name=\"_a32\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_float_point_array.html\">MFloatPointArray</a> mayaPositions;</div>\n\
<div class=\"line\">    mayaPositions.<a name=\"a33\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_float_point_array.html#a8c66dfa06f3736b2a214c5aed58bd216\">setLength</a>((<span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span>)numVertices);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">        mayaPositions[i] = <a name=\"_a34\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_float_point.html\">MFloatPoint</a>(positions[i * 3 + 0],</div>\n\
...
<div class=\"line\">    <a name=\"_a35\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_uint_array.html\">MUintArray</a>   mayaEdgeIds;</div>\n\
...
<div class=\"line\">                mayaEdgeIds.<a name=\"a36\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_uint_array.html#a29ccefc020c96f15e099924ebe83eb07\">append</a>(iter-&gt;second);</div>\n\
<div class=\"line\">                mayaCreaseData.<a name=\"a37\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_double_array.html#aafcfe8ff7afecc2dee4defccbdfb8e55\">append</a>(sharpness);</div>\n\
<div class=\"line\">            }</div>\n\
<div class=\"line\">        }</div>\n\
...
<div class=\"line\">    mayaVertexIds.<a name=\"a38\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_uint_array.html#a8c66dfa06f3736b2a214c5aed58bd216\">setLength</a>((<span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span>)numCreaseVertices);</div>\n\
<div class=\"line\">    mayaCreaseData.<a name=\"a39\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_double_array.html#a8c66dfa06f3736b2a214c5aed58bd216\">setLength</a>((<span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span>)numCreaseVertices);</div>\n\
...
<div class=\"line\">    <a name=\"_a40\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_float_array.html\">MFloatArray</a> mayaUArray((<span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span>)numUVs);</div>\n\
...
<div class=\"line\">    <a name=\"_a41\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_mesh_data.html\">MFnMeshData</a> smoothMeshData;</div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html\">MObject</a> smoothMeshDataObj = smoothMeshData.<a name=\"a42\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_mesh_data.html#af1adb4abaf5243c6c0749bcca7b5c418\">create</a>();</div>\n\
<div class=\"line\">    </div>\n\
<div class=\"line\">    <a name=\"_a43\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_mesh_smooth_options.html\">MMeshSmoothOptions</a> smoothOptions;</div>\n\
<div class=\"line\">    smoothOptions.<a name=\"a44\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_mesh_smooth_options.html#ae83b35db107d4c6252c7bd7f36b5a723\">setDivisions</a>(2);</div>\n\
...
<div class=\"line\">    <span class=\"keyword\">const</span> <a name=\"_a45\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_matrix.html\">MMatrix</a>&amp; rootMatrix, TimeInterval rootMatrixInterval)</div>\n\
<div class=\"line\">{</div>\n\
<div class=\"line\">    TimeInterval validityInterval(TimeInterval::kInfinite);</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <a name=\"_a46\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_bounding_box.html\">MBoundingBox</a> bbox;</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">        bbox.<a name=\"a47\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_bounding_box.html#aee704d46278fb5925a7bd814a5773ccd\">expand</a>(childReader-&gt;getBoundingBox());</div>\n\
...
<div class=\"line\">                seconds,</div>\n\
<div class=\"line\">                <a name=\"a48\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_matrix.html#a9b368179e6c468c7fc4e6b3358ae6f2f\">MMatrix::identity</a>,</div>\n\
...
<div class=\"line\">        SubNode::create(<a name=\"_a49\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html\">MString</a>(<span class=\"stringliteral\">&quot;|&quot;</span>), fXformData);</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">for</span>(<span class=\"keyword\">const</span> AlembicCacheObjectReader::Ptr&amp; childReader : fChildren) {</div>\n\
...
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> (material.<a name=\"a50\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html#a580388f31f60c46fac867ca48a48da1e\">length</a>() &gt; 0) {</div>\n\
...
<div class=\"line\">    fBoundingBox.<a name=\"a51\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_bounding_box.html#ac8bb3912a3ce86b15842e79d0b421204\">clear</a>();</div>\n\
...
<div class=\"line\">{</div>\n\
<div class=\"line\">    MakeSharedEnabler(<span class=\"keyword\">const</span> <a name=\"_a52\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_file_object.html\">MFileObject</a>&amp; file): AlembicCacheReader(file){}</div>\n\
<div class=\"line\">};</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html\">MString</a> resolvedFullName = file.<a name=\"a53\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_file_object.html#a9484f49594e6f95729f1be1608a6ae8f\">resolvedFullName</a>();</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">try</span> {</div>\n\
<div class=\"line\">        std::lock_guard&lt;std::mutex&gt; alembicLock(gsAlembicMutex);</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span> (resolvedFullName.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html#a580388f31f60c46fac867ca48a48da1e\">length</a>() != 0 &amp;&amp; std::ifstream(resolvedFullName.<a name=\"a54\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html#aa9ab612f356c53479afc4c648c9ef94d\">asChar</a>()).good()) {</div>\n\
...
<div class=\"line\">                DisplayError(kFileFormatWrongMsg, file.<a name=\"a55\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_file_object.html#a2f505a3eabc9709fad04e2a14d960614\">rawFullName</a>());</div>\n\
<div class=\"line\">            }</div>\n\
<div class=\"line\">        }</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">else</span> {</div>\n\
...
<div class=\"line\">        <a name=\"_a56\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string_array.html\">MStringArray</a> pathArray;</div>\n\
<div class=\"line\">        geomPath.<a name=\"a57\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html#ac914d138fc96d7065c687a4f8b40c263\">split</a>(<span class=\"charliteral\">&#39;|&#39;</span>, pathArray);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">        <span class=\"keywordflow\">for</span> (<span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span> i = 0; i &lt; pathArray.<a name=\"a58\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string_array.html#a580388f31f60c46fac867ca48a48da1e\">length</a>(); i++) {</div>\n\
...
<div class=\"line\">    <span class=\"keywordtype\">int</span> lastStep = geomPath.<a name=\"a59\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html#a8b323761724ea9659348e33b0fea356b\">rindexW</a>(<span class=\"charliteral\">&#39;|&#39;</span>);</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> (lastStep &gt; 0) {</div>\n\
<div class=\"line\">        prefix = geomPath.<a name=\"a60\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html#ad748626e545fa6db3afc2f61644b5d62\">substringW</a>(0, lastStep - 1);</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
