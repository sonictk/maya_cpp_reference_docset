...
<div class=\"line\"></div>\n\
<div class=\"line\">    syntax.<a name=\"a6\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_syntax.html#aeaeaac3794bb4de8004afb1ac1829488\">addFlag</a>(bufferOperationShortName, bufferOperationLongName, MSyntax::kString);</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"comment\">// Name of model panel to monitor</span></div>\n\
<div class=\"line\">    <span class=\"comment\">//</span></div>\n\
<div class=\"line\">    syntax.<a name=\"a7\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_syntax.html#a1d306e0ce61954dd7cbdcd0e74a905a6\">addArg</a>(MSyntax::kString);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    {</div>\n\
<div class=\"line\">        arg = args.<a name=\"a10\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_arg_list.html#ad24ff3826e4df513b55e1a0ecb0a665b\">asString</a>( i, &amp;status );</div>\n\
...
<div class=\"line\">            args.<a name=\"a11\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_arg_list.html#adc169cdc872457a2664c3d66c29cf504\">get</a>(i, operationString );</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">                status.<a name=\"a12\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a1f01a4748fea4d8bcced082df83f804d\">perror</a>(<span class=\"stringliteral\">&quot;Invalid operation specified. Using invert by default.&quot;</span>);</div>\n\
<div class=\"line\">        }</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">        = <a name=\"a14\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_ui_message.html#a896e7f0af2318e5a7145e189cb235912\">MUiMessage::add3dViewPreRenderMsgCallback</a>(panelName,</div>\n\
...
<div class=\"line\">        = <a name=\"a15\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_ui_message.html#af33879a7a29a0853f35ede9de091beb1\">MUiMessage::add3dViewPostRenderMsgCallback</a>(panelName,</div>\n\
...
<div class=\"line\">        <a name=\"a16\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_message.html#a50fe995add3ce133b8b56551abb4ed09\">MMessage::removeCallback</a>(mDeleteId);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">    cout&lt;&lt;<span class=\"stringliteral\">&quot;In delete view callback for view &quot;</span>&lt;&lt;panelName.<a name=\"a17\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html#aa9ab612f356c53479afc4c648c9ef94d\">asChar</a>()</div>\n\
...
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html\">MStatus</a> status = <a name=\"a19\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m3d_view.html#a6f8dcac6993b14738fc6259cfd50a3b8\">M3dView::getM3dViewFromModelPanel</a>(panelName, view);</div>\n\
...
<div class=\"line\">    width = view.<a name=\"a20\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m3d_view.html#a09f01ebd9a52d4e74196c90fd3c1316c\">portWidth</a>( &amp;status );</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> (status != MS::kSuccess || (width &lt; 2))</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">return</span>;</div>\n\
<div class=\"line\">    height = view.<a name=\"a21\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m3d_view.html#a419e60769b8303476d6d25853b3b5f6f\">portHeight</a>( &amp;status );</div>\n\
...
<div class=\"line\">    status = view.<a name=\"a22\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m3d_view.html#a4043cdd4c78b1c6ceafe8ae9f496763c\">pushViewport</a> (vx, vy, vwidth, vheight);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">        <a name=\"_a23\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_point.html\">MPoint</a> origin;</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">        _OPENMAYA_DEPRECATION_PUSH_AND_DISABLE_WARNING</div>\n\
<div class=\"line\">        status = view.<a name=\"a24\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m3d_view.html#a1d533091a31a590ee4599fde04fa65d7\">drawText</a>( <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html\">MString</a>(<span class=\"stringliteral\">&quot;Pre render callback: &quot;</span>) + panelName, origin );</div>\n\
<div class=\"line\">        _OPENMAYA_POP_WARNING</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    view.<a name=\"a25\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m3d_view.html#a59c2e5dd7b3333946848be138928482b\">popViewport</a>();</div>\n\
<div class=\"line\">}</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">        status = view.<a name=\"a26\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m3d_view.html#a9dd85add630aeee817d42c1018261fa8\">readDepthMap</a>( 0,0, width, height, (<span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">char</span> *)depthPixels, M3dView::kDepth_Float );</div>\n\
<div class=\"line\">        _OPENMAYA_POP_WARNING</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span> (status != MS::kSuccess)</div>\n\
<div class=\"line\">        {</div>\n\
...
<div class=\"line\">        }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">        <a name=\"_a27\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_image.html\">MImage</a> image;</div>\n\
<div class=\"line\">        image.<a name=\"a28\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_image.html#a41d909431057599c48be86e57440bcec\">setPixels</a>( colorPixels, width, height );</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">        status = view.<a name=\"a29\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m3d_view.html#a1a329cac7ac49083ab198cc78c38fa1f\">writeColorBuffer</a>( image, 5, 5 );</div>\n\
<div class=\"line\">        _OPENMAYA_POP_WARNING</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span> (depthPixels)</div>\n\
<div class=\"line\">            <span class=\"keyword\">delete</span> [] depthPixels;</div>\n\
...
<div class=\"line\">        _OPENMAYA_DEPRECATION_PUSH_AND_DISABLE_WARNING</div>\n\
<div class=\"line\">        status = view.<a name=\"a30\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m3d_view.html#a02ea5cc758421097ddafe883c64e30ee\">readColorBuffer</a>( image, readAsRGBA );</div>\n\
<div class=\"line\">        _OPENMAYA_POP_WARNING</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span> (status != MS::kSuccess)</div>\n\
<div class=\"line\">            <span class=\"keywordflow\">return</span>;</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">        _OPENMAYA_POP_WARNING</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">        <span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">char</span> *pixelPtr = (<span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">char</span>*)image.<a name=\"a31\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_image.html#aba6def80dd70f1c9af3dbd348fe270ac\">pixels</a>();</div>\n\
...
<div class=\"line\">            image.<a name=\"a32\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_image.html#acab1f6acf34fc74e4d717322fa35241a\">getSize</a>( width, height );</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">            <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_image.html\">MImage</a> image2;</div>\n\
<div class=\"line\">            image2.<a name=\"a33\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_image.html#a903ff4fa0918f6c6438c4889025b7c91\">create</a>( width, height );</div>\n\
...
<div class=\"line\"><span class=\"comment\">//</span></div>\n\
<div class=\"line\"><span class=\"comment\"></span></div>\n\
<div class=\"line\"><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html\">MStatus</a> initializePlugin( <a name=\"_a34\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html\">MObject</a> obj )</div>\n\
<div class=\"line\">{ </div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html\">MStatus</a>   status;</div>\n\
<div class=\"line\">    <a name=\"_a35\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_plugin.html\">MFnPlugin</a> plugin( obj, PLUGIN_COMPANY, <span class=\"stringliteral\">&quot;6.5&quot;</span>, <span class=\"stringliteral\">&quot;Any&quot;</span>);</div>\n\
<div class=\"line\"></div>\n\
