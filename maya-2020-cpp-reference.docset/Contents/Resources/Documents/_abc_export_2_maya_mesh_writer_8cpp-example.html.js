...
<div class=\"line\">        connSG.<a name=\"a29\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object_array.html#a3694392863ba632bca5d76cbbf190ef5\">append</a>( itDG.currentItem() );</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">return</span> connSG;</div>\n\
<div class=\"line\">}</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    <span class=\"keywordflow\">if</span>( SG.<a name=\"a30\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html#af0af77f14f96d1134fb8e8e60dc7e420\">hasFn</a>(<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn.html#a1d1cfd8ffb84e947f82999c682b666a7a1fe410ba33fcc24e08a319ee3db38896\">MFn::kShadingEngine</a>) != true )</div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">        <a name=\"_a31\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_dependency_node.html\">MFnDependencyNode</a> fnDepNode( SG );</div>\n\
<div class=\"line\">        <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html\">MString</a> message;</div>\n\
<div class=\"line\">        message.<a name=\"a32\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html#a07ae464181c795f43fa1bcc288acff91\">format</a>(<span class=\"stringliteral\">&quot;Node ^1s is not a valid shading engine...&quot;</span>, fnDepNode.<a name=\"a33\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_dependency_node.html#a049384adbea0396ea2f03d1ad4d69df1\">name</a>() );</div>\n\
...
<div class=\"line\">    <a name=\"_a34\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html\">MPlug</a> iogPlug( depNode.findPlug(instObjGroupsAttrName, <span class=\"keyword\">false</span>, &amp;status) );</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span>( status == MS::kFailure )</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">return</span> MS::kFailure;</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    <a name=\"_a35\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug_array.html\">MPlugArray</a> iogConnections;</div>\n\
...
<div class=\"line\">    <a name=\"_a36\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_set.html\">MFnSet</a> fnSet( SG );</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"comment\">// Retrieve members</span></div>\n\
<div class=\"line\">    <a name=\"_a37\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_selection_list.html\">MSelectionList</a> selList;</div>\n\
...
<div class=\"line\">    {</div>\n\
<div class=\"line\">        fnSet.<a name=\"a38\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_set.html#a4816acf44a8c21134cbe3d92a3f60925\">getMembers</a>(selList, <span class=\"keyword\">false</span>);</div>\n\
...
<div class=\"line\">    <a name=\"_a39\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_it_selection_list.html\">MItSelectionList</a>    itSelList( selList );</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">for</span>( ; itSelList.<a name=\"a40\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_it_selection_list.html#ac0f0d6fc806b11d246e05cb94e886b38\">isDone</a>()!=<span class=\"keyword\">true</span>; itSelList.<a name=\"a41\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_it_selection_list.html#a73616f002814b8abe6d921db72d7a496\">next</a>() )</div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">        <span class=\"comment\">// Test if it&#39;s a face mapping</span></div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span>( itSelList.<a name=\"a42\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_it_selection_list.html#a92d079398d0738af52f0ef1cead18c0e\">hasComponents</a>() == true )</div>\n\
<div class=\"line\">        {</div>\n\
<div class=\"line\">            itSelList.<a name=\"a43\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_it_selection_list.html#acea3f9b4576b874442d489458ac310c0\">getDagPath</a>( curDagPath, compObj );</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">            <span class=\"comment\">// Test if component object is valid and if it&#39;s the right object</span></div>\n\
<div class=\"line\">            <span class=\"keywordflow\">if</span>( (compObj.<a name=\"a44\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html#ac02f2a4d7312eb91f40980adfd4e31b2\">isNull</a>()==<span class=\"keyword\">false</span>) &amp;&amp; (curDagPath==dagPath) )</div>\n\
<div class=\"line\">            {</div>\n\
...
<div class=\"line\">    <span class=\"keywordflow\">if</span> (uvSetName.<a name=\"a45\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html#a580388f31f60c46fac867ca48a48da1e\">length</a>() != 0)</div>\n\
<div class=\"line\">    {</div>\n\
...
<div class=\"line\">        {</div>\n\
<div class=\"line\">            name = uvSetName.<a name=\"a46\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html#aa9ab612f356c53479afc4c648c9ef94d\">asChar</a>();</div>\n\
<div class=\"line\">        }</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    <span class=\"keywordflow\">if</span>( plug.<a name=\"a47\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#ab7ec149d38b7c29ca55c5aa7b407d8f9\">isNull</a>() &amp;&amp; iArgs.autoSubd )</div>\n\
<div class=\"line\">    {</div>\n\
...
<div class=\"line\">        hasToWriteSubd = ( (edgeIds.<a name=\"a50\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_uint_array.html#a580388f31f60c46fac867ca48a48da1e\">length</a>() &gt; 0) || (vertexIds.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_uint_array.html#a580388f31f60c46fac867ca48a48da1e\">length</a>() &gt; 0) );</div>\n\
...
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> ( (!plug.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#ab7ec149d38b7c29ca55c5aa7b407d8f9\">isNull</a>() &amp;&amp; plug.<a name=\"a51\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a69b4092a85b4edf58b7d50f331cc38cf\">asBool</a>()) || hasToWriteSubd )</div>\n\
<div class=\"line\">    {</div>\n\
...
<div class=\"line\">    {</div>\n\
<div class=\"line\">        <a name=\"_a52\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string_array.html\">MStringArray</a> colorSetNames;</div>\n\
<div class=\"line\">        lMesh.getColorSetNames(colorSetNames);</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span> (colorSetNames.<a name=\"a53\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string_array.html#a580388f31f60c46fac867ca48a48da1e\">length</a>() &gt; 0)</div>\n\
<div class=\"line\">        {</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">                {</div>\n\
<div class=\"line\">                    md.<a name=\"a54\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string_array.html#ad28f02905011d9f0693e8c8dc2777ddd\">set</a>(<span class=\"stringliteral\">&quot;mayaColorSet&quot;</span>, <span class=\"stringliteral\">&quot;1&quot;</span>);</div>\n\
<div class=\"line\">                }</div>\n\
<div class=\"line\">                <span class=\"keywordflow\">else</span></div>\n\
<div class=\"line\">                {</div>\n\
<div class=\"line\">                    md.<a name=\"a55\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#ad8887c924f0cc954364fd532c7867d86\">set</a>(<span class=\"stringliteral\">&quot;mayaColorSet&quot;</span>, <span class=\"stringliteral\">&quot;0&quot;</span>);</div>\n\
<div class=\"line\">                }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">                <span class=\"keywordflow\">if</span> (lMesh.getColorRepresentation(colorSetNames[i]) ==</div>\n\
<div class=\"line\">                    MFnMesh::kRGB)</div>\n\
<div class=\"line\">                {</div>\n\
...
<div class=\"line\">        <a name=\"_a56\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_single_indexed_component.html\">MFnSingleIndexedComponent</a> compFn;</div>\n\
<div class=\"line\">        compFn.<a name=\"a57\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_base.html#ad09f5acece0f9926b3e0e55cff78c3be\">setObject</a>(compObj);</div>\n\
<div class=\"line\">        compFn.<a name=\"a58\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_single_indexed_component.html#af46c6b65dba2489debae349dab66e127\">getElements</a>(indices);</div>\n\
<div class=\"line\">        <span class=\"keyword\">const</span> <span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span> numData = indices.<a name=\"a59\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_int_array.html#a580388f31f60c46fac867ca48a48da1e\">length</a>();</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">        {</div>\n\
<div class=\"line\">            faceSetName = abcFacesetNamePlug.<a name=\"a60\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a445750444a9e8c22b8b2366f19d7264a\">asString</a>().<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html#aa9ab612f356c53479afc4c648c9ef94d\">asChar</a>();</div>\n\
<div class=\"line\">        }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span> (mPolySchema.valid())</div>\n\
<div class=\"line\">        {</div>\n\
...
<div class=\"line\">            <a name=\"_a61\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_vector.html\">MVector</a> normal;</div>\n\
...
<div class=\"line\">        samp.setFaceVaryingInterpolateBoundary(plug.<a name=\"a62\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#ad99f1dea3721139cdcb457b2a2ba32e1\">asInt</a>());</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    {</div>\n\
<div class=\"line\">        <span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span> numCreases = creaseData.<a name=\"a63\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_double_array.html#a580388f31f60c46fac867ca48a48da1e\">length</a>();</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">    samp.setUVs( iUVs );</div>\n\
<div class=\"line\">    mSubDSchema.<a name=\"a64\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_uint_array.html#ac08c5c3c225a89bdedd37c833342ce44\">set</a>(samp);</div>\n\
<div class=\"line\">    writeColor();</div>\n\
<div class=\"line\">    writeUVSets();</div>\n\
<div class=\"line\">}</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <a name=\"_a65\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_float_point_array.html\">MFloatPointArray</a> pts;</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    lMesh.getPoints(pts);</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> (pts.<a name=\"a66\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_float_point_array.html#a580388f31f60c46fac867ca48a48da1e\">length</a>() &lt; 3 &amp;&amp; pts.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_float_point_array.html#a580388f31f60c46fac867ca48a48da1e\">length</a>() &gt; 0)</div>\n\
<div class=\"line\">    {</div>\n\
...
<div class=\"line\">    {</div>\n\
<div class=\"line\">        <a name=\"a67\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_global.html#acb043e7fc4eb7fc0f39833d31364b8a4\">MGlobal::displayWarning</a>(lMesh.fullPathName() + <span class=\"stringliteral\">&quot; has no polygons.&quot;</span>);</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">return</span>;</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
