...
<div class=\"line\">    <span class=\"keyword\">static</span> <a name=\"_a11\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html\">MString</a> pluginPath;</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    offsetMatrix=mAttr.<a name=\"a13\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_matrix_attribute.html#acccc043a2ac80be8fe8e32bcc36b8696\">create</a>( <span class=\"stringliteral\">&quot;locateMatrix&quot;</span>, <span class=\"stringliteral\">&quot;lm&quot;</span>);</div>\n\
<div class=\"line\">        mAttr.<a name=\"a14\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_attribute.html#a8d2be80de133a200a455bf9e2ac1b709\">setStorable</a>(<span class=\"keyword\">false</span>);</div>\n\
<div class=\"line\">        mAttr.<a name=\"a15\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_attribute.html#ab1986dcbce4e2fd86c5cb0bff5119dc0\">setConnectable</a>(<span class=\"keyword\">true</span>);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    <span class=\"comment\">//</span></div>\n\
<div class=\"line\">    <a name=\"_a17\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_data_handle.html\">MDataHandle</a> envData = block.<a name=\"a18\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_data_block.html#af4a356799acd4ed070d372ed7cfb4706\">inputValue</a>(envelope, &amp;returnStatus);</div>\n\
...
<div class=\"line\">    <span class=\"keywordtype\">float</span> env = envData.<a name=\"a19\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_data_handle.html#a43df510424a7de372dd130315d9f223c\">asFloat</a>();</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_matrix.html\">MMatrix</a> omat = matData.<a name=\"a20\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_data_handle.html#aaa25e9866d30fc06edc510817e32a8f2\">asMatrix</a>();</div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_matrix.html\">MMatrix</a> omatinv = omat.<a name=\"a21\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_matrix.html#a8ca5ebc404566e2c4a16d4754772e082\">inverse</a>();</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"comment\">// iterate through each point in the geometry</span></div>\n\
<div class=\"line\">    <span class=\"comment\">//</span></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">for</span> ( ; !iter.<a name=\"a22\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_it_geometry.html#a8b6dbf6fbab6f4e7bf50a309124cbf4c\">isDone</a>(); iter.<a name=\"a23\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_it_geometry.html#a73616f002814b8abe6d921db72d7a496\">next</a>()) {</div>\n\
<div class=\"line\">        <a name=\"_a24\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_point.html\">MPoint</a> pt = iter.<a name=\"a25\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_it_geometry.html#a5880c110ed81dd4da0289ccdca5c1592\">position</a>();</div>\n\
<div class=\"line\">        pt *= omatinv;</div>\n\
<div class=\"line\">        <span class=\"keywordtype\">float</span> weight = weightValue(block,multiIndex,iter.<a name=\"a26\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_it_geometry.html#ae85767d1d26fc7491279d1f2c277b499\">index</a>());</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">        <span class=\"comment\">// offset algorithm</span></div>\n\
<div class=\"line\">        <span class=\"comment\">//</span></div>\n\
<div class=\"line\">        pt.<a name=\"a27\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_point.html#ab927965981178aa1fba979a37168db2a\">y</a> = pt.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_point.html#ab927965981178aa1fba979a37168db2a\">y</a> + env*weight;</div>\n\
<div class=\"line\">        <span class=\"comment\">//</span></div>\n\
<div class=\"line\">        <span class=\"comment\">// end of offset algorithm</span></div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">        pt *= omat;</div>\n\
<div class=\"line\">        iter.<a name=\"a28\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_it_geometry.html#aab29469f67fee14833472410a17de18f\">setPosition</a>(pt);</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">return</span> returnStatus;</div>\n\
<div class=\"line\">}</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    <a name=\"_a44\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_index_mapper.html\">MIndexMapper</a> fIndexMapper;</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"comment\">// Storage for data on the GPU</span></div>\n\
<div class=\"line\">    <a name=\"_a45\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_auto_c_l_mem.html\">MAutoCLMem</a> fCLWeights;</div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_auto_c_l_mem.html\">MAutoCLMem</a> fCLAffectMap;</div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_auto_c_l_mem.html\">MAutoCLMem</a> fCLOffsetMatrix;</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    <a name=\"_a46\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_auto_c_l_kernel.html\">MAutoCLKernel</a> fKernel;</div>\n\
<div class=\"line\">};</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_px_g_p_u_deformer.html\">MPxGPUDeformer</a>* <a name=\"a47\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_g_p_u_deformer_registration_info.html#a69ee4850048ea760d9e03f2deaf957e4\">createGPUDeformer</a>()<span class=\"keyword\"> override</span></div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html\">MObject</a> node = plug.<a name=\"a50\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#ae024049dad815f2f186e6a4fead8be51\">node</a>();</div>\n\
...
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html\">MPlug</a> envelopePlug(node, <a name=\"a51\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_px_geometry_filter.html#a7ec5f07562204a9fa9b136a856cb97c4\">MPxDeformerNode::envelope</a>);</div>\n\
...
<div class=\"line\">    {</div>\n\
<div class=\"line\">        <a name=\"a52\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_open_c_l_info.html#a8682346bb79641242ffc37e0b163f136\">MOpenCLInfo::appendMessage</a>(messages, <span class=\"stringliteral\">&quot;Offset %s not supported by deformer evaluator because envelope is not exactly 1.0.&quot;</span>, fnNode.name().asChar());</div>\n\
...
<div class=\"line\">}</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">cl_int offsetGPUDeformer::enqueueInitializeOutputPositions(</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">    <a name=\"_a53\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_g_p_u_event_list.html\">MGPUEventList</a> eventList;</div>\n\
<div class=\"line\">    eventList.<a name=\"a54\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_g_p_u_event_list.html#a8692d830f89f7fb213410850e6e1bec6\">add</a>(syncInputEvent);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">                <a name=\"a55\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_open_c_l_info.html#a93e129c1488b06f3347eaaad703ffe34\">MOpenCLInfo::getMayaDefaultOpenCLCommandQueue</a>(),</div>\n\
<div class=\"line\">                inputPositions.<a name=\"a56\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_g_p_u_deformer_buffer.html#a1978a75e975b7269214d00fef1c5f910\">buffer</a>().<a name=\"a57\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_auto_c_l_mem.html#a4a4337dc2dfd99fcea06f9319b21cb9b\">get</a>(),</div>\n\
...
<div class=\"line\">                eventList.<a name=\"a58\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_g_p_u_event_list.html#ae2b6b45ee3c5562875d44e5c502f63c7\">size</a>(),</div>\n\
<div class=\"line\">                eventList.<a name=\"a59\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_g_p_u_event_list.html#ad249694f568f0d014f2e0285062c05bd\">array</a>(),</div>\n\
<div class=\"line\">                syncEvent.<a name=\"a60\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_auto_c_l_event.html#a5622645d1b16ac4ab77c233dcea5c5be\">getReferenceForAssignment</a>());</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <a name=\"a61\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_open_c_l_info.html#a753d7277906776cd710b3723d74f8b64\">MOpenCLInfo::checkCLErrorStatus</a>(err);</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">return</span> err;</div>\n\
<div class=\"line\">}</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    syncEvent = <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_auto_c_l_event.html\">MAutoCLEvent</a>();</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_g_p_u_event_list.html\">MGPUEventList</a> eventList;</div>\n\
<div class=\"line\">    eventList.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_g_p_u_event_list.html#a8692d830f89f7fb213410850e6e1bec6\">add</a>(syncInputEvent);</div>\n\
<div class=\"line\">  </div>\n\
...
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_open_c_l_info.html\">MOpenCLInfo</a>::checkCLErrorStatus(err);</div>\n\
<div class=\"line\">    err = clSetKernelArg(fKernel.get(), parameterId++, sizeof(cl_mem), (<span class=\"keywordtype\">void</span>*)fCLOffsetMatrix.getReadOnlyRef());</div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_open_c_l_info.html\">MOpenCLInfo</a>::checkCLErrorStatus(err);</div>\n\
...
<div class=\"line\">}</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_px_g_p_u_deformer.html\">MPxGPUDeformer</a>::DeformerStatus offsetGPUDeformer::evaluate(</div>\n\
...
<div class=\"line\">    const <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_evaluation_node.html\">MEvaluationNode</a>&amp; evaluationNode,      <span class=\"comment\">// evaluation node representing &quot;this&quot; node</span></div>\n\
<div class=\"line\">    const <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html\">MPlug</a>&amp; plug,                          <span class=\"comment\">// the multi index we&#39;re working on.  There will be a separate instance created per multi index</span></div>\n\
<div class=\"line\">    const <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_g_p_u_deformer_data.html\">MGPUDeformerData</a>&amp; inputData,          <span class=\"comment\">// the input data provided by Maya or other upstream GPU Deformers</span></div>\n\
...
<div class=\"line\">)</div>\n\
<div class=\"line\">{</div>\n\
<div class=\"line\">    <span class=\"keyword\">const</span> <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_g_p_u_deformer_buffer.html\">MGPUDeformerBuffer</a> inputPositions = inputData.getBuffer(<a name=\"a63\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_px_g_p_u_deformer.html#a3355163bdc23aa2119a8b321e8e91fe5\">MPxGPUDeformer::sPositionsName</a>());</div>\n\
...
<div class=\"line\">    fNumElements = inputPositions.<a name=\"a65\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_g_p_u_deformer_buffer.html#ac9580a2ec3ad9690d0fb0ea0b3179fec\">elementCount</a>();</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html\">MObject</a> node = plug.node();</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">        fKernel = <a name=\"a66\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_open_c_l_info.html#a9b9a0680620c0ecac7dd1b07159ee72f\">MOpenCLInfo::getOpenCLKernel</a>(openCLKernelFile, openCLKernelName);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_auto_c_l_event.html\">MAutoCLEvent</a> syncEvent = inputPositions.<a name=\"a67\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_g_p_u_deformer_buffer.html#ac80e15ff48577dcb6db7ba2db5788427\">bufferReadyEvent</a>();</div>\n\
<div class=\"line\">    cl_int err = CL_SUCCESS;</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    fCLOffsetMatrix.reset();</div>\n\
...
<div class=\"line\">}</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"><span class=\"keywordtype\">void</span> offsetGPUDeformer::extractAffectMap()</div>\n\
<div class=\"line\">{</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">        <a name=\"_a72\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_int_array.html\">MIntArray</a> affectMap = fIndexMapper.affectMap();</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">for</span> (<span class=\"keywordtype\">size_t</span> i = 0; i &lt; affectMap.<a name=\"a73\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_int_array.html#a580388f31f60c46fac867ca48a48da1e\">length</a>(); ++i)</div>\n\
...
<div class=\"line\">            <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_renderer.html#a4678a72ac6959ed21d422d27928d0343\">MHWRender::MRenderer::theRenderer</a>()-&gt;<a name=\"a74\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_renderer.html#ab4c1def24e934781098b800fd8b16cdd\">holdGPUMemory</a>(fAffectMapBufferSize);</div>\n\
<div class=\"line\">            fCLAffectMap.attach(clCreateBuffer(<a name=\"a75\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_open_c_l_info.html#a2ab4ea6f879cbd19b67ca57cb3474d7b\">MOpenCLInfo::getOpenCLContext</a>(), CL_MEM_COPY_HOST_PTR | CL_MEM_READ_ONLY, bufferSize, (<span class=\"keywordtype\">void</span>*)&amp;temp[0], &amp;err));</div>\n\
<div class=\"line\">        }</div>\n\
...
<div class=\"line\">}</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"><span class=\"keywordtype\">bool</span> offsetGPUDeformer::needsAffectMap()<span class=\"keyword\"> const</span></div>\n\
<div class=\"line\"><span class=\"keyword\"></span>{</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">return</span> (affectCount() &lt; fullCount());</div>\n\
<div class=\"line\">}</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"><span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span> offsetGPUDeformer::affectCount()<span class=\"keyword\"> const</span></div>\n\
<div class=\"line\"><span class=\"keyword\"></span>{</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">return</span> fIndexMapper.affectCount();</div>\n\
<div class=\"line\">}</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"><span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span> offsetGPUDeformer::fullCount()<span class=\"keyword\"> const</span></div>\n\
<div class=\"line\"><span class=\"keyword\"></span>{</div>\n\
...
<div class=\"line\">    <span class=\"keywordflow\">if</span> (fCLWeights.get() &amp;&amp; !<a name=\"a76\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_px_g_p_u_deformer.html#abb7238dc52214c1b33a9c4000c1f237e\">MPxGPUDeformer::hasAttributeBeenModified</a>(evaluationNode, <a name=\"a77\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_px_deformer_node.html#a35a26e066faae03152b67f2067b1d53f\">MPxDeformerNode::weightList</a>))</div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">return</span>;</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    status = weightList.<a name=\"a80\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_array_data_handle.html#a8d77f0fea87bb6854b60cd199bf26240\">jumpToElement</a>(plug.<a name=\"a81\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#aee365de27bc5ea401941e79738cc4afe\">logicalIndex</a>());</div>\n\
...
<div class=\"line\">    <span class=\"keywordflow\">else</span></div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">        <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_data_handle.html\">MDataHandle</a> weightsStructure = weightList.<a name=\"a82\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_array_data_handle.html#a81d24dca6d647d8d0a8fe0ef2c63b170\">inputValue</a>(&amp;status);</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span> (!status) <span class=\"keywordflow\">return</span>;</div>\n\
<div class=\"line\">        <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_array_data_handle.html\">MArrayDataHandle</a> weights = weightsStructure.<a name=\"a83\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_data_handle.html#a58951af761a410e17982060cae4fdf49\">child</a>(<a name=\"a84\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_px_deformer_node.html#ae4200be6c5a30e8d817e6a3b51d20402\">MPxDeformerNode::weights</a>);</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span> (!status) <span class=\"keywordflow\">return</span>;</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">        <span class=\"comment\">// number of non-zero weights</span></div>\n\
<div class=\"line\">        <span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span> numWeights = weights.<a name=\"a85\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_array_data_handle.html#a5f3dd1d27853eccbbe78b6d4383ccb79\">elementCount</a>(&amp;status);</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span> (!status) <span class=\"keywordflow\">return</span>;</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">        <span class=\"keywordflow\">for</span>(<span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span> i=0; i&lt;numWeights; i++, weights.<a name=\"a86\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_array_data_handle.html#a73616f002814b8abe6d921db72d7a496\">next</a>())</div>\n\
<div class=\"line\">        {</div>\n\
<div class=\"line\">            <span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span> weightsElementIndex = weights.<a name=\"a87\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_array_data_handle.html#a2ca3c3d60cf2f3ac005b651379f26143\">elementIndex</a>(&amp;status);</div>\n\
...
<div class=\"line\">    <span class=\"keywordflow\">if</span> (fCLOffsetMatrix.get() &amp;&amp; !<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_px_g_p_u_deformer.html#abb7238dc52214c1b33a9c4000c1f237e\">MPxGPUDeformer::hasAttributeBeenModified</a>(evaluationNode, offset::offsetMatrix))</div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">return</span>;</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    omat = omat.<a name=\"a88\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_matrix.html#a6fadbac6023eb9d361176a87b73063dc\">transpose</a>();</div>\n\
...
<div class=\"line\">    <span class=\"comment\">// Two possibilities, we could be updating an existing OpenCL buffer or allocating a new one.</span></div>\n\
<div class=\"line\">    cl_int err = CL_SUCCESS;</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> (!fCLOffsetMatrix.get())</div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">        fCLOffsetMatrix.attach(clCreateBuffer(<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_open_c_l_info.html#a2ab4ea6f879cbd19b67ca57cb3474d7b\">MOpenCLInfo::getOpenCLContext</a>(), CL_MEM_COPY_HOST_PTR | CL_MEM_READ_ONLY, numFloat * <span class=\"keyword\">sizeof</span>(<span class=\"keywordtype\">float</span>), (<span class=\"keywordtype\">void</span>*) temp, &amp;err));</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">else</span></div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">        <span class=\"comment\">// I use a blocking write here, non-blocking could be faster...  need to manage the lifetime of temp, and have the kernel wait until the write finishes before running</span></div>\n\
<div class=\"line\">        err = clEnqueueWriteBuffer(<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_open_c_l_info.html#a93e129c1488b06f3347eaaad703ffe34\">MOpenCLInfo::getMayaDefaultOpenCLCommandQueue</a>(), fCLOffsetMatrix.get(), CL_TRUE, 0, numFloat * <span class=\"keyword\">sizeof</span>(float), (<span class=\"keywordtype\">void</span>*)temp, 0, NULL, NULL);</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">{</div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html\">MStatus</a> result;</div>\n\
<div class=\"line\">    <a name=\"_a89\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_plugin.html\">MFnPlugin</a> plugin( obj, PLUGIN_COMPANY, <span class=\"stringliteral\">&quot;3.0&quot;</span>, <span class=\"stringliteral\">&quot;Any&quot;</span>);</div>\n\
<div class=\"line\">    result = plugin.registerNode( <span class=\"stringliteral\">&quot;offset&quot;</span>, offset::id, offset::creator,</div>\n\
<div class=\"line\">                                  offset::initialize, MPxNode::kDeformerNode );</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    <a name=\"a90\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_g_p_u_deformer_registry.html#adea377dddd00bec03a6cdf70360f567f\">MGPUDeformerRegistry::registerGPUDeformerCreator</a>(</div>\n\
<div class=\"line\">        nodeClassName,</div>\n\
<div class=\"line\">        registrantId,</div>\n\
<div class=\"line\">        offsetGPUDeformer::getGPUDeformerInfo());</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <a name=\"a91\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_g_p_u_deformer_registry.html#a2e96bdde07077e4af65457c6edb9c11a\">MGPUDeformerRegistry::addConditionalAttribute</a>(</div>\n\
<div class=\"line\">            nodeClassName,</div>\n\
<div class=\"line\">            registrantId,</div>\n\
...
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html\">MString</a> nodeClassName(<span class=\"stringliteral\">&quot;offset&quot;</span>);</div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html\">MString</a> registrantId(<span class=\"stringliteral\">&quot;mayaPluginExample&quot;</span>);</div>\n\
<div class=\"line\">    <a name=\"a92\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_g_p_u_deformer_registry.html#aa290ea8dc9cb67e1056f132b8e441d5f\">MGPUDeformerRegistry::deregisterGPUDeformerCreator</a>(</div>\n\
<div class=\"line\">        nodeClassName,</div>\n\
<div class=\"line\">        registrantId);</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">return</span> result;</div>\n\
