...
<div class=\"line\">                      <span class=\"keyword\">const</span> MRenderItem::RenderItemType  type,</div>\n\
...
<div class=\"line\">            <span class=\"keywordflow\">if</span> (fRenderItem) {</div>\n\
<div class=\"line\">                <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_selection_mask.html\">MSelectionMask</a> pointsForGravityMask(MSelectionMask::kSelectPointsForGravity);</div>\n\
...
<div class=\"line\">    <span class=\"keyword\">const</span> MRenderItem::RenderItemType   type()<span class=\"keyword\"> const      </span>{ <span class=\"keywordflow\">return</span> fType; }</div>\n\
...
<div class=\"line\">    <span class=\"keyword\">const</span> MRenderItem::RenderItemType       fType;</div>\n\
...
<div class=\"line\">        <span class=\"keywordflow\">for</span>(<span class=\"keyword\">const</span> HardwareInstance&amp; hwInstance : fInstances) {</div>\n\
<div class=\"line\">            <span class=\"keywordflow\">if</span> (hwInstance.master-&gt;renderItem()-&gt;name() == renderItem.<a name=\"a46\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_render_item.html#aca2cba4630391c78dcf1a828986160da\">name</a>())</div>\n\
<div class=\"line\">            {</div>\n\
...
<div class=\"line\">                {</div>\n\
<div class=\"line\">                    <a name=\"_a47\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string_array.html\">MStringArray</a> renderItemParts;</div>\n\
<div class=\"line\">                    renderItemName.<a name=\"a48\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html#ac914d138fc96d7065c687a4f8b40c263\">split</a>(<span class=\"charliteral\">&#39;:&#39;</span>, renderItemParts);</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">                    <span class=\"keywordflow\">if</span> (renderItemParts.<a name=\"a49\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string_array.html#a580388f31f60c46fac867ca48a48da1e\">length</a>() &gt; 1 &amp;&amp; renderItemParts[0].isUnsigned())</div>\n\
<div class=\"line\">                    {</div>\n\
...
<div class=\"line\">        fMayaExitingCallback = MSceneMessage::addCallback(</div>\n\
<div class=\"line\">            MSceneMessage::kMayaExiting, MayaExitingCallback, NULL);</div>\n\
<div class=\"line\">        fSelectionChangedCallback = <a name=\"a50\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_model_message.html#ac4dd423a333cf2a97157987532b36675\">MModelMessage::addCallback</a>(</div>\n\
<div class=\"line\">            MModelMessage::kActiveListModified, SelectionChangedCallback, <span class=\"keyword\">this</span>);</div>\n\
<div class=\"line\">        fTimeChangeCallback = <a name=\"a51\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_d_g_message.html#a0cf2d487672abd947a5abc89ac788789\">MDGMessage::addTimeChangeCallback</a>(</div>\n\
<div class=\"line\">            TimeChangeCallback, <span class=\"keyword\">this</span>);</div>\n\
<div class=\"line\">        fRenderLayerChangeCallback = <a name=\"a52\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_event_message.html#a8d22c58b90484867755273c2f7ffc6ec\">MEventMessage::addEventCallback</a>(</div>\n\
...
<div class=\"line\">    ~ModelCallbacks()</div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">        <a name=\"a53\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_message.html#a50fe995add3ce133b8b56551abb4ed09\">MMessage::removeCallback</a>(fMayaExitingCallback);</div>\n\
...
<div class=\"line\">        <a name=\"a54\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_global.html#a6d81d38246555884897fb153c93aaf42\">MGlobal::getActiveSelectionList</a>(list);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">        <a name=\"_a55\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_dag_path.html\">MDagPath</a>   dagPath;</div>\n\
<div class=\"line\">        <a name=\"_a56\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_it_dag.html\">MItDag</a>     dagIt;</div>\n\
<div class=\"line\">        <a name=\"_a57\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_dag_node.html\">MFnDagNode</a> dagNode;</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">for</span> (<span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span> i = 0, size = list.<a name=\"a58\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_selection_list.html#a99dd6a54b909ede1d11702fe58977e2a\">length</a>(); i &lt; size; i++) {</div>\n\
<div class=\"line\">            <span class=\"keywordflow\">if</span> (list.<a name=\"a59\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_selection_list.html#a16dda1a34d5f10be257d8421ac6deabd\">getDagPath</a>(i, dagPath) &amp;&amp; dagPath.<a name=\"a60\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_dag_path.html#a095ae34296e81703965265a42ee783ca\">isValid</a>()) {</div>\n\
<div class=\"line\">                <span class=\"comment\">// Iterate the DAG to find descendant gpuCache nodes.</span></div>\n\
<div class=\"line\">                dagIt.<a name=\"a61\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_it_dag.html#ac734f26ff1c92ecec3572a31f5e4435c\">reset</a>(dagPath, MItDag::kDepthFirst, <a name=\"a62\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn.html#a1d1cfd8ffb84e947f82999c682b666a7ad409ef3c9033402174590389a6ce18ea\">MFn::kPluginShape</a>);</div>\n\
<div class=\"line\">                <span class=\"keywordflow\">for</span> (; !dagIt.<a name=\"a63\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_it_dag.html#a8b6dbf6fbab6f4e7bf50a309124cbf4c\">isDone</a>(); dagIt.<a name=\"a64\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_it_dag.html#a73616f002814b8abe6d921db72d7a496\">next</a>()) {</div>\n\
<div class=\"line\">                    <span class=\"keywordflow\">if</span> (dagNode.<a name=\"a65\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_dag_node.html#a6b2301b53683a8e8f56dd0b9cb088b0f\">setObject</a>(dagIt.<a name=\"a66\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_it_dag.html#afc1c0d71245e763fc566fc1d67ab06ae\">currentItem</a>()) &amp;&amp; dagNode.<a name=\"a67\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_dependency_node.html#a1d0bbd4d50dae591f8e003c0aedc8135\">typeId</a>() == ShapeNode::id) {</div>\n\
<div class=\"line\">                        <span class=\"keyword\">const</span> ShapeNode* shapeNode = (<span class=\"keyword\">const</span> ShapeNode*)dagNode.<a name=\"a68\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_dependency_node.html#a4f2c53c9d1dcf25a6462c70fb25aead1\">userNode</a>();</div>\n\
<div class=\"line\">                        <span class=\"keywordflow\">if</span> (shapeNode) {</div>\n\
<div class=\"line\">                            currentSelection.insert(std::make_pair(dagIt.<a name=\"a69\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_it_dag.html#ac4b316731c4019c927aa63731d4749e8\">fullPathName</a>(), shapeNode));</div>\n\
<div class=\"line\">                        }</div>\n\
<div class=\"line\">                    }</div>\n\
<div class=\"line\">                }</div>\n\
<div class=\"line\">            }</div>\n\
...
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keyword\">static</span> <span class=\"keywordtype\">void</span> TimeChangeCallback(<a name=\"_a70\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_time.html\">MTime</a>&amp; time, <span class=\"keywordtype\">void</span>* clientData)</div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">        assert(clientData);</div>\n\
...
<div class=\"line\"><span class=\"keywordtype\">void</span> WorldMatrixChangedCallback(<a name=\"_a71\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html\">MObject</a>&amp; transformNode,</div>\n\
...
<div class=\"line\">    assert(clientData);</div>\n\
<div class=\"line\">    <a name=\"_a72\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_attribute.html\">MFnAttribute</a> attr(plug.<a name=\"a73\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a240c26abf3ba7645371553cb130691fa\">attribute</a>());</div>\n\
...
<div class=\"line\">            ));</div>\n\
<div class=\"line\">            fSnappingItem-&gt;setDrawMode(MHWRender::MGeometry::kSelectionOnly);</div>\n\
...
<div class=\"line\">        fVisibility = dagPath.<a name=\"a74\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_dag_path.html#a27f324b7f2643119a7542e39101601d1\">isVisible</a>();</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\"><span class=\"comment\">//==============================================================================</span></div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"><a name=\"_a75\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_px_sub_scene_override.html\">MPxSubSceneOverride</a>* SubSceneOverride::creator(<span class=\"keyword\">const</span> <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html\">MObject</a>&amp; <span class=\"keywordtype\">object</span>)</div>\n\
<div class=\"line\">{</div>\n\
...
<div class=\"line\">    fCastsShadowsPlug   = dagNode.<a name=\"a76\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_dependency_node.html#aac29b4a3b51c9d236175e955638f7153\">findPlug</a>(<span class=\"stringliteral\">&quot;castsShadows&quot;</span>, <span class=\"keyword\">false</span>);</div>\n\
...
<div class=\"line\">    <a name=\"a77\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_dag_path.html#a422aa5ec02565f757c13fe2873ed25d7\">MDagPath::getAPathTo</a>(<span class=\"keywordtype\">object</span>, dagPath);  <span class=\"comment\">// any path</span></div>\n\
<div class=\"line\">    fInstanceAddedCallback = <a name=\"a78\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_dag_message.html#a9c301d5a30d9424eea522166b283a98d\">MDagMessage::addInstanceAddedDagPathCallback</a>(</div>\n\
<div class=\"line\">        dagPath, InstanceChangedCallback, <span class=\"keyword\">this</span>);</div>\n\
<div class=\"line\">    fInstanceRemovedCallback = <a name=\"a79\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_dag_message.html#aafe921878a14c3ae07f6a453773c59e2\">MDagMessage::addInstanceRemovedDagPathCallback</a>(</div>\n\
<div class=\"line\">        dagPath, InstanceChangedCallback, <span class=\"keyword\">this</span>);</div>\n\
<div class=\"line\">    fWorldMatrixChangedCallback = <a name=\"a80\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_dag_message.html#a33a28fd9c6b6fbaa4fefe2c849f76636\">MDagMessage::addWorldMatrixModifiedCallback</a>(</div>\n\
...
<div class=\"line\">    <a name=\"a81\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_message.html#ac637287cc26b707b9e1a175a32f44e29\">MMessage::removeCallbacks</a>(fNodeDirtyCallbacks);</div>\n\
...
<div class=\"line\">        BoundingBoxVisitor visitor(<a name=\"a86\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_anim_control.html#a8cb1e013d828c1d012fee789b14e0060\">MAnimControl::currentTime</a>().as(MTime::kSeconds));</div>\n\
...
<div class=\"line\">                renderer-&gt;<a name=\"a87\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_renderer.html#aac2a5827e6a0ce3333e62ffa7751ba5e\">drawAPIIsOpenGL</a>() ? Frustum::kOpenGL : Frustum::kDirectX);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">        fInstanceRenderItems.clear();</div>\n\
<div class=\"line\">        container.<a name=\"a88\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_sub_scene_container.html#ac8bb3912a3ce86b15842e79d0b421204\">clear</a>();</div>\n\
...
<div class=\"line\">    fTimeInSeconds = <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_anim_control.html#a8cb1e013d828c1d012fee789b14e0060\">MAnimControl::currentTime</a>().<a name=\"a89\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_time.html#a105d41236561f4d4be6383ced757a429\">as</a>(MTime::kSeconds);</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"comment\">// Update the render items.</span></div>\n\
...
<div class=\"line\">    <span class=\"keywordtype\">int</span> hardwareInstanceIndex = intersection.<a name=\"a91\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_intersection.html#a35ab9f5cd2b7e3c46d5c661d9cd73571\">instanceID</a>();</div>\n\
...
<div class=\"line\">    {</div>\n\
<div class=\"line\">            dagPath.<a name=\"a92\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_dag_path.html#a0803071a27de28ea0eee7fdc7812de95\">set</a>(fInstanceDagPaths[pathIndex]);</div>\n\
<div class=\"line\">            <span class=\"keywordflow\">if</span> (dagPath.<a name=\"a93\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_dag_path.html#af321be336f1f2d96ac2273a87cb3c8ab\">length</a>() &gt; 1)</div>\n\
<div class=\"line\">                dagPath.<a name=\"a94\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_dag_path.html#ac71eca2b78b8cfc088adc9af6f851dfd\">pop</a>(); <span class=\"comment\">// from shape to xform.</span></div>\n\
<div class=\"line\">            <span class=\"keywordflow\">return</span> <span class=\"keyword\">true</span>;</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">return</span> <span class=\"keyword\">false</span>;</div>\n\
...
<div class=\"line\">    {</div>\n\
<div class=\"line\">        selectionContext.<a name=\"a96\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_selection_context.html#ab1ead3c2bb71ebaaaa7b94b8a1dcaa3b\">setSelectionLevel</a>(MHWRender::MSelectionContext::kComponent);</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\">}</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    <a name=\"_a97\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_dag_path_array.html\">MDagPathArray</a> paths;</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">for</span> (<span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span> i = 0; i &lt; paths.<a name=\"a98\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_dag_path_array.html#a580388f31f60c46fac867ca48a48da1e\">length</a>(); i++) {</div>\n\
...
<div class=\"line\">            <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html\">MObject</a> node = dagPath.<a name=\"a99\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_dag_path.html#ae024049dad815f2f186e6a4fead8be51\">node</a>();</div>\n\
<div class=\"line\"></div>\n\
