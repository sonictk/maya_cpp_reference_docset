...
<div class=\"line\">                                         MFnNurbsCurveData::kNurbsCurve,</div>\n\
...
<div class=\"line\">                                            MFnNurbsSurfaceData::kNurbsSurface,</div>\n\
...
<div class=\"line\">    stat = typedAttr.<a name=\"a12\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_attribute.html#a8d2be80de133a200a455bf9e2ac1b709\">setStorable</a>( <span class=\"keyword\">false</span> );</div>\n\
...
<div class=\"line\">    <span class=\"keywordtype\">int</span> numCurves = inputArray.<a name=\"a16\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_array_data_handle.html#a5f3dd1d27853eccbbe78b6d4383ccb79\">elementCount</a> ();</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    inputArray.<a name=\"a17\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_array_data_handle.html#a8d77f0fea87bb6854b60cd199bf26240\">jumpToElement</a>(0);</div>\n\
<div class=\"line\">    <a name=\"_a18\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_data_handle.html\">MDataHandle</a> elementHandle = inputArray.<a name=\"a19\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_array_data_handle.html#a81d24dca6d647d8d0a8fe0ef2c63b170\">inputValue</a>(&amp;stat);</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> (!stat) {</div>\n\
<div class=\"line\">        stat.<a name=\"a20\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a1f01a4748fea4d8bcced082df83f804d\">perror</a>(<span class=\"stringliteral\">&quot;fullLoft::loft: inputValue&quot;</span>);</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">return</span> <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html#af2a707b4254eb54763167aeced863e63\">MObject::kNullObj</a>;</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html\">MObject</a> countCurve (elementHandle.<a name=\"a21\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_data_handle.html#afa3c149ea6bce4807af2d0ca7cf4c527\">asNurbsCurve</a>());</div>\n\
<div class=\"line\">    <a name=\"_a22\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_nurbs_curve.html\">MFnNurbsCurve</a> countCurveFn (countCurve);</div>\n\
...
<div class=\"line\">    {</div>\n\
<div class=\"line\">        ku.<a name=\"a23\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_double_array.html#aafcfe8ff7afecc2dee4defccbdfb8e55\">append</a> (<span class=\"keywordtype\">double</span> (i));</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">        stat = curveFn.getCVs (curveCVs, MSpace::kWorld);</div>\n\
<div class=\"line\">        PERRORnull(<span class=\"stringliteral\">&quot;fullLoft::loft getting CVs&quot;</span>);</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span> (curveCVs.<a name=\"a24\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_point_array.html#a580388f31f60c46fac867ca48a48da1e\">length</a>() != (unsigned)numCVs)</div>\n\
...
<div class=\"line\">                cvs.<a name=\"a25\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_point_array.html#abe5a9fe36b4651af38a4a26c85f46e1a\">append</a> (curveCVs [i]);</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">        stat = inputArray.<a name=\"a26\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_array_data_handle.html#a73616f002814b8abe6d921db72d7a496\">next</a> ();</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html\">MObject</a> surf = surfFn.<a name=\"a27\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_nurbs_surface.html#a6a3e914fe9c070228f4df8f4a593b4c8\">create</a>(cvs, ku, kv, 3, 3,</div>\n\
<div class=\"line\">                                 MFnNurbsSurface::kOpen,</div>\n\
<div class=\"line\">                                 MFnNurbsSurface::kOpen,</div>\n\
...
<div class=\"line\">    {</div>\n\
<div class=\"line\">        <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_array_data_handle.html\">MArrayDataHandle</a> inputArrayData = data.<a name=\"a28\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_data_block.html#a6ba8ea2b4af93fabd2a7c846a1625587\">inputArrayValue</a>( inputCurve,</div>\n\
<div class=\"line\">                                                                &amp;stat );</div>\n\
<div class=\"line\">        PERRORfail(<span class=\"stringliteral\">&quot;fullLoft::compute getting input array data&quot;</span>);</div>\n\
<div class=\"line\">        <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_data_handle.html\">MDataHandle</a> surfHandle = data.<a name=\"a29\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_data_block.html#a5e4082d6ab961bee4ec0281676bb4834\">outputValue</a>( fullLoft::outputSurface );</div>\n\
...
<div class=\"line\">        stat = surfHandle.<a name=\"a32\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_data_handle.html#a2a75482f517f405a641c0eee0bd995ac\">set</a>( newSurfData );</div>\n\
