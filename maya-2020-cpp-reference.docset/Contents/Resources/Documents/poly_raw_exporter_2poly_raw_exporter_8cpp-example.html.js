...
<html>\n\
   <head><script src=\"../scripts/yepnope.1.5.4-min.js\" type=\"text/javascript\"></script><script src=\"../scripts/lib/jquery-1.11.1.min.js\" type=\"text/javascript\"></script>\n\
      <title>C++ API Reference: polyRawExporter/polyRawExporter.cpp</title>\n\
      \n\
	  \n\
      \n\
      \n\
...
function cpp_ref_initializeToc(forceTrigger) {\n\
    ...
    cpp_ref_adsk_ref_toc.initNavTree(\'poly_raw_exporter_2poly_raw_exporter_8cpp-example.html\', tocPrefix);\n\
...
$(window).load( function() {\n\
 ...
 if (!tocSystemNeedsToBeLoaded) { cpp_ref_initializeToc(); }\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>C++ API Reference: polyRawExporter/polyRawExporter.cpp</h1>\n\
         </div>\n\
\n\
...
<div class=\"title\">polyRawExporter/polyRawExporter.cpp</div>  </div>\n\
</div><!--header-->\n\
<div class=\"contents\">\n\
...
<div class=\"line\"><span class=\"comment\">//</span></div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"><span class=\"comment\">//polyRawExporter.cpp</span></div>\n\
<div class=\"line\"><span class=\"preprocessor\">#include &lt;maya/MFnPlugin.h&gt;</span></div>\n\
<div class=\"line\"><span class=\"preprocessor\">#include &lt;maya/MDagPath.h&gt;</span></div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"><span class=\"preprocessor\">#include &quot;polyRawExporter.h&quot;</span></div>\n\
<div class=\"line\"><span class=\"preprocessor\">#include &quot;polyRawWriter.h&quot;</span></div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"><span class=\"preprocessor\">#include &lt;sstream&gt;</span></div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">polyRawExporter::~polyRawExporter() </div>\n\
<div class=\"line\">{ </div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">     </div>\n\
<div class=\"line\"><span class=\"keywordtype\">void</span>* polyRawExporter::creator() </div>\n\
<div class=\"line\"><span class=\"comment\">//Summary:  allows Maya to allocate an instance of this object</span></div>\n\
<div class=\"line\">{</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">return</span> <span class=\"keyword\">new</span> polyRawExporter();</div>\n\
<div class=\"line\">}</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"><a name=\"_a0\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html\">MString</a> polyRawExporter::defaultExtension () const </div>\n\
...
<div class=\"line\"><span class=\"comment\">//Returns:  &quot;raw&quot;</span></div>\n\
<div class=\"line\">{</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">return</span> <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html\">MString</a>(<span class=\"stringliteral\">&quot;raw&quot;</span>);</div>\n\
<div class=\"line\">}</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    <span class=\"comment\">//</span></div>\n\
<div class=\"line\">    status =  plugin.registerFileTranslator(<span class=\"stringliteral\">&quot;RawText&quot;</span>,</div>\n\
<div class=\"line\">                                            <span class=\"stringliteral\">&quot;&quot;</span>,</div>\n\
<div class=\"line\">                                            polyRawExporter::creator,</div>\n\
<div class=\"line\">                                            <span class=\"stringliteral\">&quot;&quot;</span>,</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">    status =  plugin.deregisterFileTranslator(<span class=\"stringliteral\">&quot;RawText&quot;</span>);</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> (!status) {</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"><span class=\"keywordtype\">void</span> polyRawExporter::writeHeader(std::ostream&amp; os) </div>\n\
<div class=\"line\"><span class=\"comment\">//Summary:  outputs legend information before the main data</span></div>\n\
<div class=\"line\"><span class=\"comment\">//Args   :  os - an output stream to write to</span></div>\n\
<div class=\"line\">{</div>\n\
<div class=\"line\">    os &lt;&lt; <span class=\"stringliteral\">&quot;Legend:\\n&quot;</span></div>\n\
<div class=\"line\">       &lt;&lt; <span class=\"stringliteral\">&quot;Delimiter = TAB\\n&quot;</span></div>\n\
<div class=\"line\">       &lt;&lt; <span class=\"stringliteral\">&quot;() = coordinates\\n&quot;</span></div>\n\
<div class=\"line\">       &lt;&lt; <span class=\"stringliteral\">&quot;[] = vector\\n&quot;</span></div>\n\
<div class=\"line\">       &lt;&lt; <span class=\"stringliteral\">&quot;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\\n\\n&quot;</span>;</div>\n\
<div class=\"line\">}</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">polyWriter* polyRawExporter::createPolyWriter(<span class=\"keyword\">const</span> <a name=\"_a5\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_dag_path.html\">MDagPath</a> dagPath, <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html\">MStatus</a>&amp; status) </div>\n\
<div class=\"line\"><span class=\"comment\">//Summary:  creates a polyWriter for the raw export file type</span></div>\n\
...
<div class=\"line\">{</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">return</span> <span class=\"keyword\">new</span> polyRawWriter(dagPath, status);</div>\n\
<div class=\"line\">}</div>\n\
