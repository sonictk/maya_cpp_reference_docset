...
<html>\n\
   <head><script src=\"../scripts/yepnope.1.5.4-min.js\" type=\"text/javascript\"></script><script src=\"../scripts/lib/jquery-1.11.1.min.js\" type=\"text/javascript\"></script>\n\
      <title>C++ API Reference: splitUVCmd/splitUVMain.cpp</title>\n\
      \n\
	  \n\
      \n\
      \n\
...
function cpp_ref_initializeToc(forceTrigger) {\n\
    ...
    cpp_ref_adsk_ref_toc.initNavTree(\'split_u_v_cmd_2split_u_v_main_8cpp-example.html\', tocPrefix);\n\
...
$(window).load( function() {\n\
 ...
 if (!tocSystemNeedsToBeLoaded) { cpp_ref_initializeToc(); }\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>C++ API Reference: splitUVCmd/splitUVMain.cpp</h1>\n\
         </div>\n\
\n\
...
<div class=\"title\">splitUVCmd/splitUVMain.cpp</div>  </div>\n\
</div><!--header-->\n\
<div class=\"contents\">\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">    status = plugin.<a name=\"a3\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_plugin.html#a66f0e341f74cba9d100ab8a45e71cc0b\">registerCommand</a>( <span class=\"stringliteral\">&quot;splitUV&quot;</span>, splitUV::creator );</div>\n\
...
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    status = plugin.<a name=\"a5\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_plugin.html#aaae14c466b57bba85f52b96e2f73a9db\">registerNode</a>( <span class=\"stringliteral\">&quot;splitUVNode&quot;</span>,</div>\n\
<div class=\"line\">                                  splitUVNode::id,</div>\n\
<div class=\"line\">                                  splitUVNode::creator,</div>\n\
<div class=\"line\">                                  splitUVNode::initialize );</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> (!status) {</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">    status = plugin.deregisterCommand( <span class=\"stringliteral\">&quot;splitUV&quot;</span> );</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> (!status) {</div>\n\
...
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    status = plugin.deregisterNode( splitUVNode::id );</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> (!status) {</div>\n\
